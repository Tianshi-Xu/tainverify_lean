...
POINTWISE = {
    ...
    "FW_glu":       ("fw_glu",       "applyNode_fw_glu_out",       None, False, False),
...
COLLECTIVE = {
    ...
    "ReduceScatterPrim": dict(fn="reduceScatterPrimDimN", mini="applyNode_reduceScatterPrim_out",
                              full="applyNode_reduceScatterPrim_out", kind="list",
                              form="p0 K rank LIST", nparams=1),
