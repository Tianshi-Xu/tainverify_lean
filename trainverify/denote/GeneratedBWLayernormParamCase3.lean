...
namespace BWLayernormParamGraphK4B1S4D64DxDgammaDbeta
...
def pm : GraphDecl := { numRanks := 4, nodes := [{ rank := 0, op := "OpName.FW_float", ins := [120], outs := [121] }, { rank := 0, op := "OpName.BW_layernorm", ins := [100, 104, 3, 4], outs := [108, 112, 116] }, { rank := 1, op := "OpName.FW_float", ins := [120], outs := [122] }, { rank := 1, op := "OpName.BW_layernorm", ins := [101, 105, 3, 4], outs := [109, 113, 117] }, { rank := 2, op := "OpName.FW_float", ins := [120], outs := [123] }, { rank := 2, op := "OpName.BW_layernorm", ins := [102, 106, 3, 4], outs := [110, 114, 118] }, { rank := 3, op := "OpName.FW_float", ins := [120], outs := [124] }, { rank := 3, op := "OpName.BW_layernorm", ins := [103, 107, 3, 4], outs := [111, 115, 119] }, { rank := 0, op := "OpName.FW_float", ins := [120], outs := [125] }] }
end BWLayernormParamGraphK4B1S4D64DxDgammaDbeta
/- AUTO-GENERATED closed relation state universe. -/

open TrainVerify.Denote
open TrainVerify.Denote.RelationCompiler

namespace TrainVerify.Denote.GeneratedBWLayernormParamK4B1S4D64DxDgammaDbeta
...
private def fact_x : RelationFact :=
  .sharded 2 [104, 105, 106, 107] 1 [1, 16, 64] [1, 4, 64]
...
private def fact_dx : RelationFact :=
  .sharded 10 [108, 109, 110, 111] 1 [1, 16, 64] [1, 4, 64]

private def fact_dgamma : RelationFact :=
  .reduction 11 [112, 113, 114, 115] [64]

private def fact_dbeta : RelationFact :=
  .reduction 12 [116, 117, 118, 119] [64]
...
@[irreducible] private def segment_000000_sm_final (store : Store) : Store :=
  segment_000000_sm_nodes.foldl (applyNodeDistributedFaithful BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.sm) store
@[irreducible] private def segment_000000_pm_final (store : Store) : Store :=
  segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.pm) store
...
private theorem segment_000000_hSmdx (store : Store) :
  ...
  have hfinal : (segment_000000_sm_final store) = segment_000000_sm_nodes.foldl (applyNodeDistributedFaithful BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.sm) store := by
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.sm
    ...
    hnodes hfinal (by
      ...
      exact applyNode_bw_layernorm_dx_out BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.sm t 0 1 2 3 4 10 11 12
...
private theorem segment_000000_hPmdx0 (store : Store) :
  ...
  have hfinal : (segment_000000_pm_final store) = segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.pm) store := by
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.pm
    ...
    hnodes hfinal (by
      ...
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_dx_out BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.pm t 0 100 104 3 4 108 112 116
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hPmdx1 (store : Store) :
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.pm
    ...
    hnodes hfinal (by
      ...
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_dx_out BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.pm t 1 101 105 3 4 109 113 117
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hPmdx2 (store : Store) :
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.pm
    ...
    hnodes hfinal (by
      ...
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_dx_out BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.pm t 2 102 106 3 4 110 114 118
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hPmdx3 (store : Store) :
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.pm
    ...
    hnodes hfinal (by
      ...
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_dx_out BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.pm t 3 103 107 3 4 111 115 119
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hSmdgamma (store : Store) :
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.sm
    ...
    hnodes hfinal (by
      ...
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_dw_out BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.sm t 0 1 2 3 4 10 11 12 (by native_decide)
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hPmdgamma0 (store : Store) :
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.pm
    ...
    hnodes hfinal (by
      ...
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_dw_out BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.pm t 0 100 104 3 4 108 112 116 (by native_decide)
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hPmdgamma1 (store : Store) :
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.pm
    ...
    hnodes hfinal (by
      ...
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_dw_out BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.pm t 1 101 105 3 4 109 113 117 (by native_decide)
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hPmdgamma2 (store : Store) :
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.pm
    ...
    hnodes hfinal (by
      ...
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_dw_out BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.pm t 2 102 106 3 4 110 114 118 (by native_decide)
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hPmdgamma3 (store : Store) :
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.pm
    ...
    hnodes hfinal (by
      ...
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_dw_out BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.pm t 3 103 107 3 4 111 115 119 (by native_decide)
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hSmdbeta (store : Store) :
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.sm
    ...
    hnodes hfinal (by
      ...
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_db_out BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.sm t 0 1 2 3 4 10 11 12 (by native_decide) (by native_decide)
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hPmdbeta0 (store : Store) :
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.pm
    ...
    hnodes hfinal (by
      ...
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_db_out BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.pm t 0 100 104 3 4 108 112 116 (by native_decide) (by native_decide)
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hPmdbeta1 (store : Store) :
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.pm
    ...
    hnodes hfinal (by
      ...
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_db_out BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.pm t 1 101 105 3 4 109 113 117 (by native_decide) (by native_decide)
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hPmdbeta2 (store : Store) :
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.pm
    ...
    hnodes hfinal (by
      ...
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_db_out BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.pm t 2 102 106 3 4 110 114 118 (by native_decide) (by native_decide)
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hPmdbeta3 (store : Store) :
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.pm
    ...
    hnodes hfinal (by
      ...
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_db_out BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.pm t 3 103 107 3 4 111 115 119 (by native_decide) (by native_decide)
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_dx_semantic (smFinal pmFinal : Store)
    (hg : ShardedRel (smFinal 1) [pmFinal 100, pmFinal 101, pmFinal 102, pmFinal 103] 1 [1, 16, 64] [1, 4, 64])
    (hx : ShardedRel (smFinal 2) [pmFinal 104, pmFinal 105, pmFinal 106, pmFinal 107] 1 [1, 16, 64] [1, 4, 64])
  ...
  have hComm := TrainVerify.Denote.bw_layernorm_dx_allGatherPrimDimN_dim1_3d 4 1 4 64
  ...
  have hShape0 : (pmFinal 108).shape = [1, 4, 64] := by
    rw [hPm0, bw_layernorm_dx_shape _ _ _ _ 64 [4, 1] (by rw [hx.shard_shapes _ (by simp)]; rfl)]
    exact hx.shard_shapes _ (by simp)
  have hShape1 : (pmFinal 109).shape = [1, 4, 64] := by
    rw [hPm1, bw_layernorm_dx_shape _ _ _ _ 64 [4, 1] (by rw [hx.shard_shapes _ (by simp)]; rfl)]
    exact hx.shard_shapes _ (by simp)
  have hShape2 : (pmFinal 110).shape = [1, 4, 64] := by
    rw [hPm2, bw_layernorm_dx_shape _ _ _ _ 64 [4, 1] (by rw [hx.shard_shapes _ (by simp)]; rfl)]
    exact hx.shard_shapes _ (by simp)
  have hShape3 : (pmFinal 111).shape = [1, 4, 64] := by
    rw [hPm3, bw_layernorm_dx_shape _ _ _ _ 64 [4, 1] (by rw [hx.shard_shapes _ (by simp)]; rfl)]
    exact hx.shard_shapes _ (by simp)
  have hFull : (smFinal 10).shape = [1, 16, 64] := by
    rw [hSm, bw_layernorm_dx_shape _ _ _ _ 64 [16, 1] (by rw [hx.full_shape]; rfl)]
    exact hx.full_shape
  change ShardedRel (smFinal 10) [pmFinal 108, pmFinal 109, pmFinal 110, pmFinal 111] 1 [1, 16, 64] [1, 4, 64]
...
private theorem segment_000000_dgamma_semantic (smFinal pmFinal : Store)
  ...
  have hbetaValue : smFinal 4 = pmFinal 4 := by
    ...
    simpa only [List.length_cons, List.length_nil] using
      (allGatherPrimDimN_singleton_eq 0 (pmFinal 4) (by
        rw [hbeta.shard_shapes _ (by simp)]; decide))
  have hComm := TrainVerify.Denote.bw_layernorm_dgamma_sequence_reduction_rank3 4 1 4 64
    [pmFinal 100, pmFinal 101, pmFinal 102, pmFinal 103] [pmFinal 104, pmFinal 105, pmFinal 106, pmFinal 107] (pmFinal 3) (pmFinal 4)
    (by decide) (by decide) (by decide) (by decide) rfl rfl hg.shard_shapes hx.shard_shapes
  ...
  have hValue : smFinal 11 = tensorSum [pmFinal 112, pmFinal 113, pmFinal 114, pmFinal 115] := by
    ...
    simp only [List.zipWith]
    rw [← hPm0, ← hPm1, ← hPm2, ← hPm3]
  have hShape0 : (pmFinal 112).shape = [64] := by
    rw [hPm0, bw_layernorm_dw_shape _ _ _ _ 64 [4, 1] (by rw [hx.shard_shapes _ (by simp)]; rfl)]
    exact hgammaShape
  have hShape1 : (pmFinal 113).shape = [64] := by
    rw [hPm1, bw_layernorm_dw_shape _ _ _ _ 64 [4, 1] (by rw [hx.shard_shapes _ (by simp)]; rfl)]
    exact hgammaShape
  have hShape2 : (pmFinal 114).shape = [64] := by
    rw [hPm2, bw_layernorm_dw_shape _ _ _ _ 64 [4, 1] (by rw [hx.shard_shapes _ (by simp)]; rfl)]
    exact hgammaShape
  have hShape3 : (pmFinal 115).shape = [64] := by
    rw [hPm3, bw_layernorm_dw_shape _ _ _ _ 64 [4, 1] (by rw [hx.shard_shapes _ (by simp)]; rfl)]
    exact hgammaShape
  have hFull : (smFinal 11).shape = [64] := by
    rw [hSm, bw_layernorm_dw_shape _ _ _ _ 64 [16, 1] (by rw [hx.full_shape]; rfl)]
  ...
  have hReduce : smFinal 11 = allReducePrim [pmFinal 112, pmFinal 113, pmFinal 114, pmFinal 115].length 0 [pmFinal 112, pmFinal 113, pmFinal 114, pmFinal 115] := by
    rw [hValue]
    rfl
  change ReductionRel (smFinal 11) [pmFinal 112, pmFinal 113, pmFinal 114, pmFinal 115] [64]
...
private theorem segment_000000_dbeta_semantic (smFinal pmFinal : Store)
  ...
  have hbetaValue : smFinal 4 = pmFinal 4 := by
    ...
    simpa only [List.length_cons, List.length_nil] using
      (allGatherPrimDimN_singleton_eq 0 (pmFinal 4) (by
        rw [hbeta.shard_shapes _ (by simp)]; decide))
  have hComm := TrainVerify.Denote.bw_layernorm_dbeta_sequence_reduction_rank3 4 1 4 64
    [pmFinal 100, pmFinal 101, pmFinal 102, pmFinal 103] [pmFinal 104, pmFinal 105, pmFinal 106, pmFinal 107] (pmFinal 3) (pmFinal 4)
    (by decide) (by decide) (by decide) (by decide) rfl rfl hg.shard_shapes hx.shard_shapes
    hgammaShape hbetaShape
  have hValue : smFinal 12 = tensorSum [pmFinal 116, pmFinal 117, pmFinal 118, pmFinal 119] := by
    ...
    simp only [List.zipWith]
    rw [← hPm0, ← hPm1, ← hPm2, ← hPm3]
  have hShape0 : (pmFinal 116).shape = [64] := by
    rw [hPm0, bw_layernorm_db_shape _ _ _ _ 64 [4, 1] (by rw [hx.shard_shapes _ (by simp)]; rfl)]
    exact hbetaShape
  have hShape1 : (pmFinal 117).shape = [64] := by
    rw [hPm1, bw_layernorm_db_shape _ _ _ _ 64 [4, 1] (by rw [hx.shard_shapes _ (by simp)]; rfl)]
    exact hbetaShape
  have hShape2 : (pmFinal 118).shape = [64] := by
    rw [hPm2, bw_layernorm_db_shape _ _ _ _ 64 [4, 1] (by rw [hx.shard_shapes _ (by simp)]; rfl)]
    exact hbetaShape
  have hShape3 : (pmFinal 119).shape = [64] := by
    rw [hPm3, bw_layernorm_db_shape _ _ _ _ 64 [4, 1] (by rw [hx.shard_shapes _ (by simp)]; rfl)]
    exact hbetaShape
  ...
  have hReduce : smFinal 12 = allReducePrim [pmFinal 116, pmFinal 117, pmFinal 118, pmFinal 119].length 0 [pmFinal 116, pmFinal 117, pmFinal 118, pmFinal 119] := by
    rw [hValue]
    rfl
  change ReductionRel (smFinal 12) [pmFinal 116, pmFinal 117, pmFinal 118, pmFinal 119] [64]
  refine { full_value := hReduce, full_shape := hFull, contributions_nonempty := by simp, contribution_shapes := ?_, reduced_shape := ?_ }
  · simp only [List.forall_mem_cons]
    exact ⟨hShape0, hShape1, hShape2, hShape3, List.forall_mem_nil _⟩
  · rw [← hReduce]
...
private theorem segment_000000_sound (smStore pmStore : Store)
  ...
  change ShardedRel (smFinal 2) [pmFinal 104, pmFinal 105, pmFinal 106, pmFinal 107] 1 [1, 16, 64] [1, 4, 64] at hx
...
private def segment_000000 : ClosedDepSegmentCertificate BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.sm BWLayernormParamGraphK4B1S4D64DxDgammaDbeta.pm state_before state_after where
...
end TrainVerify.Denote.GeneratedBWLayernormParamK4B1S4D64DxDgammaDbeta
