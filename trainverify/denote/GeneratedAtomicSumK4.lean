...
def pmGraph : GraphDecl := { numRanks := 4, nodes := [{ rank := 0, op := "OpName.FW_float", ins := [8], outs := [1000] }, { rank := 1, op := "OpName.FW_float", ins := [8], outs := [993] }, { rank := 2, op := "OpName.FW_float", ins := [8], outs := [986] }, { rank := 3, op := "OpName.FW_float", ins := [8], outs := [979] }, { rank := 0, op := "OpName.FW_sum", ins := [1000], outs := [2000] }, { rank := 0, op := "OpName.BW_sum", ins := [9, 1000], outs := [3000] }, { rank := 1, op := "OpName.FW_sum", ins := [993], outs := [1993] }, { rank := 1, op := "OpName.BW_sum", ins := [9, 993], outs := [2993] }, { rank := 2, op := "OpName.FW_sum", ins := [986], outs := [1986] }, { rank := 2, op := "OpName.BW_sum", ins := [9, 986], outs := [2986] }, { rank := 3, op := "OpName.FW_sum", ins := [979], outs := [1979] }, { rank := 3, op := "OpName.BW_sum", ins := [9, 979], outs := [2979] }], replicaGroups := [] }
private def fact_g : RelationFact := .reduction 9 [9] [1]
private def fact_x : RelationFact := .sharded 10 [1000, 993, 986, 979] 1 [2, 12, 5] [2, 3, 5]
private def fact_sum : RelationFact := .reduction 20 [2000, 1993, 1986, 1979] [1]
private def fact_bw : RelationFact := .sharded 30 [3000, 2993, 2986, 2979] 1 [2, 12, 5] [2, 3, 5]
...
private def segment_000000_pm_nodes : List NodeDecl := [{ rank := 0, op := "OpName.FW_sum", ins := [1000], outs := [2000] }, { rank := 0, op := "OpName.BW_sum", ins := [9, 1000], outs := [3000] }, { rank := 1, op := "OpName.FW_sum", ins := [993], outs := [1993] }, { rank := 1, op := "OpName.BW_sum", ins := [9, 993], outs := [2993] }, { rank := 2, op := "OpName.FW_sum", ins := [986], outs := [1986] }, { rank := 2, op := "OpName.BW_sum", ins := [9, 986], outs := [2986] }, { rank := 3, op := "OpName.FW_sum", ins := [979], outs := [1979] }, { rank := 3, op := "OpName.BW_sum", ins := [9, 979], outs := [2979] }]
...
private theorem segment_000000_sumPm2 (pmStore : Store) :
    (segment_000000_pm_final pmStore) 1986 = fw_sum ((segment_000000_pm_final pmStore) 986) := by
  have hfinal : (segment_000000_pm_final pmStore) = segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful SumWitness.pmGraph) pmStore := by
    unfold segment_000000_pm_final
    rfl
  have hout_nodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 4) ++ [{ rank := 2, op := "OpName.FW_sum", ins := [986], outs := [1986] }] ++ (segment_000000_pm_nodes.drop 5) := by
    native_decide
  have hout_prefix : (segment_000000_pm_final pmStore) 1986 = fw_sum (((segment_000000_pm_nodes.take 4)).foldl (applyNodeDistributedFaithful SumWitness.pmGraph) pmStore 986) := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_middle_writer SumWitness.pmGraph pmStore
      (segment_000000_pm_nodes.take 4) (segment_000000_pm_nodes.drop 5)
      { rank := 2, op := "OpName.FW_sum", ins := [986], outs := [1986] } 1986
      (fun t => fw_sum (t 986)) (by
        intro t
        rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
        simp [applyNodeDistributed, applyNodeRingAttn]
        exact applyNode_fw_sum_out SumWitness.pmGraph t 2 986 1986
      ) (by native_decide) (by native_decide)
  have hout_read_0 : ((segment_000000_pm_nodes.take 4)).foldl (applyNodeDistributedFaithful SumWitness.pmGraph) pmStore 986 = (segment_000000_pm_final pmStore) 986 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SumWitness.pmGraph pmStore
      (segment_000000_pm_nodes.take 4) ({ rank := 2, op := "OpName.FW_sum", ins := [986], outs := [1986] } :: (segment_000000_pm_nodes.drop 5)) 986
      (by native_decide) (by native_decide)
  have hout : (segment_000000_pm_final pmStore) 1986 = fw_sum ((segment_000000_pm_final pmStore) 986) := by
    calc
      _ = fw_sum (((segment_000000_pm_nodes.take 4)).foldl (applyNodeDistributedFaithful SumWitness.pmGraph) pmStore 986) := hout_prefix
      _ = fw_sum ((segment_000000_pm_final pmStore) 986) := by rw [hout_read_0]
  exact hout

private theorem segment_000000_bwPm2 (pmStore : Store) :
    (segment_000000_pm_final pmStore) 2986 = bw_sum ((segment_000000_pm_final pmStore) 9) ((segment_000000_pm_final pmStore) 986) := by
  have hfinal : (segment_000000_pm_final pmStore) = segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful SumWitness.pmGraph) pmStore := by
    unfold segment_000000_pm_final
    rfl
  have hout_nodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 5) ++ [{ rank := 2, op := "OpName.BW_sum", ins := [9, 986], outs := [2986] }] ++ (segment_000000_pm_nodes.drop 6) := by
    native_decide
  have hout_prefix : (segment_000000_pm_final pmStore) 2986 = bw_sum (((segment_000000_pm_nodes.take 5)).foldl (applyNodeDistributedFaithful SumWitness.pmGraph) pmStore 9) (((segment_000000_pm_nodes.take 5)).foldl (applyNodeDistributedFaithful SumWitness.pmGraph) pmStore 986) := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_middle_writer SumWitness.pmGraph pmStore
      (segment_000000_pm_nodes.take 5) (segment_000000_pm_nodes.drop 6)
      { rank := 2, op := "OpName.BW_sum", ins := [9, 986], outs := [2986] } 2986
      (fun t => bw_sum (t 9) (t 986)) (by
        intro t
        rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
        simp [applyNodeDistributed, applyNodeRingAttn]
        exact applyNode_bw_sum_out SumWitness.pmGraph t 2 9 986 2986
      ) (by native_decide) (by native_decide)
  have hout_read_0 : ((segment_000000_pm_nodes.take 5)).foldl (applyNodeDistributedFaithful SumWitness.pmGraph) pmStore 9 = (segment_000000_pm_final pmStore) 9 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SumWitness.pmGraph pmStore
      (segment_000000_pm_nodes.take 5) ({ rank := 2, op := "OpName.BW_sum", ins := [9, 986], outs := [2986] } :: (segment_000000_pm_nodes.drop 6)) 9
      (by native_decide) (by native_decide)
  have hout_read_1 : ((segment_000000_pm_nodes.take 5)).foldl (applyNodeDistributedFaithful SumWitness.pmGraph) pmStore 986 = (segment_000000_pm_final pmStore) 986 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SumWitness.pmGraph pmStore
      (segment_000000_pm_nodes.take 5) ({ rank := 2, op := "OpName.BW_sum", ins := [9, 986], outs := [2986] } :: (segment_000000_pm_nodes.drop 6)) 986
      (by native_decide) (by native_decide)
  have hout : (segment_000000_pm_final pmStore) 2986 = bw_sum ((segment_000000_pm_final pmStore) 9) ((segment_000000_pm_final pmStore) 986) := by
    calc
      _ = bw_sum (((segment_000000_pm_nodes.take 5)).foldl (applyNodeDistributedFaithful SumWitness.pmGraph) pmStore 9) (((segment_000000_pm_nodes.take 5)).foldl (applyNodeDistributedFaithful SumWitness.pmGraph) pmStore 986) := hout_prefix
      _ = bw_sum ((segment_000000_pm_final pmStore) 9) ((segment_000000_pm_final pmStore) 986) := by rw [hout_read_0, hout_read_1]
  exact hout

private theorem segment_000000_sumPm3 (pmStore : Store) :
    (segment_000000_pm_final pmStore) 1979 = fw_sum ((segment_000000_pm_final pmStore) 979) := by
  have hfinal : (segment_000000_pm_final pmStore) = segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful SumWitness.pmGraph) pmStore := by
    unfold segment_000000_pm_final
    rfl
  have hout_nodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 6) ++ [{ rank := 3, op := "OpName.FW_sum", ins := [979], outs := [1979] }] ++ (segment_000000_pm_nodes.drop 7) := by
    native_decide
  have hout_prefix : (segment_000000_pm_final pmStore) 1979 = fw_sum (((segment_000000_pm_nodes.take 6)).foldl (applyNodeDistributedFaithful SumWitness.pmGraph) pmStore 979) := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_middle_writer SumWitness.pmGraph pmStore
      (segment_000000_pm_nodes.take 6) (segment_000000_pm_nodes.drop 7)
      { rank := 3, op := "OpName.FW_sum", ins := [979], outs := [1979] } 1979
      (fun t => fw_sum (t 979)) (by
        intro t
        rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
        simp [applyNodeDistributed, applyNodeRingAttn]
        exact applyNode_fw_sum_out SumWitness.pmGraph t 3 979 1979
      ) (by native_decide) (by native_decide)
  have hout_read_0 : ((segment_000000_pm_nodes.take 6)).foldl (applyNodeDistributedFaithful SumWitness.pmGraph) pmStore 979 = (segment_000000_pm_final pmStore) 979 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SumWitness.pmGraph pmStore
      (segment_000000_pm_nodes.take 6) ({ rank := 3, op := "OpName.FW_sum", ins := [979], outs := [1979] } :: (segment_000000_pm_nodes.drop 7)) 979
      (by native_decide) (by native_decide)
  have hout : (segment_000000_pm_final pmStore) 1979 = fw_sum ((segment_000000_pm_final pmStore) 979) := by
    calc
      _ = fw_sum (((segment_000000_pm_nodes.take 6)).foldl (applyNodeDistributedFaithful SumWitness.pmGraph) pmStore 979) := hout_prefix
      _ = fw_sum ((segment_000000_pm_final pmStore) 979) := by rw [hout_read_0]
  exact hout

private theorem segment_000000_bwPm3 (pmStore : Store) :
    (segment_000000_pm_final pmStore) 2979 = bw_sum ((segment_000000_pm_final pmStore) 9) ((segment_000000_pm_final pmStore) 979) := by
  have hfinal : (segment_000000_pm_final pmStore) = segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful SumWitness.pmGraph) pmStore := by
    unfold segment_000000_pm_final
    rfl
  have hout_nodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 7) ++ [{ rank := 3, op := "OpName.BW_sum", ins := [9, 979], outs := [2979] }] ++ (segment_000000_pm_nodes.drop 8) := by
    native_decide
  have hout_prefix : (segment_000000_pm_final pmStore) 2979 = bw_sum (((segment_000000_pm_nodes.take 7)).foldl (applyNodeDistributedFaithful SumWitness.pmGraph) pmStore 9) (((segment_000000_pm_nodes.take 7)).foldl (applyNodeDistributedFaithful SumWitness.pmGraph) pmStore 979) := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_middle_writer SumWitness.pmGraph pmStore
      (segment_000000_pm_nodes.take 7) (segment_000000_pm_nodes.drop 8)
      { rank := 3, op := "OpName.BW_sum", ins := [9, 979], outs := [2979] } 2979
      (fun t => bw_sum (t 9) (t 979)) (by
        intro t
        rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
        simp [applyNodeDistributed, applyNodeRingAttn]
        exact applyNode_bw_sum_out SumWitness.pmGraph t 3 9 979 2979
      ) (by native_decide) (by native_decide)
  have hout_read_0 : ((segment_000000_pm_nodes.take 7)).foldl (applyNodeDistributedFaithful SumWitness.pmGraph) pmStore 9 = (segment_000000_pm_final pmStore) 9 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SumWitness.pmGraph pmStore
      (segment_000000_pm_nodes.take 7) ({ rank := 3, op := "OpName.BW_sum", ins := [9, 979], outs := [2979] } :: (segment_000000_pm_nodes.drop 8)) 9
      (by native_decide) (by native_decide)
  have hout_read_1 : ((segment_000000_pm_nodes.take 7)).foldl (applyNodeDistributedFaithful SumWitness.pmGraph) pmStore 979 = (segment_000000_pm_final pmStore) 979 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SumWitness.pmGraph pmStore
      (segment_000000_pm_nodes.take 7) ({ rank := 3, op := "OpName.BW_sum", ins := [9, 979], outs := [2979] } :: (segment_000000_pm_nodes.drop 8)) 979
      (by native_decide) (by native_decide)
  have hout : (segment_000000_pm_final pmStore) 2979 = bw_sum ((segment_000000_pm_final pmStore) 9) ((segment_000000_pm_final pmStore) 979) := by
    calc
      _ = bw_sum (((segment_000000_pm_nodes.take 7)).foldl (applyNodeDistributedFaithful SumWitness.pmGraph) pmStore 9) (((segment_000000_pm_nodes.take 7)).foldl (applyNodeDistributedFaithful SumWitness.pmGraph) pmStore 979) := hout_prefix
      _ = bw_sum ((segment_000000_pm_final pmStore) 9) ((segment_000000_pm_final pmStore) 979) := by rw [hout_read_0, hout_read_1]
  exact hout
...
private theorem segment_000000_sound (smStore pmStore : Store)
  ...
  change ShardedRel (smFinal 10) [pmFinal 1000, pmFinal 993, pmFinal 986, pmFinal 979] 1 [2, 12, 5] [2, 3, 5] at hx
  change ReductionRel (smFinal 9) [pmFinal 9] [1] at hg
  have hxValue : smFinal 10 = allGatherPrimDimN 1 4 0 [pmFinal 1000, pmFinal 993, pmFinal 986, pmFinal 979] := by
  ...
  have hSumPm2 := segment_000000_sumPm2 pmStore
  change pmFinal 1986 = fw_sum (pmFinal 986) at hSumPm2
  have hBwPm2 := segment_000000_bwPm2 pmStore
  change pmFinal 2986 = bw_sum (pmFinal 9) (pmFinal 986) at hBwPm2
  have hXShape2 := hx.shard_shapes (pmFinal 986) (by simp)
  have hSumPm3 := segment_000000_sumPm3 pmStore
  change pmFinal 1979 = fw_sum (pmFinal 979) at hSumPm3
  have hBwPm3 := segment_000000_bwPm3 pmStore
  change pmFinal 2979 = bw_sum (pmFinal 9) (pmFinal 979) at hBwPm3
  have hXShape3 := hx.shard_shapes (pmFinal 979) (by simp)
  have hSumComm := TrainVerify.Denote.fw_sum_allGatherPrimDimN_eq_allReducePrim_fw_sum 1 4 [pmFinal 1000, pmFinal 993, pmFinal 986, pmFinal 979] rfl (by simp) [2, 3, 5]
    (by simpa using hXShape0) hx.shard_shapes hx.gather_dim_lt (by native_decide) (by native_decide)
  have hSumValue : smFinal 20 = allReducePrim [pmFinal 2000, pmFinal 1993, pmFinal 1986, pmFinal 1979].length 0 [pmFinal 2000, pmFinal 1993, pmFinal 1986, pmFinal 1979] := by
    rw [hSumSm, hxValue, hSumComm]
    simp only [List.map, List.length_cons, List.length_nil]
    rw [← hSumPm0, ← hSumPm1, ← hSumPm2, ← hSumPm3]
  have hSumOut : fact_sum.Holds smFinal pmFinal := by
    change ReductionRel (smFinal 20) [pmFinal 2000, pmFinal 1993, pmFinal 1986, pmFinal 1979] [1]
  ...
  have hBwComm : bw_sum (smFinal 9)
      (allGatherPrimDimN 1 4 0 [pmFinal 1000, pmFinal 993, pmFinal 986, pmFinal 979]) =
      allGatherPrimDimN 1 4 0 [bw_sum (smFinal 9) (pmFinal 1000), bw_sum (smFinal 9) (pmFinal 993), bw_sum (smFinal 9) (pmFinal 986), bw_sum (smFinal 9) (pmFinal 979)] := by
    simpa only [List.length_cons, List.length_nil, List.map] using
      (TrainVerify.Denote.bw_sum_allGatherPrimDimN_dim1_rank3
        (smFinal 9) [pmFinal 1000, pmFinal 993, pmFinal 986, pmFinal 979] 2 3 5
        hx.shards_nonempty (by decide) (by decide) (by decide) hx.shard_shapes)
  have hBwOut : fact_bw.Holds smFinal pmFinal := by
    change ShardedRel (smFinal 30) [pmFinal 3000, pmFinal 2993, pmFinal 2986, pmFinal 2979] 1 [2, 12, 5] [2, 3, 5]
    constructor
    · change smFinal 30 = allGatherPrimDimN 1 4 0 [pmFinal 3000, pmFinal 2993, pmFinal 2986, pmFinal 2979]
      rw [hBwSm, hxValue, hBwComm, hgValue]
      rw [← hBwPm0, ← hBwPm1, ← hBwPm2, ← hBwPm3]
    ...
    · intro t ht
      ...
      · subst t
        rw [hBwPm2, bw_sum_shape, hXShape2]
      · subst t
        rw [hBwPm3, bw_sum_shape, hXShape3]
