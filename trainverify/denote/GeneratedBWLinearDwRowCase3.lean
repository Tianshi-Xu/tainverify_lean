...
def fact_tail_in : RelationFact := .reduction 600 [6000, 6001, 6002, 6003] [2, 5, 11]
def fact_tail_out : RelationFact := .joined 600 7000 [2, 5, 11]
...
private theorem segment_000000_hPmWriter3 (pmStore : Store) :
  ...
  have hout_nodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 3) ++ [{ rank := 3, op := "OpName.BW_linear", ins := [1003, 2000, 3003], outs := [4003, 5003] }] ++ (segment_000000_pm_nodes.drop 4) := by
    native_decide
  have hout_prefix : (segment_000000_pm_final pmStore) 4003 = (bw_linear (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticBWLinearDwRow.pmGraph) pmStore 1003) (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticBWLinearDwRow.pmGraph) pmStore 2000) (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticBWLinearDwRow.pmGraph) pmStore 3003)).1 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_middle_writer SyntheticBWLinearDwRow.pmGraph pmStore
      ...
      (fun t => (bw_linear (t 1003) (t 2000) (t 3003)).1) (by
        ...
        rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
        simp [applyNodeDistributed, applyNodeRingAttn]
        exact applyNode_bw_linear_fst_out SyntheticBWLinearDwRow.pmGraph t 3 1003 2000 3003 4003 5003 (by native_decide)
      ) (by native_decide) (by native_decide)
  ...
  have hout : (segment_000000_pm_final pmStore) 4003 = (bw_linear ((segment_000000_pm_final pmStore) 1003) ((segment_000000_pm_final pmStore) 2000) ((segment_000000_pm_final pmStore) 3003)).1 := by
    calc
      _ = (bw_linear (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticBWLinearDwRow.pmGraph) pmStore 1003) (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticBWLinearDwRow.pmGraph) pmStore 2000) (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticBWLinearDwRow.pmGraph) pmStore 3003)).1 := hout_prefix
...
private theorem segment_000000_hAllReduceWriter (pmStore : Store) :
    (segment_000000_pm_final pmStore) 7000 = allReducePrim 4 0 [(segment_000000_pm_final pmStore) 6000, (segment_000000_pm_final pmStore) 6001, (segment_000000_pm_final pmStore) 6002, (segment_000000_pm_final pmStore) 6003] := by
  have hfinal : (segment_000000_pm_final pmStore) = segment_000000_pm_nodes.foldl
      (applyNodeDistributedFaithful SyntheticBWLinearDwRow.pmGraph) pmStore := by
    unfold segment_000000_pm_final
    rfl
  have hout_nodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 4) ++ [{ rank := 0, op := "OpName.AllReducePrim", ins := [6000, 6001, 6002, 6003], outs := [7000] }] ++ (segment_000000_pm_nodes.drop 5) := by
    native_decide
  have hout_prefix : (segment_000000_pm_final pmStore) 7000 = allReducePrim 4 0 [((segment_000000_pm_nodes.take 4)).foldl (applyNodeDistributedFaithful SyntheticBWLinearDwRow.pmGraph) pmStore 6000, ((segment_000000_pm_nodes.take 4)).foldl (applyNodeDistributedFaithful SyntheticBWLinearDwRow.pmGraph) pmStore 6001, ((segment_000000_pm_nodes.take 4)).foldl (applyNodeDistributedFaithful SyntheticBWLinearDwRow.pmGraph) pmStore 6002, ((segment_000000_pm_nodes.take 4)).foldl (applyNodeDistributedFaithful SyntheticBWLinearDwRow.pmGraph) pmStore 6003] := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_middle_writer SyntheticBWLinearDwRow.pmGraph pmStore
      (segment_000000_pm_nodes.take 4) (segment_000000_pm_nodes.drop 5)
      { rank := 0, op := "OpName.AllReducePrim", ins := [6000, 6001, 6002, 6003], outs := [7000] } 7000
      (fun t => allReducePrim 4 0 [t 6000, t 6001, t 6002, t 6003]) (by
        intro t
        rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
        ...
        · exact applyNode_allReducePrim_out SyntheticBWLinearDwRow.pmGraph t 0 [6000, 6001, 6002, 6003] 7000
        · native_decide
        · native_decide
      ) (by native_decide) (by native_decide)
  have hout_read_0 : ((segment_000000_pm_nodes.take 4)).foldl (applyNodeDistributedFaithful SyntheticBWLinearDwRow.pmGraph) pmStore 6000 = (segment_000000_pm_final pmStore) 6000 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SyntheticBWLinearDwRow.pmGraph pmStore
      (segment_000000_pm_nodes.take 4) ({ rank := 0, op := "OpName.AllReducePrim", ins := [6000, 6001, 6002, 6003], outs := [7000] } :: (segment_000000_pm_nodes.drop 5)) 6000
      (by native_decide) (by native_decide)
  have hout_read_1 : ((segment_000000_pm_nodes.take 4)).foldl (applyNodeDistributedFaithful SyntheticBWLinearDwRow.pmGraph) pmStore 6001 = (segment_000000_pm_final pmStore) 6001 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SyntheticBWLinearDwRow.pmGraph pmStore
      (segment_000000_pm_nodes.take 4) ({ rank := 0, op := "OpName.AllReducePrim", ins := [6000, 6001, 6002, 6003], outs := [7000] } :: (segment_000000_pm_nodes.drop 5)) 6001
      (by native_decide) (by native_decide)
  have hout_read_2 : ((segment_000000_pm_nodes.take 4)).foldl (applyNodeDistributedFaithful SyntheticBWLinearDwRow.pmGraph) pmStore 6002 = (segment_000000_pm_final pmStore) 6002 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SyntheticBWLinearDwRow.pmGraph pmStore
      (segment_000000_pm_nodes.take 4) ({ rank := 0, op := "OpName.AllReducePrim", ins := [6000, 6001, 6002, 6003], outs := [7000] } :: (segment_000000_pm_nodes.drop 5)) 6002
      (by native_decide) (by native_decide)
  have hout_read_3 : ((segment_000000_pm_nodes.take 4)).foldl (applyNodeDistributedFaithful SyntheticBWLinearDwRow.pmGraph) pmStore 6003 = (segment_000000_pm_final pmStore) 6003 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SyntheticBWLinearDwRow.pmGraph pmStore
      (segment_000000_pm_nodes.take 4) ({ rank := 0, op := "OpName.AllReducePrim", ins := [6000, 6001, 6002, 6003], outs := [7000] } :: (segment_000000_pm_nodes.drop 5)) 6003
      (by native_decide) (by native_decide)
  have hout : (segment_000000_pm_final pmStore) 7000 = allReducePrim 4 0 [(segment_000000_pm_final pmStore) 6000, (segment_000000_pm_final pmStore) 6001, (segment_000000_pm_final pmStore) 6002, (segment_000000_pm_final pmStore) 6003] := by
    calc
      _ = allReducePrim 4 0 [((segment_000000_pm_nodes.take 4)).foldl (applyNodeDistributedFaithful SyntheticBWLinearDwRow.pmGraph) pmStore 6000, ((segment_000000_pm_nodes.take 4)).foldl (applyNodeDistributedFaithful SyntheticBWLinearDwRow.pmGraph) pmStore 6001, ((segment_000000_pm_nodes.take 4)).foldl (applyNodeDistributedFaithful SyntheticBWLinearDwRow.pmGraph) pmStore 6002, ((segment_000000_pm_nodes.take 4)).foldl (applyNodeDistributedFaithful SyntheticBWLinearDwRow.pmGraph) pmStore 6003] := hout_prefix
      _ = allReducePrim 4 0 [(segment_000000_pm_final pmStore) 6000, (segment_000000_pm_final pmStore) 6001, (segment_000000_pm_final pmStore) 6002, (segment_000000_pm_final pmStore) 6003] := by rw [hout_read_0, hout_read_1, hout_read_2, hout_read_3]
  exact hout
...
private theorem segment_000000_sound (smStore pmStore : Store)
    ...
    have houtDw : fact_dw.Holds smFinal pmFinal := by
      ...
      · subst shard
        exact hDwOutShape3
    have hred : fact_tail_in.Holds smFinal pmFinal := hframe _ (by native_decide)
    change ReductionRel (smFinal 600) [pmFinal 6000, pmFinal 6001, pmFinal 6002, pmFinal 6003] [2, 5, 11] at hred
    have hReduceWriter := segment_000000_hAllReduceWriter pmStore
    change pmFinal 7000 = allReducePrim 4 0 [pmFinal 6000, pmFinal 6001, pmFinal 6002, pmFinal 6003] at hReduceWriter
    have hReduceValue : smFinal 600 = allReducePrim 4 0 [pmFinal 6000, pmFinal 6001, pmFinal 6002, pmFinal 6003] := by
      simpa only [List.length_cons, List.length_nil] using hred.full_value
    have hReduceJoined : smFinal 600 = pmFinal 7000 :=
      hReduceValue.trans hReduceWriter.symm
    have houtReduce : fact_tail_out.Holds smFinal pmFinal := by
      change smFinal 600 = pmFinal 7000 ∧ _ ∧ _
      refine ⟨hReduceJoined, hred.full_shape, ?_⟩
      rw [← hReduceJoined]
      exact hred.full_shape
    intro fact hfact
