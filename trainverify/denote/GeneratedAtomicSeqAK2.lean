...
def pmGraph : GraphDecl := { numRanks := 2, nodes := [{ rank := 0, op := "OpName.BW_linear", ins := [1000, 2000, 206], outs := [4000, 5000] }, { rank := 0, op := "OpName.AllToAllPrim", ins := [7000, 7001], outs := [8000], params := [1, 2] }, { rank := 1, op := "OpName.AllToAllPrim", ins := [7000, 7001], outs := [8001], params := [1, 2] }, { rank := 1, op := "OpName.BW_linear", ins := [1001, 2001, 206], outs := [4001, 5001] }] }
def fact_g : RelationFact := .sharded 100 [1000, 1001] 1 [2, 10, 7] [2, 5, 7]
def fact_x : RelationFact := .sharded 200 [2000, 2001] 1 [2, 10, 11] [2, 5, 11]
def fact_w : RelationFact := .sharded 206 [206] 0 [7, 11] [7, 11]
def fact_dw : RelationFact := .reduction 401 [5000, 5001] [7, 11]
def fact_out : RelationFact := .sharded 400 [4000, 4001] 1 [2, 10, 11] [2, 5, 11]
def fact_a_in : RelationFact := .sharded 700 [7000, 7001] 1 [2, 10, 22] [2, 5, 22]
def fact_a_out : RelationFact := .sharded 700 [8000, 8001] 2 [2, 10, 22] [2, 10, 11]
...
private def segment_000000_pm_nodes : List NodeDecl := [{ rank := 0, op := "OpName.BW_linear", ins := [1000, 2000, 206], outs := [4000, 5000] }, { rank := 0, op := "OpName.AllToAllPrim", ins := [7000, 7001], outs := [8000], params := [1, 2] }, { rank := 1, op := "OpName.AllToAllPrim", ins := [7000, 7001], outs := [8001], params := [1, 2] }, { rank := 1, op := "OpName.BW_linear", ins := [1001, 2001, 206], outs := [4001, 5001] }]
...
private theorem segment_000000_hPmWriter1_1 (store : Store) : (segment_000000_pm_final store) 5001 = (bw_linear ((segment_000000_pm_final store) 1001) ((segment_000000_pm_final store) 2001) ((segment_000000_pm_final store) 206)).2 := by
  have hfinal : (segment_000000_pm_final store) = segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store := by unfold segment_000000_pm_final; rfl
  have hout_nodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 3) ++ [{ rank := 1, op := "OpName.BW_linear", ins := [1001, 2001, 206], outs := [4001, 5001] }] ++ (segment_000000_pm_nodes.drop 4) := by
    native_decide
  have hout_prefix : (segment_000000_pm_final store) 5001 = (bw_linear (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 1001) (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 2001) (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 206)).2 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_middle_writer SequenceLinearAllToAll.pmGraph store
  ...
  have hout_read_0 : ((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 1001 = (segment_000000_pm_final store) 1001 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 3) ({ rank := 1, op := "OpName.BW_linear", ins := [1001, 2001, 206], outs := [4001, 5001] } :: (segment_000000_pm_nodes.drop 4)) 1001
      (by native_decide) (by native_decide)
  have hout_read_1 : ((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 2001 = (segment_000000_pm_final store) 2001 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 3) ({ rank := 1, op := "OpName.BW_linear", ins := [1001, 2001, 206], outs := [4001, 5001] } :: (segment_000000_pm_nodes.drop 4)) 2001
      (by native_decide) (by native_decide)
  have hout_read_2 : ((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 206 = (segment_000000_pm_final store) 206 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 3) ({ rank := 1, op := "OpName.BW_linear", ins := [1001, 2001, 206], outs := [4001, 5001] } :: (segment_000000_pm_nodes.drop 4)) 206
      (by native_decide) (by native_decide)
  have hout : (segment_000000_pm_final store) 5001 = (bw_linear ((segment_000000_pm_final store) 1001) ((segment_000000_pm_final store) 2001) ((segment_000000_pm_final store) 206)).2 := by
    calc
      _ = (bw_linear (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 1001) (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 2001) (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 206)).2 := hout_prefix
...
private theorem segment_000000_hPmWriter0_1 (store : Store) : (segment_000000_pm_final store) 4001 = (bw_linear ((segment_000000_pm_final store) 1001) ((segment_000000_pm_final store) 2001) ((segment_000000_pm_final store) 206)).1 := by
  ...
  have hout_nodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 3) ++ [{ rank := 1, op := "OpName.BW_linear", ins := [1001, 2001, 206], outs := [4001, 5001] }] ++ (segment_000000_pm_nodes.drop 4) := by
    native_decide
  have hout_prefix : (segment_000000_pm_final store) 4001 = (bw_linear (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 1001) (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 2001) (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 206)).1 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_middle_writer SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 3) (segment_000000_pm_nodes.drop 4)
  ...
  have hout : (segment_000000_pm_final store) 4001 = (bw_linear ((segment_000000_pm_final store) 1001) ((segment_000000_pm_final store) 2001) ((segment_000000_pm_final store) 206)).1 := by
    calc
      _ = (bw_linear (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 1001) (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 2001) (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 206)).1 := hout_prefix
...
private theorem segment_000000_hAllToAll0 (store : Store) : (segment_000000_pm_final store) 8000 = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 0 [(segment_000000_pm_final store) 7000, (segment_000000_pm_final store) 7001] 1 2 := by
  have hfinal : (segment_000000_pm_final store) = segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store := by unfold segment_000000_pm_final; rfl
  have hout_nodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 1) ++ [{ rank := 0, op := "OpName.AllToAllPrim", ins := [7000, 7001], outs := [8000], params := [1, 2] }] ++ (segment_000000_pm_nodes.drop 2) := by
    native_decide
  have hout_prefix : (segment_000000_pm_final store) 8000 = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 0 [((segment_000000_pm_nodes.take 1)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7000, ((segment_000000_pm_nodes.take 1)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7001] 1 2 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_middle_writer SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 1) (segment_000000_pm_nodes.drop 2)
      { rank := 0, op := "OpName.AllToAllPrim", ins := [7000, 7001], outs := [8000], params := [1, 2] } 8000
      (fun t => allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 0 [t 7000, t 7001] 1 2) (by
        intro t
        rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
        simp [applyNodeDistributed, applyNodeRingAttn]
        simpa only [List.map] using applyNode_allToAllPrimWithDims_out SequenceLinearAllToAll.pmGraph t 0 [7000, 7001] 8000 1 2
      ) (by native_decide) (by native_decide)
  have hout_read_0 : ((segment_000000_pm_nodes.take 1)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7000 = (segment_000000_pm_final store) 7000 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 1) ({ rank := 0, op := "OpName.AllToAllPrim", ins := [7000, 7001], outs := [8000], params := [1, 2] } :: (segment_000000_pm_nodes.drop 2)) 7000
      (by native_decide) (by native_decide)
  have hout_read_1 : ((segment_000000_pm_nodes.take 1)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7001 = (segment_000000_pm_final store) 7001 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 1) ({ rank := 0, op := "OpName.AllToAllPrim", ins := [7000, 7001], outs := [8000], params := [1, 2] } :: (segment_000000_pm_nodes.drop 2)) 7001
      (by native_decide) (by native_decide)
  have hout : (segment_000000_pm_final store) 8000 = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 0 [(segment_000000_pm_final store) 7000, (segment_000000_pm_final store) 7001] 1 2 := by
    calc
      _ = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 0 [((segment_000000_pm_nodes.take 1)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7000, ((segment_000000_pm_nodes.take 1)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7001] 1 2 := hout_prefix
      _ = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 0 [(segment_000000_pm_final store) 7000, (segment_000000_pm_final store) 7001] 1 2 := by rw [hout_read_0, hout_read_1]
  exact hout

private theorem segment_000000_hAllToAll1 (store : Store) : (segment_000000_pm_final store) 8001 = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 1 [(segment_000000_pm_final store) 7000, (segment_000000_pm_final store) 7001] 1 2 := by
  have hfinal : (segment_000000_pm_final store) = segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store := by unfold segment_000000_pm_final; rfl
  have hout_nodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 2) ++ [{ rank := 1, op := "OpName.AllToAllPrim", ins := [7000, 7001], outs := [8001], params := [1, 2] }] ++ (segment_000000_pm_nodes.drop 3) := by
    native_decide
  have hout_prefix : (segment_000000_pm_final store) 8001 = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 1 [((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7000, ((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7001] 1 2 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_middle_writer SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 2) (segment_000000_pm_nodes.drop 3)
      { rank := 1, op := "OpName.AllToAllPrim", ins := [7000, 7001], outs := [8001], params := [1, 2] } 8001
      (fun t => allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 1 [t 7000, t 7001] 1 2) (by
        intro t
        rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
        simp [applyNodeDistributed, applyNodeRingAttn]
        simpa only [List.map] using applyNode_allToAllPrimWithDims_out SequenceLinearAllToAll.pmGraph t 1 [7000, 7001] 8001 1 2
      ) (by native_decide) (by native_decide)
  have hout_read_0 : ((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7000 = (segment_000000_pm_final store) 7000 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 2) ({ rank := 1, op := "OpName.AllToAllPrim", ins := [7000, 7001], outs := [8001], params := [1, 2] } :: (segment_000000_pm_nodes.drop 3)) 7000
      (by native_decide) (by native_decide)
  have hout_read_1 : ((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7001 = (segment_000000_pm_final store) 7001 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 2) ({ rank := 1, op := "OpName.AllToAllPrim", ins := [7000, 7001], outs := [8001], params := [1, 2] } :: (segment_000000_pm_nodes.drop 3)) 7001
      (by native_decide) (by native_decide)
  have hout : (segment_000000_pm_final store) 8001 = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 1 [(segment_000000_pm_final store) 7000, (segment_000000_pm_final store) 7001] 1 2 := by
    calc
      _ = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 1 [((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7000, ((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7001] 1 2 := hout_prefix
      _ = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 1 [(segment_000000_pm_final store) 7000, (segment_000000_pm_final store) 7001] 1 2 := by rw [hout_read_0, hout_read_1]
  exact hout
...
private theorem segment_000000_sound (smStore pmStore : Store) (hstate : state_before.Holds smStore pmStore) : state_after.Holds (segment_000000_sm_final smStore) (segment_000000_pm_final pmStore) := by
 ...
 change ShardedRel (smFinal 100) [pmFinal 1000, pmFinal 1001] 1 [2, 10, 7] [2, 5, 7] at hg
 have hx : fact_x.Holds smFinal pmFinal := hframe _ (by native_decide)
 change ShardedRel (smFinal 200) [pmFinal 2000, pmFinal 2001] 1 [2, 10, 11] [2, 5, 11] at hx
 ...
 have hcomm1 := TrainVerify.Denote.bw_linear_dw_sequence_reduction_rank3 2 2 5 7 11 [pmFinal 1000, pmFinal 1001] [pmFinal 2000, pmFinal 2001] (pmFinal 206)
 ...
 have hV1 : smFinal 401 = tensorSum [pmFinal 5000, pmFinal 5001] := by
   ...
   rw [← hP1_0, ← hP1_1]
 have hFull1 : (smFinal 401).shape = [7, 11] := by rw [hS1]; exact bw_linear_3d_snd_shape 2 10 7 11 _ _ _ hg.full_shape hx.full_shape hw.full_shape
 ...
 have hout1 : fact_dw.Holds smFinal pmFinal := by
   change ReductionRel (smFinal 401) [pmFinal 5000, pmFinal 5001] [7, 11]
 ...
 have hcomm0 := TrainVerify.Denote.bw_linear_dx_sequence_allGather_rank3 2 2 5 7 11 [pmFinal 1000, pmFinal 1001] [pmFinal 2000, pmFinal 2001] (smFinal 200) (pmFinal 206)
 ...
 have hV0 : smFinal 400 = allGatherPrimDimN 1 2 0 [pmFinal 4000, pmFinal 4001] := by
   ...
   rw [← hP0_0, ← hP0_1]
 have hFull0 : (smFinal 400).shape = [2, 10, 11] := by rw [hS0]; exact bw_linear_3d_fst_shape 2 10 7 11 _ _ _ hg.full_shape hx.full_shape hw.full_shape
 ...
 have hout0 : fact_out.Holds smFinal pmFinal := by
   change ShardedRel (smFinal 400) [pmFinal 4000, pmFinal 4001] 1 [2, 10, 11] [2, 5, 11]
   ...
   · simp only [List.forall_mem_cons]; exact ⟨hShape0_0, hShape0_1, List.forall_mem_nil _⟩
   · simp only [List.length_cons,List.length_nil]; decide
 have hai : fact_a_in.Holds smFinal pmFinal := hframe _ (by native_decide)
 change ShardedRel (smFinal 700) [pmFinal 7000, pmFinal 7001] 1 [2, 10, 22] [2, 5, 22] at hai
 have hA0 : pmFinal 8000 = allToAllPrimWithDims 2 0 [pmFinal 7000, pmFinal 7001] 1 2 := segment_000000_hAllToAll0 pmStore
 have hA1 : pmFinal 8001 = allToAllPrimWithDims 2 1 [pmFinal 7000, pmFinal 7001] 1 2 := segment_000000_hAllToAll1 pmStore
 have hHead : (([pmFinal 7000, pmFinal 7001].head?.map (fun t => t.shape)).getD []) = [2, 5, 22] := hai.shard_shapes _ (by simp)
 have hAV : smFinal 700 = allGatherPrimDimN 1 2 0 [pmFinal 7000, pmFinal 7001] := by simpa only [List.length_cons,List.length_nil] using hai.full_value
 have hGS : (allGatherPrimDimN 1 2 0 [pmFinal 7000, pmFinal 7001]).shape = [2, 10, 22] := by rw [←hAV]; exact hai.full_shape
 have hOd : 2 < (allGatherPrimDimN 1 2 0 [pmFinal 7000, pmFinal 7001]).shape.length := by rw [hGS]; decide
 have hDv : (allGatherPrimDimN 1 2 0 [pmFinal 7000, pmFinal 7001]).shape.getD 2 0 % 2 = 0 := by rw [hGS]; decide
 have hAS0 : (pmFinal 8000).shape = [2, 10, 11] := by rw [hA0,allToAllPrimWithDims_shape 2 0 [pmFinal 7000, pmFinal 7001] 1 2 [2, 5, 22] hHead (by decide)]; decide
 have hAS1 : (pmFinal 8001).shape = [2, 10, 11] := by rw [hA1,allToAllPrimWithDims_shape 2 1 [pmFinal 7000, pmFinal 7001] 1 2 [2, 5, 22] hHead (by decide)]; decide
 have hOrd : [pmFinal 8000, pmFinal 8001] = List.ofFn (fun r : Fin 2 => allToAllPrimWithDims 2 r.1 [pmFinal 7000, pmFinal 7001] 1 2) := by rw [hA0, hA1]; rfl
 have hAC : allGatherPrimDimN 2 [pmFinal 8000, pmFinal 8001].length 0 [pmFinal 8000, pmFinal 8001] = allGatherPrimDimN 1 2 0 [pmFinal 7000, pmFinal 7001] := by rw [hOrd]; simpa only [List.length_cons,List.length_nil,List.length_ofFn] using (TrainVerify.Denote.allGatherPrimDimN_allToAllPrimWithDims_ofFn 1 2 [pmFinal 7000, pmFinal 7001] (by simp) hOd hDv)
 have houtA : fact_a_out.Holds smFinal pmFinal := by
   change ShardedRel (smFinal 700) [pmFinal 8000, pmFinal 8001] 2 [2, 10, 22] [2, 10, 11]
