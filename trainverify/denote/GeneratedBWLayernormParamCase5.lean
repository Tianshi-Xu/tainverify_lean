...
namespace BWLayernormParamGraphK2B3S2D5DxDbeta
...
end BWLayernormParamGraphK2B3S2D5DxDbeta
/- AUTO-GENERATED closed relation state universe. -/

open TrainVerify.Denote
open TrainVerify.Denote.RelationCompiler

namespace TrainVerify.Denote.GeneratedBWLayernormParamK2B3S2D5DxDbeta
...
private def fact_g : RelationFact :=
  .sharded 1 [100, 101] 1 [3, 4, 5] [3, 2, 5]

private def fact_x : RelationFact :=
  .sharded 2 [102, 103] 1 [3, 4, 5] [3, 2, 5]
...
private def fact_dx : RelationFact :=
  .sharded 10 [104, 105] 1 [3, 4, 5] [3, 2, 5]

private def fact_dbeta : RelationFact :=
  .reduction 12 [108, 109] [5]
...
private def state_after : RelationState where
  facts := [fact_g, fact_x, fact_gamma, fact_beta, fact_dx, fact_dbeta, public_anchor]
  nonempty := by decide
...
@[irreducible] private def segment_000000_sm_final (store : Store) : Store :=
  segment_000000_sm_nodes.foldl (applyNodeDistributedFaithful BWLayernormParamGraphK2B3S2D5DxDbeta.sm) store
@[irreducible] private def segment_000000_pm_final (store : Store) : Store :=
  segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful BWLayernormParamGraphK2B3S2D5DxDbeta.pm) store
...
private theorem segment_000000_hSmdx (store : Store) :
  ...
  have hfinal : (segment_000000_sm_final store) = segment_000000_sm_nodes.foldl (applyNodeDistributedFaithful BWLayernormParamGraphK2B3S2D5DxDbeta.sm) store := by
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK2B3S2D5DxDbeta.sm
    ...
    hnodes hfinal (by
      ...
      exact applyNode_bw_layernorm_dx_out BWLayernormParamGraphK2B3S2D5DxDbeta.sm t 0 1 2 3 4 10 11 12
...
private theorem segment_000000_hPmdx0 (store : Store) :
  ...
  have hfinal : (segment_000000_pm_final store) = segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful BWLayernormParamGraphK2B3S2D5DxDbeta.pm) store := by
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK2B3S2D5DxDbeta.pm
    ...
    hnodes hfinal (by
      ...
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_dx_out BWLayernormParamGraphK2B3S2D5DxDbeta.pm t 0 100 102 3 4 104 106 108
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hPmdx1 (store : Store) :
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK2B3S2D5DxDbeta.pm
    ...
    hnodes hfinal (by
      ...
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_dx_out BWLayernormParamGraphK2B3S2D5DxDbeta.pm t 1 101 103 3 4 105 107 109
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hSmdbeta (store : Store) :
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK2B3S2D5DxDbeta.sm
    ...
    hnodes hfinal (by
      ...
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_db_out BWLayernormParamGraphK2B3S2D5DxDbeta.sm t 0 1 2 3 4 10 11 12 (by native_decide) (by native_decide)
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hPmdbeta0 (store : Store) :
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK2B3S2D5DxDbeta.pm
    ...
    hnodes hfinal (by
      ...
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_db_out BWLayernormParamGraphK2B3S2D5DxDbeta.pm t 0 100 102 3 4 104 106 108 (by native_decide) (by native_decide)
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hPmdbeta1 (store : Store) :
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK2B3S2D5DxDbeta.pm
    ...
    hnodes hfinal (by
      ...
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_db_out BWLayernormParamGraphK2B3S2D5DxDbeta.pm t 1 101 103 3 4 105 107 109 (by native_decide) (by native_decide)
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_dx_semantic (smFinal pmFinal : Store)
    (hg : ShardedRel (smFinal 1) [pmFinal 100, pmFinal 101] 1 [3, 4, 5] [3, 2, 5])
    (hx : ShardedRel (smFinal 2) [pmFinal 102, pmFinal 103] 1 [3, 4, 5] [3, 2, 5])
    (hgamma : ShardedRel (smFinal 3) [pmFinal 3] 0 [5] [5])
    (hbeta : ShardedRel (smFinal 4) [pmFinal 4] 0 [5] [5])
  ...
  have hgammaShape : (pmFinal 3).shape = [5] := hgamma.shard_shapes _ (by simp)
  ...
  have hbetaShape : (pmFinal 4).shape = [5] := hbeta.shard_shapes _ (by simp)
  ...
  have hComm := TrainVerify.Denote.bw_layernorm_dx_allGatherPrimDimN_dim1_3d 2 3 2 5
  ...
  have hValue : smFinal 10 = allGatherPrimDimN 1 2 0 [pmFinal 104, pmFinal 105] := by
    ...
    rw [← hPm0, ← hPm1]
  have hShape0 : (pmFinal 104).shape = [3, 2, 5] := by
    rw [hPm0, bw_layernorm_dx_shape _ _ _ _ 5 [2, 3] (by rw [hx.shard_shapes _ (by simp)]; rfl)]
    exact hx.shard_shapes _ (by simp)
  have hShape1 : (pmFinal 105).shape = [3, 2, 5] := by
    rw [hPm1, bw_layernorm_dx_shape _ _ _ _ 5 [2, 3] (by rw [hx.shard_shapes _ (by simp)]; rfl)]
    exact hx.shard_shapes _ (by simp)
  have hFull : (smFinal 10).shape = [3, 4, 5] := by
    rw [hSm, bw_layernorm_dx_shape _ _ _ _ 5 [4, 3] (by rw [hx.full_shape]; rfl)]
    exact hx.full_shape
  change ShardedRel (smFinal 10) [pmFinal 104, pmFinal 105] 1 [3, 4, 5] [3, 2, 5]
...
private theorem segment_000000_dbeta_semantic (smFinal pmFinal : Store)
  ...
  have hbetaValue : smFinal 4 = pmFinal 4 := by
    ...
    simpa only [List.length_cons, List.length_nil] using
      (allGatherPrimDimN_singleton_eq 0 (pmFinal 4) (by
        rw [hbeta.shard_shapes _ (by simp)]; decide))
  have hComm := TrainVerify.Denote.bw_layernorm_dbeta_sequence_reduction_rank3 2 3 2 5
    [pmFinal 100, pmFinal 101] [pmFinal 102, pmFinal 103] (pmFinal 3) (pmFinal 4)
    (by decide) (by decide) (by decide) (by decide) rfl rfl hg.shard_shapes hx.shard_shapes
  ...
  have hValue : smFinal 12 = tensorSum [pmFinal 108, pmFinal 109] := by
    ...
    simp only [List.zipWith]
    rw [← hPm0, ← hPm1]
  have hShape0 : (pmFinal 108).shape = [5] := by
    rw [hPm0, bw_layernorm_db_shape _ _ _ _ 5 [2, 3] (by rw [hx.shard_shapes _ (by simp)]; rfl)]
    exact hbetaShape
  have hShape1 : (pmFinal 109).shape = [5] := by
    rw [hPm1, bw_layernorm_db_shape _ _ _ _ 5 [2, 3] (by rw [hx.shard_shapes _ (by simp)]; rfl)]
    exact hbetaShape
  have hFull : (smFinal 12).shape = [5] := by
    rw [hSm, bw_layernorm_db_shape _ _ _ _ 5 [4, 3] (by rw [hx.full_shape]; rfl)]
    exact hbeta.full_shape
  have hReduce : smFinal 12 = allReducePrim [pmFinal 108, pmFinal 109].length 0 [pmFinal 108, pmFinal 109] := by
    rw [hValue]
    rfl
  change ReductionRel (smFinal 12) [pmFinal 108, pmFinal 109] [5]
...
private theorem segment_000000_sound (smStore pmStore : Store)
  ...
  change ShardedRel (smFinal 1) [pmFinal 100, pmFinal 101] 1 [3, 4, 5] [3, 2, 5] at hg
  have hx : fact_x.Holds smFinal pmFinal := hframe _ (by native_decide)
  change ShardedRel (smFinal 2) [pmFinal 102, pmFinal 103] 1 [3, 4, 5] [3, 2, 5] at hx
  have hgamma : fact_gamma.Holds smFinal pmFinal := hframe _ (by native_decide)
  change ShardedRel (smFinal 3) [pmFinal 3] 0 [5] [5] at hgamma
  have hbeta : fact_beta.Holds smFinal pmFinal := hframe _ (by native_decide)
  change ShardedRel (smFinal 4) [pmFinal 4] 0 [5] [5] at hbeta
  ...
  intro fact hfact
  have covered : fact ∈ [fact_dx, fact_dbeta] ++ state_before.facts :=
    (show state_after.facts ⊆ [fact_dx, fact_dbeta] ++ state_before.facts by native_decide) hfact
...
private def segment_000000 : ClosedDepSegmentCertificate BWLayernormParamGraphK2B3S2D5DxDbeta.sm BWLayernormParamGraphK2B3S2D5DxDbeta.pm state_before state_after where
...
end TrainVerify.Denote.GeneratedBWLayernormParamK2B3S2D5DxDbeta
