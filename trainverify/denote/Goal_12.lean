...
theorem prove_goal_12_cut : goal_12_stmt_cut := by
  ...
  have hInit104 : InitGoalHolds pm_goal_12.numRanks goal_6 initSM initPM :=
    hInitGoals goal_6 (by simp [goal_12_cut_initGoals, goal_12_prereqs, initGoals])
  have hInit109 : InitGoalHolds pm_goal_12.numRanks goal_11 initSM initPM :=
    hInitGoals goal_11 (by simp [goal_12_cut_initGoals, goal_12_prereqs, initGoals])
