...
private def segment_generic :
    ClosedDepSegmentCertificate TrainVerify.Denote.GeneratedKRankLocalLinearAllGatherAtomicWitness.smGraph TrainVerify.Denote.GeneratedKRankLocalLinearAllGatherAtomicWitness.pmGraph state_pre state_post where
  ...
  sound := by
    ...
    have hLocalSm0 : smFinal 300 = fw_linear (smStore 100) (smStore 500) := by
      ...
      rw [foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankLocalLinearAllGatherAtomicWitness.smGraph (smNodes.take 1) smStore 100 (by native_decide) (by native_decide),
        foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankLocalLinearAllGatherAtomicWitness.smGraph (smNodes.take 1) smStore 500 (by native_decide) (by native_decide)]
    have hLocalPm0_0 : pmFinal 400 = fw_linear (pmStore 200) (pmStore 500) := by
      ...
      rw [foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankLocalLinearAllGatherAtomicWitness.pmGraph (pmNodes.take 0) pmStore 200 (by native_decide) (by native_decide),
        foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankLocalLinearAllGatherAtomicWitness.pmGraph (pmNodes.take 0) pmStore 500 (by native_decide) (by native_decide)]
    have hLocalPm0_1 : pmFinal 401 = fw_linear (pmStore 201) (pmStore 500) := by
      ...
      rw [foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankLocalLinearAllGatherAtomicWitness.pmGraph (pmNodes.take 2) pmStore 201 (by native_decide) (by native_decide),
        foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankLocalLinearAllGatherAtomicWitness.pmGraph (pmNodes.take 2) pmStore 500 (by native_decide) (by native_decide)]
    have hLocalPm0_2 : pmFinal 402 = fw_linear (pmStore 202) (pmStore 500) := by
      ...
      rw [foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankLocalLinearAllGatherAtomicWitness.pmGraph (pmNodes.take 4) pmStore 202 (by native_decide) (by native_decide),
        foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankLocalLinearAllGatherAtomicWitness.pmGraph (pmNodes.take 4) pmStore 500 (by native_decide) (by native_decide)]
    have hLocalSm1 : smFinal 301 = fw_linear (smStore 101) (smStore 501) := by
      ...
      rw [foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankLocalLinearAllGatherAtomicWitness.smGraph (smNodes.take 0) smStore 101 (by native_decide) (by native_decide),
        foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankLocalLinearAllGatherAtomicWitness.smGraph (smNodes.take 0) smStore 501 (by native_decide) (by native_decide)]
    have hLocalPm1_0 : pmFinal 410 = fw_linear (pmStore 210) (pmStore 501) := by
      ...
      rw [foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankLocalLinearAllGatherAtomicWitness.pmGraph (pmNodes.take 1) pmStore 210 (by native_decide) (by native_decide),
        foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankLocalLinearAllGatherAtomicWitness.pmGraph (pmNodes.take 1) pmStore 501 (by native_decide) (by native_decide)]
    have hLocalPm1_1 : pmFinal 411 = fw_linear (pmStore 211) (pmStore 501) := by
      ...
      rw [foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankLocalLinearAllGatherAtomicWitness.pmGraph (pmNodes.take 3) pmStore 211 (by native_decide) (by native_decide),
        foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankLocalLinearAllGatherAtomicWitness.pmGraph (pmNodes.take 3) pmStore 501 (by native_decide) (by native_decide)]
    have hLocalPm1_2 : pmFinal 412 = fw_linear (pmStore 212) (pmStore 501) := by
      ...
      rw [foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankLocalLinearAllGatherAtomicWitness.pmGraph (pmNodes.take 6) pmStore 212 (by native_decide) (by native_decide),
        foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankLocalLinearAllGatherAtomicWitness.pmGraph (pmNodes.take 6) pmStore 501 (by native_decide) (by native_decide)]
    have hGatherRaw : pmFinal 900 = allGatherPrimDimN 1 3 0 [(((pmNodes.take 5)).foldl (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedKRankLocalLinearAllGatherAtomicWitness.pmGraph) pmStore) 400, (((pmNodes.take 5)).foldl (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedKRankLocalLinearAllGatherAtomicWitness.pmGraph) pmStore) 401, (((pmNodes.take 5)).foldl (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedKRankLocalLinearAllGatherAtomicWitness.pmGraph) pmStore) 402] := by
    ...
    have hGatherInputFinal0 : (((pmNodes.take 5)).foldl (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedKRankLocalLinearAllGatherAtomicWitness.pmGraph) pmStore) 400 = pmFinal 400 := by
      ...
      exact h.symm
    have hGatherInputFinal1 : (((pmNodes.take 5)).foldl (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedKRankLocalLinearAllGatherAtomicWitness.pmGraph) pmStore) 401 = pmFinal 401 := by
      ...
      rw [← List.foldl_append, show (pmNodes.take 5) ++ pmNodes.drop 5 = pmNodes by exact List.take_append_drop 5 pmNodes] at h
      exact h.symm
    have hGatherInputFinal2 : (((pmNodes.take 5)).foldl (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedKRankLocalLinearAllGatherAtomicWitness.pmGraph) pmStore) 402 = pmFinal 402 := by
    ...
    have hJoinedOut : joined.Holds smFinal pmFinal := by
    ...
    intro fact hfact
    have covered : fact ∈ [output_0, output_1, joined] ++ state_pre.facts := by
      exact (show state_post.facts ⊆ [output_0, output_1, joined] ++ state_pre.facts by native_decide) hfact
