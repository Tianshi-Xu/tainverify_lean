...
Pattern proof obligations for all_goals_stmt:
  - Pattern_1.lean: prove_pattern_1  -- instances=1, ops/instance: SM=1340, PM=2964, ops=[OpName.FW_multiref, OpName.FW_per_head_mix_precision_linear, OpName.FW_reshape, OpName.FW_rms_norm, OpName.FW_rotary_embedding, OpName.FW_attn_sliding_window, OpName.FW_glu, OpName.FW_mix_precision_linear, ...]; concrete goals: 1
  ...
  - Pattern_3.lean: prove_pattern_3  -- instances=1, ops/instance: SM=1, PM=4, ops=[OpName.FW_embedding, OpName.AllReducePrim]; concrete goals: 3
  - Pattern_4.lean: prove_pattern_4  -- instances=1, ops/instance: SM=1, PM=2, ops=[OpName.FW_float]; concrete goals: 4
  - Pattern_5.lean: prove_pattern_5  -- instances=1, ops/instance: SM=2, PM=4, ops=[OpName.FW_multiref, OpName.FW_rms_norm]; concrete goals: 5
-/
