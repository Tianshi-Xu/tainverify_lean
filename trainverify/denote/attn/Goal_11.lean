...
def pm_goal_11 : GraphDecl := by
  ...
  exact [
    { rank := 0, op := "OpName.AllToAllPrim", ins := [280, 281, 282, 283], outs := [324], params := [3, 0] },
    { rank := 1, op := "OpName.AllToAllPrim", ins := [280, 281, 282, 283], outs := [325], params := [3, 0] },
    { rank := 2, op := "OpName.AllToAllPrim", ins := [280, 281, 282, 283], outs := [326], params := [3, 0] },
    { rank := 3, op := "OpName.AllToAllPrim", ins := [280, 281, 282, 283], outs := [327], params := [3, 0] },
...
theorem prove_goal_11_cut : goal_11_stmt_cut := by
  ...
  -- Extract intermediateGoal_106 from prereqs
  have hInit106 : InitGoalHolds pm_goal_11.numRanks intermediateGoal_106 initSM initPM := by
