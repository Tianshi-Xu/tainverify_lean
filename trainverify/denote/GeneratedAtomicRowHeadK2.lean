...
def pmGraph : GraphDecl := { numRanks := 2, nodes := [{ rank := 0, op := "OpName.BW_linear", ins := [1000, 2000, 3000], outs := [4000, 5000] }, { rank := 1, op := "OpName.BW_linear", ins := [1001, 2000, 3001], outs := [4001, 5001] }, { rank := 0, op := "OpName.BW_matmul", ins := [6000, 7000, 8000], outs := [9000, 10000] }, { rank := 1, op := "OpName.BW_matmul", ins := [6001, 7001, 8001], outs := [9001, 10001] }] }
...
def mg : RelationFact := .sharded 600 [6000, 6001] 1 [2, 4, 3, 7] [2, 2, 3, 7]
def mx : RelationFact := .sharded 700 [7000, 7001] 1 [2, 4, 3, 5] [2, 2, 3, 5]
def my : RelationFact := .sharded 800 [8000, 8001] 1 [2, 4, 5, 7] [2, 2, 5, 7]
def mo0 : RelationFact := .sharded 900 [9000, 9001] 1 [2, 4, 3, 5] [2, 2, 3, 5]
def mo1 : RelationFact := .sharded 901 [10000, 10001] 1 [2, 4, 5, 7] [2, 2, 5, 7]
...
private def segment_000000_pm_nodes : List NodeDecl := [{ rank := 0, op := "OpName.BW_linear", ins := [1000, 2000, 3000], outs := [4000, 5000] }, { rank := 1, op := "OpName.BW_linear", ins := [1001, 2000, 3001], outs := [4001, 5001] }, { rank := 0, op := "OpName.BW_matmul", ins := [6000, 7000, 8000], outs := [9000, 10000] }, { rank := 1, op := "OpName.BW_matmul", ins := [6001, 7001, 8001], outs := [9001, 10001] }]
...
private theorem segment_000000_head_hPm0_0(pmStore:Store):(segment_000000_pm_final pmStore) 9000=(bw_matmul ((segment_000000_pm_final pmStore) 6000) ((segment_000000_pm_final pmStore) 7000) ((segment_000000_pm_final pmStore) 8000)).1:=by
  ...
  have hout_nodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 2) ++ [{ rank := 0, op := "OpName.BW_matmul", ins := [6000, 7000, 8000], outs := [9000, 10000] }] ++ (segment_000000_pm_nodes.drop 3) := by
    native_decide
  have hout_prefix : (segment_000000_pm_final pmStore) 9000 = (bw_matmul (((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 6000) (((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 7000) (((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 8000)).1 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_middle_writer SyntheticRowHead.pmGraph pmStore
  ...
  have hout_read_0 : ((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 6000 = (segment_000000_pm_final pmStore) 6000 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SyntheticRowHead.pmGraph pmStore
      (segment_000000_pm_nodes.take 2) ({ rank := 0, op := "OpName.BW_matmul", ins := [6000, 7000, 8000], outs := [9000, 10000] } :: (segment_000000_pm_nodes.drop 3)) 6000
      (by native_decide) (by native_decide)
  have hout_read_1 : ((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 7000 = (segment_000000_pm_final pmStore) 7000 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SyntheticRowHead.pmGraph pmStore
      (segment_000000_pm_nodes.take 2) ({ rank := 0, op := "OpName.BW_matmul", ins := [6000, 7000, 8000], outs := [9000, 10000] } :: (segment_000000_pm_nodes.drop 3)) 7000
      (by native_decide) (by native_decide)
  have hout_read_2 : ((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 8000 = (segment_000000_pm_final pmStore) 8000 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SyntheticRowHead.pmGraph pmStore
      (segment_000000_pm_nodes.take 2) ({ rank := 0, op := "OpName.BW_matmul", ins := [6000, 7000, 8000], outs := [9000, 10000] } :: (segment_000000_pm_nodes.drop 3)) 8000
      (by native_decide) (by native_decide)
  have hout : (segment_000000_pm_final pmStore) 9000 = (bw_matmul ((segment_000000_pm_final pmStore) 6000) ((segment_000000_pm_final pmStore) 7000) ((segment_000000_pm_final pmStore) 8000)).1 := by
    calc
      _ = (bw_matmul (((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 6000) (((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 7000) (((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 8000)).1 := hout_prefix
...
private theorem segment_000000_head_hPm0_1(pmStore:Store):(segment_000000_pm_final pmStore) 9001=(bw_matmul ((segment_000000_pm_final pmStore) 6001) ((segment_000000_pm_final pmStore) 7001) ((segment_000000_pm_final pmStore) 8001)).1:=by
  have hfinal:(segment_000000_pm_final pmStore)=segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore:=by unfold segment_000000_pm_final;rfl
  have hout_nodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 3) ++ [{ rank := 1, op := "OpName.BW_matmul", ins := [6001, 7001, 8001], outs := [9001, 10001] }] ++ (segment_000000_pm_nodes.drop 4) := by
    native_decide
  have hout_prefix : (segment_000000_pm_final pmStore) 9001 = (bw_matmul (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 6001) (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 7001) (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 8001)).1 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_middle_writer SyntheticRowHead.pmGraph pmStore
  ...
  have hout_read_0 : ((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 6001 = (segment_000000_pm_final pmStore) 6001 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SyntheticRowHead.pmGraph pmStore
      (segment_000000_pm_nodes.take 3) ({ rank := 1, op := "OpName.BW_matmul", ins := [6001, 7001, 8001], outs := [9001, 10001] } :: (segment_000000_pm_nodes.drop 4)) 6001
      (by native_decide) (by native_decide)
  have hout_read_1 : ((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 7001 = (segment_000000_pm_final pmStore) 7001 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SyntheticRowHead.pmGraph pmStore
      (segment_000000_pm_nodes.take 3) ({ rank := 1, op := "OpName.BW_matmul", ins := [6001, 7001, 8001], outs := [9001, 10001] } :: (segment_000000_pm_nodes.drop 4)) 7001
      (by native_decide) (by native_decide)
  have hout_read_2 : ((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 8001 = (segment_000000_pm_final pmStore) 8001 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SyntheticRowHead.pmGraph pmStore
      (segment_000000_pm_nodes.take 3) ({ rank := 1, op := "OpName.BW_matmul", ins := [6001, 7001, 8001], outs := [9001, 10001] } :: (segment_000000_pm_nodes.drop 4)) 8001
      (by native_decide) (by native_decide)
  have hout : (segment_000000_pm_final pmStore) 9001 = (bw_matmul ((segment_000000_pm_final pmStore) 6001) ((segment_000000_pm_final pmStore) 7001) ((segment_000000_pm_final pmStore) 8001)).1 := by
    calc
      _ = (bw_matmul (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 6001) (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 7001) (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 8001)).1 := hout_prefix
...
private theorem segment_000000_head_hPm1_0(pmStore:Store):(segment_000000_pm_final pmStore) 10000=(bw_matmul ((segment_000000_pm_final pmStore) 6000) ((segment_000000_pm_final pmStore) 7000) ((segment_000000_pm_final pmStore) 8000)).2:=by
  ...
  have hout_nodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 2) ++ [{ rank := 0, op := "OpName.BW_matmul", ins := [6000, 7000, 8000], outs := [9000, 10000] }] ++ (segment_000000_pm_nodes.drop 3) := by
    native_decide
  have hout_prefix : (segment_000000_pm_final pmStore) 10000 = (bw_matmul (((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 6000) (((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 7000) (((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 8000)).2 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_middle_writer SyntheticRowHead.pmGraph pmStore
      (segment_000000_pm_nodes.take 2) (segment_000000_pm_nodes.drop 3)
  ...
  have hout : (segment_000000_pm_final pmStore) 10000 = (bw_matmul ((segment_000000_pm_final pmStore) 6000) ((segment_000000_pm_final pmStore) 7000) ((segment_000000_pm_final pmStore) 8000)).2 := by
    calc
      _ = (bw_matmul (((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 6000) (((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 7000) (((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 8000)).2 := hout_prefix
...
private theorem segment_000000_head_hPm1_1(pmStore:Store):(segment_000000_pm_final pmStore) 10001=(bw_matmul ((segment_000000_pm_final pmStore) 6001) ((segment_000000_pm_final pmStore) 7001) ((segment_000000_pm_final pmStore) 8001)).2:=by
  ...
  have hout_nodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 3) ++ [{ rank := 1, op := "OpName.BW_matmul", ins := [6001, 7001, 8001], outs := [9001, 10001] }] ++ (segment_000000_pm_nodes.drop 4) := by
    native_decide
  have hout_prefix : (segment_000000_pm_final pmStore) 10001 = (bw_matmul (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 6001) (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 7001) (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 8001)).2 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_middle_writer SyntheticRowHead.pmGraph pmStore
      (segment_000000_pm_nodes.take 3) (segment_000000_pm_nodes.drop 4)
  ...
  have hout : (segment_000000_pm_final pmStore) 10001 = (bw_matmul ((segment_000000_pm_final pmStore) 6001) ((segment_000000_pm_final pmStore) 7001) ((segment_000000_pm_final pmStore) 8001)).2 := by
    calc
      _ = (bw_matmul (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 6001) (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 7001) (((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticRowHead.pmGraph) pmStore 8001)).2 := hout_prefix
...
private theorem segment_000000_head_sound(smStore pmStore:Store)(hstate:state_before.Holds smStore pmStore):segment_000000_head_post.Holds (segment_000000_sm_final smStore) (segment_000000_pm_final pmStore):=by
  ...
  change ShardedRel (smFinal 600) [pmFinal 6000, pmFinal 6001] 1 [2, 4, 3, 7] [2, 2, 3, 7] at hg
  have hgV:smFinal 600=allGatherPrimDimN 1 2 0 [pmFinal 6000, pmFinal 6001]:=by simpa only [List.length_cons,List.length_nil] using hg.full_value
  have hx:mx.Holds smFinal pmFinal:=hframe _ (by native_decide)
  change ShardedRel (smFinal 700) [pmFinal 7000, pmFinal 7001] 1 [2, 4, 3, 5] [2, 2, 3, 5] at hx
  have hxV:smFinal 700=allGatherPrimDimN 1 2 0 [pmFinal 7000, pmFinal 7001]:=by simpa only [List.length_cons,List.length_nil] using hx.full_value
  have hy:my.Holds smFinal pmFinal:=hframe _ (by native_decide)
  change ShardedRel (smFinal 800) [pmFinal 8000, pmFinal 8001] 1 [2, 4, 5, 7] [2, 2, 5, 7] at hy
  have hyV:smFinal 800=allGatherPrimDimN 1 2 0 [pmFinal 8000, pmFinal 8001]:=by simpa only [List.length_cons,List.length_nil] using hy.full_value
  ...
  have hC0:=TrainVerify.Denote.bw_matmul_fst_head_gather_rank4 2 2 2 3 5 7 [pmFinal 6000, pmFinal 6001] [pmFinal 7000, pmFinal 7001] [pmFinal 8000, pmFinal 8001]
    (by decide) (by decide) (by decide) (by decide) (by decide) rfl rfl rfl hg.shard_shapes hx.shard_shapes hy.shard_shapes
  have hV0:smFinal 900=allGatherPrimDimN 1 2 0 [pmFinal 9000, pmFinal 9001]:=by
    rw [hS0,hgV,hxV,hyV,hC0]
    simp only [List.zipWith,bw_matmul,batchedMatmulBwd]
    rw [←hP0_0, ←hP0_1]
  have hFull0:(smFinal 900).shape=[2, 4, 3, 5]:=by rw [hS0];exact fw_matmul_rank4_shape _ _ 2 4 3 7 5 hg.full_shape (segment_000000_head_transpose_shape _ 2 4 5 7 hy.full_shape)
  have hout0:mo0.Holds smFinal pmFinal:=by
    change ShardedRel (smFinal 900) [pmFinal 9000, pmFinal 9001] 1 [2, 4, 3, 5] [2, 2, 3, 5]
  ...
  have hC1:=TrainVerify.Denote.bw_matmul_snd_head_gather_rank4 2 2 2 3 5 7 [pmFinal 6000, pmFinal 6001] [pmFinal 7000, pmFinal 7001] [pmFinal 8000, pmFinal 8001]
    (by decide) (by decide) (by decide) (by decide) (by decide) rfl rfl rfl hg.shard_shapes hx.shard_shapes hy.shard_shapes
  have hV1:smFinal 901=allGatherPrimDimN 1 2 0 [pmFinal 10000, pmFinal 10001]:=by
    rw [hS1,hgV,hxV,hyV,hC1]
    simp only [List.zipWith,bw_matmul,batchedMatmulBwd]
    rw [←hP1_0, ←hP1_1]
  have hFull1:(smFinal 901).shape=[2, 4, 5, 7]:=by rw [hS1];exact fw_matmul_rank4_shape _ _ 2 4 5 3 7 (segment_000000_head_transpose_shape _ 2 4 3 5 hx.full_shape) hg.full_shape
  have hout1:mo1.Holds smFinal pmFinal:=by
    change ShardedRel (smFinal 901) [pmFinal 10000, pmFinal 10001] 1 [2, 4, 5, 7] [2, 2, 5, 7]
