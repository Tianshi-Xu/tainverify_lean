...
def pmGraph : GraphDecl := { numRanks := 4, nodes := [{ rank := 0, op := "OpName.BW_linear", ins := [1000, 2000, 206], outs := [4000, 5000] }, { rank := 1, op := "OpName.BW_linear", ins := [1001, 2001, 206], outs := [4001, 5001] }, { rank := 2, op := "OpName.BW_linear", ins := [1002, 2002, 206], outs := [4002, 5002] }, { rank := 0, op := "OpName.AllToAllPrim", ins := [7000, 7001, 7002, 7003], outs := [8000], params := [1, 2] }, { rank := 1, op := "OpName.AllToAllPrim", ins := [7000, 7001, 7002, 7003], outs := [8001], params := [1, 2] }, { rank := 2, op := "OpName.AllToAllPrim", ins := [7000, 7001, 7002, 7003], outs := [8002], params := [1, 2] }, { rank := 3, op := "OpName.AllToAllPrim", ins := [7000, 7001, 7002, 7003], outs := [8003], params := [1, 2] }, { rank := 3, op := "OpName.BW_linear", ins := [1003, 2003, 206], outs := [4003, 5003] }] }
def fact_g : RelationFact := .sharded 100 [1000, 1001, 1002, 1003] 1 [2, 20, 7] [2, 5, 7]
def fact_x : RelationFact := .sharded 200 [2000, 2001, 2002, 2003] 1 [2, 20, 11] [2, 5, 11]
def fact_w : RelationFact := .sharded 206 [206] 0 [7, 11] [7, 11]
def fact_dw : RelationFact := .reduction 401 [5000, 5001, 5002, 5003] [7, 11]
def fact_out : RelationFact := .sharded 400 [4000, 4001, 4002, 4003] 1 [2, 20, 11] [2, 5, 11]
def fact_a_in : RelationFact := .sharded 700 [7000, 7001, 7002, 7003] 1 [2, 20, 44] [2, 5, 44]
def fact_a_out : RelationFact := .sharded 700 [8000, 8001, 8002, 8003] 2 [2, 20, 44] [2, 20, 11]
...
private theorem segment_000000_hPmWriter1_2 (store : Store) : (segment_000000_pm_final store) 5002 = (bw_linear ((segment_000000_pm_final store) 1002) ((segment_000000_pm_final store) 2002) ((segment_000000_pm_final store) 206)).2 := by
  have hfinal : (segment_000000_pm_final store) = segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store := by unfold segment_000000_pm_final; rfl
  have hout_nodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 2) ++ [{ rank := 2, op := "OpName.BW_linear", ins := [1002, 2002, 206], outs := [4002, 5002] }] ++ (segment_000000_pm_nodes.drop 3) := by
    native_decide
  have hout_prefix : (segment_000000_pm_final store) 5002 = (bw_linear (((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 1002) (((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 2002) (((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 206)).2 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_middle_writer SequenceLinearAllToAll.pmGraph store
  ...
  have hout_read_0 : ((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 1002 = (segment_000000_pm_final store) 1002 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 2) ({ rank := 2, op := "OpName.BW_linear", ins := [1002, 2002, 206], outs := [4002, 5002] } :: (segment_000000_pm_nodes.drop 3)) 1002
      (by native_decide) (by native_decide)
  have hout_read_1 : ((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 2002 = (segment_000000_pm_final store) 2002 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 2) ({ rank := 2, op := "OpName.BW_linear", ins := [1002, 2002, 206], outs := [4002, 5002] } :: (segment_000000_pm_nodes.drop 3)) 2002
      (by native_decide) (by native_decide)
  have hout_read_2 : ((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 206 = (segment_000000_pm_final store) 206 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 2) ({ rank := 2, op := "OpName.BW_linear", ins := [1002, 2002, 206], outs := [4002, 5002] } :: (segment_000000_pm_nodes.drop 3)) 206
      (by native_decide) (by native_decide)
  have hout : (segment_000000_pm_final store) 5002 = (bw_linear ((segment_000000_pm_final store) 1002) ((segment_000000_pm_final store) 2002) ((segment_000000_pm_final store) 206)).2 := by
    calc
      _ = (bw_linear (((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 1002) (((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 2002) (((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 206)).2 := hout_prefix
...
private theorem segment_000000_hPmWriter1_3 (store : Store) : (segment_000000_pm_final store) 5003 = (bw_linear ((segment_000000_pm_final store) 1003) ((segment_000000_pm_final store) 2003) ((segment_000000_pm_final store) 206)).2 := by
  have hfinal : (segment_000000_pm_final store) = segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store := by unfold segment_000000_pm_final; rfl
  have hout_nodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 7) ++ [{ rank := 3, op := "OpName.BW_linear", ins := [1003, 2003, 206], outs := [4003, 5003] }] ++ (segment_000000_pm_nodes.drop 8) := by
    native_decide
  have hout_prefix : (segment_000000_pm_final store) 5003 = (bw_linear (((segment_000000_pm_nodes.take 7)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 1003) (((segment_000000_pm_nodes.take 7)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 2003) (((segment_000000_pm_nodes.take 7)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 206)).2 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_middle_writer SequenceLinearAllToAll.pmGraph store
      ...
      (fun t => (bw_linear (t 1003) (t 2003) (t 206)).2) (by
        ...
        rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
        simp [applyNodeDistributed, applyNodeRingAttn]
        exact applyNode_bw_linear_snd_out SequenceLinearAllToAll.pmGraph t 3 1003 2003 206 4003 5003 (by native_decide)
      ) (by native_decide) (by native_decide)
  have hout_read_0 : ((segment_000000_pm_nodes.take 7)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 1003 = (segment_000000_pm_final store) 1003 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 7) ({ rank := 3, op := "OpName.BW_linear", ins := [1003, 2003, 206], outs := [4003, 5003] } :: (segment_000000_pm_nodes.drop 8)) 1003
      (by native_decide) (by native_decide)
  have hout_read_1 : ((segment_000000_pm_nodes.take 7)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 2003 = (segment_000000_pm_final store) 2003 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 7) ({ rank := 3, op := "OpName.BW_linear", ins := [1003, 2003, 206], outs := [4003, 5003] } :: (segment_000000_pm_nodes.drop 8)) 2003
      (by native_decide) (by native_decide)
  have hout_read_2 : ((segment_000000_pm_nodes.take 7)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 206 = (segment_000000_pm_final store) 206 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 7) ({ rank := 3, op := "OpName.BW_linear", ins := [1003, 2003, 206], outs := [4003, 5003] } :: (segment_000000_pm_nodes.drop 8)) 206
      (by native_decide) (by native_decide)
  have hout : (segment_000000_pm_final store) 5003 = (bw_linear ((segment_000000_pm_final store) 1003) ((segment_000000_pm_final store) 2003) ((segment_000000_pm_final store) 206)).2 := by
    calc
      _ = (bw_linear (((segment_000000_pm_nodes.take 7)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 1003) (((segment_000000_pm_nodes.take 7)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 2003) (((segment_000000_pm_nodes.take 7)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 206)).2 := hout_prefix
...
private theorem segment_000000_hPmWriter0_2 (store : Store) : (segment_000000_pm_final store) 4002 = (bw_linear ((segment_000000_pm_final store) 1002) ((segment_000000_pm_final store) 2002) ((segment_000000_pm_final store) 206)).1 := by
  ...
  have hout_nodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 2) ++ [{ rank := 2, op := "OpName.BW_linear", ins := [1002, 2002, 206], outs := [4002, 5002] }] ++ (segment_000000_pm_nodes.drop 3) := by
    native_decide
  have hout_prefix : (segment_000000_pm_final store) 4002 = (bw_linear (((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 1002) (((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 2002) (((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 206)).1 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_middle_writer SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 2) (segment_000000_pm_nodes.drop 3)
  ...
  have hout : (segment_000000_pm_final store) 4002 = (bw_linear ((segment_000000_pm_final store) 1002) ((segment_000000_pm_final store) 2002) ((segment_000000_pm_final store) 206)).1 := by
    calc
      _ = (bw_linear (((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 1002) (((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 2002) (((segment_000000_pm_nodes.take 2)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 206)).1 := hout_prefix
...
private theorem segment_000000_hPmWriter0_3 (store : Store) : (segment_000000_pm_final store) 4003 = (bw_linear ((segment_000000_pm_final store) 1003) ((segment_000000_pm_final store) 2003) ((segment_000000_pm_final store) 206)).1 := by
  ...
  have hout_nodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 7) ++ [{ rank := 3, op := "OpName.BW_linear", ins := [1003, 2003, 206], outs := [4003, 5003] }] ++ (segment_000000_pm_nodes.drop 8) := by
    native_decide
  have hout_prefix : (segment_000000_pm_final store) 4003 = (bw_linear (((segment_000000_pm_nodes.take 7)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 1003) (((segment_000000_pm_nodes.take 7)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 2003) (((segment_000000_pm_nodes.take 7)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 206)).1 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_middle_writer SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 7) (segment_000000_pm_nodes.drop 8)
      ...
      (fun t => (bw_linear (t 1003) (t 2003) (t 206)).1) (by
        ...
        rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
        simp [applyNodeDistributed, applyNodeRingAttn]
        exact applyNode_bw_linear_fst_out SequenceLinearAllToAll.pmGraph t 3 1003 2003 206 4003 5003 (by native_decide)
      ) (by native_decide) (by native_decide)
  have hout_read_0 : ((segment_000000_pm_nodes.take 7)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 1003 = (segment_000000_pm_final store) 1003 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
  ...
  have hout : (segment_000000_pm_final store) 4003 = (bw_linear ((segment_000000_pm_final store) 1003) ((segment_000000_pm_final store) 2003) ((segment_000000_pm_final store) 206)).1 := by
    calc
      _ = (bw_linear (((segment_000000_pm_nodes.take 7)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 1003) (((segment_000000_pm_nodes.take 7)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 2003) (((segment_000000_pm_nodes.take 7)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 206)).1 := hout_prefix
...
private theorem segment_000000_hAllToAll0 (store : Store) : (segment_000000_pm_final store) 8000 = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 0 [(segment_000000_pm_final store) 7000, (segment_000000_pm_final store) 7001, (segment_000000_pm_final store) 7002, (segment_000000_pm_final store) 7003] 1 2 := by
  have hfinal : (segment_000000_pm_final store) = segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store := by unfold segment_000000_pm_final; rfl
  have hout_nodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 3) ++ [{ rank := 0, op := "OpName.AllToAllPrim", ins := [7000, 7001, 7002, 7003], outs := [8000], params := [1, 2] }] ++ (segment_000000_pm_nodes.drop 4) := by
    native_decide
  have hout_prefix : (segment_000000_pm_final store) 8000 = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 0 [((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7000, ((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7001, ((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7002, ((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7003] 1 2 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_middle_writer SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 3) (segment_000000_pm_nodes.drop 4)
      { rank := 0, op := "OpName.AllToAllPrim", ins := [7000, 7001, 7002, 7003], outs := [8000], params := [1, 2] } 8000
      (fun t => allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 0 [t 7000, t 7001, t 7002, t 7003] 1 2) (by
        intro t
        rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
        simp [applyNodeDistributed, applyNodeRingAttn]
        simpa only [List.map] using applyNode_allToAllPrimWithDims_out SequenceLinearAllToAll.pmGraph t 0 [7000, 7001, 7002, 7003] 8000 1 2
      ) (by native_decide) (by native_decide)
  have hout_read_0 : ((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7000 = (segment_000000_pm_final store) 7000 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 3) ({ rank := 0, op := "OpName.AllToAllPrim", ins := [7000, 7001, 7002, 7003], outs := [8000], params := [1, 2] } :: (segment_000000_pm_nodes.drop 4)) 7000
      (by native_decide) (by native_decide)
  have hout_read_1 : ((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7001 = (segment_000000_pm_final store) 7001 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 3) ({ rank := 0, op := "OpName.AllToAllPrim", ins := [7000, 7001, 7002, 7003], outs := [8000], params := [1, 2] } :: (segment_000000_pm_nodes.drop 4)) 7001
      (by native_decide) (by native_decide)
  have hout_read_2 : ((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7002 = (segment_000000_pm_final store) 7002 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 3) ({ rank := 0, op := "OpName.AllToAllPrim", ins := [7000, 7001, 7002, 7003], outs := [8000], params := [1, 2] } :: (segment_000000_pm_nodes.drop 4)) 7002
      (by native_decide) (by native_decide)
  have hout_read_3 : ((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7003 = (segment_000000_pm_final store) 7003 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 3) ({ rank := 0, op := "OpName.AllToAllPrim", ins := [7000, 7001, 7002, 7003], outs := [8000], params := [1, 2] } :: (segment_000000_pm_nodes.drop 4)) 7003
      (by native_decide) (by native_decide)
  have hout : (segment_000000_pm_final store) 8000 = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 0 [(segment_000000_pm_final store) 7000, (segment_000000_pm_final store) 7001, (segment_000000_pm_final store) 7002, (segment_000000_pm_final store) 7003] 1 2 := by
    calc
      _ = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 0 [((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7000, ((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7001, ((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7002, ((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7003] 1 2 := hout_prefix
      _ = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 0 [(segment_000000_pm_final store) 7000, (segment_000000_pm_final store) 7001, (segment_000000_pm_final store) 7002, (segment_000000_pm_final store) 7003] 1 2 := by rw [hout_read_0, hout_read_1, hout_read_2, hout_read_3]
  exact hout

private theorem segment_000000_hAllToAll1 (store : Store) : (segment_000000_pm_final store) 8001 = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 1 [(segment_000000_pm_final store) 7000, (segment_000000_pm_final store) 7001, (segment_000000_pm_final store) 7002, (segment_000000_pm_final store) 7003] 1 2 := by
  have hfinal : (segment_000000_pm_final store) = segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store := by unfold segment_000000_pm_final; rfl
  have hout_nodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 4) ++ [{ rank := 1, op := "OpName.AllToAllPrim", ins := [7000, 7001, 7002, 7003], outs := [8001], params := [1, 2] }] ++ (segment_000000_pm_nodes.drop 5) := by
    native_decide
  have hout_prefix : (segment_000000_pm_final store) 8001 = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 1 [((segment_000000_pm_nodes.take 4)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7000, ((segment_000000_pm_nodes.take 4)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7001, ((segment_000000_pm_nodes.take 4)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7002, ((segment_000000_pm_nodes.take 4)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7003] 1 2 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_middle_writer SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 4) (segment_000000_pm_nodes.drop 5)
      { rank := 1, op := "OpName.AllToAllPrim", ins := [7000, 7001, 7002, 7003], outs := [8001], params := [1, 2] } 8001
      (fun t => allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 1 [t 7000, t 7001, t 7002, t 7003] 1 2) (by
        intro t
        rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
        simp [applyNodeDistributed, applyNodeRingAttn]
        simpa only [List.map] using applyNode_allToAllPrimWithDims_out SequenceLinearAllToAll.pmGraph t 1 [7000, 7001, 7002, 7003] 8001 1 2
      ) (by native_decide) (by native_decide)
  have hout_read_0 : ((segment_000000_pm_nodes.take 4)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7000 = (segment_000000_pm_final store) 7000 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 4) ({ rank := 1, op := "OpName.AllToAllPrim", ins := [7000, 7001, 7002, 7003], outs := [8001], params := [1, 2] } :: (segment_000000_pm_nodes.drop 5)) 7000
      (by native_decide) (by native_decide)
  have hout_read_1 : ((segment_000000_pm_nodes.take 4)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7001 = (segment_000000_pm_final store) 7001 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 4) ({ rank := 1, op := "OpName.AllToAllPrim", ins := [7000, 7001, 7002, 7003], outs := [8001], params := [1, 2] } :: (segment_000000_pm_nodes.drop 5)) 7001
      (by native_decide) (by native_decide)
  have hout_read_2 : ((segment_000000_pm_nodes.take 4)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7002 = (segment_000000_pm_final store) 7002 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 4) ({ rank := 1, op := "OpName.AllToAllPrim", ins := [7000, 7001, 7002, 7003], outs := [8001], params := [1, 2] } :: (segment_000000_pm_nodes.drop 5)) 7002
      (by native_decide) (by native_decide)
  have hout_read_3 : ((segment_000000_pm_nodes.take 4)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7003 = (segment_000000_pm_final store) 7003 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 4) ({ rank := 1, op := "OpName.AllToAllPrim", ins := [7000, 7001, 7002, 7003], outs := [8001], params := [1, 2] } :: (segment_000000_pm_nodes.drop 5)) 7003
      (by native_decide) (by native_decide)
  have hout : (segment_000000_pm_final store) 8001 = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 1 [(segment_000000_pm_final store) 7000, (segment_000000_pm_final store) 7001, (segment_000000_pm_final store) 7002, (segment_000000_pm_final store) 7003] 1 2 := by
    calc
      _ = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 1 [((segment_000000_pm_nodes.take 4)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7000, ((segment_000000_pm_nodes.take 4)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7001, ((segment_000000_pm_nodes.take 4)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7002, ((segment_000000_pm_nodes.take 4)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7003] 1 2 := hout_prefix
      _ = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 1 [(segment_000000_pm_final store) 7000, (segment_000000_pm_final store) 7001, (segment_000000_pm_final store) 7002, (segment_000000_pm_final store) 7003] 1 2 := by rw [hout_read_0, hout_read_1, hout_read_2, hout_read_3]
  exact hout

private theorem segment_000000_hAllToAll2 (store : Store) : (segment_000000_pm_final store) 8002 = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 2 [(segment_000000_pm_final store) 7000, (segment_000000_pm_final store) 7001, (segment_000000_pm_final store) 7002, (segment_000000_pm_final store) 7003] 1 2 := by
  have hfinal : (segment_000000_pm_final store) = segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store := by unfold segment_000000_pm_final; rfl
  have hout_nodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 5) ++ [{ rank := 2, op := "OpName.AllToAllPrim", ins := [7000, 7001, 7002, 7003], outs := [8002], params := [1, 2] }] ++ (segment_000000_pm_nodes.drop 6) := by
    native_decide
  have hout_prefix : (segment_000000_pm_final store) 8002 = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 2 [((segment_000000_pm_nodes.take 5)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7000, ((segment_000000_pm_nodes.take 5)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7001, ((segment_000000_pm_nodes.take 5)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7002, ((segment_000000_pm_nodes.take 5)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7003] 1 2 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_middle_writer SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 5) (segment_000000_pm_nodes.drop 6)
      { rank := 2, op := "OpName.AllToAllPrim", ins := [7000, 7001, 7002, 7003], outs := [8002], params := [1, 2] } 8002
      (fun t => allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 2 [t 7000, t 7001, t 7002, t 7003] 1 2) (by
        intro t
        rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
        simp [applyNodeDistributed, applyNodeRingAttn]
        simpa only [List.map] using applyNode_allToAllPrimWithDims_out SequenceLinearAllToAll.pmGraph t 2 [7000, 7001, 7002, 7003] 8002 1 2
      ) (by native_decide) (by native_decide)
  have hout_read_0 : ((segment_000000_pm_nodes.take 5)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7000 = (segment_000000_pm_final store) 7000 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 5) ({ rank := 2, op := "OpName.AllToAllPrim", ins := [7000, 7001, 7002, 7003], outs := [8002], params := [1, 2] } :: (segment_000000_pm_nodes.drop 6)) 7000
      (by native_decide) (by native_decide)
  have hout_read_1 : ((segment_000000_pm_nodes.take 5)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7001 = (segment_000000_pm_final store) 7001 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 5) ({ rank := 2, op := "OpName.AllToAllPrim", ins := [7000, 7001, 7002, 7003], outs := [8002], params := [1, 2] } :: (segment_000000_pm_nodes.drop 6)) 7001
      (by native_decide) (by native_decide)
  have hout_read_2 : ((segment_000000_pm_nodes.take 5)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7002 = (segment_000000_pm_final store) 7002 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 5) ({ rank := 2, op := "OpName.AllToAllPrim", ins := [7000, 7001, 7002, 7003], outs := [8002], params := [1, 2] } :: (segment_000000_pm_nodes.drop 6)) 7002
      (by native_decide) (by native_decide)
  have hout_read_3 : ((segment_000000_pm_nodes.take 5)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7003 = (segment_000000_pm_final store) 7003 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 5) ({ rank := 2, op := "OpName.AllToAllPrim", ins := [7000, 7001, 7002, 7003], outs := [8002], params := [1, 2] } :: (segment_000000_pm_nodes.drop 6)) 7003
      (by native_decide) (by native_decide)
  have hout : (segment_000000_pm_final store) 8002 = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 2 [(segment_000000_pm_final store) 7000, (segment_000000_pm_final store) 7001, (segment_000000_pm_final store) 7002, (segment_000000_pm_final store) 7003] 1 2 := by
    calc
      _ = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 2 [((segment_000000_pm_nodes.take 5)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7000, ((segment_000000_pm_nodes.take 5)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7001, ((segment_000000_pm_nodes.take 5)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7002, ((segment_000000_pm_nodes.take 5)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7003] 1 2 := hout_prefix
      _ = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 2 [(segment_000000_pm_final store) 7000, (segment_000000_pm_final store) 7001, (segment_000000_pm_final store) 7002, (segment_000000_pm_final store) 7003] 1 2 := by rw [hout_read_0, hout_read_1, hout_read_2, hout_read_3]
  exact hout

private theorem segment_000000_hAllToAll3 (store : Store) : (segment_000000_pm_final store) 8003 = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 3 [(segment_000000_pm_final store) 7000, (segment_000000_pm_final store) 7001, (segment_000000_pm_final store) 7002, (segment_000000_pm_final store) 7003] 1 2 := by
  have hfinal : (segment_000000_pm_final store) = segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store := by unfold segment_000000_pm_final; rfl
  have hout_nodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 6) ++ [{ rank := 3, op := "OpName.AllToAllPrim", ins := [7000, 7001, 7002, 7003], outs := [8003], params := [1, 2] }] ++ (segment_000000_pm_nodes.drop 7) := by
    native_decide
  have hout_prefix : (segment_000000_pm_final store) 8003 = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 3 [((segment_000000_pm_nodes.take 6)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7000, ((segment_000000_pm_nodes.take 6)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7001, ((segment_000000_pm_nodes.take 6)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7002, ((segment_000000_pm_nodes.take 6)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7003] 1 2 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_middle_writer SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 6) (segment_000000_pm_nodes.drop 7)
      { rank := 3, op := "OpName.AllToAllPrim", ins := [7000, 7001, 7002, 7003], outs := [8003], params := [1, 2] } 8003
      (fun t => allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 3 [t 7000, t 7001, t 7002, t 7003] 1 2) (by
        intro t
        rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
        simp [applyNodeDistributed, applyNodeRingAttn]
        simpa only [List.map] using applyNode_allToAllPrimWithDims_out SequenceLinearAllToAll.pmGraph t 3 [7000, 7001, 7002, 7003] 8003 1 2
      ) (by native_decide) (by native_decide)
  have hout_read_0 : ((segment_000000_pm_nodes.take 6)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7000 = (segment_000000_pm_final store) 7000 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 6) ({ rank := 3, op := "OpName.AllToAllPrim", ins := [7000, 7001, 7002, 7003], outs := [8003], params := [1, 2] } :: (segment_000000_pm_nodes.drop 7)) 7000
      (by native_decide) (by native_decide)
  have hout_read_1 : ((segment_000000_pm_nodes.take 6)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7001 = (segment_000000_pm_final store) 7001 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 6) ({ rank := 3, op := "OpName.AllToAllPrim", ins := [7000, 7001, 7002, 7003], outs := [8003], params := [1, 2] } :: (segment_000000_pm_nodes.drop 7)) 7001
      (by native_decide) (by native_decide)
  have hout_read_2 : ((segment_000000_pm_nodes.take 6)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7002 = (segment_000000_pm_final store) 7002 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 6) ({ rank := 3, op := "OpName.AllToAllPrim", ins := [7000, 7001, 7002, 7003], outs := [8003], params := [1, 2] } :: (segment_000000_pm_nodes.drop 7)) 7002
      (by native_decide) (by native_decide)
  have hout_read_3 : ((segment_000000_pm_nodes.take 6)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7003 = (segment_000000_pm_final store) 7003 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SequenceLinearAllToAll.pmGraph store
      (segment_000000_pm_nodes.take 6) ({ rank := 3, op := "OpName.AllToAllPrim", ins := [7000, 7001, 7002, 7003], outs := [8003], params := [1, 2] } :: (segment_000000_pm_nodes.drop 7)) 7003
      (by native_decide) (by native_decide)
  have hout : (segment_000000_pm_final store) 8003 = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 3 [(segment_000000_pm_final store) 7000, (segment_000000_pm_final store) 7001, (segment_000000_pm_final store) 7002, (segment_000000_pm_final store) 7003] 1 2 := by
    calc
      _ = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 3 [((segment_000000_pm_nodes.take 6)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7000, ((segment_000000_pm_nodes.take 6)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7001, ((segment_000000_pm_nodes.take 6)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7002, ((segment_000000_pm_nodes.take 6)).foldl (applyNodeDistributedFaithful SequenceLinearAllToAll.pmGraph) store 7003] 1 2 := hout_prefix
      _ = allToAllPrimWithDims SequenceLinearAllToAll.pmGraph.numRanks 3 [(segment_000000_pm_final store) 7000, (segment_000000_pm_final store) 7001, (segment_000000_pm_final store) 7002, (segment_000000_pm_final store) 7003] 1 2 := by rw [hout_read_0, hout_read_1, hout_read_2, hout_read_3]
  exact hout
...
private theorem segment_000000_sound (smStore pmStore : Store) (hstate : state_before.Holds smStore pmStore) : state_after.Holds (segment_000000_sm_final smStore) (segment_000000_pm_final pmStore) := by
 ...
 change ShardedRel (smFinal 100) [pmFinal 1000, pmFinal 1001, pmFinal 1002, pmFinal 1003] 1 [2, 20, 7] [2, 5, 7] at hg
 have hx : fact_x.Holds smFinal pmFinal := hframe _ (by native_decide)
 change ShardedRel (smFinal 200) [pmFinal 2000, pmFinal 2001, pmFinal 2002, pmFinal 2003] 1 [2, 20, 11] [2, 5, 11] at hx
 ...
 have hcomm1 := TrainVerify.Denote.bw_linear_dw_sequence_reduction_rank3 4 2 5 7 11 [pmFinal 1000, pmFinal 1001, pmFinal 1002, pmFinal 1003] [pmFinal 2000, pmFinal 2001, pmFinal 2002, pmFinal 2003] (pmFinal 206)
 ...
 have hFull1 : (smFinal 401).shape = [7, 11] := by rw [hS1]; exact bw_linear_3d_snd_shape 2 20 7 11 _ _ _ hg.full_shape hx.full_shape hw.full_shape
 ...
 have hShape1_3 : (pmFinal 5003).shape = [7, 11] := by rw [hP1_3]; exact bw_linear_3d_snd_shape 2 5 7 11 _ _ _ (hg.shard_shapes _ (by simp)) (hx.shard_shapes _ (by simp)) (hw.shard_shapes _ (by simp))
 have hout1 : fact_dw.Holds smFinal pmFinal := by
   change ReductionRel (smFinal 401) [pmFinal 5000, pmFinal 5001, pmFinal 5002, pmFinal 5003] [7, 11]
 ...
 have hcomm0 := TrainVerify.Denote.bw_linear_dx_sequence_allGather_rank3 4 2 5 7 11 [pmFinal 1000, pmFinal 1001, pmFinal 1002, pmFinal 1003] [pmFinal 2000, pmFinal 2001, pmFinal 2002, pmFinal 2003] (smFinal 200) (pmFinal 206)
 ...
 have hFull0 : (smFinal 400).shape = [2, 20, 11] := by rw [hS0]; exact bw_linear_3d_fst_shape 2 20 7 11 _ _ _ hg.full_shape hx.full_shape hw.full_shape
 ...
 have hShape0_3 : (pmFinal 4003).shape = [2, 5, 11] := by rw [hP0_3]; exact bw_linear_3d_fst_shape 2 5 7 11 _ _ _ (hg.shard_shapes _ (by simp)) (hx.shard_shapes _ (by simp)) (hw.shard_shapes _ (by simp))
 have hout0 : fact_out.Holds smFinal pmFinal := by
   change ShardedRel (smFinal 400) [pmFinal 4000, pmFinal 4001, pmFinal 4002, pmFinal 4003] 1 [2, 20, 11] [2, 5, 11]
 ...
 change ShardedRel (smFinal 700) [pmFinal 7000, pmFinal 7001, pmFinal 7002, pmFinal 7003] 1 [2, 20, 44] [2, 5, 44] at hai
 have hA0 : pmFinal 8000 = allToAllPrimWithDims 4 0 [pmFinal 7000, pmFinal 7001, pmFinal 7002, pmFinal 7003] 1 2 := segment_000000_hAllToAll0 pmStore
 have hA1 : pmFinal 8001 = allToAllPrimWithDims 4 1 [pmFinal 7000, pmFinal 7001, pmFinal 7002, pmFinal 7003] 1 2 := segment_000000_hAllToAll1 pmStore
 have hA2 : pmFinal 8002 = allToAllPrimWithDims 4 2 [pmFinal 7000, pmFinal 7001, pmFinal 7002, pmFinal 7003] 1 2 := segment_000000_hAllToAll2 pmStore
 have hA3 : pmFinal 8003 = allToAllPrimWithDims 4 3 [pmFinal 7000, pmFinal 7001, pmFinal 7002, pmFinal 7003] 1 2 := segment_000000_hAllToAll3 pmStore
 have hHead : (([pmFinal 7000, pmFinal 7001, pmFinal 7002, pmFinal 7003].head?.map (fun t => t.shape)).getD []) = [2, 5, 44] := hai.shard_shapes _ (by simp)
 have hAV : smFinal 700 = allGatherPrimDimN 1 4 0 [pmFinal 7000, pmFinal 7001, pmFinal 7002, pmFinal 7003] := by simpa only [List.length_cons,List.length_nil] using hai.full_value
 have hGS : (allGatherPrimDimN 1 4 0 [pmFinal 7000, pmFinal 7001, pmFinal 7002, pmFinal 7003]).shape = [2, 20, 44] := by rw [←hAV]; exact hai.full_shape
 have hOd : 2 < (allGatherPrimDimN 1 4 0 [pmFinal 7000, pmFinal 7001, pmFinal 7002, pmFinal 7003]).shape.length := by rw [hGS]; decide
 have hDv : (allGatherPrimDimN 1 4 0 [pmFinal 7000, pmFinal 7001, pmFinal 7002, pmFinal 7003]).shape.getD 2 0 % 4 = 0 := by rw [hGS]; decide
 have hAS0 : (pmFinal 8000).shape = [2, 20, 11] := by rw [hA0,allToAllPrimWithDims_shape 4 0 [pmFinal 7000, pmFinal 7001, pmFinal 7002, pmFinal 7003] 1 2 [2, 5, 44] hHead (by decide)]; decide
 have hAS1 : (pmFinal 8001).shape = [2, 20, 11] := by rw [hA1,allToAllPrimWithDims_shape 4 1 [pmFinal 7000, pmFinal 7001, pmFinal 7002, pmFinal 7003] 1 2 [2, 5, 44] hHead (by decide)]; decide
 have hAS2 : (pmFinal 8002).shape = [2, 20, 11] := by rw [hA2,allToAllPrimWithDims_shape 4 2 [pmFinal 7000, pmFinal 7001, pmFinal 7002, pmFinal 7003] 1 2 [2, 5, 44] hHead (by decide)]; decide
 have hAS3 : (pmFinal 8003).shape = [2, 20, 11] := by rw [hA3,allToAllPrimWithDims_shape 4 3 [pmFinal 7000, pmFinal 7001, pmFinal 7002, pmFinal 7003] 1 2 [2, 5, 44] hHead (by decide)]; decide
 have hOrd : [pmFinal 8000, pmFinal 8001, pmFinal 8002, pmFinal 8003] = List.ofFn (fun r : Fin 4 => allToAllPrimWithDims 4 r.1 [pmFinal 7000, pmFinal 7001, pmFinal 7002, pmFinal 7003] 1 2) := by rw [hA0, hA1, hA2, hA3]; rfl
 have hAC : allGatherPrimDimN 2 [pmFinal 8000, pmFinal 8001, pmFinal 8002, pmFinal 8003].length 0 [pmFinal 8000, pmFinal 8001, pmFinal 8002, pmFinal 8003] = allGatherPrimDimN 1 4 0 [pmFinal 7000, pmFinal 7001, pmFinal 7002, pmFinal 7003] := by rw [hOrd]; simpa only [List.length_cons,List.length_nil,List.length_ofFn] using (TrainVerify.Denote.allGatherPrimDimN_allToAllPrimWithDims_ofFn 1 2 [pmFinal 7000, pmFinal 7001, pmFinal 7002, pmFinal 7003] (by simp) hOd hDv)
 have houtA : fact_a_out.Holds smFinal pmFinal := by
   change ShardedRel (smFinal 700) [pmFinal 8000, pmFinal 8001, pmFinal 8002, pmFinal 8003] 2 [2, 20, 44] [2, 20, 11]
