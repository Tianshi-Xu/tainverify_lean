...
private def gather_input_0 : RelationFact :=
  .sharded 101 [210, 211] 1 [2, 6, 5] [2, 3, 5]

private def joined_0 : RelationFact :=
  .joined 101 900 [2, 6, 5]
...
private def state_pre : RelationState where
  facts := [input_0, weight_eq_0, weight_shape_0, gather_input_0, gather_input_1]
  nonempty := by decide
...
private def pmGraph : GraphDecl := { numRanks := 2, nodes := [{ rank := 0, op := "OpName.FW_multiref", ins := [190], outs := [200, 210, 220] }, { rank := 1, op := "OpName.FW_multiref", ins := [191], outs := [201, 211, 221] }, { rank := 0, op := "OpName.FW_linear", ins := [200, 500], outs := [400] }, { rank := 0, op := "OpName.AllGatherPrim", ins := [210, 211], outs := [900], params := [1] }, { rank := 0, op := "OpName.AllGatherPrim", ins := [220, 221], outs := [901], params := [1] }, { rank := 1, op := "OpName.FW_linear", ins := [201, 500], outs := [401] }] }
private def segment_generic_sm_nodes : List NodeDecl := [{ rank := 0, op := "OpName.FW_linear", ins := [100, 500], outs := [300] }]
private def segment_generic_pm_nodes : List NodeDecl := [{ rank := 0, op := "OpName.FW_linear", ins := [200, 500], outs := [400] }, { rank := 0, op := "OpName.AllGatherPrim", ins := [210, 211], outs := [900], params := [1] }, { rank := 0, op := "OpName.AllGatherPrim", ins := [220, 221], outs := [901], params := [1] }, { rank := 1, op := "OpName.FW_linear", ins := [201, 500], outs := [401] }]
...
private def segment_generic :
  ...
  sound := by
    ...
    have hLocalPm0_1 : pmFinal 401 = fw_linear (pmStore 201) (pmStore 500) := by
      ...
      rw [show pmNodes = pmNodes.take 3 ++ [{ rank := 1, op := "OpName.FW_linear", ins := [201, 500], outs := [401] }] ++ pmNodes.drop 4 by native_decide]
      ...
      rw [foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedLocalLinearMultiGatherWitness.pmGraph (pmNodes.take 3) pmStore 201 (by native_decide) (by native_decide),
        foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedLocalLinearMultiGatherWitness.pmGraph (pmNodes.take 3) pmStore 500 (by native_decide) (by native_decide)]
    have hGather0_Raw : pmFinal 900 = allGatherPrimDimN 1 2 0 [(((pmNodes.take 1)).foldl (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedLocalLinearMultiGatherWitness.pmGraph) pmStore) 210, (((pmNodes.take 1)).foldl (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedLocalLinearMultiGatherWitness.pmGraph) pmStore) 211] := by
      ...
      conv_lhs =>
        rw [show pmNodes = (pmNodes.take 1) ++ [{ rank := 0, op := "OpName.AllGatherPrim", ins := [210, 211], outs := [900], params := [1] }] ++ (pmNodes.drop 2) by native_decide]
      rw [foldl_faithful_middle_writer TrainVerify.Denote.GeneratedLocalLinearMultiGatherWitness.pmGraph pmStore (pmNodes.take 1) (pmNodes.drop 2)
        { rank := 0, op := "OpName.AllGatherPrim", ins := [210, 211], outs := [900], params := [1] } 900 (fun t => allGatherPrimDimN 1 2 0 [t 210, t 211]) (by
          intro t
          rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective
            (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
          simp [applyNodeDistributed, applyNodeRingAttn]
          exact applyNode_allGatherPrimDimN_out TrainVerify.Denote.GeneratedLocalLinearMultiGatherWitness.pmGraph t 0 [210, 211] 900 1
        ) (by native_decide) (by native_decide)]
    have hGather0_InputFinal0 : (((pmNodes.take 1)).foldl (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedLocalLinearMultiGatherWitness.pmGraph) pmStore) 210 = pmFinal 210 := by
      have h := foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedLocalLinearMultiGatherWitness.pmGraph (pmNodes.drop 1) (((pmNodes.take 1)).foldl (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedLocalLinearMultiGatherWitness.pmGraph) pmStore) 210 (by native_decide) (by native_decide)
      rw [← List.foldl_append, show (pmNodes.take 1) ++ pmNodes.drop 1 = pmNodes by exact List.take_append_drop 1 pmNodes] at h
      exact h.symm
    have hGather0_InputFinal1 : (((pmNodes.take 1)).foldl (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedLocalLinearMultiGatherWitness.pmGraph) pmStore) 211 = pmFinal 211 := by
      have h := foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedLocalLinearMultiGatherWitness.pmGraph (pmNodes.drop 1) (((pmNodes.take 1)).foldl (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedLocalLinearMultiGatherWitness.pmGraph) pmStore) 211 (by native_decide) (by native_decide)
      rw [← List.foldl_append, show (pmNodes.take 1) ++ pmNodes.drop 1 = pmNodes by exact List.take_append_drop 1 pmNodes] at h
      exact h.symm
    have hGather0_Writer : pmFinal 900 = allGatherPrimDimN 1 2 0 [pmFinal 210, pmFinal 211] := by
      rw [hGather0_Raw]
      rw [hGather0_InputFinal0, hGather0_InputFinal1]
    have hGather1_Raw : pmFinal 901 = allGatherPrimDimN 1 2 0 [(((pmNodes.take 2)).foldl (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedLocalLinearMultiGatherWitness.pmGraph) pmStore) 220, (((pmNodes.take 2)).foldl (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedLocalLinearMultiGatherWitness.pmGraph) pmStore) 221] := by
      ...
      conv_lhs =>
        rw [show pmNodes = (pmNodes.take 2) ++ [{ rank := 0, op := "OpName.AllGatherPrim", ins := [220, 221], outs := [901], params := [1] }] ++ (pmNodes.drop 3) by native_decide]
    ...
    have hGather1_InputFinal0 : (((pmNodes.take 2)).foldl (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedLocalLinearMultiGatherWitness.pmGraph) pmStore) 220 = pmFinal 220 := by
      have h := foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedLocalLinearMultiGatherWitness.pmGraph (pmNodes.drop 2) (((pmNodes.take 2)).foldl (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedLocalLinearMultiGatherWitness.pmGraph) pmStore) 220 (by native_decide) (by native_decide)
      rw [← List.foldl_append, show (pmNodes.take 2) ++ pmNodes.drop 2 = pmNodes by exact List.take_append_drop 2 pmNodes] at h
      exact h.symm
    have hGather1_InputFinal1 : (((pmNodes.take 2)).foldl (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedLocalLinearMultiGatherWitness.pmGraph) pmStore) 221 = pmFinal 221 := by
      have h := foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedLocalLinearMultiGatherWitness.pmGraph (pmNodes.drop 2) (((pmNodes.take 2)).foldl (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedLocalLinearMultiGatherWitness.pmGraph) pmStore) 221 (by native_decide) (by native_decide)
      rw [← List.foldl_append, show (pmNodes.take 2) ++ pmNodes.drop 2 = pmNodes by exact List.take_append_drop 2 pmNodes] at h
      exact h.symm
    ...
    change ShardedRel (smFinal 101) [pmFinal 210, pmFinal 211] 1 [2, 6, 5] [2, 3, 5] at hGather0_Final
    have hJoined0_Value : smFinal 101 = pmFinal 900 := by
    ...
    have hJoined0_Out : joined_0.Holds smFinal pmFinal := by
      change smFinal 101 = pmFinal 900 ∧ (smFinal 101).shape = [2, 6, 5] ∧ (pmFinal 900).shape = [2, 6, 5]
