...
theorem prove_goal_15_cut : goal_15_stmt_cut := by
  ...
  have h112_rec : initSM 112 = reconstructWithDim 1 pm_goal_15.numRanks 0
    ...
    simp only [goal_14, pm_goal_15, List.map] at hrec; exact hrec
  have h108_rec : initSM 108 = reconstructWithDim 3 pm_goal_15.numRanks 0
    ...
    simp only [goal_10, pm_goal_15, List.map] at hrec; exact hrec
  -- Shapes
  ...
  simp only [goal_14, List.map] at htp112_shapes
  ...
  simp only [goal_10, List.map] at htp108_shapes
