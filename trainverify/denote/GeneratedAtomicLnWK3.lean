...
namespace BWLayernormWredGraphK3B2S3D7DxDgammaDbeta
...
def pm : GraphDecl := { numRanks := 3, nodes := [{ rank := 0, op := "OpName.FW_float", ins := [115], outs := [116] }, { rank := 0, op := "OpName.BW_layernorm", ins := [100, 103, 3, 4], outs := [106, 109, 112] }, { rank := 1, op := "OpName.FW_float", ins := [115], outs := [117] }, { rank := 1, op := "OpName.BW_layernorm", ins := [101, 104, 3, 4], outs := [107, 110, 113] }, { rank := 0, op := "OpName.CROSS_DP_WRED", ins := [600, 601, 602], outs := [600] }, { rank := 2, op := "OpName.BW_layernorm", ins := [102, 105, 3, 4], outs := [108, 111, 114] }, { rank := 0, op := "OpName.FW_float", ins := [115], outs := [119] }] }
end BWLayernormWredGraphK3B2S3D7DxDgammaDbeta
/- AUTO-GENERATED closed relation state universe. -/

open TrainVerify.Denote
open TrainVerify.Denote.RelationCompiler

namespace TrainVerify.Denote.GeneratedBWLayernormWredK3B2S3D7DxDgammaDbeta
...
private def fact_g : RelationFact :=
  .sharded 1 [100, 101, 102] 1 [2, 9, 7] [2, 3, 7]

private def fact_x : RelationFact :=
  .sharded 2 [103, 104, 105] 1 [2, 9, 7] [2, 3, 7]
...
private def fact_dx : RelationFact :=
  .sharded 10 [106, 107, 108] 1 [2, 9, 7] [2, 3, 7]

private def fact_dgamma : RelationFact :=
  .reduction 11 [109, 110, 111] [7]

private def fact_dbeta : RelationFact :=
  .reduction 12 [112, 113, 114] [7]

private def fact_w : RelationFact :=
  .reduction 50 [600, 601, 602] [5, 7]
...
@[irreducible] private def segment_000000_sm_final (store : Store) : Store :=
  segment_000000_sm_nodes.foldl (applyNodeDistributedFaithful BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.sm) store
@[irreducible] private def segment_000000_pm_final (store : Store) : Store :=
  segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm) store
...
private theorem segment_000000_hSmdx (store : Store) :
  ...
  have hfinal : (segment_000000_sm_final store) = segment_000000_sm_nodes.foldl (applyNodeDistributedFaithful BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.sm) store := by
  ...
  exact segment_000000_four_input_middle_writer BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.sm
    ...
    hnodes hfinal (by
      ...
      exact applyNode_bw_layernorm_dx_out BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.sm t 0 1 2 3 4 10 11 12
...
private theorem segment_000000_hPmdx0 (store : Store) :
    (segment_000000_pm_final store) 106 = (bw_layernorm ((segment_000000_pm_final store) 100) ((segment_000000_pm_final store) 103) ((segment_000000_pm_final store) 3) ((segment_000000_pm_final store) 4)).1 := by
  have hfinal : (segment_000000_pm_final store) = segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm) store := by
    unfold segment_000000_pm_final
    rfl
  have hnodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 1) ++ [{ rank := 0, op := "OpName.BW_layernorm", ins := [100, 103, 3, 4], outs := [106, 109, 112] }] ++ (segment_000000_pm_nodes.drop 2) := by native_decide
  exact segment_000000_four_input_middle_writer BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm
    segment_000000_pm_nodes (segment_000000_pm_nodes.take 1) (segment_000000_pm_nodes.drop 2)
    store (segment_000000_pm_final store) { rank := 0, op := "OpName.BW_layernorm", ins := [100, 103, 3, 4], outs := [106, 109, 112] }
    100 103 3 4 106 (fun a b c d => (bw_layernorm a b c d).1)
    hnodes hfinal (by
      intro t
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_dx_out BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm t 0 100 103 3 4 106 109 112
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hPmdx1 (store : Store) :
    (segment_000000_pm_final store) 107 = (bw_layernorm ((segment_000000_pm_final store) 101) ((segment_000000_pm_final store) 104) ((segment_000000_pm_final store) 3) ((segment_000000_pm_final store) 4)).1 := by
  have hfinal : (segment_000000_pm_final store) = segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm) store := by
    unfold segment_000000_pm_final
    rfl
  have hnodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 3) ++ [{ rank := 1, op := "OpName.BW_layernorm", ins := [101, 104, 3, 4], outs := [107, 110, 113] }] ++ (segment_000000_pm_nodes.drop 4) := by native_decide
  exact segment_000000_four_input_middle_writer BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm
    segment_000000_pm_nodes (segment_000000_pm_nodes.take 3) (segment_000000_pm_nodes.drop 4)
    store (segment_000000_pm_final store) { rank := 1, op := "OpName.BW_layernorm", ins := [101, 104, 3, 4], outs := [107, 110, 113] }
    101 104 3 4 107 (fun a b c d => (bw_layernorm a b c d).1)
    hnodes hfinal (by
      intro t
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_dx_out BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm t 1 101 104 3 4 107 110 113
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hPmdx2 (store : Store) :
    (segment_000000_pm_final store) 108 = (bw_layernorm ((segment_000000_pm_final store) 102) ((segment_000000_pm_final store) 105) ((segment_000000_pm_final store) 3) ((segment_000000_pm_final store) 4)).1 := by
  have hfinal : (segment_000000_pm_final store) = segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm) store := by
    unfold segment_000000_pm_final
    rfl
  have hnodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 5) ++ [{ rank := 2, op := "OpName.BW_layernorm", ins := [102, 105, 3, 4], outs := [108, 111, 114] }] ++ (segment_000000_pm_nodes.drop 6) := by native_decide
  exact segment_000000_four_input_middle_writer BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm
    segment_000000_pm_nodes (segment_000000_pm_nodes.take 5) (segment_000000_pm_nodes.drop 6)
    store (segment_000000_pm_final store) { rank := 2, op := "OpName.BW_layernorm", ins := [102, 105, 3, 4], outs := [108, 111, 114] }
    102 105 3 4 108 (fun a b c d => (bw_layernorm a b c d).1)
    hnodes hfinal (by
      intro t
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_dx_out BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm t 2 102 105 3 4 108 111 114
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hSmdgamma (store : Store) :
  ...
  exact segment_000000_four_input_middle_writer BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.sm
    ...
    hnodes hfinal (by
      ...
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_dw_out BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.sm t 0 1 2 3 4 10 11 12 (by native_decide)
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hPmdgamma0 (store : Store) :
    (segment_000000_pm_final store) 109 = (bw_layernorm ((segment_000000_pm_final store) 100) ((segment_000000_pm_final store) 103) ((segment_000000_pm_final store) 3) ((segment_000000_pm_final store) 4)).2.1 := by
  have hfinal : (segment_000000_pm_final store) = segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm) store := by
    unfold segment_000000_pm_final
    rfl
  have hnodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 1) ++ [{ rank := 0, op := "OpName.BW_layernorm", ins := [100, 103, 3, 4], outs := [106, 109, 112] }] ++ (segment_000000_pm_nodes.drop 2) := by native_decide
  exact segment_000000_four_input_middle_writer BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm
    segment_000000_pm_nodes (segment_000000_pm_nodes.take 1) (segment_000000_pm_nodes.drop 2)
    store (segment_000000_pm_final store) { rank := 0, op := "OpName.BW_layernorm", ins := [100, 103, 3, 4], outs := [106, 109, 112] }
    100 103 3 4 109 (fun a b c d => (bw_layernorm a b c d).2.1)
    hnodes hfinal (by
      intro t
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_dw_out BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm t 0 100 103 3 4 106 109 112 (by native_decide)
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hPmdgamma1 (store : Store) :
    (segment_000000_pm_final store) 110 = (bw_layernorm ((segment_000000_pm_final store) 101) ((segment_000000_pm_final store) 104) ((segment_000000_pm_final store) 3) ((segment_000000_pm_final store) 4)).2.1 := by
  have hfinal : (segment_000000_pm_final store) = segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm) store := by
    unfold segment_000000_pm_final
    rfl
  have hnodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 3) ++ [{ rank := 1, op := "OpName.BW_layernorm", ins := [101, 104, 3, 4], outs := [107, 110, 113] }] ++ (segment_000000_pm_nodes.drop 4) := by native_decide
  exact segment_000000_four_input_middle_writer BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm
    segment_000000_pm_nodes (segment_000000_pm_nodes.take 3) (segment_000000_pm_nodes.drop 4)
    store (segment_000000_pm_final store) { rank := 1, op := "OpName.BW_layernorm", ins := [101, 104, 3, 4], outs := [107, 110, 113] }
    101 104 3 4 110 (fun a b c d => (bw_layernorm a b c d).2.1)
    hnodes hfinal (by
      intro t
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_dw_out BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm t 1 101 104 3 4 107 110 113 (by native_decide)
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hPmdgamma2 (store : Store) :
    (segment_000000_pm_final store) 111 = (bw_layernorm ((segment_000000_pm_final store) 102) ((segment_000000_pm_final store) 105) ((segment_000000_pm_final store) 3) ((segment_000000_pm_final store) 4)).2.1 := by
  have hfinal : (segment_000000_pm_final store) = segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm) store := by
    unfold segment_000000_pm_final
    rfl
  have hnodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 5) ++ [{ rank := 2, op := "OpName.BW_layernorm", ins := [102, 105, 3, 4], outs := [108, 111, 114] }] ++ (segment_000000_pm_nodes.drop 6) := by native_decide
  exact segment_000000_four_input_middle_writer BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm
    segment_000000_pm_nodes (segment_000000_pm_nodes.take 5) (segment_000000_pm_nodes.drop 6)
    store (segment_000000_pm_final store) { rank := 2, op := "OpName.BW_layernorm", ins := [102, 105, 3, 4], outs := [108, 111, 114] }
    102 105 3 4 111 (fun a b c d => (bw_layernorm a b c d).2.1)
    hnodes hfinal (by
      intro t
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_dw_out BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm t 2 102 105 3 4 108 111 114 (by native_decide)
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hSmdbeta (store : Store) :
  ...
  exact segment_000000_four_input_middle_writer BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.sm
    ...
    hnodes hfinal (by
      ...
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_db_out BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.sm t 0 1 2 3 4 10 11 12 (by native_decide) (by native_decide)
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hPmdbeta0 (store : Store) :
    (segment_000000_pm_final store) 112 = (bw_layernorm ((segment_000000_pm_final store) 100) ((segment_000000_pm_final store) 103) ((segment_000000_pm_final store) 3) ((segment_000000_pm_final store) 4)).2.2 := by
  have hfinal : (segment_000000_pm_final store) = segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm) store := by
    unfold segment_000000_pm_final
    rfl
  have hnodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 1) ++ [{ rank := 0, op := "OpName.BW_layernorm", ins := [100, 103, 3, 4], outs := [106, 109, 112] }] ++ (segment_000000_pm_nodes.drop 2) := by native_decide
  exact segment_000000_four_input_middle_writer BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm
    segment_000000_pm_nodes (segment_000000_pm_nodes.take 1) (segment_000000_pm_nodes.drop 2)
    store (segment_000000_pm_final store) { rank := 0, op := "OpName.BW_layernorm", ins := [100, 103, 3, 4], outs := [106, 109, 112] }
    100 103 3 4 112 (fun a b c d => (bw_layernorm a b c d).2.2)
    hnodes hfinal (by
      intro t
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_db_out BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm t 0 100 103 3 4 106 109 112 (by native_decide) (by native_decide)
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hPmdbeta1 (store : Store) :
    (segment_000000_pm_final store) 113 = (bw_layernorm ((segment_000000_pm_final store) 101) ((segment_000000_pm_final store) 104) ((segment_000000_pm_final store) 3) ((segment_000000_pm_final store) 4)).2.2 := by
  have hfinal : (segment_000000_pm_final store) = segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm) store := by
    unfold segment_000000_pm_final
    rfl
  have hnodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 3) ++ [{ rank := 1, op := "OpName.BW_layernorm", ins := [101, 104, 3, 4], outs := [107, 110, 113] }] ++ (segment_000000_pm_nodes.drop 4) := by native_decide
  exact segment_000000_four_input_middle_writer BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm
    segment_000000_pm_nodes (segment_000000_pm_nodes.take 3) (segment_000000_pm_nodes.drop 4)
    store (segment_000000_pm_final store) { rank := 1, op := "OpName.BW_layernorm", ins := [101, 104, 3, 4], outs := [107, 110, 113] }
    101 104 3 4 113 (fun a b c d => (bw_layernorm a b c d).2.2)
    hnodes hfinal (by
      intro t
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_db_out BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm t 1 101 104 3 4 107 110 113 (by native_decide) (by native_decide)
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hPmdbeta2 (store : Store) :
    (segment_000000_pm_final store) 114 = (bw_layernorm ((segment_000000_pm_final store) 102) ((segment_000000_pm_final store) 105) ((segment_000000_pm_final store) 3) ((segment_000000_pm_final store) 4)).2.2 := by
  have hfinal : (segment_000000_pm_final store) = segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm) store := by
    unfold segment_000000_pm_final
    rfl
  have hnodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 5) ++ [{ rank := 2, op := "OpName.BW_layernorm", ins := [102, 105, 3, 4], outs := [108, 111, 114] }] ++ (segment_000000_pm_nodes.drop 6) := by native_decide
  exact segment_000000_four_input_middle_writer BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm
    segment_000000_pm_nodes (segment_000000_pm_nodes.take 5) (segment_000000_pm_nodes.drop 6)
    store (segment_000000_pm_final store) { rank := 2, op := "OpName.BW_layernorm", ins := [102, 105, 3, 4], outs := [108, 111, 114] }
    102 105 3 4 114 (fun a b c d => (bw_layernorm a b c d).2.2)
    hnodes hfinal (by
      intro t
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_db_out BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm t 2 102 105 3 4 108 111 114 (by native_decide) (by native_decide)
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_wred_writer_0 (pmStore : Store) :
    (segment_000000_pm_final pmStore) 600 = cross_dp_wred ([600, 601, 602].map pmStore) := by
  have hfinal : segment_000000_pm_final pmStore = segment_000000_pm_nodes.foldl
      (applyNodeDistributedFaithful BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm) pmStore := by
    unfold segment_000000_pm_final
    rfl
  have hnodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 4) ++ [{ rank := 0, op := "OpName.CROSS_DP_WRED", ins := [600, 601, 602], outs := [600] }] ++ (segment_000000_pm_nodes.drop 5) := by native_decide
  have hprefix : (segment_000000_pm_final pmStore) 600 =
      cross_dp_wred ([600, 601, 602].map ((segment_000000_pm_nodes.take 4).foldl
        (applyNodeDistributedFaithful BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm) pmStore)) := by
    rw [hfinal, hnodes]
    exact foldl_faithful_middle_writer BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm pmStore (segment_000000_pm_nodes.take 4) (segment_000000_pm_nodes.drop 5)
      { rank := 0, op := "OpName.CROSS_DP_WRED", ins := [600, 601, 602], outs := [600] } 600
      (fun t => cross_dp_wred ([600, 601, 602].map t)) (by
        intro t
        ...
        · exact applyNode_cross_dp_wred_out BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm t 0 [600, 601, 602] 600
        · native_decide
        · native_decide
      ) (by native_decide) (by native_decide)
  have hread0 : ((segment_000000_pm_nodes.take 4).foldl
      (applyNodeDistributedFaithful BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm) pmStore) 600 = pmStore 600 :=
    foldl_applyNodeDistributedFaithful_at_not_written BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm
      (segment_000000_pm_nodes.take 4) pmStore 600 (by native_decide) (by native_decide)
  have hread1 : ((segment_000000_pm_nodes.take 4).foldl
      (applyNodeDistributedFaithful BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm) pmStore) 601 = pmStore 601 :=
    foldl_applyNodeDistributedFaithful_at_not_written BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm
      (segment_000000_pm_nodes.take 4) pmStore 601 (by native_decide) (by native_decide)
  have hread2 : ((segment_000000_pm_nodes.take 4).foldl
      (applyNodeDistributedFaithful BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm) pmStore) 602 = pmStore 602 :=
    foldl_applyNodeDistributedFaithful_at_not_written BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm
      (segment_000000_pm_nodes.take 4) pmStore 602 (by native_decide) (by native_decide)
  simp only [List.map] at hprefix ⊢
  rw [hread0, hread1, hread2] at hprefix
  exact hprefix

set_option maxHeartbeats 500000 in
private theorem segment_000000_dx_semantic (smFinal pmFinal : Store)
    (hg : ShardedRel (smFinal 1) [pmFinal 100, pmFinal 101, pmFinal 102] 1 [2, 9, 7] [2, 3, 7])
    (hx : ShardedRel (smFinal 2) [pmFinal 103, pmFinal 104, pmFinal 105] 1 [2, 9, 7] [2, 3, 7])
    ...
    (hPm0 : pmFinal 106 = (bw_layernorm (pmFinal 100) (pmFinal 103) (pmFinal 3) (pmFinal 4)).1)
    (hPm1 : pmFinal 107 = (bw_layernorm (pmFinal 101) (pmFinal 104) (pmFinal 3) (pmFinal 4)).1)
    (hPm2 : pmFinal 108 = (bw_layernorm (pmFinal 102) (pmFinal 105) (pmFinal 3) (pmFinal 4)).1)
  ...
  have hxValue : smFinal 2 = allGatherPrimDimN 1 3 0 [pmFinal 103, pmFinal 104, pmFinal 105] := by
  ...
  have hComm := TrainVerify.Denote.bw_layernorm_dx_allGatherPrimDimN_dim1_3d 3 2 3 7
    [pmFinal 100, pmFinal 101, pmFinal 102] [pmFinal 103, pmFinal 104, pmFinal 105] (pmFinal 3) (pmFinal 4)
    (by decide) (by decide) (by decide) (by decide) rfl rfl hg.shard_shapes hx.shard_shapes
  have hValue : smFinal 10 = allGatherPrimDimN 1 3 0 [pmFinal 106, pmFinal 107, pmFinal 108] := by
    rw [hSm, hgValue, hxValue, hgammaValue, hbetaValue, hComm]
    simp only [List.zipWith]
    rw [← hPm0, ← hPm1, ← hPm2]
  have hShape0 : (pmFinal 106).shape = [2, 3, 7] := by
    rw [hPm0, bw_layernorm_dx_shape _ _ _ _ 7 [3, 2] (by rw [hx.shard_shapes _ (by simp)]; rfl)]
    exact hx.shard_shapes _ (by simp)
  have hShape1 : (pmFinal 107).shape = [2, 3, 7] := by
    rw [hPm1, bw_layernorm_dx_shape _ _ _ _ 7 [3, 2] (by rw [hx.shard_shapes _ (by simp)]; rfl)]
    exact hx.shard_shapes _ (by simp)
  have hShape2 : (pmFinal 108).shape = [2, 3, 7] := by
    rw [hPm2, bw_layernorm_dx_shape _ _ _ _ 7 [3, 2] (by rw [hx.shard_shapes _ (by simp)]; rfl)]
    exact hx.shard_shapes _ (by simp)
  have hFull : (smFinal 10).shape = [2, 9, 7] := by
    rw [hSm, bw_layernorm_dx_shape _ _ _ _ 7 [9, 2] (by rw [hx.full_shape]; rfl)]
    exact hx.full_shape
  change ShardedRel (smFinal 10) [pmFinal 106, pmFinal 107, pmFinal 108] 1 [2, 9, 7] [2, 3, 7]
...
private theorem segment_000000_dgamma_semantic (smFinal pmFinal : Store)
    ...
    (hPm0 : pmFinal 109 = (bw_layernorm (pmFinal 100) (pmFinal 103) (pmFinal 3) (pmFinal 4)).2.1)
    (hPm1 : pmFinal 110 = (bw_layernorm (pmFinal 101) (pmFinal 104) (pmFinal 3) (pmFinal 4)).2.1)
    (hPm2 : pmFinal 111 = (bw_layernorm (pmFinal 102) (pmFinal 105) (pmFinal 3) (pmFinal 4)).2.1)
  ...
  have hbetaValue : smFinal 4 = pmFinal 4 := by
    ...
    simpa only [List.length_cons, List.length_nil] using
      (allGatherPrimDimN_singleton_eq 0 (pmFinal 4) (by
        rw [hbeta.shard_shapes _ (by simp)]; decide))
  have hComm := TrainVerify.Denote.bw_layernorm_dgamma_sequence_reduction_rank3 3 2 3 7
    [pmFinal 100, pmFinal 101, pmFinal 102] [pmFinal 103, pmFinal 104, pmFinal 105] (pmFinal 3) (pmFinal 4)
    (by decide) (by decide) (by decide) (by decide) rfl rfl hg.shard_shapes hx.shard_shapes
    hgammaShape hbetaShape
  have hValue : smFinal 11 = tensorSum [pmFinal 109, pmFinal 110, pmFinal 111] := by
    rw [hSm, hgValue, hxValue, hgammaValue, hbetaValue, hComm]
    simp only [List.zipWith]
    rw [← hPm0, ← hPm1, ← hPm2]
  have hShape0 : (pmFinal 109).shape = [7] := by
    rw [hPm0, bw_layernorm_dw_shape _ _ _ _ 7 [3, 2] (by rw [hx.shard_shapes _ (by simp)]; rfl)]
    exact hgammaShape
  have hShape1 : (pmFinal 110).shape = [7] := by
    rw [hPm1, bw_layernorm_dw_shape _ _ _ _ 7 [3, 2] (by rw [hx.shard_shapes _ (by simp)]; rfl)]
    exact hgammaShape
  have hShape2 : (pmFinal 111).shape = [7] := by
    rw [hPm2, bw_layernorm_dw_shape _ _ _ _ 7 [3, 2] (by rw [hx.shard_shapes _ (by simp)]; rfl)]
    exact hgammaShape
  have hFull : (smFinal 11).shape = [7] := by
    rw [hSm, bw_layernorm_dw_shape _ _ _ _ 7 [9, 2] (by rw [hx.full_shape]; rfl)]
    exact hgamma.full_shape
  have hReduce : smFinal 11 = allReducePrim [pmFinal 109, pmFinal 110, pmFinal 111].length 0 [pmFinal 109, pmFinal 110, pmFinal 111] := by
    rw [hValue]
    rfl
  change ReductionRel (smFinal 11) [pmFinal 109, pmFinal 110, pmFinal 111] [7]
...
private theorem segment_000000_dbeta_semantic (smFinal pmFinal : Store)
    ...
    (hPm0 : pmFinal 112 = (bw_layernorm (pmFinal 100) (pmFinal 103) (pmFinal 3) (pmFinal 4)).2.2)
    (hPm1 : pmFinal 113 = (bw_layernorm (pmFinal 101) (pmFinal 104) (pmFinal 3) (pmFinal 4)).2.2)
    (hPm2 : pmFinal 114 = (bw_layernorm (pmFinal 102) (pmFinal 105) (pmFinal 3) (pmFinal 4)).2.2)
  ...
  have hbetaValue : smFinal 4 = pmFinal 4 := by
    ...
    simpa only [List.length_cons, List.length_nil] using
      (allGatherPrimDimN_singleton_eq 0 (pmFinal 4) (by
        rw [hbeta.shard_shapes _ (by simp)]; decide))
  have hComm := TrainVerify.Denote.bw_layernorm_dbeta_sequence_reduction_rank3 3 2 3 7
    [pmFinal 100, pmFinal 101, pmFinal 102] [pmFinal 103, pmFinal 104, pmFinal 105] (pmFinal 3) (pmFinal 4)
    (by decide) (by decide) (by decide) (by decide) rfl rfl hg.shard_shapes hx.shard_shapes
    hgammaShape hbetaShape
  have hValue : smFinal 12 = tensorSum [pmFinal 112, pmFinal 113, pmFinal 114] := by
    rw [hSm, hgValue, hxValue, hgammaValue, hbetaValue, hComm]
    simp only [List.zipWith]
    rw [← hPm0, ← hPm1, ← hPm2]
  ...
  have hFull : (smFinal 12).shape = [7] := by
    rw [hSm, bw_layernorm_db_shape _ _ _ _ 7 [9, 2] (by rw [hx.full_shape]; rfl)]
    exact hbeta.full_shape
  have hReduce : smFinal 12 = allReducePrim [pmFinal 112, pmFinal 113, pmFinal 114].length 0 [pmFinal 112, pmFinal 113, pmFinal 114] := by
    rw [hValue]
    rfl
  change ReductionRel (smFinal 12) [pmFinal 112, pmFinal 113, pmFinal 114] [7]
  refine { full_value := hReduce, full_shape := hFull, contributions_nonempty := by simp, contribution_shapes := ?_, reduced_shape := ?_ }
  · simp only [List.forall_mem_cons]
    exact ⟨hShape0, hShape1, hShape2, List.forall_mem_nil _⟩
  · rw [← hReduce]
...
private theorem segment_000000_sound (smStore pmStore : Store)
  ...
  change ShardedRel (smFinal 1) [pmFinal 100, pmFinal 101, pmFinal 102] 1 [2, 9, 7] [2, 3, 7] at hg
  have hx : fact_x.Holds smFinal pmFinal := hframe _ (by native_decide)
  change ShardedRel (smFinal 2) [pmFinal 103, pmFinal 104, pmFinal 105] 1 [2, 9, 7] [2, 3, 7] at hx
  ...
  have hout0 := segment_000000_dx_semantic smFinal pmFinal hg hx hgamma hbeta
    (segment_000000_hSmdx smStore) (segment_000000_hPmdx0 pmStore) (segment_000000_hPmdx1 pmStore) (segment_000000_hPmdx2 pmStore)
  have hout1 := segment_000000_dgamma_semantic smFinal pmFinal hg hx hgamma hbeta
    (segment_000000_hSmdgamma smStore) (segment_000000_hPmdgamma0 pmStore) (segment_000000_hPmdgamma1 pmStore) (segment_000000_hPmdgamma2 pmStore)
  have hout2 := segment_000000_dbeta_semantic smFinal pmFinal hg hx hgamma hbeta
    (segment_000000_hSmdbeta smStore) (segment_000000_hPmdbeta0 pmStore) (segment_000000_hPmdbeta1 pmStore) (segment_000000_hPmdbeta2 pmStore)
  have hinWred0 : fact_w.Holds smStore pmStore :=
    hstate fact_w (by native_decide)
  change ReductionRel (smStore 50) ([600, 601, 602].map pmStore) [5, 7] at hinWred0
  have hWredWriter0 := segment_000000_wred_writer_0 pmStore
  change pmFinal 600 = cross_dp_wred ([600, 601, 602].map pmStore) at hWredWriter0
  have hWredReduce0 : pmFinal 600 =
      allReducePrim ([600, 601, 602].map pmStore).length 0 ([600, 601, 602].map pmStore) := by
    rw [hWredWriter0]
  ...
  have hSmRead0 : smFinal 50 = smStore 50 := by
    ...
    exact foldl_applyNodeDistributedFaithful_at_not_written BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.sm
...
private def segment_000000 : ClosedDepSegmentCertificate BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.sm BWLayernormWredGraphK3B2S3D7DxDgammaDbeta.pm state_before state_after where
...
end TrainVerify.Denote.GeneratedBWLayernormWredK3B2S3D7DxDgammaDbeta
