...
namespace TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness
...
private def gather_pre : RelationFact :=
  .sharded 99 [3000, 3001, 3002] 1 [2, 9, 15] [2, 3, 15]

private def gather_post : RelationFact :=
  .joined 99 3999 [2, 9, 15]

private def anchor : RelationFact :=
  .tensorShape .sm 777 [1]

private def state_pre : RelationState where
  facts := [anchor, pre_0, pre_1, gather_pre]
  nonempty := by decide

private def state_post : RelationState where
  facts := [anchor, post_0, post_1, gather_post]
  nonempty := by decide

end
end TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness
...
private def segment_generic :
    ClosedDepSegmentCertificate TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.smGraph TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph state_pre state_post where
  smNodes := []
  pmNodes := [{ rank := 0, op := "OpName.AllToAllPrim", ins := [1000, 1001, 1002], outs := [2000], params := [1, 2] }, { rank := 0, op := "OpName.AllToAllPrim", ins := [1100, 1101, 1102], outs := [2100], params := [1, 2] }, { rank := 0, op := "OpName.AllGatherPrim", ins := [3000, 3001, 3002], outs := [3999], params := [1] }, { rank := 1, op := "OpName.AllToAllPrim", ins := [1000, 1001, 1002], outs := [2001], params := [1, 2] }, { rank := 1, op := "OpName.AllToAllPrim", ins := [1100, 1101, 1102], outs := [2101], params := [1, 2] }, { rank := 2, op := "OpName.AllToAllPrim", ins := [1000, 1001, 1002], outs := [2002], params := [1, 2] }, { rank := 2, op := "OpName.AllToAllPrim", ins := [1100, 1101, 1102], outs := [2102], params := [1, 2] }]
  sound := by
    ...
    have hInputs0_0 : inputTids0.map (((pmNodes.take 0)).foldl
        (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph) pmStore) = xs0 := by
      apply List.map_congr_left
      intro tid htid
      simp only [inputTids0, List.mem_cons, List.not_mem_nil, or_false] at htid
      rcases htid with h0 | h1 | h2
      · subst tid
        exact foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph
    ...
    have hAllToAll0_0 : pmFinal 2000 = allToAllPrimWithDims rankCount 0 xs0 1 2 := by
      change (pmNodes.foldl (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph) pmStore) 2000 = _
      ...
      rw [foldl_faithful_middle_writer TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph pmStore (pmNodes.take 0) (pmNodes.drop 1)
      ...
      · intro t
        ...
        rw [hRankCount]
        simpa [inputTids0] using applyNode_allToAllPrimWithDims_out TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph t 0 inputTids0 2000 1 2
      · native_decide
      · native_decide
    have hAllToAllShape0_0 : (pmFinal 2000).shape = [2, 9, 5] := by
      ...
      native_decide
    have hInputs0_1 : inputTids0.map (((pmNodes.take 3)).foldl
        (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph) pmStore) = xs0 := by
      apply List.map_congr_left
      intro tid htid
      simp only [inputTids0, List.mem_cons, List.not_mem_nil, or_false] at htid
      ...
      · subst tid
        exact foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph
          (pmNodes.take 3) pmStore 1000 (by native_decide) (by native_decide)
      · subst tid
        exact foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph
          (pmNodes.take 3) pmStore 1001 (by native_decide) (by native_decide)
      · subst tid
        exact foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph
          (pmNodes.take 3) pmStore 1002 (by native_decide) (by native_decide)
    have hAllToAll0_1 : pmFinal 2001 = allToAllPrimWithDims rankCount 1 xs0 1 2 := by
      change (pmNodes.foldl (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph) pmStore) 2001 = _
      rw [show pmNodes = (pmNodes.take 3) ++ [{ rank := 1, op := "OpName.AllToAllPrim", ins := [1000, 1001, 1002], outs := [2001], params := [1, 2] }] ++ (pmNodes.drop 4) by native_decide]
      rw [foldl_faithful_middle_writer TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph pmStore (pmNodes.take 3) (pmNodes.drop 4)
      ...
      · intro t
        ...
        simp only [applyNodeDistributedFaithful, applyNodeDistributed, applyNodeRingAttn]
        rw [hRankCount]
        simpa [inputTids0] using applyNode_allToAllPrimWithDims_out TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph t 1 inputTids0 2001 1 2
      · native_decide
      · native_decide
    have hAllToAllShape0_1 : (pmFinal 2001).shape = [2, 9, 5] := by
      ...
      native_decide
    have hInputs0_2 : inputTids0.map (((pmNodes.take 5)).foldl
        (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph) pmStore) = xs0 := by
      apply List.map_congr_left
      intro tid htid
      simp only [inputTids0, List.mem_cons, List.not_mem_nil, or_false] at htid
      ...
      · subst tid
        exact foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph
          (pmNodes.take 5) pmStore 1000 (by native_decide) (by native_decide)
      · subst tid
        exact foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph
          (pmNodes.take 5) pmStore 1001 (by native_decide) (by native_decide)
      · subst tid
        exact foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph
          (pmNodes.take 5) pmStore 1002 (by native_decide) (by native_decide)
    have hAllToAll0_2 : pmFinal 2002 = allToAllPrimWithDims rankCount 2 xs0 1 2 := by
      change (pmNodes.foldl (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph) pmStore) 2002 = _
      rw [show pmNodes = (pmNodes.take 5) ++ [{ rank := 2, op := "OpName.AllToAllPrim", ins := [1000, 1001, 1002], outs := [2002], params := [1, 2] }] ++ (pmNodes.drop 6) by native_decide]
      rw [foldl_faithful_middle_writer TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph pmStore (pmNodes.take 5) (pmNodes.drop 6)
      ...
      · intro t
        ...
        simp only [applyNodeDistributedFaithful, applyNodeDistributed, applyNodeRingAttn]
        rw [hRankCount]
        simpa [inputTids0] using applyNode_allToAllPrimWithDims_out TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph t 2 inputTids0 2002 1 2
      · native_decide
      · native_decide
    ...
    have hInputs1_0 : inputTids1.map (((pmNodes.take 1)).foldl
        (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph) pmStore) = xs1 := by
      apply List.map_congr_left
      intro tid htid
    ...
    have hAllToAll1_0 : pmFinal 2100 = allToAllPrimWithDims rankCount 0 xs1 1 2 := by
      change (pmNodes.foldl (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph) pmStore) 2100 = _
      ...
      rw [foldl_faithful_middle_writer TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph pmStore (pmNodes.take 1) (pmNodes.drop 2)
      ...
      · intro t
        ...
        simp only [applyNodeDistributedFaithful, applyNodeDistributed, applyNodeRingAttn]
        rw [hRankCount]
        simpa [inputTids1] using applyNode_allToAllPrimWithDims_out TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph t 0 inputTids1 2100 1 2
      · native_decide
      · native_decide
    have hAllToAllShape1_0 : (pmFinal 2100).shape = [2, 9, 5] := by
      ...
      native_decide
    have hInputs1_1 : inputTids1.map (((pmNodes.take 4)).foldl
        (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph) pmStore) = xs1 := by
      apply List.map_congr_left
      intro tid htid
      simp only [inputTids1, List.mem_cons, List.not_mem_nil, or_false] at htid
      ...
      · subst tid
        exact foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph
          (pmNodes.take 4) pmStore 1100 (by native_decide) (by native_decide)
      · subst tid
        exact foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph
          (pmNodes.take 4) pmStore 1101 (by native_decide) (by native_decide)
      · subst tid
        exact foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph
          (pmNodes.take 4) pmStore 1102 (by native_decide) (by native_decide)
    have hAllToAll1_1 : pmFinal 2101 = allToAllPrimWithDims rankCount 1 xs1 1 2 := by
      change (pmNodes.foldl (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph) pmStore) 2101 = _
      rw [show pmNodes = (pmNodes.take 4) ++ [{ rank := 1, op := "OpName.AllToAllPrim", ins := [1100, 1101, 1102], outs := [2101], params := [1, 2] }] ++ (pmNodes.drop 5) by native_decide]
      rw [foldl_faithful_middle_writer TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph pmStore (pmNodes.take 4) (pmNodes.drop 5)
      ...
      · intro t
        ...
        simp only [applyNodeDistributedFaithful, applyNodeDistributed, applyNodeRingAttn]
        rw [hRankCount]
        simpa [inputTids1] using applyNode_allToAllPrimWithDims_out TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph t 1 inputTids1 2101 1 2
      · native_decide
      · native_decide
    have hAllToAllShape1_1 : (pmFinal 2101).shape = [2, 9, 5] := by
      ...
      native_decide
    have hInputs1_2 : inputTids1.map (((pmNodes.take 6)).foldl
        (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph) pmStore) = xs1 := by
      apply List.map_congr_left
      intro tid htid
      simp only [inputTids1, List.mem_cons, List.not_mem_nil, or_false] at htid
      ...
      · subst tid
        exact foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph
          (pmNodes.take 6) pmStore 1100 (by native_decide) (by native_decide)
      · subst tid
        exact foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph
          (pmNodes.take 6) pmStore 1101 (by native_decide) (by native_decide)
      · subst tid
        exact foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph
          (pmNodes.take 6) pmStore 1102 (by native_decide) (by native_decide)
    have hAllToAll1_2 : pmFinal 2102 = allToAllPrimWithDims rankCount 2 xs1 1 2 := by
      change (pmNodes.foldl (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph) pmStore) 2102 = _
      rw [show pmNodes = (pmNodes.take 6) ++ [{ rank := 2, op := "OpName.AllToAllPrim", ins := [1100, 1101, 1102], outs := [2102], params := [1, 2] }] ++ (pmNodes.drop 7) by native_decide]
      rw [foldl_faithful_middle_writer TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph pmStore (pmNodes.take 6) (pmNodes.drop 7)
      ...
      · intro t
        ...
        simp only [applyNodeDistributedFaithful, applyNodeDistributed, applyNodeRingAttn]
        rw [hRankCount]
        simpa [inputTids1] using applyNode_allToAllPrimWithDims_out TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph t 2 inputTids1 2102 1 2
      · native_decide
      · native_decide
    ...
    let gatherInputTids : List Tid := [3000, 3001, 3002]
    have hGatherBefore : gatherInputTids.map (((pmNodes.take 2)).foldl (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph) pmStore) = gatherInputTids.map pmStore := by
      apply List.map_congr_left
      intro tid htid
      ...
      · subst tid
        exact foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph
          (pmNodes.take 2) pmStore 3000 (by native_decide) (by native_decide)
      · subst tid
        exact foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph
          (pmNodes.take 2) pmStore 3001 (by native_decide) (by native_decide)
      · subst tid
        exact foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph
          (pmNodes.take 2) pmStore 3002 (by native_decide) (by native_decide)
    have hGatherFinal : gatherInputTids.map pmFinal = gatherInputTids.map pmStore := by
      ...
      · subst tid
        exact foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph
          pmNodes pmStore 3000 (by native_decide) (by native_decide)
      · subst tid
        exact foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph
          pmNodes pmStore 3001 (by native_decide) (by native_decide)
      · subst tid
        exact foldl_applyNodeDistributedFaithful_at_not_written TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph
          pmNodes pmStore 3002 (by native_decide) (by native_decide)
    have hGatherWriter : pmFinal 3999 = allGatherPrimDimN 1 rankCount 0 (gatherInputTids.map pmFinal) := by
      change (pmNodes.foldl (applyNodeDistributedFaithful TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph) pmStore) 3999 = _
      rw [show pmNodes = (pmNodes.take 2) ++ [{ rank := 0, op := "OpName.AllGatherPrim", ins := [3000, 3001, 3002], outs := [3999], params := [1] }] ++ (pmNodes.drop 3) by native_decide]
      rw [foldl_faithful_middle_writer TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph pmStore (pmNodes.take 2) (pmNodes.drop 3)
        { rank := 0, op := "OpName.AllGatherPrim", ins := [3000, 3001, 3002], outs := [3999], params := [1] } 3999 (fun t => allGatherPrimDimN 1 rankCount 0 (gatherInputTids.map t))]
      ...
      · intro t
        ...
        simp only [applyNodeDistributedFaithful, applyNodeDistributed, applyNodeRingAttn]
        rw [hRankCount]
        simpa [gatherInputTids] using applyNode_allGatherPrimDimN_out TrainVerify.Denote.GeneratedKRankAllToAllAllGatherAtomicWitness.pmGraph t 0 gatherInputTids 3999 1
      · native_decide
      · native_decide
    have hinGather : gather_pre.Holds smFinal pmFinal := hframe gather_pre (by native_decide)
    change ShardedRel (smFinal 99) (gatherInputTids.map pmFinal) 1 [2, 9, 15] [2, 3, 15] at hinGather
    have hJoined : smFinal 99 = pmFinal 3999 := (ShardedRel.to_joined_allGather hinGather).trans hGatherWriter.symm
    have houtGather : gather_post.Holds smFinal pmFinal := by
      change smFinal 99 = pmFinal 3999 ∧ (smFinal 99).shape = [2, 9, 15] ∧ (pmFinal 3999).shape = [2, 9, 15]
      refine ⟨hJoined, hinGather.full_shape, ?_⟩
      rw [← hJoined]
      exact hinGather.full_shape
    intro fact hfact
    have covered : fact ∈ [post_0, post_1, gather_post] ++ state_pre.facts := by
      exact (show state_post.facts ⊆ [post_0, post_1, gather_post] ++ state_pre.facts by native_decide) hfact
