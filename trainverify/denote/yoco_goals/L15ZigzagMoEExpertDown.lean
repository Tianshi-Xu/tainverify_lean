/- Canonical Goal 1, layer 15: faithful remote-expert MoE output. -/
...
private theorem l15ZMed_reduce5
...
private theorem l15ZMed_reduce7
    (g : GraphDecl) (init : Store) (k : Nat) (node : NodeDecl)
...
private def l15ZMedSmMoE : NodeDecl :=
  { rank := 0, op := "OpName.FW_all2all_moe_gmm",
    ins := [8718, 5896, 5897, 5899, 5900], outs := [5901],
    params := [64, 0, 64, 8] }
private def l15ZMedPmMoE0 : NodeDecl :=
  { rank := 0, op := "OpName.FW_all2all_moe_gmm",
    ins := [14512, 10598, 10600, 10604, 10606], outs := [10608],
    params := [64, 0, 32, 8] }
private def l15ZMedPmMoE1 : NodeDecl :=
  { rank := 1, op := "OpName.FW_all2all_moe_gmm",
    ins := [14513, 10599, 10601, 10605, 10607], outs := [10609],
    params := [64, 32, 64, 8] }

private theorem l15ZMed_sm_buddies :
    sm_goal_1.replicaBuddies l15ZMedSmMoE = [l15ZMedSmMoE] := by
  native_decide

private theorem l15ZMed_pm0_buddies :
    pm_goal_1.replicaBuddies l15ZMedPmMoE0 = [l15ZMedPmMoE0, l15ZMedPmMoE1] := by
  native_decide

private theorem l15ZMed_pm1_buddies :
    pm_goal_1.replicaBuddies l15ZMedPmMoE1 = [l15ZMedPmMoE0, l15ZMedPmMoE1] := by
  native_decide

private theorem l15ZMed_red_sm5901 (initSM : Store) :
    denoteGraphDistributedFaithful sm_goal_1 initSM 5901 =
      fw_all2all_moe_gmm_full
        ...
        [denoteGraphDistributedFaithful sm_goal_1 initSM 5899]
        [denoteGraphDistributedFaithful sm_goal_1 initSM 5900]
        64 8 (((10 : Nat) : Scalar)) := by
  refine l15ZMed_reduce5 sm_goal_1 initSM 702 l15ZMedSmMoE
    8718 5896 5897 5899 5900 5901
  ...
  intro s
  have hb := l15ZMed_sm_buddies
  unfold l15ZMedSmMoE at hb ⊢
  rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective _ _ _
    (by decide) (by decide) (by decide)]
  rw [applyNodeDistributed_moe_out sm_goal_1 s 0 8718 5896 5897 5899 5900 5901
    [64, 0, 64, 8]]
  unfold applyNodeFullExpertMoE_value
  rw [hb]
  rfl

private theorem l15ZMed_red_pm10608 (initPM : Store) :
    denoteGraphDistributedFaithful pm_goal_1 initPM 10608 =
      fw_all2all_moe_gmm_full
        ...
        [denoteGraphDistributedFaithful pm_goal_1 initPM 10604,
         denoteGraphDistributedFaithful pm_goal_1 initPM 10605]
        [denoteGraphDistributedFaithful pm_goal_1 initPM 10606,
         denoteGraphDistributedFaithful pm_goal_1 initPM 10607]
        64 8 (((10 : Nat) : Scalar)) := by
  refine l15ZMed_reduce7 pm_goal_1 initPM 1547 l15ZMedPmMoE0
    14512 10598 10600 10604 10606 10605 10607 10608
  ...
  intro s
  have hb := l15ZMed_pm0_buddies
  unfold l15ZMedPmMoE0 at hb ⊢
  rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective _ _ _
    (by decide) (by decide) (by decide)]
  rw [applyNodeDistributed_moe_out pm_goal_1 s 0 14512 10598 10600 10604 10606
    10608 [64, 0, 32, 8]]
  unfold applyNodeFullExpertMoE_value
  rw [hb]
  rfl

private theorem l15ZMed_red_pm10609 (initPM : Store) :
    denoteGraphDistributedFaithful pm_goal_1 initPM 10609 =
      fw_all2all_moe_gmm_full
        ...
        [denoteGraphDistributedFaithful pm_goal_1 initPM 10606,
         denoteGraphDistributedFaithful pm_goal_1 initPM 10607]
        64 8 (((10 : Nat) : Scalar)) := by
  refine l15ZMed_reduce7 pm_goal_1 initPM 1548 l15ZMedPmMoE1
    14513 10599 10601 10604 10605 10606 10607 10609
    ...
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  intro s
  have hb := l15ZMed_pm1_buddies
  unfold l15ZMedPmMoE1 at hb ⊢
  rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective _ _ _
    (by decide) (by decide) (by decide)]
  rw [applyNodeDistributed_moe_out pm_goal_1 s 1 14513 10599 10601 10605 10607
    10609 [64, 32, 64, 8]]
  unfold applyNodeFullExpertMoE_value
  rw [hb]
  rfl

private theorem l15ZMed_leaf (g : GraphDecl) (init : Store) (tid : Tid)
...
private theorem l15ZMed_weight_bridge (initSM initPM : Store)
...
private theorem l15ZMed_hdec {full z0 z1 : Tensor} {k : Nat} (initPM : Store)
  ...
  have hleaf : denoteGraphDistributedFaithful pm_goal_1 initPM 6252 = initPM 6252 :=
    l15ZMed_leaf pm_goal_1 initPM 6252 (by native_decide) (by native_decide)
...
/-- The real canonical L15 remote-expert node preserves the CP2 zigzag layout.
...
theorem l15_zigzag_moe_expert_from_branch_inputs (initSM initPM : Store)
  ...
  have hdec := l15ZMed_hdec initPM hPM hX
  obtain ⟨x0, x1, hxs⟩ := hX
  ...
  have hbW13 : initSM 5899 = allGatherPrimDimN 0 2 0 [initPM 10604, initPM 10605] :=
    l15ZMed_weight_bridge initSM initPM hInit initGoal_5899 (by native_decide)
      5899 10604 10605 [32, 1024, 1024] rfl rfl rfl rfl rfl (by decide)
  have hbW2 : initSM 5900 = allGatherPrimDimN 0 2 0 [initPM 10606, initPM 10607] :=
    l15ZMed_weight_bridge initSM initPM hInit initGoal_5900 (by native_decide)
      5900 10606 10607 [32, 1024, 512] rfl rfl rfl rfl rfl (by decide)
  have hw13shape : (initSM 5899).shape = [64, 1024, 1024] :=
    hSM 5899 [64, 1024, 1024] (by native_decide)
  have hw2shape : (initSM 5900).shape = [64, 1024, 512] :=
    hSM 5900 [64, 1024, 512] (by native_decide)
  rw [l15ZMed_red_sm5901 initSM, l15ZMed_red_pm10608 initPM,
    l15ZMed_red_pm10609 initPM]
  rw [l15ZMed_leaf sm_goal_1 initSM 5899 (by native_decide) (by native_decide),
    l15ZMed_leaf sm_goal_1 initSM 5900 (by native_decide) (by native_decide),
    l15ZMed_leaf pm_goal_1 initPM 10604 (by native_decide) (by native_decide),
    l15ZMed_leaf pm_goal_1 initPM 10605 (by native_decide) (by native_decide),
    l15ZMed_leaf pm_goal_1 initPM 10606 (by native_decide) (by native_decide),
    l15ZMed_leaf pm_goal_1 initPM 10607 (by native_decide) (by native_decide)]
  unfold fw_all2all_moe_gmm_full
  simp only [List.length_cons, List.length_nil]
  rw [allGatherPrimDimN_singleton_eq 0 (initSM 5899) (by rw [hw13shape]; decide),
    allGatherPrimDimN_singleton_eq 0 (initSM 5900) (by rw [hw2shape]; decide)]
  rw [hbW13, hbW2]
  exact Zigzag2Rel.all2all_moe_gmm
    (allGatherPrimDimN 0 2 0 [initPM 10604, initPM 10605])
    (allGatherPrimDimN 0 2 0 [initPM 10606, initPM 10607])
...
/-- The canonical L15 remote-expert output from the exact L15 attention-residual boundary.
...
theorem l15_zigzag_moe_expert_from_attention_output (initSM initPM : Store)
    (hSM : StoreShapesHold initSM sm_goal_1InitEnv)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
    (hInit : InitGoalsHold pm_goal_1.numRanks goal_1_full_initGoals initSM initPM)
    ...
    Zigzag2Rel
      ...
      (denoteGraphDistributedFaithful pm_goal_1 initPM 6252)
      [4096, 1024] [2048, 1024] := by
  have hX := l15_zigzag_moe_activation_from_attention_output initSM initPM hInit hAttention
  have hRouter :=
    l15_zigzag_moe_router_from_attention_output initSM initPM hPM hInit hAttention
  exact l15_zigzag_moe_expert_from_branch_inputs initSM initPM hSM hPM hInit
    hX hRouter.1 hRouter.2

#print axioms l15_zigzag_moe_expert_from_attention_output
