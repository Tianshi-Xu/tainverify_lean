...
import denote.yoco_goals.Goal4PublicFaithfulL14Attention
...
theorem goal4_l14_norm_from_attention
    (initSM initPM : Store)
  ...
  exact l14_zigzag_moe_norm_from_attention_output initSM initPM hInit1 hA14
end
