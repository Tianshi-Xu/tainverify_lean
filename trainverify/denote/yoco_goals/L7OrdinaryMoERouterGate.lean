...
import denote.yoco_goals.L7OrdinaryMoENorm
...
theorem l7_ordinary_moe_logits_from_norm_input (initSM initPM : Store)
    ...
    Gather2Rel
      ...
      [4096, 64] [2048, 64] := by
  have hwEq := l7OMr_weight_eq initSM initPM hInit
  have hwShape := l7OMr_weight_shape initPM hPM
  ...
  rw [l7OMr_red_sm5347 initSM, l7OMr_red_sm5345 initSM,
    l7OMr_red_sm8140 initSM, hwEq,
    l7OMr_red_pm8988 initPM, l7OMr_red_pm8989 initPM,
    l7OMr_red_pm5347 initPM, l7OMr_red_pm5345 initPM,
    l7OMr_red_pm11966 initPM, l7OMr_red_pm15352 initPM,
    l7OMr_red_pm15354 initPM,
    ...
    l7OMr_chunk_gather0 _ _ hp0Shape hp1Shape,
    l7OMr_chunk_gather1 _ _ hp0Shape hp1Shape]
  exact hLocal
...
theorem l7_ordinary_moe_router_from_norm_input (initSM initPM : Store)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
    (hInit : InitGoalsHold pm_goal_1.numRanks initGoals initSM initPM)
    (hNorm : Gather2Rel
      (denoteGraphDistributedFaithful sm_goal_1 initSM 5344)
    ...
    Gather2Rel
      ...
      [4096, 64] [2048, 64] := by
  have hLogits := l7_ordinary_moe_logits_from_norm_input initSM initPM hPM hInit hNorm
  ...
  rw [l7OMr_red_sm5348 initSM hLogits.full_shape,
    l7OMr_red_pm8990 initPM hLogits.shard0_shape,
    l7OMr_red_pm8991 initPM hLogits.shard1_shape,
    l7OMr_red_sm5349 initSM hLogits.full_shape,
    l7OMr_red_pm8992 initPM hLogits.shard0_shape,
    l7OMr_red_pm8993 initPM hLogits.shard1_shape]
  exact ⟨hProbs, hMap⟩

/-- The real scalar-gate branch preserves ordinary dim-0 layout. -/
theorem l7_ordinary_moe_gate_from_norm_input (initSM initPM : Store)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
    (hInit : InitGoalsHold pm_goal_1.numRanks initGoals initSM initPM)
    (hNorm : Gather2Rel
      (denoteGraphDistributedFaithful sm_goal_1 initSM 5344)
  ...
  have hSource : Gather2Rel
    ...
    rw [l7OMrg_red_sm8148 initSM, l7OMrg_red_pm13302 initPM,
      l7OMrg_red_pm13303 initPM]
    exact hNorm
  have hReshape : Gather2Rel
      ...
      [4096, 1024] [2048, 1024] := by
    rw [l7OMrg_red_sm5354 initSM, l7OMrg_red_pm9002 initPM,
      l7OMrg_red_pm9003 initPM]
    exact Gather2Rel.view_id hSource
  have hwEq := l7OMrg_weight_eq initSM initPM hInit
  have hwShape := l7OMrg_weight_shape initPM hPM
  have hLinear : Gather2Rel
      ...
      [4096, 1] [2048, 1] := by
    rw [l7OMrg_red_sm5356 initSM, l7OMrg_red_pm9006 initPM,
      l7OMrg_red_pm9007 initPM, hwEq]
  ...
  have hView : Gather2Rel
      ...
      [4096, 1] [2048, 1] := by
    rw [l7OMrg_red_sm5357 initSM, l7OMrg_red_pm9008 initPM,
      l7OMrg_red_pm9009 initPM]
    exact Gather2Rel.view_id hLinear
  rw [l7OMrg_red_sm5358 initSM, l7OMrg_red_pm9010 initPM,
    l7OMrg_red_pm9011 initPM]
...
theorem l7_ordinary_moe_router_from_attention_output (initSM initPM : Store)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
    ...
    Gather2Rel
      ...
      (denoteGraphDistributedFaithful pm_goal_1 initPM 8993)
      [4096, 64] [2048, 64] := by
  have hNorm := l7_ordinary_moe_norm_from_attention_output
    initSM initPM hInit hAttention
  exact l7_ordinary_moe_router_from_norm_input initSM initPM hPM hInit hNorm

/-- The ordinary scalar gate is closed directly from attention output. -/
theorem l7_ordinary_moe_gate_from_attention_output (initSM initPM : Store)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
    (hInit : InitGoalsHold pm_goal_1.numRanks goal_1_full_initGoals initSM initPM)
    (hAttention : Gather2Rel
      (denoteGraphDistributedFaithful sm_goal_1 initSM 5342)
  ...
  have hNorm := l7_ordinary_moe_norm_from_attention_output
    initSM initPM hInit hAttention
  exact l7_ordinary_moe_gate_from_norm_input initSM initPM hPM hInit hNorm

#print axioms l7_ordinary_moe_router_from_norm_input
#print axioms l7_ordinary_moe_gate_from_norm_input
#print axioms l7_ordinary_moe_router_from_attention_output
#print axioms l7_ordinary_moe_gate_from_attention_output
