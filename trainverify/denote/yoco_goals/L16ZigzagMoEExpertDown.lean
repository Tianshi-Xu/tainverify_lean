/- Canonical Goal 1, layer 16: faithful remote-expert MoE output. -/
...
private theorem l16ZMed_reduce5
...
private theorem l16ZMed_reduce7
    (g : GraphDecl) (init : Store) (k : Nat) (node : NodeDecl)
...
private def l16ZMedSmMoE : NodeDecl :=
  { rank := 0, op := "OpName.FW_all2all_moe_gmm",
    ins := [8757, 5950, 5951, 5953, 5954], outs := [5955],
    params := [64, 0, 64, 8] }
private def l16ZMedPmMoE0 : NodeDecl :=
  { rank := 0, op := "OpName.FW_all2all_moe_gmm",
    ins := [14628, 10752, 10754, 10758, 10760], outs := [10762],
    params := [64, 0, 32, 8] }
private def l16ZMedPmMoE1 : NodeDecl :=
  { rank := 1, op := "OpName.FW_all2all_moe_gmm",
    ins := [14629, 10753, 10755, 10759, 10761], outs := [10763],
    params := [64, 32, 64, 8] }

private theorem l16ZMed_sm_buddies :
    sm_goal_1.replicaBuddies l16ZMedSmMoE = [l16ZMedSmMoE] := by
  native_decide

private theorem l16ZMed_pm0_buddies :
    pm_goal_1.replicaBuddies l16ZMedPmMoE0 = [l16ZMedPmMoE0, l16ZMedPmMoE1] := by
  native_decide

private theorem l16ZMed_pm1_buddies :
    pm_goal_1.replicaBuddies l16ZMedPmMoE1 = [l16ZMedPmMoE0, l16ZMedPmMoE1] := by
  native_decide

private theorem l16ZMed_red_sm5955 (initSM : Store) :
    denoteGraphDistributedFaithful sm_goal_1 initSM 5955 =
      fw_all2all_moe_gmm_full
        ...
        [denoteGraphDistributedFaithful sm_goal_1 initSM 5953]
        [denoteGraphDistributedFaithful sm_goal_1 initSM 5954]
        64 8 (((10 : Nat) : Scalar)) := by
  refine l16ZMed_reduce5 sm_goal_1 initSM 737 l16ZMedSmMoE
    8757 5950 5951 5953 5954 5955
  ...
  intro s
  have hb := l16ZMed_sm_buddies
  unfold l16ZMedSmMoE at hb ⊢
  rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective _ _ _
    (by decide) (by decide) (by decide)]
  rw [applyNodeDistributed_moe_out sm_goal_1 s 0 8757 5950 5951 5953 5954 5955
    [64, 0, 64, 8]]
  unfold applyNodeFullExpertMoE_value
  rw [hb]
  rfl

private theorem l16ZMed_red_pm10762 (initPM : Store) :
    denoteGraphDistributedFaithful pm_goal_1 initPM 10762 =
      fw_all2all_moe_gmm_full
        ...
        [denoteGraphDistributedFaithful pm_goal_1 initPM 10758,
         denoteGraphDistributedFaithful pm_goal_1 initPM 10759]
        [denoteGraphDistributedFaithful pm_goal_1 initPM 10760,
         denoteGraphDistributedFaithful pm_goal_1 initPM 10761]
        64 8 (((10 : Nat) : Scalar)) := by
  refine l16ZMed_reduce7 pm_goal_1 initPM 1623 l16ZMedPmMoE0
    14628 10752 10754 10758 10760 10759 10761 10762
  ...
  intro s
  have hb := l16ZMed_pm0_buddies
  unfold l16ZMedPmMoE0 at hb ⊢
  rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective _ _ _
    (by decide) (by decide) (by decide)]
  rw [applyNodeDistributed_moe_out pm_goal_1 s 0 14628 10752 10754 10758 10760
    10762 [64, 0, 32, 8]]
  unfold applyNodeFullExpertMoE_value
  rw [hb]
  rfl

private theorem l16ZMed_red_pm10763 (initPM : Store) :
    denoteGraphDistributedFaithful pm_goal_1 initPM 10763 =
      fw_all2all_moe_gmm_full
        ...
        [denoteGraphDistributedFaithful pm_goal_1 initPM 10760,
         denoteGraphDistributedFaithful pm_goal_1 initPM 10761]
        64 8 (((10 : Nat) : Scalar)) := by
  refine l16ZMed_reduce7 pm_goal_1 initPM 1624 l16ZMedPmMoE1
    14629 10753 10755 10758 10759 10760 10761 10763
    ...
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  intro s
  have hb := l16ZMed_pm1_buddies
  unfold l16ZMedPmMoE1 at hb ⊢
  rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective _ _ _
    (by decide) (by decide) (by decide)]
  rw [applyNodeDistributed_moe_out pm_goal_1 s 1 14629 10753 10755 10759 10761
    10763 [64, 32, 64, 8]]
  unfold applyNodeFullExpertMoE_value
  rw [hb]
  rfl

private theorem l16ZMed_leaf (g : GraphDecl) (init : Store) (tid : Tid)
...
private theorem l16ZMed_weight_bridge (initSM initPM : Store)
...
private theorem l16ZMed_hdec {full z0 z1 : Tensor} {k : Nat} (initPM : Store)
  ...
  have hleaf : denoteGraphDistributedFaithful pm_goal_1 initPM 6252 = initPM 6252 :=
    l16ZMed_leaf pm_goal_1 initPM 6252 (by native_decide) (by native_decide)
...
/-- The real canonical L16 remote-expert node preserves the CP2 zigzag layout.
...
theorem l16_zigzag_moe_expert_from_branch_inputs (initSM initPM : Store)
  ...
  have hdec := l16ZMed_hdec initPM hPM hX
  obtain ⟨x0, x1, hxs⟩ := hX
  ...
  have hbW13 : initSM 5953 = allGatherPrimDimN 0 2 0 [initPM 10758, initPM 10759] :=
    l16ZMed_weight_bridge initSM initPM hInit initGoal_5953 (by native_decide)
      5953 10758 10759 [32, 1024, 1024] rfl rfl rfl rfl rfl (by decide)
  have hbW2 : initSM 5954 = allGatherPrimDimN 0 2 0 [initPM 10760, initPM 10761] :=
    l16ZMed_weight_bridge initSM initPM hInit initGoal_5954 (by native_decide)
      5954 10760 10761 [32, 1024, 512] rfl rfl rfl rfl rfl (by decide)
  have hw13shape : (initSM 5953).shape = [64, 1024, 1024] :=
    hSM 5953 [64, 1024, 1024] (by native_decide)
  have hw2shape : (initSM 5954).shape = [64, 1024, 512] :=
    hSM 5954 [64, 1024, 512] (by native_decide)
  rw [l16ZMed_red_sm5955 initSM, l16ZMed_red_pm10762 initPM,
    l16ZMed_red_pm10763 initPM]
  rw [l16ZMed_leaf sm_goal_1 initSM 5953 (by native_decide) (by native_decide),
    l16ZMed_leaf sm_goal_1 initSM 5954 (by native_decide) (by native_decide),
    l16ZMed_leaf pm_goal_1 initPM 10758 (by native_decide) (by native_decide),
    l16ZMed_leaf pm_goal_1 initPM 10759 (by native_decide) (by native_decide),
    l16ZMed_leaf pm_goal_1 initPM 10760 (by native_decide) (by native_decide),
    l16ZMed_leaf pm_goal_1 initPM 10761 (by native_decide) (by native_decide)]
  unfold fw_all2all_moe_gmm_full
  simp only [List.length_cons, List.length_nil]
  rw [allGatherPrimDimN_singleton_eq 0 (initSM 5953) (by rw [hw13shape]; decide),
    allGatherPrimDimN_singleton_eq 0 (initSM 5954) (by rw [hw2shape]; decide)]
  rw [hbW13, hbW2]
  exact Zigzag2Rel.all2all_moe_gmm
    (allGatherPrimDimN 0 2 0 [initPM 10758, initPM 10759])
    (allGatherPrimDimN 0 2 0 [initPM 10760, initPM 10761])
...
/-- The canonical L16 remote-expert output from the exact L16 attention-residual boundary.
...
theorem l16_zigzag_moe_expert_from_attention_output (initSM initPM : Store)
    (hSM : StoreShapesHold initSM sm_goal_1InitEnv)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
    (hInit : InitGoalsHold pm_goal_1.numRanks goal_1_full_initGoals initSM initPM)
    ...
    Zigzag2Rel
      ...
      (denoteGraphDistributedFaithful pm_goal_1 initPM 6252)
      [4096, 1024] [2048, 1024] := by
  have hX := l16_zigzag_moe_activation_from_attention_output initSM initPM hInit hAttention
  have hRouter :=
    l16_zigzag_moe_router_from_attention_output initSM initPM hPM hInit hAttention
  exact l16_zigzag_moe_expert_from_branch_inputs initSM initPM hSM hPM hInit
    hX hRouter.1 hRouter.2

#print axioms l16_zigzag_moe_expert_from_attention_output
