...
private theorem l10a_reduce1 (g : GraphDecl) (init : Store) (k : Nat)
  ...
  rw [l10a_node_core g init k node o hk hn hm hdn hdw, ha,
...
private theorem l10_sm_sliding_node : sm.nodes[399]'(by native_decide) = l10SmSliding := by native_decide
private theorem l10_pm_sliding_node0 : pm.nodes[889]'(by native_decide) = l10PmSliding0 := by native_decide
private theorem l10_pm_sliding_node1 : pm.nodes[890]'(by native_decide) = l10PmSliding1 := by native_decide
private theorem l10_sm_sliding_buddy : ringAttnBuddies sm l10SmSliding = [l10SmSliding] := by native_decide
private theorem l10_pm_sliding_buddy0 : ringAttnBuddies pm l10PmSliding0 = [l10PmSliding0, l10PmSliding1] := by native_decide
private theorem l10_pm_sliding_buddy1 : ringAttnBuddies pm l10PmSliding1 = [l10PmSliding0, l10PmSliding1] := by native_decide
...
theorem l10o_raw5499_rel_of_qkv
    (initSM initPM : Store)
    (hq : Gather2Rel (denoteGraphDistributed sm initSM 5495)
      (denoteGraphDistributed pm initPM 9434) (denoteGraphDistributed pm initPM 9435)
      [4096, 16, 64] [2048, 16, 64])
    (hk : Gather2Rel (denoteGraphDistributed sm initSM 5496)
      (denoteGraphDistributed pm initPM 9436) (denoteGraphDistributed pm initPM 9437)
      [4096, 4, 64] [2048, 4, 64])
    (hv : Gather2Rel (denoteGraphDistributed sm initSM 5493)
      (denoteGraphDistributed pm initPM 9422) (denoteGraphDistributed pm initPM 9423)
      [4096, 4, 64] [2048, 4, 64])
    (hcuQ : denoteGraphDistributed sm initSM 5497 = denoteGraphDistributed pm initPM 5497)
    (hcuK : denoteGraphDistributed sm initSM 5498 = denoteGraphDistributed pm initPM 5498) :
    Gather2Rel (denoteGraphDistributed sm initSM 5499)
      (denoteGraphDistributed pm initPM 9438) (denoteGraphDistributed pm initPM 9439)
      [4096, 16, 64] [2048, 16, 64] := by
  let fs := (sm.nodes.take 399).foldl (applyNodeDistributed sm) initSM
  let fp := (pm.nodes.take 889).foldl (applyNodeDistributed pm) initPM
  let fp' := (pm.nodes.take 890).foldl (applyNodeDistributed pm) initPM
  have bs (t : Tid) (hn : ∀ n ∈ sm.nodes.drop 399, n.outs ≠ [])
      (hw : ∀ n ∈ sm.nodes.drop 399, t ∉ n.outs) : fs t = denoteGraphDistributed sm initSM t :=
    l10a_prefix_read sm initSM 399 t hn hw
  have bp (t : Tid) (hn : ∀ n ∈ pm.nodes.drop 889, n.outs ≠ [])
      (hw : ∀ n ∈ pm.nodes.drop 889, t ∉ n.outs) : fp t = denoteGraphDistributed pm initPM t :=
    l10a_prefix_read pm initPM 889 t hn hw
  have e9434 : fp 9434 = fp' 9434 := l10a_split pm pm.nodes initPM 9434 889 890
    (by omega) (by native_decide) (by native_decide)
  have e9435 : fp 9435 = fp' 9435 := l10a_split pm pm.nodes initPM 9435 889 890
    (by omega) (by native_decide) (by native_decide)
  have e9436 : fp 9436 = fp' 9436 := l10a_split pm pm.nodes initPM 9436 889 890
    (by omega) (by native_decide) (by native_decide)
  have e9437 : fp 9437 = fp' 9437 := l10a_split pm pm.nodes initPM 9437 889 890
    (by omega) (by native_decide) (by native_decide)
  have e9422 : fp 9422 = fp' 9422 := l10a_split pm pm.nodes initPM 9422 889 890
    (by omega) (by native_decide) (by native_decide)
  have e9423 : fp 9423 = fp' 9423 := l10a_split pm pm.nodes initPM 9423 889 890
    (by omega) (by native_decide) (by native_decide)
  have e5497 : fp 5497 = fp' 5497 := l10a_split pm pm.nodes initPM 5497 889 890
    (by omega) (by native_decide) (by native_decide)
  have e5498 : fp 5498 = fp' 5498 := l10a_split pm pm.nodes initPM 5498 889 890
    (by omega) (by native_decide) (by native_decide)
  ...
  have bridge : applyNodeRingAttn_sliding_window pm fp l10PmSliding1 =
      applyNodeRingAttn_sliding_window pm fp' l10PmSliding1 := by
    ...
    · exact e5497
    · exact e5498
  have rSM : denoteGraphDistributed sm initSM 5499 =
      applyNodeRingAttn_sliding_window sm fs l10SmSliding := by
    rw [l10a_node_core sm initSM 399 l10SmSliding 5499 (by native_decide)
      l10_sm_sliding_node (by decide) (by native_decide) (by native_decide)]
    exact l10a_ring_sliding_first_out sm _ 0 5495 5496 5493 5497 5498 5499 5500
      [16, 4, 64, 64, 1, 512]
  have rP0 : denoteGraphDistributed pm initPM 9438 =
      applyNodeRingAttn_sliding_window pm fp l10PmSliding0 := by
    rw [l10a_node_core pm initPM 889 l10PmSliding0 9438 (by native_decide)
      l10_pm_sliding_node0 (by decide) (by native_decide) (by native_decide)]
    exact l10a_ring_sliding_first_out pm _ 0 9434 9436 9422 5497 5498 9438 5500
      [16, 4, 64, 64, 1, 512]
  have rP1 : denoteGraphDistributed pm initPM 9439 =
      applyNodeRingAttn_sliding_window pm fp' l10PmSliding1 := by
    rw [l10a_node_core pm initPM 890 l10PmSliding1 9439 (by native_decide)
      l10_pm_sliding_node1 (by decide) (by native_decide) (by native_decide)]
    exact l10a_ring_sliding_first_out pm _ 1 9435 9437 9423 5497 5498 9439 5500
      [16, 4, 64, 64, 1, 512]
  ...
  have hrec := applyNodeRingAttn_sliding_window_reconstruction_2_of_buddy_pair
    sm pm fs fp l10SmSliding l10PmSliding0 l10PmSliding1 2048 16 64
  ...
  have hval : denoteGraphDistributed sm initSM 5499 = allGatherPrimDimN 0 2 0
      [denoteGraphDistributed pm initPM 9438, denoteGraphDistributed pm initPM 9439] := by
    rw [rSM, hrec, bridge, ← rP0, ← rP1]
  have hs0 : (denoteGraphDistributed pm initPM 9438).shape = [2048, 16, 64] := by
    rw [rP0, applyNodeRingAttn_sliding_window_pair_eq_chunk pm fp l10PmSliding0
    ...
    rfl
  have hs1 : (denoteGraphDistributed pm initPM 9439).shape = [2048, 16, 64] := by
    rw [rP1, applyNodeRingAttn_sliding_window_pair_eq_chunk pm fp' l10PmSliding1
...
private theorem l10a_reshape (g : GraphDecl) (init : Store) (k r i o hd : Nat) (tl : List Nat)
  ...
  l10a_reduce1 g init k _ i o (fw_view (hd :: tl)) hk hn (by simp)
...
private theorem l10a_linear (g : GraphDecl) (init : Store) (k r x w o : Nat)
  ...
  l10a_reduce2 g init k _ x w o fw_linear hk hn (by simp)
...
private theorem l10a_float (g : GraphDecl) (init : Store) (k r i o : Nat)
  ...
  have h := l10a_reduce1 g init k _ i o id hk hn (by simp)
...
private theorem l10a_add (g : GraphDecl) (init : Store) (k r x y o : Nat)
  ...
  l10a_reduce2 g init k _ x y o elemwiseAdd hk hn (by simp)
...
theorem l10o_residual5507_rel_of_raw
    ...
    (hraw : Gather2Rel (denoteGraphDistributed sm initSM 5499)
      (denoteGraphDistributed pm initPM 9438) (denoteGraphDistributed pm initPM 9439)
      [4096, 16, 64] [2048, 16, 64])
    (hbypass : Gather2Rel (denoteGraphDistributed sm initSM 8268)
      (denoteGraphDistributed pm initPM 15762) (denoteGraphDistributed pm initPM 15770)
      [4096, 1024] [2048, 1024]) :
    Gather2Rel (denoteGraphDistributed sm initSM 5507)
      (denoteGraphDistributed pm initPM 9468) (denoteGraphDistributed pm initPM 9469)
      [4096, 1024] [2048, 1024] := by
  have rs0 := l10a_reshape sm initSM 400 0 5499 5501 4096 [1024] (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have r00 := l10a_reshape pm initPM 891 0 9438 9440 2048 [1024] (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have r10 := l10a_reshape pm initPM 892 1 9439 9441 2048 [1024] (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have h0 : Gather2Rel (denoteGraphDistributed sm initSM 5501) (denoteGraphDistributed pm initPM 9440)
      (denoteGraphDistributed pm initPM 9441) [4096,1024] [2048,1024] := by
  ...
  have rs1 := l10a_reshape sm initSM 401 0 5501 5502 4096 [1024] (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have r01 := l10a_reshape pm initPM 893 0 9440 9446 2048 [1024] (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have r11 := l10a_reshape pm initPM 894 1 9441 9447 2048 [1024] (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have h1 : Gather2Rel (denoteGraphDistributed sm initSM 5502) (denoteGraphDistributed pm initPM 9446)
      (denoteGraphDistributed pm initPM 9447) [4096,1024] [2048,1024] := by
    have es : denoteGraphDistributed sm initSM 5502 = denoteGraphDistributed sm initSM 5501 := by rw [rs1, fw_view_id_shape _ _ h0.full_shape]
    have e0 : denoteGraphDistributed pm initPM 9446 = denoteGraphDistributed pm initPM 9440 := by rw [r01, fw_view_id_shape _ _ h0.shard0_shape]
    have e1 : denoteGraphDistributed pm initPM 9447 = denoteGraphDistributed pm initPM 9441 := by rw [r11, fw_view_id_shape _ _ h0.shard1_shape]
  ...
  have hpw : (denoteGraphDistributed pm initPM 5503).shape = [1024,1024] := by rw [← hw]; exact hws
  have rsl := l10a_linear sm initSM 402 0 5502 5503 5504 (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have r0l := l10a_linear pm initPM 895 0 9446 5503 9450 (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have r1l := l10a_linear pm initPM 896 1 9447 5503 9451 (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have hl : Gather2Rel (denoteGraphDistributed sm initSM 5504) (denoteGraphDistributed pm initPM 9450)
      (denoteGraphDistributed pm initPM 9451) [4096,1024] [2048,1024] := by
  ...
  have rsv := l10a_view sm initSM 403 0 5504 5505 4096 [1024] (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have r0v := l10a_view pm initPM 897 0 9450 9460 2048 [1024] (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have r1v := l10a_view pm initPM 898 1 9451 9461 2048 [1024] (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have hvw : Gather2Rel (denoteGraphDistributed sm initSM 5505) (denoteGraphDistributed pm initPM 9460)
      (denoteGraphDistributed pm initPM 9461) [4096,1024] [2048,1024] := by
    have es : denoteGraphDistributed sm initSM 5505 = denoteGraphDistributed sm initSM 5504 := by rw [rsv, fw_view_id_shape _ _ hl.full_shape]
    have e0 : denoteGraphDistributed pm initPM 9460 = denoteGraphDistributed pm initPM 9450 := by rw [r0v, fw_view_id_shape _ _ hl.shard0_shape]
    have e1 : denoteGraphDistributed pm initPM 9461 = denoteGraphDistributed pm initPM 9451 := by rw [r1v, fw_view_id_shape _ _ hl.shard1_shape]
  ...
  have rsf := l10a_float sm initSM 404 0 5505 5506 (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have r0f := l10a_float pm initPM 899 0 9460 9464 (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have r1f := l10a_float pm initPM 900 1 9461 9465 (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have hf : Gather2Rel (denoteGraphDistributed sm initSM 5506) (denoteGraphDistributed pm initPM 9464)
      (denoteGraphDistributed pm initPM 9465) [4096,1024] [2048,1024] :=
  ...
  have rsa := l10a_add sm initSM 405 0 8268 5506 5507 (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have r0a := l10a_add pm initPM 901 0 15762 9464 9468 (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have r1a := l10a_add pm initPM 902 1 15770 9465 9469 (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  refine ⟨?_, ?_, ?_, ?_, by decide⟩
...
theorem l10o_residual5507_rel_of_qkv
    (initSM initPM : Store) (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM)
    (hq : Gather2Rel (denoteGraphDistributed sm initSM 5495) (denoteGraphDistributed pm initPM 9434)
      (denoteGraphDistributed pm initPM 9435) [4096,16,64] [2048,16,64])
    (hk : Gather2Rel (denoteGraphDistributed sm initSM 5496) (denoteGraphDistributed pm initPM 9436)
      (denoteGraphDistributed pm initPM 9437) [4096,4,64] [2048,4,64])
    (hv : Gather2Rel (denoteGraphDistributed sm initSM 5493) (denoteGraphDistributed pm initPM 9422)
      (denoteGraphDistributed pm initPM 9423) [4096,4,64] [2048,4,64])
    (hcuQ : denoteGraphDistributed sm initSM 5497 = denoteGraphDistributed pm initPM 5497)
    (hcuK : denoteGraphDistributed sm initSM 5498 = denoteGraphDistributed pm initPM 5498)
    (hbypass : Gather2Rel (denoteGraphDistributed sm initSM 8268) (denoteGraphDistributed pm initPM 15762)
      (denoteGraphDistributed pm initPM 15770) [4096,1024] [2048,1024]) :
    Gather2Rel (denoteGraphDistributed sm initSM 5507) (denoteGraphDistributed pm initPM 9468)
      (denoteGraphDistributed pm initPM 9469) [4096,1024] [2048,1024] :=
...
theorem l10o_residual5507_rel_from_boundary5485_of_qkv
    (initSM initPM : Store) (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM)
    (hboundary : Gather2Rel (denoteGraphDistributed sm initSM 5485)
