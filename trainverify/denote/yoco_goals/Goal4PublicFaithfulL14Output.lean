...
import denote.yoco_goals.Goal4PublicFaithfulL14Router
...
theorem goal4_l14_output_from_attention
    (initSM initPM : Store)
  ...
  exact l14_zigzag_moe_output_from_attention_output initSM initPM hSM1 hPM1 hInit1 hA14
end
