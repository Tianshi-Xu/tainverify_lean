...
private theorem l11o_reduce4 (g : GraphDecl) (init : Store) (k : Nat)
    ...
    (hk : k < g.nodes.length) (hnode : g.nodes[k]'hk = node)
    (hmoe : node.op ≠ "OpName.FW_all2all_moe_gmm")
    (happly : ∀ s, applyNodeRingAttn g s node outTid =
    ...
    denoteGraphDistributed g init outTid =
      opfun (denoteGraphDistributed g init in0) (denoteGraphDistributed g init in1)
        (denoteGraphDistributed g init in2) (denoteGraphDistributed g init in3) := by
  rw [l11o_node_core g init k node outTid hk hnode hmoe hdrop_nil hdrop,
...
private theorem l11o_allgather2 (g : GraphDecl) (init : Store) (k r x0 x1 o : Nat)
    ...
    denoteGraphDistributed g init o = allGatherPrimDimN 0 g.numRanks r
      [denoteGraphDistributed g init x0, denoteGraphDistributed g init x1] :=
  l11o_reduce2 g init k _ x0 x1 o (fun a b => allGatherPrimDimN 0 g.numRanks r [a, b])
    hk hn (by simp)
    (fun st => by
      rw [applyNodeRingAttn_eq_applyNode_of_not_ring g st _ (by simp) (by simp)]
...
private theorem l11o_chunk (g : GraphDecl) (init : Store) (k r x o : Nat)
    ...
    (hpx : ∀ n ∈ g.nodes.drop k, x ∉ n.outs) :
    denoteGraphDistributed g init o =
      chunkPrimDimN 0 g.numRanks r (denoteGraphDistributed g init x) :=
...
theorem l11o_q5550_k5551_rels_from_boundary (initSM initPM : Store)
    ...
    (h : Gather2Rel (denoteGraphDistributed sm initSM 5540)
      (denoteGraphDistributed pm initPM 9558) (denoteGraphDistributed pm initPM 9559)
      [4096, 1024] [2048, 1024]) :
    Gather2Rel (denoteGraphDistributed sm initSM 5550)
      (denoteGraphDistributed pm initPM 9598) (denoteGraphDistributed pm initPM 9599)
      [4096, 16, 64] [2048, 16, 64] ∧
    Gather2Rel (denoteGraphDistributed sm initSM 5551)
  ...
  have qmS := l11o_reduce1 sm initSM 433
    { rank := 0, op := "OpName.FW_multiref", ins := [5542], outs := [8325, 8329, 8333], params := [3] }
    5542 8325 id (by native_decide) (by native_decide) (by decide)
    (fun st => l11o_apply_multiref_at sm st 0 5542 [8325, 8329, 8333] 3 rfl 8325 (by decide))
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have qm0 := l11o_reduce1 pm initPM 960
    { rank := 0, op := "OpName.FW_multiref", ins := [9562], outs := [15380, 13744, 13752], params := [3] }
    9562 15380 id (by native_decide) (by native_decide) (by decide)
    (fun st => l11o_apply_multiref_at pm st 0 9562 [15380, 13744, 13752] 3 rfl 15380 (by decide))
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have qm1 := l11o_reduce1 pm initPM 961
    { rank := 1, op := "OpName.FW_multiref", ins := [9563], outs := [15382, 13745, 13753], params := [3] }
    9563 15382 id (by native_decide) (by native_decide) (by decide)
    (fun st => l11o_apply_multiref_at pm st 1 9563 [15382, 13745, 13753] 3 rfl 15382 (by decide))
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  simp only [id_eq] at qmS qm0 qm1
  have qg := l11o_allgather2 pm initPM 964 0 15380 15382 12078
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  ...
  have hpwq : (denoteGraphDistributed pm initPM 5543).shape = [16, 64, 1024] := by
    rw [← hwq]; exact hswq
  have qs := l11o_per_head sm initSM 434 0 8325 5543 5544
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have qp := l11o_per_head pm initPM 968 1 12078 5543 5544
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have hpmR : pm.numRanks = 2 := rfl
  rw [hpmR] at qg
  have qeq : denoteGraphDistributed sm initSM 5544 = denoteGraphDistributed pm initPM 5544 := by
    rw [qs, qmS, rmsRel.value, ← qm0, ← qm1, ← qg, hwq, ← qp]
  have hqfullS : (denoteGraphDistributed sm initSM 5544).shape = [4096, 16, 64] := by
    rw [qs]
    exact l11o_per_head_shape _ _ 4096 1024 16 64
      (by rw [qmS]; exact rmsRel.full_shape) hswq
  have hqfullP : (denoteGraphDistributed pm initPM 5544).shape = [4096, 16, 64] := by
    rw [← qeq]; exact hqfullS
  have cq0 := l11o_chunk pm initPM 969 0 5544 9564
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have cq1 := l11o_chunk pm initPM 970 1 5544 9565
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  rw [hpmR] at cq0 cq1
  have hq0 : (denoteGraphDistributed pm initPM 9564).shape = [2048, 16, 64] := by
    rw [cq0, chunkPrimDimN_shape 0 2 0 _ [4096, 16, 64] hqfullP (by omega)]
    rfl
  have hq1 : (denoteGraphDistributed pm initPM 9565).shape = [2048, 16, 64] := by
    rw [cq1, chunkPrimDimN_shape 0 2 1 _ [4096, 16, 64] hqfullP (by omega)]
    rfl
  have qRel : Gather2Rel (denoteGraphDistributed sm initSM 5544)
      (denoteGraphDistributed pm initPM 9564) (denoteGraphDistributed pm initPM 9565)
      [4096, 16, 64] [2048, 16, 64] := by
    refine ⟨?_, hqfullS, hq0, hq1, by decide⟩
    rw [qeq, cq0, cq1]
    exact (l11o_allGather0_reconstruct_chunks_3d 2048 16 64 (by omega) (by omega) (by omega)
      (denoteGraphDistributed pm initPM 5544) (by simpa using hqfullP)).symm
  ...
  have kmS := l11o_reduce1 sm initSM 433
    { rank := 0, op := "OpName.FW_multiref", ins := [5542], outs := [8325, 8329, 8333], params := [3] }
    5542 8329 id (by native_decide) (by native_decide) (by decide)
    (fun st => l11o_apply_multiref_at sm st 0 5542 [8325, 8329, 8333] 3 rfl 8329 (by decide))
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have km0 := l11o_reduce1 pm initPM 960
    { rank := 0, op := "OpName.FW_multiref", ins := [9562], outs := [15380, 13744, 13752], params := [3] }
    9562 13744 id (by native_decide) (by native_decide) (by decide)
    (fun st => l11o_apply_multiref_at pm st 0 9562 [15380, 13744, 13752] 3 rfl 13744 (by decide))
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have km1 := l11o_reduce1 pm initPM 961
    { rank := 1, op := "OpName.FW_multiref", ins := [9563], outs := [15382, 13745, 13753], params := [3] }
    9563 13745 id (by native_decide) (by native_decide) (by decide)
    (fun st => l11o_apply_multiref_at pm st 1 9563 [15382, 13745, 13753] 3 rfl 13745 (by decide))
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  ...
  have hpwk : (denoteGraphDistributed pm initPM 5545).shape = [4, 64, 1024] := by
    rw [← hwk]; exact hswk
  have ks := l11o_per_head sm initSM 435 0 8329 5545 5546
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have kp0 := l11o_per_head pm initPM 962 0 13744 5545 9576
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have kp1 := l11o_per_head pm initPM 965 1 13745 5545 9577
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have kRel : Gather2Rel (denoteGraphDistributed sm initSM 5546)
      (denoteGraphDistributed pm initPM 9576) (denoteGraphDistributed pm initPM 9577)
      [4096, 4, 64] [2048, 4, 64] := by
    refine ⟨?_, ?_, ?_, ?_, by decide⟩
  ...
  have pc0 := l11o_chunk pm initPM 12 0 5549 9596
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have pc1 := l11o_chunk pm initPM 26 1 5549 9597
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  rw [hpmR] at pc0 pc1
  have qS := l11o_reduce4 sm initSM 437
    ...
    (fun st => by
      ...
      exact applyNode_fw_rotary_embedding_fst_out sm st 0 16 4 4944 5549 5544 5546 5550 5551)
    (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have kS := l11o_reduce4 sm initSM 437
    { rank := 0, op := "OpName.FW_rotary_embedding", ins := [4944, 5549, 5544, 5546],
      outs := [5550, 5551], params := [16, 4] }
    ...
    (fun st => by
      rw [applyNodeRingAttn_eq_applyNode_of_not_ring sm st _ (by decide) (by decide)]
      exact applyNode_fw_rotary_embedding_snd_out sm st 0 16 4 4944 5549 5544 5546 5550 5551 (by decide))
    (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have q0 := l11o_reduce4 pm initPM 971
    ...
    (fun st => by
      ...
      exact applyNode_fw_rotary_embedding_fst_out pm st 0 16 4 4944 9596 9564 9576 9598 9600)
    (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have k0 := l11o_reduce4 pm initPM 971
    { rank := 0, op := "OpName.FW_rotary_embedding", ins := [4944, 9596, 9564, 9576],
      outs := [9598, 9600], params := [16, 4] }
    ...
    (fun st => by
      rw [applyNodeRingAttn_eq_applyNode_of_not_ring pm st _ (by decide) (by decide)]
      exact applyNode_fw_rotary_embedding_snd_out pm st 0 16 4 4944 9596 9564 9576 9598 9600 (by decide))
    (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have q1 := l11o_reduce4 pm initPM 972
    ...
    (fun st => by
      rw [applyNodeRingAttn_eq_applyNode_of_not_ring pm st _ (by decide) (by decide)]
      exact applyNode_fw_rotary_embedding_fst_out pm st 1 16 4 4944 9597 9565 9577 9599 9601)
    (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have k1 := l11o_reduce4 pm initPM 972
    { rank := 1, op := "OpName.FW_rotary_embedding", ins := [4944, 9597, 9565, 9577],
      outs := [9599, 9601], params := [16, 4] }
    ...
    (fun st => by
      rw [applyNodeRingAttn_eq_applyNode_of_not_ring pm st _ (by decide) (by decide)]
      exact applyNode_fw_rotary_embedding_snd_out pm st 1 16 4 4944 9597 9565 9577 9599 9601 (by decide))
    (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have qval : denoteGraphDistributed sm initSM 5550 = allGatherPrimDimN 0 2 0
      [denoteGraphDistributed pm initPM 9598, denoteGraphDistributed pm initPM 9599] := by
    rw [qS]
    simp only [fw_rotary_embedding]
    rw [qRel.value, l11o_rotary_allGather0_1d (denoteGraphDistributed sm initSM 4944)
      (denoteGraphDistributed sm initSM 5549) (denoteGraphDistributed pm initPM 9564)
      (denoteGraphDistributed pm initPM 9565) 2048 16 64 (by omega) (by omega) (by omega)
      hspos qRel.shard0_shape qRel.shard1_shape, hcache, hpos, ← pc0, ← pc1, q0, q1]
    simp only [fw_rotary_embedding]
  have kval : denoteGraphDistributed sm initSM 5551 = allGatherPrimDimN 0 2 0
      [denoteGraphDistributed pm initPM 9600, denoteGraphDistributed pm initPM 9601] := by
    rw [kS]
    simp only [fw_rotary_embedding]
    rw [kRel.value, l11o_rotary_allGather0_1d (denoteGraphDistributed sm initSM 4944)
      (denoteGraphDistributed sm initSM 5549) (denoteGraphDistributed pm initPM 9576)
      (denoteGraphDistributed pm initPM 9577) 2048 4 64 (by omega) (by omega) (by omega)
      hspos kRel.shard0_shape kRel.shard1_shape, hcache, hpos, ← pc0, ← pc1, k0, k1]
    simp only [fw_rotary_embedding]
  have qs0 : (denoteGraphDistributed pm initPM 9598).shape = [2048, 16, 64] := by
    rw [q0]
    simp only [fw_rotary_embedding]
    exact fw_rotary_apply_shape_c2a _ _ _ 2048 16 64 qRel.shard0_shape
  have qs1 : (denoteGraphDistributed pm initPM 9599).shape = [2048, 16, 64] := by
    rw [q1]
    simp only [fw_rotary_embedding]
    exact fw_rotary_apply_shape_c2a _ _ _ 2048 16 64 qRel.shard1_shape
  have ks0 : (denoteGraphDistributed pm initPM 9600).shape = [2048, 4, 64] := by
    rw [k0]
    simp only [fw_rotary_embedding]
    exact fw_rotary_apply_shape_c2a _ _ _ 2048 4 64 kRel.shard0_shape
  have ks1 : (denoteGraphDistributed pm initPM 9601).shape = [2048, 4, 64] := by
    rw [k1]
    simp only [fw_rotary_embedding]
