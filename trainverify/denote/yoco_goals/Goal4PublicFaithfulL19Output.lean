...
import denote.yoco_goals.Goal4PublicFaithfulL19Router
...
theorem goal4_l19_output_from_attention
    (initSM initPM : Store)
  ...
  exact l19_zigzag_moe_output_from_attention_output initSM initPM hSM1 hPM1 hInit1 hA19
end
