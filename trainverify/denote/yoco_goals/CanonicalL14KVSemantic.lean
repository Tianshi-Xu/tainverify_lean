/- Pure tensor-level ordinary K/V transport for canonical L14. -/
...
private theorem cL14KV_ordinary_semantic
...
theorem canonical_l14_k_ordinary_semantic
    ...
    Gather2Rel
      ...
      [4096, 4, 64] [2048, 4, 64] :=
  cL14KV_ordinary_semantic hCache hRmsW hKW hKShape

/-- Ordinary rank-order V transport, kept separate from graph alignment. -/
theorem canonical_l14_v_ordinary_semantic
    ...
    Gather2Rel
      ...
      [4096, 4, 64] [2048, 4, 64] :=
  cL14KV_ordinary_semantic hCache hRmsW hVW hVShape
