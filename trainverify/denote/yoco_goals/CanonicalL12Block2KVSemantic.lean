/- Pure tensor-level ordinary K/V transport for canonical L12 block 2. -/
...
private theorem cL12B2KV_ordinary_semantic
...
theorem canonical_l12b2_k_ordinary_semantic
    ...
    Gather2Rel
      ...
      [4096, 4, 64] [2048, 4, 64] :=
  cL12B2KV_ordinary_semantic hCache hRmsW hKW hKShape

/-- Ordinary rank-order V transport, kept separate from graph alignment. -/
theorem canonical_l12b2_v_ordinary_semantic
    ...
    Gather2Rel
      ...
      [4096, 4, 64] [2048, 4, 64] :=
  cL12B2KV_ordinary_semantic hCache hRmsW hVW hVShape
