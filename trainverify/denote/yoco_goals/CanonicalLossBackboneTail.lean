...
private theorem sm_all_nonempty : ∀ n ∈ sm_goal_1.nodes, n.outs ≠ [] := by
  native_decide
private theorem pm_all_nonempty : ∀ n ∈ pm_goal_1.nodes, n.outs ≠ [] := by
  native_decide
private theorem sm_nonempty (k : Nat) : ∀ n ∈ sm_goal_1.nodes.drop k, n.outs ≠ [] :=
  fun n hn => sm_all_nonempty n (List.mem_of_mem_drop hn)
private theorem pm_nonempty (k : Nat) : ∀ n ∈ pm_goal_1.nodes.drop k, n.outs ≠ [] :=
  fun n hn => pm_all_nonempty n (List.mem_of_mem_drop hn)

private theorem sm_922_lt : 922 < sm_goal_1.nodes.length := by native_decide
private theorem sm_922_node : sm_goal_1.nodes[922]'sm_922_lt = cSmUnshuffle := by
  native_decide
private theorem sm_after_6253 : ∀ n ∈ sm_goal_1.nodes.drop 923, 6253 ∉ n.outs := by
  native_decide
private theorem sm_from_922_6247 : ∀ n ∈ sm_goal_1.nodes.drop 922, 6247 ∉ n.outs := by
  native_decide

private theorem red_sm6253 (initSM : Store) :
    denoteGraphDistributedFaithful sm_goal_1 initSM 6253 =
      denoteGraphDistributedFaithful sm_goal_1 initSM 6247 := by
  refine denoteGraphDistributedFaithful_reduce1 sm_goal_1 initSM 922 cSmUnshuffle
    6247 6253 (fun x => x)
...
private theorem red_pm11606 (initPM : Store) :
    denoteGraphDistributedFaithful pm_goal_1 initPM 11606 =
      fw_maybe_unshuffle_collective
        ...
        (decodeCuSeqlens (denoteGraphDistributedFaithful pm_goal_1 initPM 6252)) 2 0 := by
  refine denoteGraphDistributedFaithful_reduce3 pm_goal_1 initPM 2016 cPmUnshuffle0
  ...
  have hb : pm_goal_1.replicaBuddies
      { rank := 0, op := "OpName.FW_maybe_unshuffle", ins := [11598, 6252],
        outs := [11606], params := [2, 0] } =
      [{ rank := 0, op := "OpName.FW_maybe_unshuffle", ins := [11598, 6252],
         outs := [11606], params := [2, 0] },
...
private theorem red_pm11607 (initPM : Store) :
    denoteGraphDistributedFaithful pm_goal_1 initPM 11607 =
      fw_maybe_unshuffle_collective
        [denoteGraphDistributedFaithful pm_goal_1 initPM 11598,
         denoteGraphDistributedFaithful pm_goal_1 initPM 11599]
        (decodeCuSeqlens (denoteGraphDistributedFaithful pm_goal_1 initPM 6252)) 2 1 := by
  refine denoteGraphDistributedFaithful_reduce3 pm_goal_1 initPM 2017 cPmUnshuffle1
...
private theorem red_sm6255 (initSM : Store) :
    denoteGraphDistributedFaithful sm_goal_1 initSM 6255 =
      fw_rms_norm
        (denoteGraphDistributedFaithful sm_goal_1 initSM 6253)
        (denoteGraphDistributedFaithful sm_goal_1 initSM 6254) := by
  refine denoteGraphDistributedFaithful_reduce2 sm_goal_1 initSM 923 cSmNorm
  ...
  rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective _ _ _
    (by decide) (by decide)]
  exact applyNode_fw_rms_norm_out_1p sm_goal_1 s 0 6253 6254 6255

private theorem red_pm11712 (initPM : Store) :
    denoteGraphDistributedFaithful pm_goal_1 initPM 11712 =
      fw_rms_norm
        (denoteGraphDistributedFaithful pm_goal_1 initPM 11606)
        (denoteGraphDistributedFaithful pm_goal_1 initPM 6254) := by
  refine denoteGraphDistributedFaithful_reduce2 pm_goal_1 initPM 2018 cPmNorm0
  ...
  rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective _ _ _
    (by decide) (by decide)]
  exact applyNode_fw_rms_norm_out_1p pm_goal_1 s 0 11606 6254 11712
...
private theorem red_pm11713 (initPM : Store) :
    denoteGraphDistributedFaithful pm_goal_1 initPM 11713 =
      fw_rms_norm
        (denoteGraphDistributedFaithful pm_goal_1 initPM 11607)
        (denoteGraphDistributedFaithful pm_goal_1 initPM 6254) := by
  refine denoteGraphDistributedFaithful_reduce2 pm_goal_1 initPM 2019 cPmNorm1
  ...
  rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective _ _ _
    (by decide) (by decide)]
  exact applyNode_fw_rms_norm_out_1p pm_goal_1 s 1 11607 6254 11713

private theorem canonical_weight_eq (initSM initPM : Store)
    (hInit : InitGoalsHold pm_goal_1.numRanks initGoals initSM initPM) :
    denoteGraphDistributedFaithful sm_goal_1 initSM 6254 =
      denoteGraphDistributedFaithful pm_goal_1 initPM 6254 := by
  ...
  rw [foldl_applyNodeDistributedFaithful_at_not_written sm_goal_1 sm_goal_1.nodes initSM 6254
      (by native_decide) (by native_decide),
    foldl_applyNodeDistributedFaithful_at_not_written pm_goal_1 pm_goal_1.nodes initPM 6254
      (by native_decide) (by native_decide)]
  exact hi
...
private theorem canonical_final_unshuffle_value (initSM initPM : Store)
    ...
    denoteGraphDistributedFaithful sm_goal_1 initSM 6253 =
      allGatherPrimDimN 0 2 0
        [denoteGraphDistributedFaithful pm_goal_1 initPM 11606,
         denoteGraphDistributedFaithful pm_goal_1 initPM 11607] := by
  calc
    denoteGraphDistributedFaithful sm_goal_1 initSM 6253
          = denoteGraphDistributedFaithful sm_goal_1 initSM 6247 := red_sm6253 initSM
    _ = allGatherPrimDimN 0 2 0
          [fw_maybe_unshuffle_collective
              [denoteGraphDistributedFaithful pm_goal_1 initPM 11598,
               denoteGraphDistributedFaithful pm_goal_1 initPM 11599]
              (decodeCuSeqlens (denoteGraphDistributedFaithful pm_goal_1 initPM 6252)) 2 0,
           fw_maybe_unshuffle_collective
              [denoteGraphDistributedFaithful pm_goal_1 initPM 11598,
               denoteGraphDistributedFaithful pm_goal_1 initPM 11599]
              (decodeCuSeqlens (denoteGraphDistributedFaithful pm_goal_1 initPM 6252)) 2 1] :=
...
private theorem canonical_final_unshuffle_full_shape (initSM initPM : Store)
    (hpre : Zigzag2Rel
      ...
      (denoteGraphDistributedFaithful pm_goal_1 initPM 6252)
      [4096, 1024] [2048, 1024]) :
    (denoteGraphDistributedFaithful sm_goal_1 initSM 6253).shape = [4096, 1024] :=
...
private theorem canonical_final_unshuffle_rank0_shape (initSM initPM : Store)
    (hpre : Zigzag2Rel
      ...
      (denoteGraphDistributedFaithful pm_goal_1 initPM 6252)
      [4096, 1024] [2048, 1024]) :
    (denoteGraphDistributedFaithful pm_goal_1 initPM 11606).shape = [2048, 1024] := by
...
private theorem canonical_final_unshuffle_rank1_shape (initSM initPM : Store)
    (hpre : Zigzag2Rel
      ...
      (denoteGraphDistributedFaithful pm_goal_1 initPM 6252)
      [4096, 1024] [2048, 1024]) :
    (denoteGraphDistributedFaithful pm_goal_1 initPM 11607).shape = [2048, 1024] := by
...
private theorem canonical_cu_not_written :
    ∀ n ∈ pm_goal_1.nodes, (6252 : Tid) ∉ n.outs := by
  native_decide

private theorem canonical_cu_input (initPM : Store) :
    denoteGraphDistributedFaithful pm_goal_1 initPM 6252 = initPM 6252 := by
  unfold denoteGraphDistributedFaithful
  exact foldl_applyNodeDistributedFaithful_at_not_written
    pm_goal_1 pm_goal_1.nodes initPM 6252
...
theorem canonical_loss_backbone_tail (initSM initPM : Store)
    (hInit : InitGoalsHold pm_goal_1.numRanks initGoals initSM initPM)
    (hpre : Zigzag2Rel
      (denoteGraphDistributedFaithful sm_goal_1 initSM 6247)
      (denoteGraphDistributedFaithful pm_goal_1 initPM 11598)
  ...
  · calc
      denoteGraphDistributedFaithful sm_goal_1 initSM 6255
          = fw_rms_norm
              (denoteGraphDistributedFaithful sm_goal_1 initSM 6253)
              (denoteGraphDistributedFaithful sm_goal_1 initSM 6254) := red_sm6255 initSM
      _ = allGatherPrimDimN 0 2 0
            [fw_rms_norm (denoteGraphDistributedFaithful pm_goal_1 initPM 11606)
              (denoteGraphDistributedFaithful pm_goal_1 initPM 6254),
             fw_rms_norm (denoteGraphDistributedFaithful pm_goal_1 initPM 11607)
              (denoteGraphDistributedFaithful pm_goal_1 initPM 6254)] := by
            rw [hu.value, hw]
      ...
      _ = allGatherPrimDimN 0 2 0
            [denoteGraphDistributedFaithful pm_goal_1 initPM 11712,
             denoteGraphDistributedFaithful pm_goal_1 initPM 11713] := by
            rw [red_pm11712, red_pm11713]
  · calc
      (denoteGraphDistributedFaithful sm_goal_1 initSM 6255).shape
          = (fw_rms_norm
              (denoteGraphDistributedFaithful sm_goal_1 initSM 6253)
              (denoteGraphDistributedFaithful sm_goal_1 initSM 6254)).shape :=
      ...
      _ = [4096, 1024] := by
            ...
            rfl
  · calc
      (denoteGraphDistributedFaithful pm_goal_1 initPM 11712).shape
          = (fw_rms_norm
              (denoteGraphDistributedFaithful pm_goal_1 initPM 11606)
              (denoteGraphDistributedFaithful pm_goal_1 initPM 6254)).shape :=
      ...
      _ = [2048, 1024] := by
            ...
            rfl
  · calc
      (denoteGraphDistributedFaithful pm_goal_1 initPM 11713).shape
          = (fw_rms_norm
              (denoteGraphDistributedFaithful pm_goal_1 initPM 11607)
              (denoteGraphDistributedFaithful pm_goal_1 initPM 6254)).shape :=
