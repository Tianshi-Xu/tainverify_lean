/- L2 ordinary MoE composition from attention residual to block output. -/
import denote.yoco_goals.L2OrdinaryMoEBoundary
import denote.yoco_goals.L2OrdinaryMoEExpert
...
theorem l2_ordinary_moe_composition (initSM initPM : Store)
