...
import denote.yoco_goals.Goal4PublicFaithfulL17Score
...
theorem goal4_l17_checkpoint_from_l16
    (initSM initPM : Store)
    ...
    (mid : Goal4L16Checkpoint initSM initPM) : Goal4L17Checkpoint initSM initPM := by
  have hA17 := goal4_l17_attention_from_l16 initSM initPM hPM1 hInit1 hClasses hDec mid
  have hN17 := goal4_l17_norm_from_attention initSM initPM hInit1 hA17
  have hAll17 := goal4_l17_router_from_norm initSM initPM hPM1 hInit1 hN17
  have hO17 := goal4_l17_output_from_attention initSM initPM hSM1 hPM1 hInit1 hA17
  have hScore17 := goal4_l17_score_from_router initSM initPM hDec hAll17
  refine { base := mid, output17 := hO17, l19 := ?_ }
  exact zigzag_transport hScore17
      (goal4_late_sm_to_goal1 initSM 6006 (by decide))
      (goal4_late_pm_to_goal1 initPM 10910 (by decide))
      (goal4_late_pm_to_goal1 initPM 10911 (by decide))
      (goal4_canonical_cu_alias initPM hClasses 6034 (by decide))

theorem goal4_l17_checkpoint_of_external
    (initSM initPM : Store)
    ...
    (hContract : Goal4ExternalInputContract initSM initPM) : Goal4L17Checkpoint initSM initPM := by
  ...
  exact goal4_l17_checkpoint_from_l16 initSM initPM hSM1 hPM1 hInit1 hContract.2.1 hDec
    (goal4_l16_checkpoint_of_external initSM initPM hSM hPM hInit hContract)
end
