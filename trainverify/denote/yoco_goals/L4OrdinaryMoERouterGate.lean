...
import denote.yoco_goals.L4OrdinaryMoENorm
...
theorem l4_ordinary_moe_logits_from_norm_input (initSM initPM : Store)
    ...
    Gather2Rel
      ...
      [4096, 64] [2048, 64] := by
  have hwEq := l4OMr_weight_eq initSM initPM hInit
  have hwShape := l4OMr_weight_shape initPM hPM
  ...
  rw [l4OMr_red_sm5182 initSM, l4OMr_red_sm5180 initSM,
    l4OMr_red_sm7984 initSM, hwEq,
    l4OMr_red_pm8496 initPM, l4OMr_red_pm8497 initPM,
    l4OMr_red_pm5182 initPM, l4OMr_red_pm5180 initPM,
    l4OMr_red_pm11870 initPM, l4OMr_red_pm15328 initPM,
    l4OMr_red_pm15330 initPM,
    ...
    l4OMr_chunk_gather0 _ _ hp0Shape hp1Shape,
    l4OMr_chunk_gather1 _ _ hp0Shape hp1Shape]
  exact hLocal
...
theorem l4_ordinary_moe_router_from_norm_input (initSM initPM : Store)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
    (hInit : InitGoalsHold pm_goal_1.numRanks initGoals initSM initPM)
    (hNorm : Gather2Rel
      (denoteGraphDistributedFaithful sm_goal_1 initSM 5179)
    ...
    Gather2Rel
      ...
      [4096, 64] [2048, 64] := by
  have hLogits := l4_ordinary_moe_logits_from_norm_input initSM initPM hPM hInit hNorm
  ...
  rw [l4OMr_red_sm5183 initSM hLogits.full_shape,
    l4OMr_red_pm8498 initPM hLogits.shard0_shape,
    l4OMr_red_pm8499 initPM hLogits.shard1_shape,
    l4OMr_red_sm5184 initSM hLogits.full_shape,
    l4OMr_red_pm8500 initPM hLogits.shard0_shape,
    l4OMr_red_pm8501 initPM hLogits.shard1_shape]
  exact ⟨hProbs, hMap⟩

/-- The real scalar-gate branch preserves ordinary dim-0 layout. -/
theorem l4_ordinary_moe_gate_from_norm_input (initSM initPM : Store)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
    (hInit : InitGoalsHold pm_goal_1.numRanks initGoals initSM initPM)
    (hNorm : Gather2Rel
      (denoteGraphDistributedFaithful sm_goal_1 initSM 5179)
  ...
  have hSource : Gather2Rel
    ...
    rw [l4OMrg_red_sm7992 initSM, l4OMrg_red_pm12924 initPM,
      l4OMrg_red_pm12925 initPM]
    exact hNorm
  have hReshape : Gather2Rel
      ...
      [4096, 1024] [2048, 1024] := by
    rw [l4OMrg_red_sm5189 initSM, l4OMrg_red_pm8510 initPM,
      l4OMrg_red_pm8511 initPM]
    exact Gather2Rel.view_id hSource
  have hwEq := l4OMrg_weight_eq initSM initPM hInit
  have hwShape := l4OMrg_weight_shape initPM hPM
  have hLinear : Gather2Rel
      ...
      [4096, 1] [2048, 1] := by
    rw [l4OMrg_red_sm5191 initSM, l4OMrg_red_pm8514 initPM,
      l4OMrg_red_pm8515 initPM, hwEq]
  ...
  have hView : Gather2Rel
      ...
      [4096, 1] [2048, 1] := by
    rw [l4OMrg_red_sm5192 initSM, l4OMrg_red_pm8516 initPM,
      l4OMrg_red_pm8517 initPM]
    exact Gather2Rel.view_id hLinear
  rw [l4OMrg_red_sm5193 initSM, l4OMrg_red_pm8518 initPM,
    l4OMrg_red_pm8519 initPM]
...
theorem l4_ordinary_moe_router_from_attention_output (initSM initPM : Store)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
    ...
    Gather2Rel
      ...
      (denoteGraphDistributedFaithful pm_goal_1 initPM 8501)
      [4096, 64] [2048, 64] := by
  have hNorm := l4_ordinary_moe_norm_from_attention_output
    initSM initPM hInit hAttention
  exact l4_ordinary_moe_router_from_norm_input initSM initPM hPM hInit hNorm

/-- The ordinary scalar gate is closed directly from attention output. -/
theorem l4_ordinary_moe_gate_from_attention_output (initSM initPM : Store)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
    (hInit : InitGoalsHold pm_goal_1.numRanks goal_1_full_initGoals initSM initPM)
    (hAttention : Gather2Rel
      (denoteGraphDistributedFaithful sm_goal_1 initSM 5177)
  ...
  have hNorm := l4_ordinary_moe_norm_from_attention_output
    initSM initPM hInit hAttention
  exact l4_ordinary_moe_gate_from_norm_input initSM initPM hPM hInit hNorm

#print axioms l4_ordinary_moe_router_from_norm_input
#print axioms l4_ordinary_moe_gate_from_norm_input
#print axioms l4_ordinary_moe_router_from_attention_output
#print axioms l4_ordinary_moe_gate_from_attention_output
