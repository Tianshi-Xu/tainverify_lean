/- L1 ordinary MoE composition from attention residual to block output. -/
import denote.yoco_goals.L1OrdinaryMoEBoundary
import denote.yoco_goals.L1OrdinaryMoEExpert
...
theorem l1_ordinary_moe_composition (initSM initPM : Store)
