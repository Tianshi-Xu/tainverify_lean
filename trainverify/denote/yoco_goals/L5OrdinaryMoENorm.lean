...
theorem l5_ordinary_moe_norm_from_attention_output (initSM initPM : Store)
  ...
  · rw [l5OMon_red_sm5234 initSM, l5OMon_red_pm8652 initPM,
      l5OMon_red_pm8653 initPM, hRef.value, hw,
      ordinary_fw_rms_norm_allGather0_commute_2 _ _ _ 2048 1024
        (by omega) (by omega) hRef.shard0_shape hRef.shard1_shape]
  · rw [l5OMon_red_sm5234 initSM]
    exact ordinary_fw_rms_norm_shape2 _ _ 4096 1024
      (by rw [l5OMon_red_sm8025 initSM]; exact hRef.full_shape)
  · rw [l5OMon_red_pm8652 initPM]
    exact ordinary_fw_rms_norm_shape2 _ _ 2048 1024
      (by rw [l5OMon_red_pm15614 initPM]; exact hRef.shard0_shape)
  · rw [l5OMon_red_pm8653 initPM]
    exact ordinary_fw_rms_norm_shape2 _ _ 2048 1024
      (by rw [l5OMon_red_pm15622 initPM]; exact hRef.shard1_shape)
