/- Pure tensor-level ordinary K/V transport for canonical L17. -/
...
private theorem cL17KV_ordinary_semantic
...
theorem canonical_l17_k_ordinary_semantic
    ...
    Gather2Rel
      ...
      [4096, 4, 64] [2048, 4, 64] :=
  cL17KV_ordinary_semantic hCache hRmsW hKW hKShape

/-- Ordinary rank-order V transport, kept separate from graph alignment. -/
theorem canonical_l17_v_ordinary_semantic
    ...
    Gather2Rel
      ...
      [4096, 4, 64] [2048, 4, 64] :=
  cL17KV_ordinary_semantic hCache hRmsW hVW hVShape
