...
-- The legacy cut statement and its frozen generated init-goal declarations
-- live in `Goal_3_Cut`; this module intentionally exports only the graph and
-- shape environments shared by the cut proof.
