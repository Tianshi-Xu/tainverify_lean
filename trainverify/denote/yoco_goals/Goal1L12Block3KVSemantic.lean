/- Pure tensor-level ordinary K/V transport for canonical L12 block 3. -/
...
private theorem b3KV_ordinary_semantic
...
theorem goal1_l12_block3_k_ordinary_semantic
    ...
    Gather2Rel
      ...
      [4096, 4, 64] [2048, 4, 64] :=
  b3KV_ordinary_semantic hCache hRmsW hKW hKShape

/-- Ordinary rank-order V transport, kept separate from graph alignment. -/
theorem goal1_l12_block3_v_ordinary_semantic
    ...
    Gather2Rel
      ...
      [4096, 4, 64] [2048, 4, 64] :=
  b3KV_ordinary_semantic hCache hRmsW hVW hVShape
