...
import denote.yoco_goals.L10OrdinaryMoERouterGate
...
private theorem l10OMOe_reduce5
...
private theorem l10OMOe_reduce7
    (g : GraphDecl) (init : Store) (k : Nat) (node : NodeDecl)
...
private def l10OMOeSmMoE : NodeDecl :=
  { rank := 0, op := "OpName.FW_all2all_moe_gmm",
    ins := [8300, 5513, 5514, 5516, 5517], outs := [5518],
    params := [64, 0, 64, 8] }
private def l10OMOePmMoE0 : NodeDecl :=
  { rank := 0, op := "OpName.FW_all2all_moe_gmm",
    ins := [13670, 9482, 9484, 9488, 9490], outs := [9492],
    params := [64, 0, 32, 8] }
private def l10OMOePmMoE1 : NodeDecl :=
  { rank := 1, op := "OpName.FW_all2all_moe_gmm",
    ins := [13671, 9483, 9485, 9489, 9491], outs := [9493],
    params := [64, 32, 64, 8] }

private theorem l10OMOe_buddies :
    sm_goal_1.replicaBuddies l10OMOeSmMoE = [l10OMOeSmMoE] ∧
    pm_goal_1.replicaBuddies l10OMOePmMoE0 = [l10OMOePmMoE0, l10OMOePmMoE1] ∧
    pm_goal_1.replicaBuddies l10OMOePmMoE1 = [l10OMOePmMoE0, l10OMOePmMoE1] := by
  native_decide

private theorem l10OMOe_red_sm5518 (initSM : Store) :
    denoteGraphDistributedFaithful sm_goal_1 initSM 5518 =
      fw_all2all_moe_gmm_full
        ...
        [denoteGraphDistributedFaithful sm_goal_1 initSM 5516]
        [denoteGraphDistributedFaithful sm_goal_1 initSM 5517]
        64 8 (((10 : Nat) : Scalar)) := by
  refine l10OMOe_reduce5 sm_goal_1 initSM 421 l10OMOeSmMoE
    8300 5513 5514 5516 5517 5518
  ...
  intro s
  have hb := l10OMOe_buddies.1
  unfold l10OMOeSmMoE at hb ⊢
  rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective _ _ _
    (by decide) (by decide) (by decide)]
  rw [applyNodeDistributed_moe_out sm_goal_1 s 0 8300 5513 5514 5516 5517 5518
    [64, 0, 64, 8]]
  unfold applyNodeFullExpertMoE_value
  rw [hb]
  rfl

private theorem l10OMOe_red_pm9492 (initPM : Store) :
    denoteGraphDistributedFaithful pm_goal_1 initPM 9492 =
      fw_all2all_moe_gmm_full
        ...
        [denoteGraphDistributedFaithful pm_goal_1 initPM 9488,
         denoteGraphDistributedFaithful pm_goal_1 initPM 9489]
        [denoteGraphDistributedFaithful pm_goal_1 initPM 9490,
         denoteGraphDistributedFaithful pm_goal_1 initPM 9491]
        64 8 (((10 : Nat) : Scalar)) := by
  refine l10OMOe_reduce7 pm_goal_1 initPM 943 l10OMOePmMoE0
    13670 9482 9484 9488 9490 9489 9491 9492
  ...
  intro s
  have hb := l10OMOe_buddies.2.1
  unfold l10OMOePmMoE0 at hb ⊢
  rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective _ _ _
    (by decide) (by decide) (by decide)]
  rw [applyNodeDistributed_moe_out pm_goal_1 s 0 13670 9482 9484 9488 9490 9492
    [64, 0, 32, 8]]
  unfold applyNodeFullExpertMoE_value
  rw [hb]
  rfl

private theorem l10OMOe_red_pm9493 (initPM : Store) :
    denoteGraphDistributedFaithful pm_goal_1 initPM 9493 =
      fw_all2all_moe_gmm_full
        ...
        [denoteGraphDistributedFaithful pm_goal_1 initPM 9490,
         denoteGraphDistributedFaithful pm_goal_1 initPM 9491]
        64 8 (((10 : Nat) : Scalar)) := by
  refine l10OMOe_reduce7 pm_goal_1 initPM 944 l10OMOePmMoE1
    13671 9483 9485 9488 9489 9490 9491 9493
    ...
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  intro s
  have hb := l10OMOe_buddies.2.2
  unfold l10OMOePmMoE1 at hb ⊢
  rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective _ _ _
    (by decide) (by decide) (by decide)]
  rw [applyNodeDistributed_moe_out pm_goal_1 s 1 13671 9483 9485 9489 9491 9493
    [64, 32, 64, 8]]
  unfold applyNodeFullExpertMoE_value
  rw [hb]
  rfl

private theorem l10OMOe_leaf (g : GraphDecl) (init : Store) (tid : Tid)
...
private theorem l10OMOe_weight_bridge (initSM initPM : Store)
...
theorem l10_ordinary_moe_expert_from_branch_inputs (initSM initPM : Store)
  ...
  have hbW13 : initSM 5516 = allGatherPrimDimN 0 2 0 [initPM 9488, initPM 9489] :=
    l10OMOe_weight_bridge initSM initPM hInit initGoal_5516 (by native_decide)
      5516 9488 9489 [32, 1024, 1024] rfl rfl rfl rfl rfl (by decide)
  have hbW2 : initSM 5517 = allGatherPrimDimN 0 2 0 [initPM 9490, initPM 9491] :=
    l10OMOe_weight_bridge initSM initPM hInit initGoal_5517 (by native_decide)
      5517 9490 9491 [32, 1024, 512] rfl rfl rfl rfl rfl (by decide)
  have hW13 : Gather2Rel
      (denoteGraphDistributedFaithful sm_goal_1 initSM 5516)
      (denoteGraphDistributedFaithful pm_goal_1 initPM 9488)
      (denoteGraphDistributedFaithful pm_goal_1 initPM 9489)
      [64, 1024, 1024] [32, 1024, 1024] := by
    rw [l10OMOe_leaf sm_goal_1 initSM 5516 (by native_decide) (by native_decide),
      l10OMOe_leaf pm_goal_1 initPM 9488 (by native_decide) (by native_decide),
      l10OMOe_leaf pm_goal_1 initPM 9489 (by native_decide) (by native_decide)]
    exact ⟨hbW13, hSM 5516 _ (by native_decide), hPM 9488 _ (by native_decide),
      hPM 9489 _ (by native_decide), by decide⟩
  have hW2 : Gather2Rel
      (denoteGraphDistributedFaithful sm_goal_1 initSM 5517)
      (denoteGraphDistributedFaithful pm_goal_1 initPM 9490)
      (denoteGraphDistributedFaithful pm_goal_1 initPM 9491)
      [64, 1024, 512] [32, 1024, 512] := by
    rw [l10OMOe_leaf sm_goal_1 initSM 5517 (by native_decide) (by native_decide),
      l10OMOe_leaf pm_goal_1 initPM 9490 (by native_decide) (by native_decide),
      l10OMOe_leaf pm_goal_1 initPM 9491 (by native_decide) (by native_decide)]
    exact ⟨hbW2, hSM 5517 _ (by native_decide), hPM 9490 _ (by native_decide),
      hPM 9491 _ (by native_decide), by decide⟩
  have hfullNode : denoteGraphDistributedFaithful sm_goal_1 initSM 5518 =
      fw_all2all_moe_gmm_full
        (denoteGraphDistributedFaithful sm_goal_1 initSM 8300)
        (denoteGraphDistributedFaithful sm_goal_1 initSM 5513)
        (denoteGraphDistributedFaithful sm_goal_1 initSM 5514)
  ...
  have houtShape : (denoteGraphDistributedFaithful sm_goal_1 initSM 5518).shape =
      [4096, 1024] := by
    rw [l10OMOe_red_sm5518 initSM]
    exact fw_all2all_moe_gmm_full_shape _ _ _ _ _ _ _ _ 4096 1024
      (by rw [hX.full_shape]; rfl) (by rw [hX.full_shape]; rfl)
  have hout0Shape : (denoteGraphDistributedFaithful pm_goal_1 initPM 9492).shape =
      [2048, 1024] := by
    rw [l10OMOe_red_pm9492 initPM]
    exact fw_all2all_moe_gmm_full_shape _ _ _ _ _ _ _ _ 2048 1024
      (by rw [hX.shard0_shape]; rfl) (by rw [hX.shard0_shape]; rfl)
  have hout1Shape : (denoteGraphDistributedFaithful pm_goal_1 initPM 9493).shape =
      [2048, 1024] := by
    rw [l10OMOe_red_pm9493 initPM]
    exact fw_all2all_moe_gmm_full_shape _ _ _ _ _ _ _ _ 2048 1024
      (by rw [hX.shard1_shape]; rfl) (by rw [hX.shard1_shape]; rfl)
  exact gather2Rel_fullExpertMoE_boundary
    (input := denoteGraphDistributedFaithful sm_goal_1 initSM 8300)
    (input0 := denoteGraphDistributedFaithful pm_goal_1 initPM 13670)
    (input1 := denoteGraphDistributedFaithful pm_goal_1 initPM 13671)
    (rp := denoteGraphDistributedFaithful sm_goal_1 initSM 5513)
    (rp0 := denoteGraphDistributedFaithful pm_goal_1 initPM 9482)
    (rp1 := denoteGraphDistributedFaithful pm_goal_1 initPM 9483)
    (rm := denoteGraphDistributedFaithful sm_goal_1 initSM 5514)
    (rm0 := denoteGraphDistributedFaithful pm_goal_1 initPM 9484)
    (rm1 := denoteGraphDistributedFaithful pm_goal_1 initPM 9485)
    (w130 := denoteGraphDistributedFaithful pm_goal_1 initPM 9488)
    (w131 := denoteGraphDistributedFaithful pm_goal_1 initPM 9489)
    (w20 := denoteGraphDistributedFaithful pm_goal_1 initPM 9490)
    (w21 := denoteGraphDistributedFaithful pm_goal_1 initPM 9491)
    (out := denoteGraphDistributedFaithful sm_goal_1 initSM 5518)
    (out0 := denoteGraphDistributedFaithful pm_goal_1 initPM 9492)
    (out1 := denoteGraphDistributedFaithful pm_goal_1 initPM 9493)
    ...
    hX hRP hRM (hPM 9488 _ (by native_decide)) (hPM 9489 _ (by native_decide))
    (hPM 9490 _ (by native_decide)) (hPM 9491 _ (by native_decide)) hfullNode
    (l10OMOe_red_pm9492 initPM) (l10OMOe_red_pm9493 initPM)
...
theorem l10_ordinary_moe_expert_from_attention_output (initSM initPM : Store)
    (hSM : StoreShapesHold initSM sm_goal_1InitEnv)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
    (hInit : InitGoalsHold pm_goal_1.numRanks goal_1_full_initGoals initSM initPM)
    ...
    Gather2Rel
      ...
      (denoteGraphDistributedFaithful pm_goal_1 initPM 9493)
      [4096, 1024] [2048, 1024] := by
  have hX := l10_ordinary_moe_activation_from_attention_output
    initSM initPM hInit hAttention
  have hRouter := l10_ordinary_moe_router_from_attention_output
    initSM initPM hPM hInit hAttention
  exact l10_ordinary_moe_expert_from_branch_inputs
    initSM initPM hSM hPM hInit hX hRouter.1 hRouter.2

#print axioms l10_ordinary_moe_expert_from_branch_inputs
#print axioms l10_ordinary_moe_expert_from_attention_output
