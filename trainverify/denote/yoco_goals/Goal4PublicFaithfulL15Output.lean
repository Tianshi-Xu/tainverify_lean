...
import denote.yoco_goals.Goal4PublicFaithfulL15Router
...
theorem goal4_l15_output_from_attention
    (initSM initPM : Store)
  ...
  exact l15_zigzag_moe_output_from_attention_output initSM initPM hSM1 hPM1 hInit1 hA15
end
