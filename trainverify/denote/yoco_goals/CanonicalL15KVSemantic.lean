/- Pure tensor-level ordinary K/V transport for canonical L15. -/
...
private theorem cL15KV_ordinary_semantic
...
theorem canonical_l15_k_ordinary_semantic
    ...
    Gather2Rel
      ...
      [4096, 4, 64] [2048, 4, 64] :=
  cL15KV_ordinary_semantic hCache hRmsW hKW hKShape

/-- Ordinary rank-order V transport, kept separate from graph alignment. -/
theorem canonical_l15_v_ordinary_semantic
    ...
    Gather2Rel
      ...
      [4096, 4, 64] [2048, 4, 64] :=
  cL15KV_ordinary_semantic hCache hRmsW hVW hVShape
