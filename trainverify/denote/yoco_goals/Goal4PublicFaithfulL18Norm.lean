...
import denote.yoco_goals.Goal4PublicFaithfulL18Attention
...
theorem goal4_l18_norm_from_attention
    (initSM initPM : Store)
  ...
  exact l18_zigzag_moe_norm_from_attention_output initSM initPM hInit1 hA18
end
