...
import denote.yoco_goals.Goal4PublicFaithfulL17Norm
...
theorem goal4_l17_router_from_norm
    (initSM initPM : Store)
  ...
  exact l17_zigzag_moe_router_all_from_norm_input initSM initPM hPM1 hInit1 hN17
end
