...
private def m3Sm7396 : NodeDecl :=
  { rank := 0, op := "OpName.FW_multiref", ins := [4683], outs := [7392, 7396, 7400],
    params := [3] }

private def m3Pm14624 : NodeDecl :=
  { rank := 0, op := "OpName.FW_multiref", ins := [4683], outs := [14620, 14624, 14628],
    params := [3] }

private def m3Pm14636 : NodeDecl :=
  { rank := 1, op := "OpName.FW_multiref", ins := [4683], outs := [14632, 14636, 14640],
    params := [3] }

set_option maxRecDepth 1000000 in
private theorem m3_sn7396 : sm.nodes[4]'(by native_decide) = m3Sm7396 := by
  native_decide

set_option maxRecDepth 1000000 in
private theorem m3_pn14624 : pm.nodes[33]'(by native_decide) = m3Pm14624 := by
  native_decide

set_option maxRecDepth 1000000 in
private theorem m3_pn14636 : pm.nodes[34]'(by native_decide) = m3Pm14636 := by
  native_decide

set_option maxRecDepth 10000000 in
set_option maxHeartbeats 16000000 in
theorem recon_intermediateGoal_7396_faithful (initSM initPM : Store)
  ...
  have hs : (denoteGraphDistributedFaithful sm initSM 4683).shape = [4096, 1024] :=
    hparent.1
  have rSM : denoteGraphDistributedFaithful sm initSM 7396 =
      denoteGraphDistributedFaithful sm initSM 4683 := by
    refine denoteGraphDistributedFaithful_reduce1 sm initSM 4 m3Sm7396 4683 7396
      (fun x => x) (by native_decide) m3_sn7396 ?_
    ...
    rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective _ _ _
      (by decide) (by decide)]
    exact applyNode_fw_multiref_at sm st 0 4683 [7392, 7396, 7400] 3 rfl 7396 (by decide)
  have rPM0 : denoteGraphDistributedFaithful pm initPM 14624 =
      denoteGraphDistributedFaithful pm initPM 4683 := by
    refine denoteGraphDistributedFaithful_reduce1 pm initPM 33 m3Pm14624 4683 14624
      (fun x => x) (by native_decide) m3_pn14624 ?_
  ...
  have rPM1 : denoteGraphDistributedFaithful pm initPM 14636 =
      denoteGraphDistributedFaithful pm initPM 4683 := by
    refine denoteGraphDistributedFaithful_reduce1 pm initPM 34 m3Pm14636 4683 14636
      (fun x => x) (by native_decide) m3_pn14636 ?_
      (fun n hn => layer1_pm_nodes_nonempty n (List.mem_of_mem_drop hn)) (by native_decide)
      (fun n hn => layer1_pm_nodes_nonempty n (List.mem_of_mem_drop hn)) (by native_decide)
    intro st
    unfold m3Pm14636
  ...
  simp only [intermediateGoal_7396, List.map]
