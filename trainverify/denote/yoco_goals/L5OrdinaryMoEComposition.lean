/- L5 ordinary MoE composition from attention residual to block output. -/
import denote.yoco_goals.L5OrdinaryMoEBoundary
import denote.yoco_goals.L5OrdinaryMoEExpert
...
theorem l5_ordinary_moe_composition (initSM initPM : Store)
