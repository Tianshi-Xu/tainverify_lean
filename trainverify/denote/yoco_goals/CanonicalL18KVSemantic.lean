/- Pure tensor-level ordinary K/V transport for canonical L18. -/
...
private theorem cL18KV_ordinary_semantic
...
theorem canonical_l18_k_ordinary_semantic
    ...
    Gather2Rel
      ...
      [4096, 4, 64] [2048, 4, 64] :=
  cL18KV_ordinary_semantic hCache hRmsW hKW hKShape

/-- Ordinary rank-order V transport, kept separate from graph alignment. -/
theorem canonical_l18_v_ordinary_semantic
    ...
    Gather2Rel
      ...
      [4096, 4, 64] [2048, 4, 64] :=
  cL18KV_ordinary_semantic hCache hRmsW hVW hVShape
