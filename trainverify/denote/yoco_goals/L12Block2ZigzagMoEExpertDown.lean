...
private theorem l12B2ZMed_reduce5
...
private theorem l12B2ZMed_reduce7
    (g : GraphDecl) (init : Store) (k : Nat) (node : NodeDecl)
...
private def l12B2ZMedSmMoE : NodeDecl :=
  { rank := 0, op := "OpName.FW_all2all_moe_gmm",
    ins := [8562, 5680, 5681, 5683, 5684], outs := [5685],
    params := [64, 0, 64, 8] }
private def l12B2ZMedPmMoE0 : NodeDecl :=
  { rank := 0, op := "OpName.FW_all2all_moe_gmm",
    ins := [14048, 9982, 9984, 9988, 9990], outs := [9992],
    params := [64, 0, 32, 8] }
private def l12B2ZMedPmMoE1 : NodeDecl :=
  { rank := 1, op := "OpName.FW_all2all_moe_gmm",
    ins := [14049, 9983, 9985, 9989, 9991], outs := [9993],
    params := [64, 32, 64, 8] }

private theorem l12B2ZMed_buddies :
    sm_goal_1.replicaBuddies l12B2ZMedSmMoE = [l12B2ZMedSmMoE] ∧
    pm_goal_1.replicaBuddies l12B2ZMedPmMoE0 = [l12B2ZMedPmMoE0, l12B2ZMedPmMoE1] ∧
    pm_goal_1.replicaBuddies l12B2ZMedPmMoE1 = [l12B2ZMedPmMoE0, l12B2ZMedPmMoE1] := by
  native_decide

private theorem l12B2ZMed_red_sm5685 (initSM : Store) :
    denoteGraphDistributedFaithful sm_goal_1 initSM 5685 =
      fw_all2all_moe_gmm_full
        ...
        [denoteGraphDistributedFaithful sm_goal_1 initSM 5683]
        [denoteGraphDistributedFaithful sm_goal_1 initSM 5684]
        64 8 (((10 : Nat) : Scalar)) := by
  refine l12B2ZMed_reduce5 sm_goal_1 initSM 562 l12B2ZMedSmMoE
    8562 5680 5681 5683 5684 5685
  ...
  intro s
  have hb := l12B2ZMed_buddies.1
  unfold l12B2ZMedSmMoE at hb ⊢
  rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective _ _ _
    (by decide) (by decide) (by decide)]
  rw [applyNodeDistributed_moe_out sm_goal_1 s 0 8562 5680 5681 5683 5684 5685
    [64, 0, 64, 8]]
  unfold applyNodeFullExpertMoE_value
  rw [hb]
  rfl

private theorem l12B2ZMed_red_pm9992 (initPM : Store) :
    denoteGraphDistributedFaithful pm_goal_1 initPM 9992 =
      fw_all2all_moe_gmm_full
        ...
        [denoteGraphDistributedFaithful pm_goal_1 initPM 9988,
         denoteGraphDistributedFaithful pm_goal_1 initPM 9989]
        [denoteGraphDistributedFaithful pm_goal_1 initPM 9990,
         denoteGraphDistributedFaithful pm_goal_1 initPM 9991]
        64 8 (((10 : Nat) : Scalar)) := by
  refine l12B2ZMed_reduce7 pm_goal_1 initPM 1243 l12B2ZMedPmMoE0
    14048 9982 9984 9988 9990 9989 9991 9992
  ...
  intro s
  have hb := l12B2ZMed_buddies.2.1
  unfold l12B2ZMedPmMoE0 at hb ⊢
  rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective _ _ _
    (by decide) (by decide) (by decide)]
  rw [applyNodeDistributed_moe_out pm_goal_1 s 0 14048 9982 9984 9988 9990
    9992 [64, 0, 32, 8]]
  unfold applyNodeFullExpertMoE_value
  rw [hb]
  rfl

private theorem l12B2ZMed_red_pm9993 (initPM : Store) :
    denoteGraphDistributedFaithful pm_goal_1 initPM 9993 =
      fw_all2all_moe_gmm_full
        ...
        [denoteGraphDistributedFaithful pm_goal_1 initPM 9990,
         denoteGraphDistributedFaithful pm_goal_1 initPM 9991]
        64 8 (((10 : Nat) : Scalar)) := by
  refine l12B2ZMed_reduce7 pm_goal_1 initPM 1244 l12B2ZMedPmMoE1
    14049 9983 9985 9988 9989 9990 9991 9993
    ...
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  intro s
  have hb := l12B2ZMed_buddies.2.2
  unfold l12B2ZMedPmMoE1 at hb ⊢
  rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective _ _ _
    (by decide) (by decide) (by decide)]
  rw [applyNodeDistributed_moe_out pm_goal_1 s 1 14049 9983 9985 9989 9991
    9993 [64, 32, 64, 8]]
  unfold applyNodeFullExpertMoE_value
  rw [hb]
  rfl

private theorem l12B2ZMed_leaf (g : GraphDecl) (init : Store) (tid : Tid)
...
private theorem l12B2ZMed_weight_bridge (initSM initPM : Store)
...
private theorem l12B2ZMed_hdec {full z0 z1 : Tensor} {k : Nat} (initPM : Store)
  ...
  have hleaf : denoteGraphDistributedFaithful pm_goal_1 initPM 6252 = initPM 6252 :=
    l12B2ZMed_leaf pm_goal_1 initPM 6252 (by native_decide) (by native_decide)
...
theorem l12b2_zigzag_moe_expert_from_branch_inputs (initSM initPM : Store)
  ...
  have hdec := l12B2ZMed_hdec initPM hPM hX
  obtain ⟨x0, x1, hxs⟩ := hX
  ...
  have hbW13 : initSM 5683 = allGatherPrimDimN 0 2 0 [initPM 9988, initPM 9989] :=
    l12B2ZMed_weight_bridge initSM initPM hInit initGoal_5683 (by native_decide)
      5683 9988 9989 [32, 1024, 1024] rfl rfl rfl rfl rfl (by decide)
  have hbW2 : initSM 5684 = allGatherPrimDimN 0 2 0 [initPM 9990, initPM 9991] :=
    l12B2ZMed_weight_bridge initSM initPM hInit initGoal_5684 (by native_decide)
      5684 9990 9991 [32, 1024, 512] rfl rfl rfl rfl rfl (by decide)
  have hw13shape : (initSM 5683).shape = [64, 1024, 1024] :=
    hSM 5683 [64, 1024, 1024] (by native_decide)
  have hw2shape : (initSM 5684).shape = [64, 1024, 512] :=
    hSM 5684 [64, 1024, 512] (by native_decide)
  rw [l12B2ZMed_red_sm5685 initSM, l12B2ZMed_red_pm9992 initPM,
    l12B2ZMed_red_pm9993 initPM]
  rw [l12B2ZMed_leaf sm_goal_1 initSM 5683 (by native_decide) (by native_decide),
    l12B2ZMed_leaf sm_goal_1 initSM 5684 (by native_decide) (by native_decide),
    l12B2ZMed_leaf pm_goal_1 initPM 9988 (by native_decide) (by native_decide),
    l12B2ZMed_leaf pm_goal_1 initPM 9989 (by native_decide) (by native_decide),
    l12B2ZMed_leaf pm_goal_1 initPM 9990 (by native_decide) (by native_decide),
    l12B2ZMed_leaf pm_goal_1 initPM 9991 (by native_decide) (by native_decide)]
  unfold fw_all2all_moe_gmm_full
  simp only [List.length_cons, List.length_nil]
  rw [allGatherPrimDimN_singleton_eq 0 (initSM 5683) (by rw [hw13shape]; decide),
    allGatherPrimDimN_singleton_eq 0 (initSM 5684) (by rw [hw2shape]; decide)]
  rw [hbW13, hbW2]
  exact Zigzag2Rel.all2all_moe_gmm
    (allGatherPrimDimN 0 2 0 [initPM 9988, initPM 9989])
    (allGatherPrimDimN 0 2 0 [initPM 9990, initPM 9991])
...
theorem l12b2_zigzag_moe_expert_from_attention_output (initSM initPM : Store)
    (hSM : StoreShapesHold initSM sm_goal_1InitEnv)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
    (hInit : InitGoalsHold pm_goal_1.numRanks goal_1_full_initGoals initSM initPM)
    ...
    Zigzag2Rel
      ...
      (denoteGraphDistributedFaithful pm_goal_1 initPM 6252)
      [4096, 1024] [2048, 1024] := by
  have hX := l12b2_zigzag_moe_activation_from_attention_output initSM initPM hInit hAttention
  have hRouter :=
    l12b2_zigzag_moe_router_from_attention_output initSM initPM hPM hInit hAttention
  exact l12b2_zigzag_moe_expert_from_branch_inputs initSM initPM hSM hPM hInit
    hX hRouter.1 hRouter.2

#print axioms l12b2_zigzag_moe_expert_from_attention_output
