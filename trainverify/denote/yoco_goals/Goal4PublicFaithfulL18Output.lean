...
import denote.yoco_goals.Goal4PublicFaithfulL18Router
...
theorem goal4_l18_output_from_attention
    (initSM initPM : Store)
  ...
  exact l18_zigzag_moe_output_from_attention_output initSM initPM hSM1 hPM1 hInit1 hA18
end
