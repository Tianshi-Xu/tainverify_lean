...
theorem l7_ordinary_moe_norm_from_attention_output (initSM initPM : Store)
  ...
  · rw [l7OMon_red_sm5344 initSM, l7OMon_red_pm8980 initPM,
      l7OMon_red_pm8981 initPM, hRef.value, hw,
      ordinary_fw_rms_norm_allGather0_commute_2 _ _ _ 2048 1024
        (by omega) (by omega) hRef.shard0_shape hRef.shard1_shape]
  · rw [l7OMon_red_sm5344 initSM]
    exact ordinary_fw_rms_norm_shape2 _ _ 4096 1024
      (by rw [l7OMon_red_sm8129 initSM]; exact hRef.full_shape)
  · rw [l7OMon_red_pm8980 initPM]
    exact ordinary_fw_rms_norm_shape2 _ _ 2048 1024
      (by rw [l7OMon_red_pm15678 initPM]; exact hRef.shard0_shape)
  · rw [l7OMon_red_pm8981 initPM]
    exact ordinary_fw_rms_norm_shape2 _ _ 2048 1024
      (by rw [l7OMon_red_pm15686 initPM]; exact hRef.shard1_shape)
