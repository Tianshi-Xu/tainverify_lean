...
theorem l12_ordinary_moe_router_from_norm_input (initSM initPM : Store)
    ...
    Gather2Rel
      ...
      [4096, 64] [2048, 64] := by
  have hwEq := l12OMr_weight_eq initSM initPM hInit
  have hwShape := l12OMr_weight_shape initPM hPM
  ...
  have hLogits : Gather2Rel
      ...
      [4096, 64] [2048, 64] := by
    rw [l12OMr_red_sm5625 initSM, l12OMr_red_sm5623 initSM,
      l12OMr_red_sm8519 initSM, hwEq,
      l12OMr_red_pm9826 initPM, l12OMr_red_pm9827 initPM,
      l12OMr_red_pm5625 initPM, l12OMr_red_pm5623 initPM,
      l12OMr_red_pm12114 initPM, l12OMr_red_pm15388 initPM,
      l12OMr_red_pm15390 initPM,
      ...
      l12OMr_chunk_gather0 _ _ hp0Shape hp1Shape,
      l12OMr_chunk_gather1 _ _ hp0Shape hp1Shape]
    exact hLocal
  ...
  rw [l12OMr_red_sm5626 initSM hLogits.full_shape,
    l12OMr_red_pm9828 initPM hLogits.shard0_shape,
    l12OMr_red_pm9829 initPM hLogits.shard1_shape,
    l12OMr_red_sm5627 initSM hLogits.full_shape,
    l12OMr_red_pm9830 initPM hLogits.shard0_shape,
    l12OMr_red_pm9831 initPM hLogits.shard1_shape]
  exact ⟨hProbs, hMap⟩

/-- The real scalar-gate branch preserves ordinary dim-0 layout. -/
theorem l12_ordinary_moe_gate_from_norm_input (initSM initPM : Store)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
    (hInit : InitGoalsHold pm_goal_1.numRanks initGoals initSM initPM)
    (hNorm : Gather2Rel
      (denoteGraphDistributedFaithful sm_goal_1 initSM 5622)
  ...
  have hSource : Gather2Rel
    ...
    rw [l12OMrg_red_sm8527 initSM, l12OMrg_red_pm13942 initPM,
      l12OMrg_red_pm13943 initPM]
    exact hNorm
  have hReshape : Gather2Rel
      ...
      [4096, 1024] [2048, 1024] := by
    rw [l12OMrg_red_sm5632 initSM, l12OMrg_red_pm9840 initPM,
      l12OMrg_red_pm9841 initPM]
    exact Gather2Rel.view_id hSource
  have hwEq := l12OMrg_weight_eq initSM initPM hInit
  have hwShape := l12OMrg_weight_shape initPM hPM
  have hLinear : Gather2Rel
      ...
      [4096, 1] [2048, 1] := by
    rw [l12OMrg_red_sm5634 initSM, l12OMrg_red_pm9844 initPM,
      l12OMrg_red_pm9845 initPM, hwEq]
  ...
  have hView : Gather2Rel
      ...
      [4096, 1] [2048, 1] := by
    rw [l12OMrg_red_sm5635 initSM, l12OMrg_red_pm9846 initPM,
      l12OMrg_red_pm9847 initPM]
    exact Gather2Rel.view_id hLinear
  rw [l12OMrg_red_sm5636 initSM, l12OMrg_red_pm9848 initPM,
    l12OMrg_red_pm9849 initPM]
...
theorem l12_ordinary_moe_router_from_attention_output (initSM initPM : Store)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
  ...
  exact l12_ordinary_moe_router_from_norm_input initSM initPM hPM hInit hNorm

/-- The ordinary scalar gate is closed directly from attention output. -/
theorem l12_ordinary_moe_gate_from_attention_output (initSM initPM : Store)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
    (hInit : InitGoalsHold pm_goal_1.numRanks goal_1_full_initGoals initSM initPM)
    (hAttention : Gather2Rel
      (denoteGraphDistributedFaithful sm_goal_1 initSM 5620)
  ...
  have hNorm := l12_ordinary_moe_norm_from_attention_output
    initSM initPM hInit hAttention
  exact l12_ordinary_moe_gate_from_norm_input initSM initPM hPM hInit hNorm

#print axioms l12_ordinary_moe_router_from_norm_input
#print axioms l12_ordinary_moe_gate_from_norm_input
#print axioms l12_ordinary_moe_router_from_attention_output
#print axioms l12_ordinary_moe_gate_from_attention_output
