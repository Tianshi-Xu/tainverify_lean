/- L7 ordinary MoE composition from attention residual to block output. -/
import denote.yoco_goals.L7OrdinaryMoEBoundary
import denote.yoco_goals.L7OrdinaryMoEExpert
...
theorem l7_ordinary_moe_composition (initSM initPM : Store)
