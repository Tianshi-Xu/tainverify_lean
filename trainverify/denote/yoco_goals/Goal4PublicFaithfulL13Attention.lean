...
import denote.yoco_goals.Goal4PublicFaithfulL12BlocksCheckpoint
...
structure Goal4L13Checkpoint (initSM initPM : Store) : Prop where
  base : Goal4L12BlocksCheckpoint initSM initPM
  output13 : Zigzag2Rel (denoteGraphDistributedFaithful sm_goal_1 initSM 5815)
...
theorem goal4_l13_attention_from_l12_blocks
    (initSM initPM : Store)
    ...
    (mid : Goal4L12BlocksCheckpoint initSM initPM) :
    Zigzag2Rel
  ...
  have hIncoming : Zigzag2Rel
      ...
      (denoteGraphDistributedFaithful pm_goal_1 initPM 6252)
      [4096, 1024] [2048, 1024] := mid.output12b3
  have hCache : Gather2Rel
      ...
      [4096, 1024] [2048, 1024] := mid.base.base.cache
  have hCu4 : denoteGraphDistributedFaithful pm_goal_4 initPM 5772 = initPM 5772 := by
  ...
  have hCu1 : denoteGraphDistributedFaithful pm_goal_1 initPM 5772 = initPM 5772 := by
    unfold denoteGraphDistributedFaithful
    exact foldl_applyNodeDistributedFaithful_at_not_written pm_goal_1 pm_goal_1.nodes
      initPM 5772 (by native_decide) (by native_decide)
  have hAlias4 : denoteGraphDistributedFaithful pm_goal_4 initPM 5772 =
      denoteGraphDistributedFaithful pm_goal_1 initPM 6252 :=
    goal4_canonical_cu_alias initPM hClasses 5772 (by decide)
  have hAlias : denoteGraphDistributedFaithful pm_goal_1 initPM 5772 =
      denoteGraphDistributedFaithful pm_goal_1 initPM 6252 := by
    rw [hCu1, ← hCu4]
    exact hAlias4
  exact canonical_l13_attention_residual_from_incoming_and_cache initSM initPM hPM1 hInit1
