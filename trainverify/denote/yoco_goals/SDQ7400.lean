...
private def m3Sm7400 : NodeDecl :=
  { rank := 0, op := "OpName.FW_multiref", ins := [4683], outs := [7392, 7396, 7400],
    params := [3] }

private def m3Pm14628 : NodeDecl :=
  { rank := 0, op := "OpName.FW_multiref", ins := [4683], outs := [14620, 14624, 14628],
    params := [3] }

private def m3Pm14640 : NodeDecl :=
  { rank := 1, op := "OpName.FW_multiref", ins := [4683], outs := [14632, 14636, 14640],
    params := [3] }

set_option maxRecDepth 1000000 in
private theorem m3_sn7400 : sm.nodes[4]'(by native_decide) = m3Sm7400 := by
  native_decide

set_option maxRecDepth 1000000 in
private theorem m3_pn14628 : pm.nodes[33]'(by native_decide) = m3Pm14628 := by
  native_decide

set_option maxRecDepth 1000000 in
private theorem m3_pn14640 : pm.nodes[34]'(by native_decide) = m3Pm14640 := by
  native_decide

set_option maxRecDepth 10000000 in
set_option maxHeartbeats 16000000 in
theorem recon_intermediateGoal_7400_faithful (initSM initPM : Store)
  ...
  have hs : (denoteGraphDistributedFaithful sm initSM 4683).shape = [4096, 1024] :=
    hparent.1
  have rSM : denoteGraphDistributedFaithful sm initSM 7400 =
      denoteGraphDistributedFaithful sm initSM 4683 := by
    refine denoteGraphDistributedFaithful_reduce1 sm initSM 4 m3Sm7400 4683 7400
      (fun x => x) (by native_decide) m3_sn7400 ?_
    ...
    rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective _ _ _
      (by decide) (by decide)]
    exact applyNode_fw_multiref_at sm st 0 4683 [7392, 7396, 7400] 3 rfl 7400 (by decide)
  have rPM0 : denoteGraphDistributedFaithful pm initPM 14628 =
      denoteGraphDistributedFaithful pm initPM 4683 := by
    refine denoteGraphDistributedFaithful_reduce1 pm initPM 33 m3Pm14628 4683 14628
      (fun x => x) (by native_decide) m3_pn14628 ?_
  ...
  have rPM1 : denoteGraphDistributedFaithful pm initPM 14640 =
      denoteGraphDistributedFaithful pm initPM 4683 := by
    refine denoteGraphDistributedFaithful_reduce1 pm initPM 34 m3Pm14640 4683 14640
      (fun x => x) (by native_decide) m3_pn14640 ?_
      (fun n hn => layer1_pm_nodes_nonempty n (List.mem_of_mem_drop hn)) (by native_decide)
      (fun n hn => layer1_pm_nodes_nonempty n (List.mem_of_mem_drop hn)) (by native_decide)
    intro st
    unfold m3Pm14640
  ...
  simp only [intermediateGoal_7400, List.map]
