/- Goal 4 faithful checkpoint through layer 20. -/
import denote.yoco_goals.Goal4PublicFaithfulL19Checkpoint
...
structure Goal4L20Checkpoint (initSM initPM : Store) : Prop where
  base : Goal4L19Checkpoint initSM initPM
  output20 : Zigzag2Rel (denoteGraphDistributedFaithful sm_goal_1 initSM 6160)
...
theorem goal4_l20_checkpoint_from_l19 (initSM initPM : Store)
    ...
    (mid : Goal4L19Checkpoint initSM initPM) : Goal4L20Checkpoint initSM initPM := by
  have hIncoming : Zigzag2Rel
      ...
      [4096, 1024] [2048, 1024] := mid.output19
  have hCache : Gather2Rel
      ...
      [4096, 1024] [2048, 1024] := mid.base.base.base.base.base.base.base.base.base.cache
  have hCu4 : denoteGraphDistributedFaithful pm_goal_4 initPM 6150 = initPM 6150 := by
  ...
  have hCu1 : denoteGraphDistributedFaithful pm_goal_1 initPM 6150 = initPM 6150 := by
    unfold denoteGraphDistributedFaithful
    exact foldl_applyNodeDistributedFaithful_at_not_written pm_goal_1 pm_goal_1.nodes
      initPM 6150 (by native_decide) (by native_decide)
  have hAlias4 : denoteGraphDistributedFaithful pm_goal_4 initPM 6150 =
      denoteGraphDistributedFaithful pm_goal_1 initPM 6252 :=
    goal4_canonical_cu_alias initPM hClasses 6150 (by decide)
  have hAlias : denoteGraphDistributedFaithful pm_goal_1 initPM 6150 =
      denoteGraphDistributedFaithful pm_goal_1 initPM 6252 := by
    rw [hCu1, ← hCu4]
    exact hAlias4
  have hO20 := canonical_l20_output_from_l19_and_cache initSM initPM hPM1 hInit1
    hIncoming hCache hAlias hDec
  exact { base := mid, output20 := hO20 }
theorem goal4_l20_checkpoint_of_external (initSM initPM : Store)
    ...
    (hContract : Goal4ExternalInputContract initSM initPM) : Goal4L20Checkpoint initSM initPM := by
  ...
  exact goal4_l20_checkpoint_from_l19 initSM initPM hPM1 hInit1 hContract.2.1 hDec
    (goal4_l19_checkpoint_of_external initSM initPM hSM hPM hInit hContract)
end
