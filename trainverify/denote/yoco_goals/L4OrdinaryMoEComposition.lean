/- L4 ordinary MoE composition from attention residual to block output. -/
import denote.yoco_goals.L4OrdinaryMoEBoundary
import denote.yoco_goals.L4OrdinaryMoEExpert
...
theorem l4_ordinary_moe_composition (initSM initPM : Store)
