...
Pattern proof obligations for all_goals_stmt:
  - Pattern_1.lean: prove_pattern_1  -- instances=1, ops/instance: SM=27, PM=57, ops=[OpName.FW_pyfunc, OpName.FW_multiref, OpName.FW_reshape, OpName.FW_mix_precision_linear, OpName.FW_topk_routing, OpName.FW_view, OpName.FW_all2all_moe_gmm, OpName.FW_sigmoid, ...]; concrete goals: 1
  ...
  - Pattern_3.lean: prove_pattern_3  -- instances=1, ops/instance: SM=965, PM=1991, ops=[OpName.FW_pyfunc, OpName.FW_embedding, OpName.FW_float, OpName.FW_multiref, OpName.FW_rms_norm, OpName.FW_per_head_mix_precision_linear, OpName.FW_rotary_embedding, OpName.FW_attn_sliding_window, ...]; concrete goals: 3
  ...
  - Pattern_5.lean: prove_pattern_5  -- instances=1, ops/instance: SM=1, PM=2, ops=[OpName.FW_pyfunc]; concrete goals: 5
-/
