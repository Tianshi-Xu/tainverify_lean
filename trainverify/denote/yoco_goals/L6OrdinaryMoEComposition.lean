/- L6 ordinary MoE composition from attention residual to block output. -/
import denote.yoco_goals.L6OrdinaryMoEBoundary
import denote.yoco_goals.L6OrdinaryMoEExpert
...
theorem l6_ordinary_moe_composition (initSM initPM : Store)
