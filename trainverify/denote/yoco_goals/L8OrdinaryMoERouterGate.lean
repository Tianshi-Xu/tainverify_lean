...
theorem l8_ordinary_moe_logits_from_norm_input (initSM initPM : Store)
    ...
    Gather2Rel
      ...
      [4096, 64] [2048, 64] := by
  have hwEq := l8OMr_weight_eq initSM initPM hInit
  have hwShape := l8OMr_weight_shape initPM hPM
  ...
  rw [l8OMr_red_sm5402 initSM, l8OMr_red_sm5400 initSM,
    l8OMr_red_sm8192 initSM, hwEq,
    l8OMr_red_pm9152 initPM, l8OMr_red_pm9153 initPM,
    l8OMr_red_pm5402 initPM, l8OMr_red_pm5400 initPM,
    l8OMr_red_pm11998 initPM, l8OMr_red_pm15360 initPM,
    l8OMr_red_pm15362 initPM,
    ...
    l8OMr_chunk_gather0 _ _ hp0Shape hp1Shape,
    l8OMr_chunk_gather1 _ _ hp0Shape hp1Shape]
  exact hLocal
...
theorem l8_ordinary_moe_router_from_norm_input (initSM initPM : Store)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
    (hInit : InitGoalsHold pm_goal_1.numRanks initGoals initSM initPM)
    (hNorm : Gather2Rel
      (denoteGraphDistributedFaithful sm_goal_1 initSM 5399)
    ...
    Gather2Rel
      ...
      [4096, 64] [2048, 64] := by
  have hLogits := l8_ordinary_moe_logits_from_norm_input initSM initPM hPM hInit hNorm
  ...
  rw [l8OMr_red_sm5403 initSM hLogits.full_shape,
    l8OMr_red_pm9154 initPM hLogits.shard0_shape,
    l8OMr_red_pm9155 initPM hLogits.shard1_shape,
    l8OMr_red_sm5404 initSM hLogits.full_shape,
    l8OMr_red_pm9156 initPM hLogits.shard0_shape,
    l8OMr_red_pm9157 initPM hLogits.shard1_shape]
  exact ⟨hProbs, hMap⟩

/-- The real scalar-gate branch preserves ordinary dim-0 layout. -/
theorem l8_ordinary_moe_gate_from_norm_input (initSM initPM : Store)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
    (hInit : InitGoalsHold pm_goal_1.numRanks initGoals initSM initPM)
    (hNorm : Gather2Rel
      (denoteGraphDistributedFaithful sm_goal_1 initSM 5399)
  ...
  have hSource : Gather2Rel
    ...
    rw [l8OMrg_red_sm8200 initSM, l8OMrg_red_pm13428 initPM,
      l8OMrg_red_pm13429 initPM]
    exact hNorm
  have hReshape : Gather2Rel
      ...
      [4096, 1024] [2048, 1024] := by
    rw [l8OMrg_red_sm5409 initSM, l8OMrg_red_pm9166 initPM,
      l8OMrg_red_pm9167 initPM]
    exact Gather2Rel.view_id hSource
  have hwEq := l8OMrg_weight_eq initSM initPM hInit
  have hwShape := l8OMrg_weight_shape initPM hPM
  have hLinear : Gather2Rel
      ...
      [4096, 1] [2048, 1] := by
    rw [l8OMrg_red_sm5411 initSM, l8OMrg_red_pm9170 initPM,
      l8OMrg_red_pm9171 initPM, hwEq]
  ...
  have hView : Gather2Rel
      ...
      [4096, 1] [2048, 1] := by
    rw [l8OMrg_red_sm5412 initSM, l8OMrg_red_pm9172 initPM,
      l8OMrg_red_pm9173 initPM]
    exact Gather2Rel.view_id hLinear
  rw [l8OMrg_red_sm5413 initSM, l8OMrg_red_pm9174 initPM,
    l8OMrg_red_pm9175 initPM]
...
theorem l8_ordinary_moe_router_from_attention_output (initSM initPM : Store)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
  ...
  exact l8_ordinary_moe_router_from_norm_input initSM initPM hPM hInit hNorm

/-- The ordinary scalar gate is closed directly from attention output. -/
theorem l8_ordinary_moe_gate_from_attention_output (initSM initPM : Store)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
    (hInit : InitGoalsHold pm_goal_1.numRanks goal_1_full_initGoals initSM initPM)
    (hAttention : Gather2Rel
      (denoteGraphDistributedFaithful sm_goal_1 initSM 5397)
  ...
  have hNorm := l8_ordinary_moe_norm_from_attention_output
    initSM initPM hInit hAttention
  exact l8_ordinary_moe_gate_from_norm_input initSM initPM hPM hInit hNorm

#print axioms l8_ordinary_moe_router_from_norm_input
#print axioms l8_ordinary_moe_gate_from_norm_input
#print axioms l8_ordinary_moe_router_from_attention_output
#print axioms l8_ordinary_moe_gate_from_attention_output
