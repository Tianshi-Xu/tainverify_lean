...
import denote.yoco_goals.Goal4PublicFaithfulL14Score
...
theorem goal4_l14_checkpoint_from_l13
    (initSM initPM : Store)
    ...
    (mid : Goal4L13Checkpoint initSM initPM) : Goal4L14Checkpoint initSM initPM := by
  have hA14 := goal4_l14_attention_from_l13 initSM initPM hPM1 hInit1 hClasses hDec mid
  have hN14 := goal4_l14_norm_from_attention initSM initPM hInit1 hA14
  have hAll14 := goal4_l14_router_from_norm initSM initPM hPM1 hInit1 hN14
  have hO14 := goal4_l14_output_from_attention initSM initPM hSM1 hPM1 hInit1 hA14
  have hScore14 := goal4_l14_score_from_router initSM initPM hDec hAll14
  refine { base := mid, output14 := hO14, l16 := ?_ }
  exact zigzag_transport hScore14
      (goal4_late_sm_to_goal1 initSM 5844 (by decide))
      (goal4_late_pm_to_goal1 initPM 10448 (by decide))
      (goal4_late_pm_to_goal1 initPM 10449 (by decide))
      (goal4_canonical_cu_alias initPM hClasses 5872 (by decide))

theorem goal4_l14_checkpoint_of_external
    (initSM initPM : Store)
    ...
    (hContract : Goal4ExternalInputContract initSM initPM) : Goal4L14Checkpoint initSM initPM := by
  ...
  exact goal4_l14_checkpoint_from_l13 initSM initPM hSM1 hPM1 hInit1 hContract.2.1 hDec
    (goal4_l13_checkpoint_of_external initSM initPM hSM hPM hInit hContract)
end
