...
import denote.yoco_goals.Goal4PublicFaithfulL13Router
...
theorem goal4_l13_output_from_attention
    (initSM initPM : Store)
  ...
  exact l13_zigzag_moe_output_from_attention_output initSM initPM hSM1 hPM1 hInit1 hA13
end
