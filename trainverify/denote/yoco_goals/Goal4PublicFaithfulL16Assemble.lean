...
import denote.yoco_goals.Goal4PublicFaithfulL16Score
...
theorem goal4_l16_checkpoint_from_l15
    (initSM initPM : Store)
    ...
    (mid : Goal4L15Checkpoint initSM initPM) : Goal4L16Checkpoint initSM initPM := by
  have hA16 := goal4_l16_attention_from_l15 initSM initPM hPM1 hInit1 hClasses hDec mid
  have hN16 := goal4_l16_norm_from_attention initSM initPM hInit1 hA16
  have hAll16 := goal4_l16_router_from_norm initSM initPM hPM1 hInit1 hN16
  have hO16 := goal4_l16_output_from_attention initSM initPM hSM1 hPM1 hInit1 hA16
  have hScore16 := goal4_l16_score_from_router initSM initPM hDec hAll16
  refine { base := mid, output16 := hO16, l18 := ?_ }
  exact zigzag_transport hScore16
      (goal4_late_sm_to_goal1 initSM 5952 (by decide))
      (goal4_late_pm_to_goal1 initPM 10756 (by decide))
      (goal4_late_pm_to_goal1 initPM 10757 (by decide))
      (goal4_canonical_cu_alias initPM hClasses 5980 (by decide))

theorem goal4_l16_checkpoint_of_external
    (initSM initPM : Store)
    ...
    (hContract : Goal4ExternalInputContract initSM initPM) : Goal4L16Checkpoint initSM initPM := by
  ...
  exact goal4_l16_checkpoint_from_l15 initSM initPM hSM1 hPM1 hInit1 hContract.2.1 hDec
    (goal4_l15_checkpoint_of_external initSM initPM hSM hPM hInit hContract)
end
