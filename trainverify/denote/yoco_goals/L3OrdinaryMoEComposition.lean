/- L3 ordinary MoE composition from attention residual to block output. -/
import denote.yoco_goals.L3OrdinaryMoEBoundary
import denote.yoco_goals.L3OrdinaryMoEExpert
...
theorem l3_ordinary_moe_composition (initSM initPM : Store)
