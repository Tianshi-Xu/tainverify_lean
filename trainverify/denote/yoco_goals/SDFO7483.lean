...
private def f1Sm7483 : NodeDecl :=
  { rank := 0, op := "OpName.FW_multiref", ins := [4759], outs := [7467, 7471, 7475, 7479, 7483],
    params := [5] }

private def f1Pm11907 : NodeDecl :=
  { rank := 1, op := "OpName.FW_multiref", ins := [4759], outs := [11903, 11904, 11905, 11906, 11907],
    params := [5] }

set_option maxRecDepth 1000000 in
private theorem f1_sn7483 : sm.nodes[57]'(by native_decide) = f1Sm7483 := by
  native_decide

set_option maxRecDepth 1000000 in
private theorem f1_pn11907 : pm.nodes[166]'(by native_decide) = f1Pm11907 := by
  native_decide

set_option maxRecDepth 10000000 in
set_option maxHeartbeats 16000000 in
theorem recon_intermediateGoal_7483_faithful (initSM initPM : Store)
  ...
  have rSM : denoteGraphDistributedFaithful sm initSM 7483 =
      denoteGraphDistributedFaithful sm initSM 4759 := by
    refine denoteGraphDistributedFaithful_reduce1 sm initSM 57 f1Sm7483 4759 7483
      (fun x => x) (by native_decide) f1_sn7483 ?_
    ...
    rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective _ _ _
      (by decide) (by decide)]
    exact applyNode_fw_multiref_at sm st 0 4759 [7467, 7471, 7475, 7479, 7483] 5 rfl 7483 (by decide)
  -- Both PM ranks write `11907`; anchor on the last writer.
  have rPM : denoteGraphDistributedFaithful pm initPM 11907 =
      denoteGraphDistributedFaithful pm initPM 4759 := by
    refine denoteGraphDistributedFaithful_reduce1 pm initPM 166 f1Pm11907 4759 11907
      (fun x => x) (by native_decide) f1_pn11907 ?_
    ...
    rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective _ _ _
      (by decide) (by decide)]
    exact applyNode_fw_multiref_at pm st 1 4759 [11903, 11904, 11905, 11906, 11907] 5 rfl 11907 (by decide)
  have hval : denoteGraphDistributedFaithful sm initSM 7483 =
      denoteGraphDistributedFaithful pm initPM 11907 := by
    rw [rSM, rPM, hv]
  have hshape : (denoteGraphDistributedFaithful sm initSM 7483).shape = [4096, 1024] := by
    rw [rSM]; exact hs
  ...
  simp only [intermediateGoal_7483, List.map]
