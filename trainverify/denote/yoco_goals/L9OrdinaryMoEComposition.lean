/- L9 ordinary MoE composition from attention residual to block output. -/
import denote.yoco_goals.L9OrdinaryMoEBoundary
import denote.yoco_goals.L9OrdinaryMoEExpert
...
theorem l9_ordinary_moe_composition (initSM initPM : Store)
