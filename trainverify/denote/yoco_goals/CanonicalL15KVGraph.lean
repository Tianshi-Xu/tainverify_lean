...
private theorem cL15KV_storeSet_zip_replicate (s : Store) (v : Tensor) :
...
private def cL15KV_multirefNode (rank n : Nat) (xTid : Tid) (outs : List Tid) : NodeDecl :=
  { rank := rank, op := "OpName.FW_multiref", ins := [xTid], outs := outs, params := [n] }

private theorem cL15KV_reduce_multiref (g : GraphDecl) (init : Store)
    (idx rank n xTid t : Nat) (outs : List Tid)
    (hidx : idx < g.nodes.length)
    (hnode : g.nodes[idx]'hidx = cL15KV_multirefNode rank n xTid outs)
  ...
  exact cL15KV_storeSet_zip_replicate s (s xTid) outs n t hmem hlen

private def cL15KV_rmsNode (rank : Nat) (x w out : Tid) : NodeDecl :=
  { rank := rank, op := "OpName.FW_rms_norm", ins := [x, w], outs := [out] }
private def cL15KV_projNode (rank : Nat) (x w out : Tid) : NodeDecl :=
  { rank := rank, op := "OpName.FW_per_head_mix_precision_linear", ins := [x, w], outs := [out] }
private def cL15KV_toNode (rank : Nat) (x out : Tid) : NodeDecl :=
  { rank := rank, op := "OpName.FW_to", ins := [x], outs := [out] }

private theorem cL15KV_reduce_rms (g : GraphDecl) (init : Store)
    (idx rank x w out : Nat) (hidx : idx < g.nodes.length)
    (hnode : g.nodes[idx]'hidx = cL15KV_rmsNode rank x w out)
...
private theorem cL15KV_reduce_proj (g : GraphDecl) (init : Store)
    (idx rank x w out : Nat) (hidx : idx < g.nodes.length)
    (hnode : g.nodes[idx]'hidx = cL15KV_projNode rank x w out)
    (ha : ∀ nd ∈ g.nodes.drop (idx + 1), nd.outs ≠ [])
    (ho : ∀ nd ∈ g.nodes.drop (idx + 1), out ∉ nd.outs)
    (hp : ∀ nd ∈ g.nodes.drop idx, nd.outs ≠ [])
    (hx : ∀ nd ∈ g.nodes.drop idx, x ∉ nd.outs)
...
private theorem cL15KV_reduce_to (g : GraphDecl) (init : Store)
    (idx rank x out : Nat) (hidx : idx < g.nodes.length)
    (hnode : g.nodes[idx]'hidx = cL15KV_toNode rank x out)
    (ha : ∀ nd ∈ g.nodes.drop (idx + 1), nd.outs ≠ [])
    (ho : ∀ nd ∈ g.nodes.drop (idx + 1), out ∉ nd.outs)
    (hp : ∀ nd ∈ g.nodes.drop idx, nd.outs ≠ [])
    (hx : ∀ nd ∈ g.nodes.drop idx, x ∉ nd.outs) :
...
/-- Complete real SM L15 K graph relation: cache source through RMS, projection,
12-way fanout, and the L15 cast. -/
theorem canonical_l15_k_sm_reduce (initSM : Store) :
  ...
  have hb := cL15KV_reduce_multiref sm_goal_1 initSM 470 0 2 5595 8368 [8368, 8372]
    (by native_decide) (by native_decide) (by decide) (by decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have hr := cL15KV_reduce_rms sm_goal_1 initSM 471 0 8368 5596 5597
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have hs := cL15KV_reduce_multiref sm_goal_1 initSM 473 0 2 5597 8376 [8376, 8380]
    (by native_decide) (by native_decide) (by decide) (by decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have hp := cL15KV_reduce_proj sm_goal_1 initSM 475 0 8376 5598 5599
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have hf := cL15KV_reduce_multiref sm_goal_1 initSM 478 0 12 5599 8414
    [8394, 8398, 8402, 8406, 8410, 8414, 8418, 8422, 8426, 8430, 8434, 8438]
    (by native_decide) (by native_decide) (by decide) (by decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have hc := cL15KV_reduce_to sm_goal_1 initSM 486 0 8414 5878
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  rw [hc, hf, hp, hs, hr, hb]

/-- Rank-0's complete real PM L15 K graph reduction. -/
theorem canonical_l15_k_pm0_reduce (initPM : Store) :
  ...
  have hb := cL15KV_reduce_multiref pm_goal_1 initPM 1040 0 2 9722 15822
    [15822, 15826] (by native_decide) (by native_decide) (by decide) (by decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have hr := cL15KV_reduce_rms pm_goal_1 initPM 1042 0 15822 5596 9726
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have hs := cL15KV_reduce_multiref pm_goal_1 initPM 1046 0 2 9726 15838
    [15838, 15842] (by native_decide) (by native_decide) (by decide) (by decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have hp := cL15KV_reduce_proj pm_goal_1 initPM 1050 0 15838 5598 9728
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have hf := cL15KV_reduce_multiref pm_goal_1 initPM 1056 0 12 9728 15884
    [15864, 15868, 15872, 15876, 15880, 15884, 15888, 15892, 15896, 15900,
      15904, 15908]
    (by native_decide) (by native_decide) (by decide) (by decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have hc := cL15KV_reduce_to pm_goal_1 initPM 1066 0 15884 10542
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  rw [hc, hf, hp, hs, hr, hb]

/-- Rank-1's complete real PM L15 K graph reduction. -/
theorem canonical_l15_k_pm1_reduce (initPM : Store) :
    denoteGraphDistributedFaithful pm_goal_1 initPM 10543 =
      fw_per_head_linear
        (fw_rms_norm (denoteGraphDistributedFaithful pm_goal_1 initPM 9723)
          (denoteGraphDistributedFaithful pm_goal_1 initPM 5596))
        (denoteGraphDistributedFaithful pm_goal_1 initPM 5598) := by
  have hb := cL15KV_reduce_multiref pm_goal_1 initPM 1041 1 2 9723 15830
    [15830, 15834] (by native_decide) (by native_decide) (by decide) (by decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have hr := cL15KV_reduce_rms pm_goal_1 initPM 1044 1 15830 5596 9727
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have hs := cL15KV_reduce_multiref pm_goal_1 initPM 1048 1 2 9727 15846
    [15846, 15850] (by native_decide) (by native_decide) (by decide) (by decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have hp := cL15KV_reduce_proj pm_goal_1 initPM 1053 1 15846 5598 9729
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have hf := cL15KV_reduce_multiref pm_goal_1 initPM 1058 1 12 9729 15942
    [15922, 15926, 15930, 15934, 15938, 15942, 15946, 15950, 15954, 15958,
      15962, 15966]
    (by native_decide) (by native_decide) (by decide) (by decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have hc := cL15KV_reduce_to pm_goal_1 initPM 1090 1 15942 10543
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  rw [hc, hf, hp, hs, hr, hb]

/-- Complete real SM L15 V graph relation. -/
theorem canonical_l15_v_sm_reduce (initSM : Store) :
  ...
  have hr := cL15KV_reduce_rms sm_goal_1 initSM 471 0 8368 5596 5597
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have hs := cL15KV_reduce_multiref sm_goal_1 initSM 473 0 2 5597 8380 [8376, 8380]
    (by native_decide) (by native_decide) (by decide) (by decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have hp := cL15KV_reduce_proj sm_goal_1 initSM 476 0 8380 5600 5601
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have hf := cL15KV_reduce_multiref sm_goal_1 initSM 479 0 12 5601 8472
    [8452, 8456, 8460, 8464, 8468, 8472, 8476, 8480, 8484, 8488, 8492, 8496]
    (by native_decide) (by native_decide) (by decide) (by decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have hc := cL15KV_reduce_to sm_goal_1 initSM 498 0 8472 5879
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  rw [hc, hf, hp, hs, hr, hb]

/-- Complete real PM L15 V graph relation on both ranks. -/
theorem canonical_l15_v_pm_reduce (initPM : Store) :
  ...
  have hb0 := cL15KV_reduce_multiref pm_goal_1 initPM 1040 0 2 9722 15822
    [15822, 15826] (by native_decide) (by native_decide) (by decide) (by decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have hb1 := cL15KV_reduce_multiref pm_goal_1 initPM 1041 1 2 9723 15830
    [15830, 15834] (by native_decide) (by native_decide) (by decide) (by decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have hr0 := cL15KV_reduce_rms pm_goal_1 initPM 1042 0 15822 5596 9726
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have hr1 := cL15KV_reduce_rms pm_goal_1 initPM 1044 1 15830 5596 9727
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have hs0 := cL15KV_reduce_multiref pm_goal_1 initPM 1046 0 2 9726 15842
    [15838, 15842] (by native_decide) (by native_decide) (by decide) (by decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have hs1 := cL15KV_reduce_multiref pm_goal_1 initPM 1048 1 2 9727 15850
    [15846, 15850] (by native_decide) (by native_decide) (by decide) (by decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have hp0 := cL15KV_reduce_proj pm_goal_1 initPM 1051 0 15842 5600 9740
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have hp1 := cL15KV_reduce_proj pm_goal_1 initPM 1054 1 15850 5600 9741
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have hf0 := cL15KV_reduce_multiref pm_goal_1 initPM 1057 0 12 9740 16000
    [15980, 15984, 15988, 15992, 15996, 16000, 16004, 16008, 16012, 16016,
      16020, 16024]
    (by native_decide) (by native_decide) (by decide) (by decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have hf1 := cL15KV_reduce_multiref pm_goal_1 initPM 1059 1 12 9741 16058
    [16038, 16042, 16046, 16050, 16054, 16058, 16062, 16066, 16070, 16074,
      16078, 16082]
    (by native_decide) (by native_decide) (by decide) (by decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have hc0 := cL15KV_reduce_to pm_goal_1 initPM 1078 0 16000 10548
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have hc1 := cL15KV_reduce_to pm_goal_1 initPM 1102 1 16058 10549
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  refine ⟨?_, ?_⟩
...
private theorem cL15V_init_singleton_eq (initSM initPM : Store)
...
private theorem cL15V_weight_value (g : GraphDecl) (init : Store) (tid : Tid)
...
private theorem cL15V_weight_eq (initSM initPM : Store)
    (hInit : InitGoalsHold pm_goal_1.numRanks goal_1_full_initGoals initSM initPM)
  ...
  have hi := cL15V_init_singleton_eq initSM initPM hInit g hg tid htp hgd hrep hts
  rw [cL15V_weight_value sm_goal_1 initSM tid (by native_decide) hsnw,
    cL15V_weight_value pm_goal_1 initPM tid (by native_decide) hpnw, hi]

private theorem cL15V_proj_weight_shape (initPM : Store)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv) :
    (denoteGraphDistributedFaithful pm_goal_1 initPM 5600).shape = [4, 64, 1024] := by
  rw [cL15V_weight_value pm_goal_1 initPM 5600 (by native_decide) (by native_decide)]
  exact hPM 5600 [4, 64, 1024] (by native_decide)

/-- Full ordinary canonical L15 V SM/PM graph relation. -/
theorem canonical_l15_v_ordinary_relation
    (initSM initPM : Store)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
    (hInit : InitGoalsHold pm_goal_1.numRanks goal_1_full_initGoals initSM initPM)
    (hCache : Gather2Rel
  ...
  have hRmsW := cL15V_weight_eq initSM initPM hInit 5596 initGoal_5596
    (by native_decide) rfl rfl rfl rfl (by native_decide) (by native_decide)
  have hVW := cL15V_weight_eq initSM initPM hInit 5600 initGoal_5600
    (by native_decide) rfl rfl rfl rfl (by native_decide) (by native_decide)
  have hVShape := cL15V_proj_weight_shape initPM hPM
  have hSemantic := canonical_l15_v_ordinary_semantic hCache hRmsW hVW hVShape
  have hPMr := canonical_l15_v_pm_reduce initPM
  have hSMr := canonical_l15_v_sm_reduce initSM
  rw [hSMr, hPMr.1, hPMr.2]
  exact hSemantic

#print axioms canonical_l15_k_sm_reduce
#print axioms canonical_l15_k_pm0_reduce
#print axioms canonical_l15_k_pm1_reduce
#print axioms canonical_l15_v_sm_reduce
#print axioms canonical_l15_v_pm_reduce
#print axioms canonical_l15_v_ordinary_relation
