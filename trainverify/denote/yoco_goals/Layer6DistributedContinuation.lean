...
private theorem l6d_sigmoid (g : GraphDecl) (init : Store) (k r i o : Nat)
    (hk : k < g.nodes.length)
...
private theorem l6d_swiglu (g : GraphDecl) (init : Store) (k r x y o : Nat)
    (hk : k < g.nodes.length)
    (hn : g.nodes[k]'hk =
...
private theorem l6d_mul (g : GraphDecl) (init : Store) (k r x y o : Nat)
    (hk : k < g.nodes.length)
...
/-! ### L7 router expert side branches — `mref5-pos{2,3,4}(5029)` reshape/mixlin/view. -/

private theorem l6d_reshape5039_rel (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    Gather2Rel (denoteGraphDistributed sm initSM 5039)
      (denoteGraphDistributed pm initPM 8609) (denoteGraphDistributed pm initPM 8610)
      [4096, 1024] [2048, 1024] := by
  have h := l6d_rms5029_rel initSM initPM hSM hPM hInit
  have s := distributed_reduce1 sm initSM 252
    { rank := 0, op := "OpName.FW_multiref", ins := [5029],
      outs := [7727, 7731, 7735, 7739, 7743], params := [5] }
    5029 7735 id (by native_decide) (by native_decide) (by decide)
    (fun st => applyNode_fw_multiref5_at_pos2_out sm st 0 5029 7727 7731 7735 7739 7743
      (by decide) (by decide))
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have p0 := distributed_reduce1 pm initPM 565
    { rank := 0, op := "OpName.FW_multiref", ins := [8587],
      outs := [15178, 15182, 15186, 15190, 15194], params := [5] }
    8587 15186 id (by native_decide) (by native_decide) (by decide)
    (fun st => applyNode_fw_multiref5_at_pos2_out pm st 0 8587 15178 15182 15186 15190 15194
      (by decide) (by decide))
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have p1 := distributed_reduce1 pm initPM 566
    { rank := 1, op := "OpName.FW_multiref", ins := [8588],
      outs := [15201, 15205, 15209, 15213, 15217], params := [5] }
    8588 15209 id (by native_decide) (by native_decide) (by decide)
    (fun st => applyNode_fw_multiref5_at_pos2_out pm st 1 8588 15201 15205 15209 15213 15217
      (by decide) (by decide))
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  simp only [id_eq] at s p0 p1
  have rs := l6d_reshape sm initSM 254 0 7735 5039 4096 [1024]
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have r0 := l6d_reshape pm initPM 568 0 15186 8609 2048 [1024]
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have r1 := l6d_reshape pm initPM 572 1 15209 8610 2048 [1024]
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have es : denoteGraphDistributed sm initSM 5039 = denoteGraphDistributed sm initSM 7735 := by
    rw [rs, fw_view_id_shape [4096, 1024] _ (by rw [s]; exact h.full_shape)]
  have e0 : denoteGraphDistributed pm initPM 8609 = denoteGraphDistributed pm initPM 15186 := by
    rw [r0, fw_view_id_shape [2048, 1024] _ (by rw [p0]; exact h.shard0_shape)]
  have e1 : denoteGraphDistributed pm initPM 8610 = denoteGraphDistributed pm initPM 15209 := by
...
/-- Pure-distributed exact 2-TP reconstruction of `mref5-pos2(5029)` reshape. -/
theorem recon_intermediateGoal_5039_distributed (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    InitGoalHolds pm.numRanks intermediateGoal_5039
      (denoteGraphDistributed sm initSM) (denoteGraphDistributed pm initPM) :=
  Gather2Rel.to_initGoalHolds _ _ intermediateGoal_5039 5039 8609 8610
    [4096, 1024] [2048, 1024] rfl rfl rfl rfl rfl rfl
    (l6d_reshape5039_rel initSM initPM hSM hPM hInit)

private theorem l6d_reshape5044_rel (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    Gather2Rel (denoteGraphDistributed sm initSM 5044)
      (denoteGraphDistributed pm initPM 8623) (denoteGraphDistributed pm initPM 8624)
      [4096, 1024] [2048, 1024] := by
  have h := l6d_rms5029_rel initSM initPM hSM hPM hInit
  have s := distributed_reduce1 sm initSM 252
    { rank := 0, op := "OpName.FW_multiref", ins := [5029],
      outs := [7727, 7731, 7735, 7739, 7743], params := [5] }
    5029 7739 id (by native_decide) (by native_decide) (by decide)
    (fun st => applyNode_fw_multiref5_at_pos3_out sm st 0 5029 7727 7731 7735 7739 7743
      (by decide) (by decide) (by decide))
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have p0 := distributed_reduce1 pm initPM 565
    { rank := 0, op := "OpName.FW_multiref", ins := [8587],
      outs := [15178, 15182, 15186, 15190, 15194], params := [5] }
    8587 15190 id (by native_decide) (by native_decide) (by decide)
    (fun st => applyNode_fw_multiref5_at_pos3_out pm st 0 8587 15178 15182 15186 15190 15194
      (by decide) (by decide) (by decide))
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have p1 := distributed_reduce1 pm initPM 566
    { rank := 1, op := "OpName.FW_multiref", ins := [8588],
      outs := [15201, 15205, 15209, 15213, 15217], params := [5] }
    8588 15213 id (by native_decide) (by native_decide) (by decide)
    (fun st => applyNode_fw_multiref5_at_pos3_out pm st 1 8588 15201 15205 15209 15213 15217
      (by decide) (by decide) (by decide))
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  simp only [id_eq] at s p0 p1
  have rs := l6d_reshape sm initSM 255 0 7739 5044 4096 [1024]
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have r0 := l6d_reshape pm initPM 569 0 15190 8623 2048 [1024]
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have r1 := l6d_reshape pm initPM 573 1 15213 8624 2048 [1024]
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have es : denoteGraphDistributed sm initSM 5044 = denoteGraphDistributed sm initSM 7739 := by
    rw [rs, fw_view_id_shape [4096, 1024] _ (by rw [s]; exact h.full_shape)]
  have e0 : denoteGraphDistributed pm initPM 8623 = denoteGraphDistributed pm initPM 15190 := by
    rw [r0, fw_view_id_shape [2048, 1024] _ (by rw [p0]; exact h.shard0_shape)]
  have e1 : denoteGraphDistributed pm initPM 8624 = denoteGraphDistributed pm initPM 15213 := by
    rw [r1, fw_view_id_shape [2048, 1024] _ (by rw [p1]; exact h.shard1_shape)]
  exact ⟨by rw [es, s, h.value, ← p0, ← p1, ← e0, ← e1], by rw [es, s]; exact h.full_shape,
    by rw [e0, p0]; exact h.shard0_shape, by rw [e1, p1]; exact h.shard1_shape, by decide⟩

/-- Pure-distributed exact 2-TP reconstruction of `mref5-pos3(5029)` reshape. -/
theorem recon_intermediateGoal_5044_distributed (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    InitGoalHolds pm.numRanks intermediateGoal_5044
      (denoteGraphDistributed sm initSM) (denoteGraphDistributed pm initPM) :=
  Gather2Rel.to_initGoalHolds _ _ intermediateGoal_5044 5044 8623 8624
    [4096, 1024] [2048, 1024] rfl rfl rfl rfl rfl rfl
    (l6d_reshape5044_rel initSM initPM hSM hPM hInit)

private theorem l6d_reshape5048_rel (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    Gather2Rel (denoteGraphDistributed sm initSM 5048)
      (denoteGraphDistributed pm initPM 8641) (denoteGraphDistributed pm initPM 8642)
      [4096, 1024] [2048, 1024] := by
  have h := l6d_rms5029_rel initSM initPM hSM hPM hInit
  have s := distributed_reduce1 sm initSM 252
    { rank := 0, op := "OpName.FW_multiref", ins := [5029],
      outs := [7727, 7731, 7735, 7739, 7743], params := [5] }
    5029 7743 id (by native_decide) (by native_decide) (by decide)
    (fun st => applyNode_fw_multiref5_at_pos4_out sm st 0 5029 7727 7731 7735 7739 7743
      (by decide) (by decide) (by decide) (by decide))
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have p0 := distributed_reduce1 pm initPM 565
    { rank := 0, op := "OpName.FW_multiref", ins := [8587],
      outs := [15178, 15182, 15186, 15190, 15194], params := [5] }
    8587 15194 id (by native_decide) (by native_decide) (by decide)
    (fun st => applyNode_fw_multiref5_at_pos4_out pm st 0 8587 15178 15182 15186 15190 15194
      (by decide) (by decide) (by decide) (by decide))
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have p1 := distributed_reduce1 pm initPM 566
    { rank := 1, op := "OpName.FW_multiref", ins := [8588],
      outs := [15201, 15205, 15209, 15213, 15217], params := [5] }
    8588 15217 id (by native_decide) (by native_decide) (by decide)
    (fun st => applyNode_fw_multiref5_at_pos4_out pm st 1 8588 15201 15205 15209 15213 15217
      (by decide) (by decide) (by decide) (by decide))
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  simp only [id_eq] at s p0 p1
  have rs := l6d_reshape sm initSM 256 0 7743 5048 4096 [1024]
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have r0 := l6d_reshape pm initPM 570 0 15194 8641 2048 [1024]
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have r1 := l6d_reshape pm initPM 574 1 15217 8642 2048 [1024]
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have es : denoteGraphDistributed sm initSM 5048 = denoteGraphDistributed sm initSM 7743 := by
    rw [rs, fw_view_id_shape [4096, 1024] _ (by rw [s]; exact h.full_shape)]
  have e0 : denoteGraphDistributed pm initPM 8641 = denoteGraphDistributed pm initPM 15194 := by
    rw [r0, fw_view_id_shape [2048, 1024] _ (by rw [p0]; exact h.shard0_shape)]
  have e1 : denoteGraphDistributed pm initPM 8642 = denoteGraphDistributed pm initPM 15217 := by
    rw [r1, fw_view_id_shape [2048, 1024] _ (by rw [p1]; exact h.shard1_shape)]
  exact ⟨by rw [es, s, h.value, ← p0, ← p1, ← e0, ← e1], by rw [es, s]; exact h.full_shape,
    by rw [e0, p0]; exact h.shard0_shape, by rw [e1, p1]; exact h.shard1_shape, by decide⟩

/-- Pure-distributed exact 2-TP reconstruction of `mref5-pos4(5029)` reshape. -/
theorem recon_intermediateGoal_5048_distributed (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    InitGoalHolds pm.numRanks intermediateGoal_5048
      (denoteGraphDistributed sm initSM) (denoteGraphDistributed pm initPM) :=
  Gather2Rel.to_initGoalHolds _ _ intermediateGoal_5048 5048 8641 8642
    [4096, 1024] [2048, 1024] rfl rfl rfl rfl rfl rfl
    (l6d_reshape5048_rel initSM initPM hSM hPM hInit)

private theorem l6d_linear5041_rel (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    Gather2Rel (denoteGraphDistributed sm initSM 5041)
      (denoteGraphDistributed pm initPM 8613) (denoteGraphDistributed pm initPM 8614)
      [4096, 1] [2048, 1] := by
  have h := l6d_reshape5039_rel initSM initPM hSM hPM hInit
  have hw := distributed_init_singleton_value initSM initPM hInit initGoal_5040
    (by native_decide) 5040 rfl rfl rfl rfl layer1_sm_nodes_nonempty
    (by native_decide) layer1_pm_nodes_nonempty (by native_decide)
  have hws := distributed_init_singleton_shape initSM initPM hInit initGoal_5040
    (by native_decide) 5040 [1, 1024] rfl rfl layer1_sm_nodes_nonempty (by native_decide)
  have hpw : (denoteGraphDistributed pm initPM 5040).shape = [1, 1024] := by rw [← hw]; exact hws
  have rs := l6d_linear sm initSM 258 0 5039 5040 5041
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have r0 := l6d_linear pm initPM 576 0 8609 5040 8613
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have r1 := l6d_linear pm initPM 580 1 8610 5040 8614
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  refine ⟨?_, ?_, ?_, ?_, by decide⟩
...
/-- Pure-distributed exact 2-TP reconstruction of expert linear `fw_linear(5039, 5040)`. -/
theorem recon_intermediateGoal_5041_distributed (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    InitGoalHolds pm.numRanks intermediateGoal_5041
      (denoteGraphDistributed sm initSM) (denoteGraphDistributed pm initPM) :=
  Gather2Rel.to_initGoalHolds _ _ intermediateGoal_5041 5041 8613 8614
    [4096, 1] [2048, 1] rfl rfl rfl rfl rfl rfl
    (l6d_linear5041_rel initSM initPM hSM hPM hInit)

private theorem l6d_linear5046_rel (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    Gather2Rel (denoteGraphDistributed sm initSM 5046)
      (denoteGraphDistributed pm initPM 8627) (denoteGraphDistributed pm initPM 8628)
      [4096, 512] [2048, 512] := by
  have h := l6d_reshape5044_rel initSM initPM hSM hPM hInit
  have hw := distributed_init_singleton_value initSM initPM hInit initGoal_5045
    (by native_decide) 5045 rfl rfl rfl rfl layer1_sm_nodes_nonempty
    (by native_decide) layer1_pm_nodes_nonempty (by native_decide)
  have hws := distributed_init_singleton_shape initSM initPM hInit initGoal_5045
    (by native_decide) 5045 [512, 1024] rfl rfl layer1_sm_nodes_nonempty (by native_decide)
  have hpw : (denoteGraphDistributed pm initPM 5045).shape = [512, 1024] := by rw [← hw]; exact hws
  have rs := l6d_linear sm initSM 259 0 5044 5045 5046
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have r0 := l6d_linear pm initPM 577 0 8623 5045 8627
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have r1 := l6d_linear pm initPM 581 1 8624 5045 8628
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  refine ⟨?_, ?_, ?_, ?_, by decide⟩
...
/-- Pure-distributed exact 2-TP reconstruction of expert linear `fw_linear(5044, 5045)`. -/
theorem recon_intermediateGoal_5046_distributed (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    InitGoalHolds pm.numRanks intermediateGoal_5046
      (denoteGraphDistributed sm initSM) (denoteGraphDistributed pm initPM) :=
  Gather2Rel.to_initGoalHolds _ _ intermediateGoal_5046 5046 8627 8628
    [4096, 512] [2048, 512] rfl rfl rfl rfl rfl rfl
    (l6d_linear5046_rel initSM initPM hSM hPM hInit)

private theorem l6d_linear5050_rel (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    Gather2Rel (denoteGraphDistributed sm initSM 5050)
      (denoteGraphDistributed pm initPM 8645) (denoteGraphDistributed pm initPM 8646)
      [4096, 512] [2048, 512] := by
  have h := l6d_reshape5048_rel initSM initPM hSM hPM hInit
  have hw := distributed_init_singleton_value initSM initPM hInit initGoal_5049
    (by native_decide) 5049 rfl rfl rfl rfl layer1_sm_nodes_nonempty
    (by native_decide) layer1_pm_nodes_nonempty (by native_decide)
  have hws := distributed_init_singleton_shape initSM initPM hInit initGoal_5049
    (by native_decide) 5049 [512, 1024] rfl rfl layer1_sm_nodes_nonempty (by native_decide)
  have hpw : (denoteGraphDistributed pm initPM 5049).shape = [512, 1024] := by rw [← hw]; exact hws
  have rs := l6d_linear sm initSM 260 0 5048 5049 5050
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have r0 := l6d_linear pm initPM 578 0 8641 5049 8645
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have r1 := l6d_linear pm initPM 582 1 8642 5049 8646
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  refine ⟨?_, ?_, ?_, ?_, by decide⟩
  · rw [rs, h.value, hw, fw_mix_precision_linear_allGather0_commute_2 _ _ _ 2048 1024 512
...
/-- Pure-distributed exact 2-TP reconstruction of expert linear `fw_linear(5048, 5049)`. -/
theorem recon_intermediateGoal_5050_distributed (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    InitGoalHolds pm.numRanks intermediateGoal_5050
      (denoteGraphDistributed sm initSM) (denoteGraphDistributed pm initPM) :=
  Gather2Rel.to_initGoalHolds _ _ intermediateGoal_5050 5050 8645 8646
    [4096, 512] [2048, 512] rfl rfl rfl rfl rfl rfl
    (l6d_linear5050_rel initSM initPM hSM hPM hInit)

private theorem l6d_view5042_rel (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    Gather2Rel (denoteGraphDistributed sm initSM 5042)
      (denoteGraphDistributed pm initPM 8619) (denoteGraphDistributed pm initPM 8620)
      [4096, 1] [2048, 1] := by
  have h := l6d_linear5041_rel initSM initPM hSM hPM hInit
  have rs := l6d_view sm initSM 262 0 5041 5042 4096 [1]
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have r0 := l6d_view pm initPM 584 0 8613 8619 2048 [1]
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have r1 := l6d_view pm initPM 588 1 8614 8620 2048 [1]
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have es : denoteGraphDistributed sm initSM 5042 = denoteGraphDistributed sm initSM 5041 := by
    rw [rs, fw_view_id_shape [4096, 1] _ h.full_shape]
  have e0 : denoteGraphDistributed pm initPM 8619 = denoteGraphDistributed pm initPM 8613 := by
    rw [r0, fw_view_id_shape [2048, 1] _ h.shard0_shape]
  have e1 : denoteGraphDistributed pm initPM 8620 = denoteGraphDistributed pm initPM 8614 := by
    rw [r1, fw_view_id_shape [2048, 1] _ h.shard1_shape]
  exact ⟨by rw [es, h.value, ← e0, ← e1], by rw [es]; exact h.full_shape,
    by rw [e0]; exact h.shard0_shape, by rw [e1]; exact h.shard1_shape, by decide⟩

/-- Pure-distributed exact 2-TP reconstruction of expert identity view `fw_view [4096,1] (5041)`. -/
theorem recon_intermediateGoal_5042_distributed (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    InitGoalHolds pm.numRanks intermediateGoal_5042
      (denoteGraphDistributed sm initSM) (denoteGraphDistributed pm initPM) :=
  Gather2Rel.to_initGoalHolds _ _ intermediateGoal_5042 5042 8619 8620
    [4096, 1] [2048, 1] rfl rfl rfl rfl rfl rfl
    (l6d_view5042_rel initSM initPM hSM hPM hInit)

private theorem l6d_view5047_rel (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    Gather2Rel (denoteGraphDistributed sm initSM 5047)
      (denoteGraphDistributed pm initPM 8637) (denoteGraphDistributed pm initPM 8638)
      [4096, 512] [2048, 512] := by
  have h := l6d_linear5046_rel initSM initPM hSM hPM hInit
  have rs := l6d_view sm initSM 263 0 5046 5047 4096 [512]
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have r0 := l6d_view pm initPM 585 0 8627 8637 2048 [512]
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have r1 := l6d_view pm initPM 589 1 8628 8638 2048 [512]
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have es : denoteGraphDistributed sm initSM 5047 = denoteGraphDistributed sm initSM 5046 := by
    rw [rs, fw_view_id_shape [4096, 512] _ h.full_shape]
  have e0 : denoteGraphDistributed pm initPM 8637 = denoteGraphDistributed pm initPM 8627 := by
    rw [r0, fw_view_id_shape [2048, 512] _ h.shard0_shape]
  have e1 : denoteGraphDistributed pm initPM 8638 = denoteGraphDistributed pm initPM 8628 := by
    rw [r1, fw_view_id_shape [2048, 512] _ h.shard1_shape]
  exact ⟨by rw [es, h.value, ← e0, ← e1], by rw [es]; exact h.full_shape,
    by rw [e0]; exact h.shard0_shape, by rw [e1]; exact h.shard1_shape, by decide⟩

/-- Pure-distributed exact 2-TP reconstruction of expert identity view `fw_view [4096,512] (5046)`. -/
theorem recon_intermediateGoal_5047_distributed (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    InitGoalHolds pm.numRanks intermediateGoal_5047
      (denoteGraphDistributed sm initSM) (denoteGraphDistributed pm initPM) :=
  Gather2Rel.to_initGoalHolds _ _ intermediateGoal_5047 5047 8637 8638
    [4096, 512] [2048, 512] rfl rfl rfl rfl rfl rfl
    (l6d_view5047_rel initSM initPM hSM hPM hInit)

private theorem l6d_view5051_rel (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    Gather2Rel (denoteGraphDistributed sm initSM 5051)
      (denoteGraphDistributed pm initPM 8655) (denoteGraphDistributed pm initPM 8656)
      [4096, 512] [2048, 512] := by
  have h := l6d_linear5050_rel initSM initPM hSM hPM hInit
  have rs := l6d_view sm initSM 264 0 5050 5051 4096 [512]
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have r0 := l6d_view pm initPM 586 0 8645 8655 2048 [512]
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have r1 := l6d_view pm initPM 590 1 8646 8656 2048 [512]
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have es : denoteGraphDistributed sm initSM 5051 = denoteGraphDistributed sm initSM 5050 := by
    rw [rs, fw_view_id_shape [4096, 512] _ h.full_shape]
  have e0 : denoteGraphDistributed pm initPM 8655 = denoteGraphDistributed pm initPM 8645 := by
    rw [r0, fw_view_id_shape [2048, 512] _ h.shard0_shape]
  have e1 : denoteGraphDistributed pm initPM 8656 = denoteGraphDistributed pm initPM 8646 := by
    rw [r1, fw_view_id_shape [2048, 512] _ h.shard1_shape]
  exact ⟨by rw [es, h.value, ← e0, ← e1], by rw [es]; exact h.full_shape,
    by rw [e0]; exact h.shard0_shape, by rw [e1]; exact h.shard1_shape, by decide⟩

/-- Pure-distributed exact 2-TP reconstruction of expert identity view `fw_view [4096,512] (5050)`. -/
theorem recon_intermediateGoal_5051_distributed (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    InitGoalHolds pm.numRanks intermediateGoal_5051
      (denoteGraphDistributed sm initSM) (denoteGraphDistributed pm initPM) :=
  Gather2Rel.to_initGoalHolds _ _ intermediateGoal_5051 5051 8655 8656
    [4096, 512] [2048, 512] rfl rfl rfl rfl rfl rfl
    (l6d_view5051_rel initSM initPM hSM hPM hInit)

/-! ### Next-layer gate/expert postprocessing, pure-distributed exact 2-TP. -/

private theorem l6d_sigmoid5043_rel (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    Gather2Rel (denoteGraphDistributed sm initSM 5043)
      (denoteGraphDistributed pm initPM 8621) (denoteGraphDistributed pm initPM 8622)
      [4096, 1] [2048, 1] := by
  have h := l6d_view5042_rel initSM initPM hSM hPM hInit
  have rs := l6d_sigmoid sm initSM 266 0 5042 5043
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have r0 := l6d_sigmoid pm initPM 592 0 8619 8621
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have r1 := l6d_sigmoid pm initPM 595 1 8620 8622
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  refine ⟨?_, ?_, ?_, ?_, by decide⟩
...
/-- Pure-distributed exact 2-TP reconstruction of gate sigmoid `fw_sigmoid(5042)`. -/
theorem recon_intermediateGoal_5043_distributed (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    InitGoalHolds pm.numRanks intermediateGoal_5043
      (denoteGraphDistributed sm initSM) (denoteGraphDistributed pm initPM) :=
  Gather2Rel.to_initGoalHolds _ _ intermediateGoal_5043 5043 8621 8622
    [4096, 1] [2048, 1] rfl rfl rfl rfl rfl rfl
    (l6d_sigmoid5043_rel initSM initPM hSM hPM hInit)

private theorem l6d_swiglu5052_rel (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    Gather2Rel (denoteGraphDistributed sm initSM 5052)
      (denoteGraphDistributed pm initPM 8659) (denoteGraphDistributed pm initPM 8660)
      [4096, 512] [2048, 512] := by
  have hx := l6d_view5047_rel initSM initPM hSM hPM hInit
  have hy := l6d_view5051_rel initSM initPM hSM hPM hInit
  have rs := l6d_swiglu sm initSM 267 0 5047 5051 5052
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have r0 := l6d_swiglu pm initPM 593 0 8637 8655 8659
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have r1 := l6d_swiglu pm initPM 596 1 8638 8656 8660
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  refine ⟨?_, ?_, ?_, ?_, by decide⟩
...
/-- Pure-distributed exact 2-TP reconstruction of expert `fw_swiglu(5047, 5051)`. -/
theorem recon_intermediateGoal_5052_distributed (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    InitGoalHolds pm.numRanks intermediateGoal_5052
      (denoteGraphDistributed sm initSM) (denoteGraphDistributed pm initPM) :=
  Gather2Rel.to_initGoalHolds _ _ intermediateGoal_5052 5052 8659 8660
    [4096, 512] [2048, 512] rfl rfl rfl rfl rfl rfl
    (l6d_swiglu5052_rel initSM initPM hSM hPM hInit)

private theorem l6d_reshape5053_rel (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    Gather2Rel (denoteGraphDistributed sm initSM 5053)
      (denoteGraphDistributed pm initPM 8661) (denoteGraphDistributed pm initPM 8662)
      [4096, 512] [2048, 512] := by
  have h := l6d_swiglu5052_rel initSM initPM hSM hPM hInit
  have rs := l6d_reshape sm initSM 268 0 5052 5053 4096 [512]
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have r0 := l6d_reshape pm initPM 597 0 8659 8661 2048 [512]
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have r1 := l6d_reshape pm initPM 598 1 8660 8662 2048 [512]
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have es : denoteGraphDistributed sm initSM 5053 = denoteGraphDistributed sm initSM 5052 := by
    rw [rs, fw_view_id_shape [4096, 512] _ h.full_shape]
  have e0 : denoteGraphDistributed pm initPM 8661 = denoteGraphDistributed pm initPM 8659 := by
    rw [r0, fw_view_id_shape [2048, 512] _ h.shard0_shape]
  have e1 : denoteGraphDistributed pm initPM 8662 = denoteGraphDistributed pm initPM 8660 := by
    rw [r1, fw_view_id_shape [2048, 512] _ h.shard1_shape]
  exact ⟨by rw [es, h.value, ← e0, ← e1], by rw [es]; exact h.full_shape,
    by rw [e0]; exact h.shard0_shape, by rw [e1]; exact h.shard1_shape, by decide⟩

/-- Pure-distributed exact 2-TP reconstruction of expert reshape `5053`. -/
theorem recon_intermediateGoal_5053_distributed (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    InitGoalHolds pm.numRanks intermediateGoal_5053
      (denoteGraphDistributed sm initSM) (denoteGraphDistributed pm initPM) :=
  Gather2Rel.to_initGoalHolds _ _ intermediateGoal_5053 5053 8661 8662
    [4096, 512] [2048, 512] rfl rfl rfl rfl rfl rfl
    (l6d_reshape5053_rel initSM initPM hSM hPM hInit)

private theorem l6d_linear5055_rel (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    Gather2Rel (denoteGraphDistributed sm initSM 5055)
      (denoteGraphDistributed pm initPM 8667) (denoteGraphDistributed pm initPM 8668)
      [4096, 1024] [2048, 1024] := by
  have h := l6d_reshape5053_rel initSM initPM hSM hPM hInit
  have hw := distributed_init_singleton_value initSM initPM hInit initGoal_5054
    (by native_decide) 5054 rfl rfl rfl rfl layer1_sm_nodes_nonempty
    (by native_decide) layer1_pm_nodes_nonempty (by native_decide)
  have hws := distributed_init_singleton_shape initSM initPM hInit initGoal_5054
    (by native_decide) 5054 [1024, 512] rfl rfl layer1_sm_nodes_nonempty (by native_decide)
  have hpw : (denoteGraphDistributed pm initPM 5054).shape = [1024, 512] := by
    rw [← hw]; exact hws
  have rs := l6d_linear sm initSM 269 0 5053 5054 5055
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have r0 := l6d_linear pm initPM 599 0 8661 5054 8667
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have r1 := l6d_linear pm initPM 600 1 8662 5054 8668
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  refine ⟨?_, ?_, ?_, ?_, by decide⟩
...
/-- Pure-distributed exact 2-TP reconstruction of expert output linear `5055`. -/
theorem recon_intermediateGoal_5055_distributed (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    InitGoalHolds pm.numRanks intermediateGoal_5055
      (denoteGraphDistributed sm initSM) (denoteGraphDistributed pm initPM) :=
  Gather2Rel.to_initGoalHolds _ _ intermediateGoal_5055 5055 8667 8668
    [4096, 1024] [2048, 1024] rfl rfl rfl rfl rfl rfl
    (l6d_linear5055_rel initSM initPM hSM hPM hInit)

private theorem l6d_view5056_rel (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    Gather2Rel (denoteGraphDistributed sm initSM 5056)
      (denoteGraphDistributed pm initPM 8677) (denoteGraphDistributed pm initPM 8678)
      [4096, 1024] [2048, 1024] := by
  have h := l6d_linear5055_rel initSM initPM hSM hPM hInit
  have rs := l6d_view sm initSM 270 0 5055 5056 4096 [1024]
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have r0 := l6d_view pm initPM 601 0 8667 8677 2048 [1024]
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have r1 := l6d_view pm initPM 602 1 8668 8678 2048 [1024]
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
  have es : denoteGraphDistributed sm initSM 5056 = denoteGraphDistributed sm initSM 5055 := by
    rw [rs, fw_view_id_shape [4096, 1024] _ h.full_shape]
  have e0 : denoteGraphDistributed pm initPM 8677 = denoteGraphDistributed pm initPM 8667 := by
    rw [r0, fw_view_id_shape [2048, 1024] _ h.shard0_shape]
  have e1 : denoteGraphDistributed pm initPM 8678 = denoteGraphDistributed pm initPM 8668 := by
    rw [r1, fw_view_id_shape [2048, 1024] _ h.shard1_shape]
  exact ⟨by rw [es, h.value, ← e0, ← e1], by rw [es]; exact h.full_shape,
    by rw [e0]; exact h.shard0_shape, by rw [e1]; exact h.shard1_shape, by decide⟩

/-- Pure-distributed exact 2-TP reconstruction of expert identity view `5056`. -/
theorem recon_intermediateGoal_5056_distributed (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    InitGoalHolds pm.numRanks intermediateGoal_5056
      (denoteGraphDistributed sm initSM) (denoteGraphDistributed pm initPM) :=
  Gather2Rel.to_initGoalHolds _ _ intermediateGoal_5056 5056 8677 8678
    [4096, 1024] [2048, 1024] rfl rfl rfl rfl rfl rfl
    (l6d_view5056_rel initSM initPM hSM hPM hInit)

private theorem l6d_mul_shape (x y : Tensor) (s h : Nat) (hh : 1 ≤ h)
...
private theorem l6d_mul5057_rel (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    Gather2Rel (denoteGraphDistributed sm initSM 5057)
      (denoteGraphDistributed pm initPM 8681) (denoteGraphDistributed pm initPM 8682)
      [4096, 1024] [2048, 1024] := by
  have hx := l6d_sigmoid5043_rel initSM initPM hSM hPM hInit
  have hy := l6d_view5056_rel initSM initPM hSM hPM hInit
  have rs := l6d_mul sm initSM 271 0 5043 5056 5057
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have r0 := l6d_mul pm initPM 603 0 8621 8677 8681
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  have r1 := l6d_mul pm initPM 604 1 8622 8678 8682
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide)
  refine ⟨?_, ?_, ?_, ?_, by decide⟩
  · rw [rs, hx.value, hy.value,
      fw_mul_allGather0_commute_2_of_broadcast _ _ _ _ 2048 1024
        ...
        hx.shard0_shape hx.shard1_shape hy.shard0_shape hy.shard1_shape, r0, r1]
  · rw [rs]; exact l6d_mul_shape _ _ 4096 1024 (by omega) hx.full_shape hy.full_shape
  · rw [r0]; exact l6d_mul_shape _ _ 2048 1024 (by omega) hx.shard0_shape hy.shard0_shape
  · rw [r1]; exact l6d_mul_shape _ _ 2048 1024 (by omega) hx.shard1_shape hy.shard1_shape

/-- Pure-distributed exact 2-TP reconstruction of gate/expert broadcast product `5057`. -/
theorem recon_intermediateGoal_5057_distributed (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    InitGoalHolds pm.numRanks intermediateGoal_5057
      (denoteGraphDistributed sm initSM) (denoteGraphDistributed pm initPM) :=
  Gather2Rel.to_initGoalHolds _ _ intermediateGoal_5057 5057 8681 8682
    [4096, 1024] [2048, 1024] rfl rfl rfl rfl rfl rfl
    (l6d_mul5057_rel initSM initPM hSM hPM hInit)

/-! ### Layer-7 public token bridge and faithful full-expert MoE. -/

private theorem l7d_token7731_rel (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    Gather2Rel (denoteGraphDistributed sm initSM 7731)
      (denoteGraphDistributed pm initPM 15182) (denoteGraphDistributed pm initPM 15205)
      [4096, 1024] [2048, 1024] := by
  have h := Gather2Rel.of_initGoalHolds _ _ intermediateGoal_5029 5029 8587 8588
    [4096, 1024] [2048, 1024] rfl rfl rfl rfl rfl rfl (by decide)
    (recon_intermediateGoal_5029_distributed initSM initPM hSM hPM hInit)
  have s := distributed_reduce1 sm initSM 252
    { rank := 0, op := "OpName.FW_multiref", ins := [5029],
      outs := [7727, 7731, 7735, 7739, 7743], params := [5] }
    5029 7731 id (by native_decide) (by native_decide) (by decide)
    (fun st => applyNode_fw_multiref5_at_pos1_out sm st 0 5029 7727 7731 7735 7739 7743 (by decide))
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have p0 := distributed_reduce1 pm initPM 565
    { rank := 0, op := "OpName.FW_multiref", ins := [8587],
      outs := [15178, 15182, 15186, 15190, 15194], params := [5] }
    8587 15182 id (by native_decide) (by native_decide) (by decide)
    (fun st => applyNode_fw_multiref5_at_pos1_out pm st 0 8587 15178 15182 15186 15190 15194 (by decide))
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have p1 := distributed_reduce1 pm initPM 566
    { rank := 1, op := "OpName.FW_multiref", ins := [8588],
      outs := [15201, 15205, 15209, 15213, 15217], params := [5] }
    8588 15205 id (by native_decide) (by native_decide) (by decide)
    (fun st => applyNode_fw_multiref5_at_pos1_out pm st 1 8588 15201 15205 15209 15213 15217 (by decide))
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  simp only [id_eq] at s p0 p1
  exact ⟨by rw [s, h.value, ← p0, ← p1], by rw [s]; exact h.full_shape,
    by rw [p0]; exact h.shard0_shape, by rw [p1]; exact h.shard1_shape, by decide⟩

/-- Public pure-distributed exact 2-TP bridge for `mref5-pos1(5029)`. -/
theorem recon_intermediateGoal_7731_distributed (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    InitGoalHolds pm.numRanks intermediateGoal_7731
      (denoteGraphDistributed sm initSM) (denoteGraphDistributed pm initPM) :=
  Gather2Rel.to_initGoalHolds _ _ intermediateGoal_7731 7731 15182 15205
    [4096, 1024] [2048, 1024] rfl rfl rfl rfl rfl rfl
    (l7d_token7731_rel initSM initPM hSM hPM hInit)

private def layer7SmMoe : NodeDecl :=
  { rank := 0, op := "OpName.FW_all2all_moe_gmm",
    ins := [7731, 5033, 5034, 5036, 5037], outs := [5038], params := [64, 0, 64, 8] }
private def layer7PmMoe0 : NodeDecl :=
  { rank := 0, op := "OpName.FW_all2all_moe_gmm",
    ins := [15182, 8597, 8599, 8603, 8605], outs := [8607], params := [64, 0, 32, 8] }
private def layer7PmMoe1 : NodeDecl :=
  { rank := 1, op := "OpName.FW_all2all_moe_gmm",
    ins := [15205, 8598, 8600, 8604, 8606], outs := [8608], params := [64, 32, 64, 8] }

set_option maxRecDepth 1000000 in
private theorem layer7_sm_node265 : sm.nodes[265]'(by native_decide) = layer7SmMoe := by native_decide
set_option maxRecDepth 1000000 in
private theorem layer7_pm_node591 : pm.nodes[591]'(by native_decide) = layer7PmMoe0 := by native_decide
set_option maxRecDepth 1000000 in
private theorem layer7_pm_node594 : pm.nodes[594]'(by native_decide) = layer7PmMoe1 := by native_decide
set_option maxRecDepth 1000000 in
private theorem layer7_sm_buddies : sm.replicaBuddies layer7SmMoe = [layer7SmMoe] := by native_decide
set_option maxRecDepth 1000000 in
private theorem layer7_pm_buddies0 :
    pm.replicaBuddies layer7PmMoe0 = [layer7PmMoe0, layer7PmMoe1] := by native_decide
set_option maxRecDepth 1000000 in
private theorem layer7_pm_buddies1 :
    pm.replicaBuddies layer7PmMoe1 = [layer7PmMoe0, layer7PmMoe1] := by native_decide

set_option maxRecDepth 10000000 in
set_option maxHeartbeats 12000000 in
/-- Faithful pure-distributed full-expert reconstruction of the layer-7 MoE boundary. -/
theorem recon_intermediateGoal_5038_distributed (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    InitGoalHolds pm.numRanks intermediateGoal_5038
      (denoteGraphDistributed sm initSM) (denoteGraphDistributed pm initPM) := by
  have hi := l7d_token7731_rel initSM initPM hSM hPM hInit
  have hrp := Gather2Rel.of_initGoalHolds _ _ intermediateGoal_5033 5033 8597 8598
    [4096, 64] [2048, 64] rfl rfl rfl rfl rfl rfl (by decide)
    (recon_intermediateGoal_5033_distributed initSM initPM hSM hPM hInit)
  have hrm := Gather2Rel.of_initGoalHolds _ _ intermediateGoal_5034 5034 8599 8600
    [4096, 64] [2048, 64] rfl rfl rfl rfl rfl rfl (by decide)
    (recon_intermediateGoal_5034_distributed initSM initPM hSM hPM hInit)
  have hW13 := hInit initGoal_5036 (by native_decide)
  have hW2 := hInit initGoal_5037 (by native_decide)
  have hsW13 := hW13.2.1
  have hsW2 := hW2.2.1
  simp only [initGoal_5036, List.map, List.cons.injEq, and_true] at hsW13
  simp only [initGoal_5037, List.map, List.cons.injEq, and_true] at hsW2
  have hsW13A : (denoteGraphDistributed pm initPM 8603).shape = [32, 1024, 1024] := by
    rw [denoteGraphDistributed,
      foldl_applyNodeDistributed_at_not_written pm pm.nodes initPM 8603
        layer1_pm_nodes_nonempty (by native_decide)]
    exact hsW13.1
  have hsW13B : (denoteGraphDistributed pm initPM 8604).shape = [32, 1024, 1024] := by
    rw [denoteGraphDistributed,
      foldl_applyNodeDistributed_at_not_written pm pm.nodes initPM 8604
        layer1_pm_nodes_nonempty (by native_decide)]
    exact hsW13.2
  have hsW2A : (denoteGraphDistributed pm initPM 8605).shape = [32, 1024, 512] := by
    rw [denoteGraphDistributed,
      foldl_applyNodeDistributed_at_not_written pm pm.nodes initPM 8605
        layer1_pm_nodes_nonempty (by native_decide)]
    exact hsW2.1
  have hsW2B : (denoteGraphDistributed pm initPM 8606).shape = [32, 1024, 512] := by
    rw [denoteGraphDistributed,
      foldl_applyNodeDistributed_at_not_written pm pm.nodes initPM 8606
        layer1_pm_nodes_nonempty (by native_decide)]
    exact hsW2.2
  have hbrW13 : denoteGraphDistributed sm initSM 5036 = allGatherPrimDimN 0 2 0
      [denoteGraphDistributed pm initPM 8603, denoteGraphDistributed pm initPM 8604] := by
    have hv := hW13.2.2
    rw [reconstructForGoal_of_not_replicated initGoal_5036 pm.numRanks _ rfl] at hv
    simp only [initGoal_5036, List.map] at hv
    rw [reconstructWithDim_cons_cons_nonscalar 0 pm.numRanks 0 _ _ []
      (by rw [hsW13.1]; decide)] at hv
    have ds : denoteGraphDistributed sm initSM 5036 = initSM 5036 := by
      rw [denoteGraphDistributed]
      exact foldl_applyNodeDistributed_at_not_written sm sm.nodes initSM 5036
        layer1_sm_nodes_nonempty (by native_decide)
    have dp0 : denoteGraphDistributed pm initPM 8603 = initPM 8603 := by
      rw [denoteGraphDistributed]
      exact foldl_applyNodeDistributed_at_not_written pm pm.nodes initPM 8603
        layer1_pm_nodes_nonempty (by native_decide)
    have dp1 : denoteGraphDistributed pm initPM 8604 = initPM 8604 := by
      rw [denoteGraphDistributed]
      exact foldl_applyNodeDistributed_at_not_written pm pm.nodes initPM 8604
        layer1_pm_nodes_nonempty (by native_decide)
    rw [ds, dp0, dp1]
    exact hv
  have hbrW2 : denoteGraphDistributed sm initSM 5037 = allGatherPrimDimN 0 2 0
      [denoteGraphDistributed pm initPM 8605, denoteGraphDistributed pm initPM 8606] := by
    have hv := hW2.2.2
    rw [reconstructForGoal_of_not_replicated initGoal_5037 pm.numRanks _ rfl] at hv
    simp only [initGoal_5037, List.map] at hv
    rw [reconstructWithDim_cons_cons_nonscalar 0 pm.numRanks 0 _ _ []
      (by rw [hsW2.1]; decide)] at hv
    have ds : denoteGraphDistributed sm initSM 5037 = initSM 5037 := by
      rw [denoteGraphDistributed]
      exact foldl_applyNodeDistributed_at_not_written sm sm.nodes initSM 5037
        layer1_sm_nodes_nonempty (by native_decide)
    have dp0 : denoteGraphDistributed pm initPM 8605 = initPM 8605 := by
      rw [denoteGraphDistributed]
      exact foldl_applyNodeDistributed_at_not_written pm pm.nodes initPM 8605
        layer1_pm_nodes_nonempty (by native_decide)
    have dp1 : denoteGraphDistributed pm initPM 8606 = initPM 8606 := by
      rw [denoteGraphDistributed]
      exact foldl_applyNodeDistributed_at_not_written pm pm.nodes initPM 8606
        layer1_pm_nodes_nonempty (by native_decide)
    rw [ds, dp0, dp1]
    exact hv
  have hW13single : allGatherPrimDimN 0 1 0 [denoteGraphDistributed sm initSM 5036] =
      denoteGraphDistributed sm initSM 5036 := by
    have hs : (denoteGraphDistributed sm initSM 5036).shape = [64, 1024, 1024] := by
      rw [hbrW13, allGatherPrimDimN_shape 0 2 _ [32, 1024, 1024] (by simp [hsW13A])]
      simp [List.set]
    exact allGatherPrimDimN_singleton_eq 0 _ (by rw [hs]; decide)
  have hW2single : allGatherPrimDimN 0 1 0 [denoteGraphDistributed sm initSM 5037] =
      denoteGraphDistributed sm initSM 5037 := by
    have hs : (denoteGraphDistributed sm initSM 5037).shape = [64, 1024, 512] := by
      rw [hbrW2, allGatherPrimDimN_shape 0 2 _ [32, 1024, 512] (by simp [hsW2A])]
      simp [List.set]
    exact allGatherPrimDimN_singleton_eq 0 _ (by rw [hs]; decide)
  have hSMout : denoteGraphDistributed sm initSM 5038 =
      fw_all2all_moe_gmm_full (denoteGraphDistributed sm initSM 7731)
        (denoteGraphDistributed sm initSM 5033) (denoteGraphDistributed sm initSM 5034)
        [denoteGraphDistributed pm initPM 8603, denoteGraphDistributed pm initPM 8604]
        [denoteGraphDistributed pm initPM 8605, denoteGraphDistributed pm initPM 8606]
        64 8 (((10 : Nat) : Scalar)) := by
    have hk : 265 < sm.nodes.length := by native_decide
    rw [distributed_moe_reduce sm initSM 265 layer7SmMoe 5038 hk
      (show sm.nodes[265]'hk = layer7SmMoe from layer7_sm_node265)
      rfl rfl (by native_decide) (by native_decide)]
    unfold applyNodeFullExpertMoE_value
    rw [layer7_sm_buddies]
    simp only [layer7SmMoe, List.map, List.getD, List.getElem?_cons_zero,
      List.getElem?_cons_succ, List.getElem?_nil, Option.getD_some, Option.getD_none]
    rw [foldl_take_distributed_eq sm initSM 7731 265 (by native_decide) (by native_decide),
      foldl_take_distributed_eq sm initSM 5033 265 (by native_decide) (by native_decide),
      foldl_take_distributed_eq sm initSM 5034 265 (by native_decide) (by native_decide),
      foldl_take_distributed_eq sm initSM 5036 265 (by native_decide) (by native_decide),
      foldl_take_distributed_eq sm initSM 5037 265 (by native_decide) (by native_decide)]
    unfold fw_all2all_moe_gmm_full
    simp only [List.length_cons, List.length_nil]
    rw [hW13single, hW2single, hbrW13, hbrW2]
  have hP0 : denoteGraphDistributed pm initPM 8607 =
      fw_all2all_moe_gmm_full (denoteGraphDistributed pm initPM 15182)
        (denoteGraphDistributed pm initPM 8597) (denoteGraphDistributed pm initPM 8599)
        [denoteGraphDistributed pm initPM 8603, denoteGraphDistributed pm initPM 8604]
        [denoteGraphDistributed pm initPM 8605, denoteGraphDistributed pm initPM 8606]
        64 8 (((10 : Nat) : Scalar)) := by
    have hk : 591 < pm.nodes.length := by native_decide
    rw [distributed_moe_reduce pm initPM 591 layer7PmMoe0 8607 hk
      (show pm.nodes[591]'hk = layer7PmMoe0 from layer7_pm_node591)
      rfl rfl (by native_decide) (by native_decide)]
    unfold applyNodeFullExpertMoE_value
    rw [layer7_pm_buddies0]
    simp only [layer7PmMoe0, layer7PmMoe1, List.map, List.getD, List.getElem?_cons_zero,
      List.getElem?_cons_succ, List.getElem?_nil, Option.getD_some, Option.getD_none]
    rw [foldl_take_distributed_eq pm initPM 15182 591 (by native_decide) (by native_decide),
      foldl_take_distributed_eq pm initPM 8597 591 (by native_decide) (by native_decide),
      foldl_take_distributed_eq pm initPM 8599 591 (by native_decide) (by native_decide),
      foldl_take_distributed_eq pm initPM 8603 591 (by native_decide) (by native_decide),
      foldl_take_distributed_eq pm initPM 8604 591 (by native_decide) (by native_decide),
      foldl_take_distributed_eq pm initPM 8605 591 (by native_decide) (by native_decide),
      foldl_take_distributed_eq pm initPM 8606 591 (by native_decide) (by native_decide)]
  have hP1 : denoteGraphDistributed pm initPM 8608 =
      fw_all2all_moe_gmm_full (denoteGraphDistributed pm initPM 15205)
        (denoteGraphDistributed pm initPM 8598) (denoteGraphDistributed pm initPM 8600)
        [denoteGraphDistributed pm initPM 8603, denoteGraphDistributed pm initPM 8604]
        [denoteGraphDistributed pm initPM 8605, denoteGraphDistributed pm initPM 8606]
        64 8 (((10 : Nat) : Scalar)) := by
    have hk : 594 < pm.nodes.length := by native_decide
    rw [distributed_moe_reduce pm initPM 594 layer7PmMoe1 8608 hk
      (show pm.nodes[594]'hk = layer7PmMoe1 from layer7_pm_node594)
      rfl rfl (by native_decide) (by native_decide)]
    unfold applyNodeFullExpertMoE_value
    rw [layer7_pm_buddies1]
    simp only [layer7PmMoe0, layer7PmMoe1, List.map, List.getD, List.getElem?_cons_zero,
      List.getElem?_cons_succ, List.getElem?_nil, Option.getD_some, Option.getD_none]
    rw [foldl_take_distributed_eq pm initPM 15205 594 (by native_decide) (by native_decide),
      foldl_take_distributed_eq pm initPM 8598 594 (by native_decide) (by native_decide),
      foldl_take_distributed_eq pm initPM 8600 594 (by native_decide) (by native_decide),
      foldl_take_distributed_eq pm initPM 8603 594 (by native_decide) (by native_decide),
      foldl_take_distributed_eq pm initPM 8604 594 (by native_decide) (by native_decide),
      foldl_take_distributed_eq pm initPM 8605 594 (by native_decide) (by native_decide),
      foldl_take_distributed_eq pm initPM 8606 594 (by native_decide) (by native_decide)]
  have hc := fw_all2all_moe_gmm_full_split_commute_2
    (denoteGraphDistributed pm initPM 15182) (denoteGraphDistributed pm initPM 15205)
    (denoteGraphDistributed pm initPM 8597) (denoteGraphDistributed pm initPM 8598)
    (denoteGraphDistributed pm initPM 8599) (denoteGraphDistributed pm initPM 8600)
    ...
    hi.shard0_shape hi.shard1_shape hrp.shard0_shape hrp.shard1_shape
    hrm.shard0_shape hrm.shard1_shape hsW13A hsW13B hsW2A hsW2B
  have hval : denoteGraphDistributed sm initSM 5038 = allGatherPrimDimN 0 pm.numRanks 0
      [denoteGraphDistributed pm initPM 8607, denoteGraphDistributed pm initPM 8608] := by
    rw [hSMout, hi.value, hrp.value, hrm.value, hc, ← hP0, ← hP1,
      show pm.numRanks = 2 from rfl]
  have hsP0 : (denoteGraphDistributed pm initPM 8607).shape = [2048, 1024] := by
    rw [hP0]
    exact fw_all2all_moe_gmm_full_shape
      (input := denoteGraphDistributed pm initPM 15182)
      (rp := denoteGraphDistributed pm initPM 8597)
      (rm := denoteGraphDistributed pm initPM 8599)
      (w13s := [denoteGraphDistributed pm initPM 8603, denoteGraphDistributed pm initPM 8604])
      (w2s := [denoteGraphDistributed pm initPM 8605, denoteGraphDistributed pm initPM 8606])
      (numExp := 64) (topK := 8) (swigluLimit := (((10 : Nat) : Scalar)))
      (lDim := 2048) (hModel := 1024)
      (by rw [hi.shard0_shape]; rfl) (by rw [hi.shard0_shape]; rfl)
  have hsP1 : (denoteGraphDistributed pm initPM 8608).shape = [2048, 1024] := by
    rw [hP1]
    exact fw_all2all_moe_gmm_full_shape
      (input := denoteGraphDistributed pm initPM 15205)
      (rp := denoteGraphDistributed pm initPM 8598)
      (rm := denoteGraphDistributed pm initPM 8600)
      (w13s := [denoteGraphDistributed pm initPM 8603, denoteGraphDistributed pm initPM 8604])
      (w2s := [denoteGraphDistributed pm initPM 8605, denoteGraphDistributed pm initPM 8606])
      (numExp := 64) (topK := 8) (swigluLimit := (((10 : Nat) : Scalar)))
      (lDim := 2048) (hModel := 1024)
      (by rw [hi.shard1_shape]; rfl) (by rw [hi.shard1_shape]; rfl)
  have hsSM : (denoteGraphDistributed sm initSM 5038).shape = [4096, 1024] := by
    rw [hval, show pm.numRanks = 2 from rfl,
      allGatherPrimDimN_shape 0 2 _ [2048, 1024] (by simp [hsP0])]
    simp [List.set]
  exact wrap_2tp_allGather_gen _ _ intermediateGoal_5038 5038 8607 8608
    [4096, 1024] [2048, 1024] rfl rfl rfl rfl rfl rfl (by decide)
    hval hsSM hsP0 hsP1

/-! ### Next-layer pure-distributed post-MoE residual tail. -/

private theorem l7d_carry7720_rel (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    Gather2Rel (denoteGraphDistributed sm initSM 7720)
      (denoteGraphDistributed pm initPM 15163) (denoteGraphDistributed pm initPM 15171)
      [4096, 1024] [2048, 1024] := by
  have h := Gather2Rel.of_initGoalHolds _ _ intermediateGoal_5027 5027 8583 8584
    [4096, 1024] [2048, 1024] rfl rfl rfl rfl rfl rfl (by decide)
    (recon_intermediateGoal_5027_distributed initSM initPM hSM hPM hInit)
  have rs := distributed_reduce1 sm initSM 250
    { rank := 0, op := "OpName.FW_multiref", ins := [5027], outs := [7716, 7720], params := [2] }
    5027 7720 id (by native_decide) (by native_decide) (by decide)
    (fun st => applyNode_fw_multiref2_second_out' sm st 0 5027 7716 7720 (by decide))
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have r0 := distributed_reduce1 pm initPM 561
    { rank := 0, op := "OpName.FW_multiref", ins := [8583], outs := [15159, 15163], params := [2] }
    8583 15163 id (by native_decide) (by native_decide) (by decide)
    (fun st => applyNode_fw_multiref2_second_out' pm st 0 8583 15159 15163 (by decide))
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have r1 := distributed_reduce1 pm initPM 562
    { rank := 1, op := "OpName.FW_multiref", ins := [8584], outs := [15167, 15171], params := [2] }
    8584 15171 id (by native_decide) (by native_decide) (by decide)
    (fun st => applyNode_fw_multiref2_second_out' pm st 1 8584 15167 15171 (by decide))
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  simp only [id_eq] at rs r0 r1
  exact ⟨by rw [rs, h.value, ← r0, ← r1], by rw [rs]; exact h.full_shape,
    by rw [r0]; exact h.shard0_shape, by rw [r1]; exact h.shard1_shape, by decide⟩

/-- Pure-distributed exact 2-TP `mref2`-second carry of the pre-MoE residual `5027`. -/
theorem recon_intermediateGoal_7720_distributed (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    InitGoalHolds pm.numRanks intermediateGoal_7720
      (denoteGraphDistributed sm initSM) (denoteGraphDistributed pm initPM) :=
  Gather2Rel.to_initGoalHolds _ _ intermediateGoal_7720 7720 15163 15171
    [4096, 1024] [2048, 1024] rfl rfl rfl rfl rfl rfl
    (l7d_carry7720_rel initSM initPM hSM hPM hInit)

private theorem l7d_add5058_rel (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    Gather2Rel (denoteGraphDistributed sm initSM 5058)
      (denoteGraphDistributed pm initPM 8685) (denoteGraphDistributed pm initPM 8686)
      [4096, 1024] [2048, 1024] := by
  have ha := Gather2Rel.of_initGoalHolds _ _ intermediateGoal_5038 5038 8607 8608
    [4096, 1024] [2048, 1024] rfl rfl rfl rfl rfl rfl (by decide)
    (recon_intermediateGoal_5038_distributed initSM initPM hSM hPM hInit)
  have hb := l6d_mul5057_rel initSM initPM hSM hPM hInit
  have rs := distributed_reduce2 sm initSM 272
    { rank := 0, op := "OpName.FW_add", ins := [5038, 5057], outs := [5058] }
    5038 5057 5058 elemwiseAdd (by native_decide) (by native_decide) (by decide)
    (fun st => applyNode_fw_add2_out sm st 0 5038 5057 5058)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have r0 := distributed_reduce2 pm initPM 605
    { rank := 0, op := "OpName.FW_add", ins := [8607, 8681], outs := [8685] }
    8607 8681 8685 elemwiseAdd (by native_decide) (by native_decide) (by decide)
    (fun st => applyNode_fw_add2_out pm st 0 8607 8681 8685)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have r1 := distributed_reduce2 pm initPM 606
    { rank := 1, op := "OpName.FW_add", ins := [8608, 8682], outs := [8686] }
    8608 8682 8686 elemwiseAdd (by native_decide) (by native_decide) (by decide)
    (fun st => applyNode_fw_add2_out pm st 1 8608 8682 8686)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  refine ⟨?_, ?_, ?_, ?_, by decide⟩
...
/-- Pure-distributed exact 2-TP post-MoE residual add `5038 + 5057`. -/
theorem recon_intermediateGoal_5058_distributed (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    InitGoalHolds pm.numRanks intermediateGoal_5058
      (denoteGraphDistributed sm initSM) (denoteGraphDistributed pm initPM) :=
  Gather2Rel.to_initGoalHolds _ _ intermediateGoal_5058 5058 8685 8686
    [4096, 1024] [2048, 1024] rfl rfl rfl rfl rfl rfl
    (l7d_add5058_rel initSM initPM hSM hPM hInit)

private theorem l7d_float5059_rel (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    Gather2Rel (denoteGraphDistributed sm initSM 5059)
      (denoteGraphDistributed pm initPM 8691) (denoteGraphDistributed pm initPM 8692)
      [4096, 1024] [2048, 1024] := by
  have h := l7d_add5058_rel initSM initPM hSM hPM hInit
  have rs := l6d_float sm initSM 273 0 5058 5059 (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have r0 := l6d_float pm initPM 607 0 8685 8691 (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have r1 := l6d_float pm initPM 608 1 8686 8692 (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  exact ⟨by rw [rs, h.value, r0, r1], by rw [rs]; exact h.full_shape,
    by rw [r0]; exact h.shard0_shape, by rw [r1]; exact h.shard1_shape, by decide⟩

/-- Pure-distributed exact 2-TP identity float of the post-MoE residual. -/
theorem recon_intermediateGoal_5059_distributed (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    InitGoalHolds pm.numRanks intermediateGoal_5059
      (denoteGraphDistributed sm initSM) (denoteGraphDistributed pm initPM) :=
  Gather2Rel.to_initGoalHolds _ _ intermediateGoal_5059 5059 8691 8692
    [4096, 1024] [2048, 1024] rfl rfl rfl rfl rfl rfl
    (l7d_float5059_rel initSM initPM hSM hPM hInit)

/-- Pure-distributed exact 2-TP cross-block residual add `7720 + 5059`. -/
theorem recon_intermediateGoal_5060_distributed (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    InitGoalHolds pm.numRanks intermediateGoal_5060
      (denoteGraphDistributed sm initSM) (denoteGraphDistributed pm initPM) := by
  have ha := l7d_carry7720_rel initSM initPM hSM hPM hInit
  have hb := l7d_float5059_rel initSM initPM hSM hPM hInit
  have rs := distributed_reduce2 sm initSM 274
    { rank := 0, op := "OpName.FW_add", ins := [7720, 5059], outs := [5060] }
    7720 5059 5060 elemwiseAdd (by native_decide) (by native_decide) (by decide)
    (fun st => applyNode_fw_add2_out sm st 0 7720 5059 5060)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have r0 := distributed_reduce2 pm initPM 609
    { rank := 0, op := "OpName.FW_add", ins := [15163, 8691], outs := [8695] }
    15163 8691 8695 elemwiseAdd (by native_decide) (by native_decide) (by decide)
    (fun st => applyNode_fw_add2_out pm st 0 15163 8691 8695)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have r1 := distributed_reduce2 pm initPM 610
    { rank := 1, op := "OpName.FW_add", ins := [15171, 8692], outs := [8696] }
    15171 8692 8696 elemwiseAdd (by native_decide) (by native_decide) (by decide)
    (fun st => applyNode_fw_add2_out pm st 1 15171 8692 8696)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  have hv : denoteGraphDistributed sm initSM 5060 = allGatherPrimDimN 0 pm.numRanks 0
      [denoteGraphDistributed pm initPM 8695, denoteGraphDistributed pm initPM 8696] := by
    rw [rs, ha.value, hb.value, show pm.numRanks = 2 from rfl,
      fw_add_allGather0_commute_2_2048_1024 _ _ _ _ ha.shard0_shape ha.shard1_shape
        hb.shard0_shape hb.shard1_shape, ← r0, ← r1]
  have hs0 : (denoteGraphDistributed pm initPM 8695).shape = [2048, 1024] := by
    rw [r0]; exact elemwiseAdd_shape_of_shapes _ _ _ ha.shard0_shape hb.shard0_shape
  have hs1 : (denoteGraphDistributed pm initPM 8696).shape = [2048, 1024] := by
    rw [r1]; exact elemwiseAdd_shape_of_shapes _ _ _ ha.shard1_shape hb.shard1_shape
  have hs : (denoteGraphDistributed sm initSM 5060).shape = [4096, 1024] := by
    rw [rs]; exact elemwiseAdd_shape_of_shapes _ _ _ ha.full_shape hb.full_shape
  exact wrap_2tp_allGather_gen _ _ intermediateGoal_5060 5060 8695 8696
    [4096, 1024] [2048, 1024] rfl rfl rfl rfl rfl rfl (by decide) hv hs hs0 hs1
