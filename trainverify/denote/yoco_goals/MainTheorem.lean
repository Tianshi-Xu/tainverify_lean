...
This module composes the exact ancestry-closed faithful full statements for all
five goals.
...
/-- The five exact ancestry-closed faithful public statements. -/
def FullPatternTier : Prop :=
  goal_1_stmt_full ∧
  goal_2_stmt_full ∧
  goal_3_stmt_full ∧
  goal_4_stmt_full ∧
...
/-- All five faithful full statements hold. -/
theorem full_pattern_tier : FullPatternTier := by
...
theorem yoco_moe_corrected_main : FullPatternTier :=
  full_pattern_tier
