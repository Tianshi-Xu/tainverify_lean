...
import denote.yoco_goals.L2OrdinaryMoENorm
...
theorem l2_ordinary_moe_logits_from_norm_input (initSM initPM : Store)
    ...
    Gather2Rel
      ...
      [4096, 64] [2048, 64] := by
  have hwEq := l2OMr_weight_eq initSM initPM hInit
  have hwShape := l2OMr_weight_shape initPM hPM
  ...
  rw [l2OMr_red_sm5072 initSM, l2OMr_red_sm5070 initSM,
    l2OMr_red_sm7880 initSM, hwEq,
    l2OMr_red_pm8168 initPM, l2OMr_red_pm8169 initPM,
    l2OMr_red_pm5072 initPM, l2OMr_red_pm5070 initPM,
    l2OMr_red_pm11806 initPM, l2OMr_red_pm15312 initPM,
    l2OMr_red_pm15314 initPM,
    ...
    l2OMr_chunk_gather0 _ _ hp0Shape hp1Shape,
    l2OMr_chunk_gather1 _ _ hp0Shape hp1Shape]
  exact hLocal
...
theorem l2_ordinary_moe_router_from_norm_input (initSM initPM : Store)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
    (hInit : InitGoalsHold pm_goal_1.numRanks initGoals initSM initPM)
    (hNorm : Gather2Rel
      (denoteGraphDistributedFaithful sm_goal_1 initSM 5069)
    ...
    Gather2Rel
      ...
      [4096, 64] [2048, 64] := by
  have hLogits := l2_ordinary_moe_logits_from_norm_input initSM initPM hPM hInit hNorm
  ...
  rw [l2OMr_red_sm5073 initSM hLogits.full_shape,
    l2OMr_red_pm8170 initPM hLogits.shard0_shape,
    l2OMr_red_pm8171 initPM hLogits.shard1_shape,
    l2OMr_red_sm5074 initSM hLogits.full_shape,
    l2OMr_red_pm8172 initPM hLogits.shard0_shape,
    l2OMr_red_pm8173 initPM hLogits.shard1_shape]
  exact ⟨hProbs, hMap⟩

/-- The real scalar-gate branch preserves ordinary dim-0 layout. -/
theorem l2_ordinary_moe_gate_from_norm_input (initSM initPM : Store)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
    (hInit : InitGoalsHold pm_goal_1.numRanks initGoals initSM initPM)
    (hNorm : Gather2Rel
      (denoteGraphDistributedFaithful sm_goal_1 initSM 5069)
  ...
  have hSource : Gather2Rel
    ...
    rw [l2OMrg_red_sm7888 initSM, l2OMrg_red_pm12672 initPM,
      l2OMrg_red_pm12673 initPM]
    exact hNorm
  have hReshape : Gather2Rel
      ...
      [4096, 1024] [2048, 1024] := by
    rw [l2OMrg_red_sm5079 initSM, l2OMrg_red_pm8182 initPM,
      l2OMrg_red_pm8183 initPM]
    exact Gather2Rel.view_id hSource
  have hwEq := l2OMrg_weight_eq initSM initPM hInit
  have hwShape := l2OMrg_weight_shape initPM hPM
  have hLinear : Gather2Rel
      ...
      [4096, 1] [2048, 1] := by
    rw [l2OMrg_red_sm5081 initSM, l2OMrg_red_pm8186 initPM,
      l2OMrg_red_pm8187 initPM, hwEq]
  ...
  have hView : Gather2Rel
      ...
      [4096, 1] [2048, 1] := by
    rw [l2OMrg_red_sm5082 initSM, l2OMrg_red_pm8188 initPM,
      l2OMrg_red_pm8189 initPM]
    exact Gather2Rel.view_id hLinear
  rw [l2OMrg_red_sm5083 initSM, l2OMrg_red_pm8190 initPM,
    l2OMrg_red_pm8191 initPM]
...
theorem l2_ordinary_moe_router_from_attention_output (initSM initPM : Store)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
    ...
    Gather2Rel
      ...
      (denoteGraphDistributedFaithful pm_goal_1 initPM 8173)
      [4096, 64] [2048, 64] := by
  have hNorm := l2_ordinary_moe_norm_from_attention_output
    initSM initPM hInit hAttention
  exact l2_ordinary_moe_router_from_norm_input initSM initPM hPM hInit hNorm

/-- The ordinary scalar gate is closed directly from attention output. -/
theorem l2_ordinary_moe_gate_from_attention_output (initSM initPM : Store)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
    (hInit : InitGoalsHold pm_goal_1.numRanks goal_1_full_initGoals initSM initPM)
    (hAttention : Gather2Rel
      (denoteGraphDistributedFaithful sm_goal_1 initSM 5067)
  ...
  have hNorm := l2_ordinary_moe_norm_from_attention_output
    initSM initPM hInit hAttention
  exact l2_ordinary_moe_gate_from_norm_input initSM initPM hPM hInit hNorm

#print axioms l2_ordinary_moe_router_from_norm_input
#print axioms l2_ordinary_moe_gate_from_norm_input
#print axioms l2_ordinary_moe_router_from_attention_output
#print axioms l2_ordinary_moe_gate_from_attention_output
