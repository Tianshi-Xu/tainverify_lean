/- L0 ordinary MoE composition from attention residual to block output. -/
import denote.yoco_goals.L0OrdinaryMoEBoundary
import denote.yoco_goals.L0OrdinaryMoEExpert
...
theorem l0_ordinary_moe_composition (initSM initPM : Store)
