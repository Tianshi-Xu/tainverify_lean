...
import denote.yoco_goals.L6OrdinaryMoERouterGate
...
private theorem l6OMOe_reduce5
...
private theorem l6OMOe_reduce7
    (g : GraphDecl) (init : Store) (k : Nat) (node : NodeDecl)
...
private def l6OMOeSmMoE : NodeDecl :=
  { rank := 0, op := "OpName.FW_all2all_moe_gmm",
    ins := [8092, 5293, 5294, 5296, 5297], outs := [5298],
    params := [64, 0, 64, 8] }
private def l6OMOePmMoE0 : NodeDecl :=
  { rank := 0, op := "OpName.FW_all2all_moe_gmm",
    ins := [13166, 8826, 8828, 8832, 8834], outs := [8836],
    params := [64, 0, 32, 8] }
private def l6OMOePmMoE1 : NodeDecl :=
  { rank := 1, op := "OpName.FW_all2all_moe_gmm",
    ins := [13167, 8827, 8829, 8833, 8835], outs := [8837],
    params := [64, 32, 64, 8] }

private theorem l6OMOe_buddies_sm :
    sm_goal_1.replicaBuddies l6OMOeSmMoE = [l6OMOeSmMoE] := by
  native_decide

private theorem l6OMOe_buddies_pm0 :
    pm_goal_1.replicaBuddies l6OMOePmMoE0 = [l6OMOePmMoE0, l6OMOePmMoE1] := by
  native_decide

private theorem l6OMOe_buddies_pm1 :
    pm_goal_1.replicaBuddies l6OMOePmMoE1 = [l6OMOePmMoE0, l6OMOePmMoE1] := by
  native_decide

private theorem l6OMOe_red_sm5298 (initSM : Store) :
    denoteGraphDistributedFaithful sm_goal_1 initSM 5298 =
      fw_all2all_moe_gmm_full
        ...
        [denoteGraphDistributedFaithful sm_goal_1 initSM 5296]
        [denoteGraphDistributedFaithful sm_goal_1 initSM 5297]
        64 8 (((10 : Nat) : Scalar)) := by
  refine l6OMOe_reduce5 sm_goal_1 initSM 265 l6OMOeSmMoE
    8092 5293 5294 5296 5297 5298
  ...
  intro s
  have hb := l6OMOe_buddies_sm
  unfold l6OMOeSmMoE at hb ⊢
  rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective _ _ _
    (by decide) (by decide) (by decide)]
  rw [applyNodeDistributed_moe_out sm_goal_1 s 0 8092 5293 5294 5296 5297 5298
    [64, 0, 64, 8]]
  unfold applyNodeFullExpertMoE_value
  rw [hb]
  rfl

private theorem l6OMOe_red_pm8836 (initPM : Store) :
    denoteGraphDistributedFaithful pm_goal_1 initPM 8836 =
      fw_all2all_moe_gmm_full
        ...
        [denoteGraphDistributedFaithful pm_goal_1 initPM 8832,
         denoteGraphDistributedFaithful pm_goal_1 initPM 8833]
        [denoteGraphDistributedFaithful pm_goal_1 initPM 8834,
         denoteGraphDistributedFaithful pm_goal_1 initPM 8835]
        64 8 (((10 : Nat) : Scalar)) := by
  refine l6OMOe_reduce7 pm_goal_1 initPM 607 l6OMOePmMoE0
    13166 8826 8828 8832 8834 8833 8835 8836
  ...
  intro s
  have hb := l6OMOe_buddies_pm0
  unfold l6OMOePmMoE0 at hb ⊢
  rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective _ _ _
    (by decide) (by decide) (by decide)]
  rw [applyNodeDistributed_moe_out pm_goal_1 s 0 13166 8826 8828 8832 8834 8836
    [64, 0, 32, 8]]
  unfold applyNodeFullExpertMoE_value
  rw [hb]
  rfl

private theorem l6OMOe_red_pm8837 (initPM : Store) :
    denoteGraphDistributedFaithful pm_goal_1 initPM 8837 =
      fw_all2all_moe_gmm_full
        ...
        [denoteGraphDistributedFaithful pm_goal_1 initPM 8834,
         denoteGraphDistributedFaithful pm_goal_1 initPM 8835]
        64 8 (((10 : Nat) : Scalar)) := by
  refine l6OMOe_reduce7 pm_goal_1 initPM 608 l6OMOePmMoE1
    13167 8827 8829 8832 8833 8834 8835 8837
    ...
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
  intro s
  have hb := l6OMOe_buddies_pm1
  unfold l6OMOePmMoE1 at hb ⊢
  rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective _ _ _
    (by decide) (by decide) (by decide)]
  rw [applyNodeDistributed_moe_out pm_goal_1 s 1 13167 8827 8829 8833 8835 8837
    [64, 32, 64, 8]]
  unfold applyNodeFullExpertMoE_value
  rw [hb]
  rfl

private theorem l6OMOe_leaf (g : GraphDecl) (init : Store) (tid : Tid)
...
private theorem l6OMOe_weight_bridge (initSM initPM : Store)
...
theorem l6_ordinary_moe_expert_from_branch_inputs (initSM initPM : Store)
  ...
  have hbW13 : initSM 5296 = allGatherPrimDimN 0 2 0 [initPM 8832, initPM 8833] :=
    l6OMOe_weight_bridge initSM initPM hInit initGoal_5296 (by native_decide)
      5296 8832 8833 [32, 1024, 1024] rfl rfl rfl rfl rfl (by decide)
  have hbW2 : initSM 5297 = allGatherPrimDimN 0 2 0 [initPM 8834, initPM 8835] :=
    l6OMOe_weight_bridge initSM initPM hInit initGoal_5297 (by native_decide)
      5297 8834 8835 [32, 1024, 512] rfl rfl rfl rfl rfl (by decide)
  have hW13 : Gather2Rel
      (denoteGraphDistributedFaithful sm_goal_1 initSM 5296)
      (denoteGraphDistributedFaithful pm_goal_1 initPM 8832)
      (denoteGraphDistributedFaithful pm_goal_1 initPM 8833)
      [64, 1024, 1024] [32, 1024, 1024] := by
    rw [l6OMOe_leaf sm_goal_1 initSM 5296 (by native_decide) (by native_decide),
      l6OMOe_leaf pm_goal_1 initPM 8832 (by native_decide) (by native_decide),
      l6OMOe_leaf pm_goal_1 initPM 8833 (by native_decide) (by native_decide)]
    exact ⟨hbW13, hSM 5296 _ (by native_decide), hPM 8832 _ (by native_decide),
      hPM 8833 _ (by native_decide), by decide⟩
  have hW2 : Gather2Rel
      (denoteGraphDistributedFaithful sm_goal_1 initSM 5297)
      (denoteGraphDistributedFaithful pm_goal_1 initPM 8834)
      (denoteGraphDistributedFaithful pm_goal_1 initPM 8835)
      [64, 1024, 512] [32, 1024, 512] := by
    rw [l6OMOe_leaf sm_goal_1 initSM 5297 (by native_decide) (by native_decide),
      l6OMOe_leaf pm_goal_1 initPM 8834 (by native_decide) (by native_decide),
      l6OMOe_leaf pm_goal_1 initPM 8835 (by native_decide) (by native_decide)]
    exact ⟨hbW2, hSM 5297 _ (by native_decide), hPM 8834 _ (by native_decide),
      hPM 8835 _ (by native_decide), by decide⟩
  have hfullNode : denoteGraphDistributedFaithful sm_goal_1 initSM 5298 =
      fw_all2all_moe_gmm_full
        (denoteGraphDistributedFaithful sm_goal_1 initSM 8092)
        (denoteGraphDistributedFaithful sm_goal_1 initSM 5293)
        (denoteGraphDistributedFaithful sm_goal_1 initSM 5294)
  ...
  have houtShape : (denoteGraphDistributedFaithful sm_goal_1 initSM 5298).shape =
      [4096, 1024] := by
    rw [l6OMOe_red_sm5298 initSM]
    exact fw_all2all_moe_gmm_full_shape _ _ _ _ _ _ _ _ 4096 1024
      (by rw [hX.full_shape]; rfl) (by rw [hX.full_shape]; rfl)
  have hout0Shape : (denoteGraphDistributedFaithful pm_goal_1 initPM 8836).shape =
      [2048, 1024] := by
    rw [l6OMOe_red_pm8836 initPM]
    exact fw_all2all_moe_gmm_full_shape _ _ _ _ _ _ _ _ 2048 1024
      (by rw [hX.shard0_shape]; rfl) (by rw [hX.shard0_shape]; rfl)
  have hout1Shape : (denoteGraphDistributedFaithful pm_goal_1 initPM 8837).shape =
      [2048, 1024] := by
    rw [l6OMOe_red_pm8837 initPM]
    exact fw_all2all_moe_gmm_full_shape _ _ _ _ _ _ _ _ 2048 1024
      (by rw [hX.shard1_shape]; rfl) (by rw [hX.shard1_shape]; rfl)
  exact gather2Rel_fullExpertMoE_boundary
    (input := denoteGraphDistributedFaithful sm_goal_1 initSM 8092)
    (input0 := denoteGraphDistributedFaithful pm_goal_1 initPM 13166)
    (input1 := denoteGraphDistributedFaithful pm_goal_1 initPM 13167)
    (rp := denoteGraphDistributedFaithful sm_goal_1 initSM 5293)
    (rp0 := denoteGraphDistributedFaithful pm_goal_1 initPM 8826)
    (rp1 := denoteGraphDistributedFaithful pm_goal_1 initPM 8827)
    (rm := denoteGraphDistributedFaithful sm_goal_1 initSM 5294)
    (rm0 := denoteGraphDistributedFaithful pm_goal_1 initPM 8828)
    (rm1 := denoteGraphDistributedFaithful pm_goal_1 initPM 8829)
    (w130 := denoteGraphDistributedFaithful pm_goal_1 initPM 8832)
    (w131 := denoteGraphDistributedFaithful pm_goal_1 initPM 8833)
    (w20 := denoteGraphDistributedFaithful pm_goal_1 initPM 8834)
    (w21 := denoteGraphDistributedFaithful pm_goal_1 initPM 8835)
    (out := denoteGraphDistributedFaithful sm_goal_1 initSM 5298)
    (out0 := denoteGraphDistributedFaithful pm_goal_1 initPM 8836)
    (out1 := denoteGraphDistributedFaithful pm_goal_1 initPM 8837)
    ...
    hX hRP hRM (hPM 8832 _ (by native_decide)) (hPM 8833 _ (by native_decide))
    (hPM 8834 _ (by native_decide)) (hPM 8835 _ (by native_decide)) hfullNode
    (l6OMOe_red_pm8836 initPM) (l6OMOe_red_pm8837 initPM)
...
theorem l6_ordinary_moe_expert_from_attention_output (initSM initPM : Store)
    (hSM : StoreShapesHold initSM sm_goal_1InitEnv)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
    (hInit : InitGoalsHold pm_goal_1.numRanks goal_1_full_initGoals initSM initPM)
    ...
    Gather2Rel
      ...
      (denoteGraphDistributedFaithful pm_goal_1 initPM 8837)
      [4096, 1024] [2048, 1024] := by
  have hX := l6_ordinary_moe_activation_from_attention_output
    initSM initPM hInit hAttention
  have hRouter := l6_ordinary_moe_router_from_attention_output
    initSM initPM hPM hInit hAttention
  exact l6_ordinary_moe_expert_from_branch_inputs
    initSM initPM hSM hPM hInit hX hRouter.1 hRouter.2

#print axioms l6_ordinary_moe_expert_from_branch_inputs
#print axioms l6_ordinary_moe_expert_from_attention_output
