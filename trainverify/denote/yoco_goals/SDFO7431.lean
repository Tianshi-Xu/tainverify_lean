...
private def f1Sm7431 : NodeDecl :=
  { rank := 0, op := "OpName.FW_multiref", ins := [4705], outs := [7415, 7419, 7423, 7427, 7431],
    params := [5] }

private def f1Pm11879 : NodeDecl :=
  { rank := 1, op := "OpName.FW_multiref", ins := [4705], outs := [11875, 11876, 11877, 11878, 11879],
    params := [5] }

set_option maxRecDepth 1000000 in
private theorem f1_sn7431 : sm.nodes[18]'(by native_decide) = f1Sm7431 := by
  native_decide

set_option maxRecDepth 1000000 in
private theorem f1_pn11879 : pm.nodes[69]'(by native_decide) = f1Pm11879 := by
  native_decide

set_option maxRecDepth 10000000 in
set_option maxHeartbeats 16000000 in
theorem recon_intermediateGoal_7431_faithful (initSM initPM : Store)
  ...
  have rSM : denoteGraphDistributedFaithful sm initSM 7431 =
      denoteGraphDistributedFaithful sm initSM 4705 := by
    refine denoteGraphDistributedFaithful_reduce1 sm initSM 18 f1Sm7431 4705 7431
      (fun x => x) (by native_decide) f1_sn7431 ?_
    ...
    rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective _ _ _
      (by decide) (by decide)]
    exact applyNode_fw_multiref_at sm st 0 4705 [7415, 7419, 7423, 7427, 7431] 5 rfl 7431 (by decide)
  -- Both PM ranks write `11879`; anchor on the last writer.
  have rPM : denoteGraphDistributedFaithful pm initPM 11879 =
      denoteGraphDistributedFaithful pm initPM 4705 := by
    refine denoteGraphDistributedFaithful_reduce1 pm initPM 69 f1Pm11879 4705 11879
      (fun x => x) (by native_decide) f1_pn11879 ?_
    ...
    rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective _ _ _
      (by decide) (by decide)]
    exact applyNode_fw_multiref_at pm st 1 4705 [11875, 11876, 11877, 11878, 11879] 5 rfl 11879 (by decide)
  have hval : denoteGraphDistributedFaithful sm initSM 7431 =
      denoteGraphDistributedFaithful pm initPM 11879 := by
    rw [rSM, rPM, hv]
  have hshape : (denoteGraphDistributedFaithful sm initSM 7431).shape = [4096, 1024] := by
    rw [rSM]; exact hs
  ...
  simp only [intermediateGoal_7431, List.map]
