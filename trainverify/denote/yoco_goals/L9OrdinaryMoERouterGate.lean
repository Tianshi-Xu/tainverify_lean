...
import denote.yoco_goals.L9OrdinaryMoENorm
...
theorem l9_ordinary_moe_logits_from_norm_input (initSM initPM : Store)
    ...
    Gather2Rel
      ...
      [4096, 64] [2048, 64] := by
  have hwEq := l9OMr_weight_eq initSM initPM hInit
  have hwShape := l9OMr_weight_shape initPM hPM
  ...
  rw [l9OMr_red_sm5457 initSM, l9OMr_red_sm5455 initSM,
    l9OMr_red_sm8244 initSM, hwEq,
    l9OMr_red_pm9316 initPM, l9OMr_red_pm9317 initPM,
    l9OMr_red_pm5457 initPM, l9OMr_red_pm5455 initPM,
    l9OMr_red_pm12030 initPM, l9OMr_red_pm15368 initPM,
    l9OMr_red_pm15370 initPM,
    ...
    l9OMr_chunk_gather0 _ _ hp0Shape hp1Shape,
    l9OMr_chunk_gather1 _ _ hp0Shape hp1Shape]
  exact hLocal
...
theorem l9_ordinary_moe_router_from_norm_input (initSM initPM : Store)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
    (hInit : InitGoalsHold pm_goal_1.numRanks initGoals initSM initPM)
    (hNorm : Gather2Rel
      (denoteGraphDistributedFaithful sm_goal_1 initSM 5454)
    ...
    Gather2Rel
      ...
      [4096, 64] [2048, 64] := by
  have hLogits := l9_ordinary_moe_logits_from_norm_input initSM initPM hPM hInit hNorm
  ...
  rw [l9OMr_red_sm5458 initSM hLogits.full_shape,
    l9OMr_red_pm9318 initPM hLogits.shard0_shape,
    l9OMr_red_pm9319 initPM hLogits.shard1_shape,
    l9OMr_red_sm5459 initSM hLogits.full_shape,
    l9OMr_red_pm9320 initPM hLogits.shard0_shape,
    l9OMr_red_pm9321 initPM hLogits.shard1_shape]
  exact ⟨hProbs, hMap⟩

/-- The real scalar-gate branch preserves ordinary dim-0 layout. -/
theorem l9_ordinary_moe_gate_from_norm_input (initSM initPM : Store)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
    (hInit : InitGoalsHold pm_goal_1.numRanks initGoals initSM initPM)
    (hNorm : Gather2Rel
      (denoteGraphDistributedFaithful sm_goal_1 initSM 5454)
  ...
  have hSource : Gather2Rel
    ...
    rw [l9OMrg_red_sm8252 initSM, l9OMrg_red_pm13554 initPM,
      l9OMrg_red_pm13555 initPM]
    exact hNorm
  have hReshape : Gather2Rel
      ...
      [4096, 1024] [2048, 1024] := by
    rw [l9OMrg_red_sm5464 initSM, l9OMrg_red_pm9330 initPM,
      l9OMrg_red_pm9331 initPM]
    exact Gather2Rel.view_id hSource
  have hwEq := l9OMrg_weight_eq initSM initPM hInit
  have hwShape := l9OMrg_weight_shape initPM hPM
  have hLinear : Gather2Rel
      ...
      [4096, 1] [2048, 1] := by
    rw [l9OMrg_red_sm5466 initSM, l9OMrg_red_pm9334 initPM,
      l9OMrg_red_pm9335 initPM, hwEq]
  ...
  have hView : Gather2Rel
      ...
      [4096, 1] [2048, 1] := by
    rw [l9OMrg_red_sm5467 initSM, l9OMrg_red_pm9336 initPM,
      l9OMrg_red_pm9337 initPM]
    exact Gather2Rel.view_id hLinear
  rw [l9OMrg_red_sm5468 initSM, l9OMrg_red_pm9338 initPM,
    l9OMrg_red_pm9339 initPM]
...
theorem l9_ordinary_moe_router_from_attention_output (initSM initPM : Store)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
    ...
    Gather2Rel
      ...
      (denoteGraphDistributedFaithful pm_goal_1 initPM 9321)
      [4096, 64] [2048, 64] := by
  have hNorm := l9_ordinary_moe_norm_from_attention_output
    initSM initPM hInit hAttention
  exact l9_ordinary_moe_router_from_norm_input initSM initPM hPM hInit hNorm

/-- The ordinary scalar gate is closed directly from attention output. -/
theorem l9_ordinary_moe_gate_from_attention_output (initSM initPM : Store)
    (hPM : StoreShapesHold initPM pm_goal_1InitEnv)
    (hInit : InitGoalsHold pm_goal_1.numRanks goal_1_full_initGoals initSM initPM)
    (hAttention : Gather2Rel
      (denoteGraphDistributedFaithful sm_goal_1 initSM 5452)
  ...
  have hNorm := l9_ordinary_moe_norm_from_attention_output
    initSM initPM hInit hAttention
  exact l9_ordinary_moe_gate_from_norm_input initSM initPM hPM hInit hNorm

#print axioms l9_ordinary_moe_router_from_norm_input
#print axioms l9_ordinary_moe_gate_from_norm_input
#print axioms l9_ordinary_moe_router_from_attention_output
#print axioms l9_ordinary_moe_gate_from_attention_output
