/- Pure tensor-level ordinary K/V transport for canonical L20. -/
...
private theorem cL20KV_ordinary_semantic
...
theorem canonical_l20_k_ordinary_semantic
    ...
    Gather2Rel
      ...
      [4096, 4, 64] [2048, 4, 64] :=
  cL20KV_ordinary_semantic hCache hRmsW hKW hKShape

/-- Ordinary rank-order V transport, kept separate from graph alignment. -/
theorem canonical_l20_v_ordinary_semantic
    ...
    Gather2Rel
      ...
      [4096, 4, 64] [2048, 4, 64] :=
  cL20KV_ordinary_semantic hCache hRmsW hVW hVShape
