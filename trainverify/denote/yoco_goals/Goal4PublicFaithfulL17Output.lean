...
import denote.yoco_goals.Goal4PublicFaithfulL17Router
...
theorem goal4_l17_output_from_attention
    (initSM initPM : Store)
  ...
  exact l17_zigzag_moe_output_from_attention_output initSM initPM hSM1 hPM1 hInit1 hA17
end
