...
theorem hbw3_229 (initPM : Store) :
    (denoteGraph pm_goal_229 initPM) 2991 = transposeAxes 2 3 (initPM 2992) := by
  have hL : denoteGraph pm_goal_229 initPM 2991
          = denoteGraph {pm_goal_229 with nodes := pm_goal_229.nodes.take 8} initPM 2991 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_229 initPM 2991 _ _
