...
theorem hpm2base_248 (initPM : Store) :
    (denoteGraph pm_goal_248 initPM) 3282 = allToAllPrimWithDims 4 2 [(denoteGraph pm_goal_248 initPM) 3305, (denoteGraph pm_goal_248 initPM) 3307, (denoteGraph pm_goal_248 initPM) 3309, (denoteGraph pm_goal_248 initPM) 3311] 2 1 := by
  have hL : denoteGraph pm_goal_248 initPM 3282
          = denoteGraph {pm_goal_248 with nodes := pm_goal_248.nodes.take 11} initPM 3282 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_248 initPM 3282 _ _
      (List.take_append_drop 11 _).symm (by decide)
  have hR : ∀ t : Tid, t = 3305 ∨ t = 3307 ∨ t = 3309 ∨ t = 3311 →
      denoteGraph pm_goal_248 initPM t
        = denoteGraph {pm_goal_248 with nodes := pm_goal_248.nodes.take 10} initPM t := by
