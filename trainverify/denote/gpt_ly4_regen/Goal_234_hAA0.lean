...
theorem hAA0_234 (initPM : Store) :
    (denoteGraph pm_goal_234 initPM) 3041 =
      allToAllPrimWithDims 4 0 [initPM 3021, initPM 3022, initPM 3023, initPM 3024] 2 1 := by
  have hL : denoteGraph pm_goal_234 initPM 3041
          = denoteGraph {pm_goal_234 with nodes := pm_goal_234.nodes.take 1} initPM 3041 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_234 initPM 3041 _ _
