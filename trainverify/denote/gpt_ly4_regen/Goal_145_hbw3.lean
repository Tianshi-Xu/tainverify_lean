...
theorem hbw3_145 (initPM : Store) :
    (denoteGraph pm_goal_145 initPM) 1659 =
      (bw_add2 (initPM 1660) (initPM 1632)
        (allToAllPrimWithDims 4 3 [initPM 1605, initPM 1606, initPM 1607, initPM 1608] 1 2)).2 := by
  have hL : denoteGraph pm_goal_145 initPM 1659
          = denoteGraph {pm_goal_145 with nodes := pm_goal_145.nodes.take 8} initPM 1659 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_145 initPM 1659 _ _
