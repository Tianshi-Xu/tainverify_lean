...
theorem hbw1_192 (initPM : Store) :
    (denoteGraph pm_goal_192 initPM) 2456 =
      batchedMatmul (initPM 2458) (transpose2d (initPM 653)) := by
  have hL : denoteGraph pm_goal_192 initPM 2456
          = denoteGraph {pm_goal_192 with nodes := pm_goal_192.nodes.take 6} initPM 2456 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_192 initPM 2456 _ _
