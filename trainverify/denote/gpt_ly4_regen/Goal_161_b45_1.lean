...
theorem b45_1_161 (initPM : Store) :
    (denoteGraph pm_goal_161 initPM) 1946 =
  ...
  have hL : denoteGraph pm_goal_161 initPM 1946
          = denoteGraph {pm_goal_161 with nodes := pm_goal_161.nodes.take 6} initPM 1946 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_161 initPM 1946 _ _
