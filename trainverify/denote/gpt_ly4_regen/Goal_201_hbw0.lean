...
theorem hbw0_201 (initPM : Store) :
    (denoteGraph pm_goal_201 initPM) 2545 = transposeAxes 1 2 (initPM 2546) := by
  have hL : denoteGraph pm_goal_201 initPM 2545
          = denoteGraph {pm_goal_201 with nodes := pm_goal_201.nodes.take 5} initPM 2545 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_201 initPM 2545 _ _
