...
theorem pm_full_g35_1777 (initPM : Store) :
...
theorem pm_full_g35_1778 (initPM : Store) :
...
theorem pm_full_g35_1779 (initPM : Store) :
...
theorem pm_full_g35_1780 (initPM : Store) :
...
theorem goal_35_cut_to_full (h : goal_35_stmt_cut) : goal_35_stmt := by
  ...
  have hInitCut : InitGoalsHold pm_goal_35.numRanks goal_35_cut_initGoals Ssm Spm := by
    ...
    simp only [goal_35_cut_initGoals, goal_35_prereqs, List.forall_mem_append,
      List.forall_mem_cons, List.forall_mem_nil, and_true]
    exact ⟨hinitC, hg2, hg3, hg4, hg5, hg6, hg7, hg8, hg9, hg10, hg11, hg12, hg13, hg14, hg15, hg16, hg17, hg18, hg19, hg20, hg21, hg22, hg23, hg24, hg25, hg26, hg27, hg28, hg29, hg30, hg31, hg34, hg257, hg259, hg261, hg263, hg265, hg267, hg269, hg271, hg275, List.forall_mem_nil _⟩
