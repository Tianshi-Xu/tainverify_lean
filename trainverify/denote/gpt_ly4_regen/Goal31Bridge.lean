...
theorem pm_full_1701 (initPM : Store) :
...
theorem pm_full_1702 (initPM : Store) :
...
theorem pm_full_1703 (initPM : Store) :
...
theorem pm_full_1704 (initPM : Store) :
...
theorem pm_frame_607_self (initPM : Store) :
  ...
  rw [pm_full_1701, pm_full_1702, pm_full_1703, pm_full_1704]
...
theorem goal_31_cut_to_full (h : goal_31_stmt_cut) : goal_31_stmt := by
  ...
  have hInitCut : InitGoalsHold pm_goal_31.numRanks goal_31_cut_initGoals Ssm Spm := by
    rw [hnr]; intro g hg
    simp only [goal_31_cut_initGoals, goal_31_prereqs, List.mem_append] at hg
...
theorem goal_31_intermediate (initSM initPM : Store)
  ...
  simpa [InitGoalHolds, goal_31] using this
