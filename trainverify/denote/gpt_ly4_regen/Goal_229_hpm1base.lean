...
theorem hpm1base_229 (initPM : Store) :
    (denoteGraph pm_goal_229 initPM) 2940 = allToAllPrimWithDims 4 1
  ...
  have hL : denoteGraph pm_goal_229 initPM 2940
    ...
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_229 initPM 2940 _ _
      (List.take_append_drop 10 _).symm (by decide)
  have hR : ∀ t : Tid, t = 2985 ∨ t = 2987 ∨ t = 2989 ∨ t = 2991 →
      denoteGraph pm_goal_229 initPM t
        = denoteGraph {pm_goal_229 with nodes := pm_goal_229.nodes.take 9} initPM t := by
