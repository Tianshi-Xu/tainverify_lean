...
theorem hbw1_200 (initPM : Store) :
    (denoteGraph pm_goal_200 initPM) 2520 =
      batchedMatmul (initPM 2522)
        (transpose2d (allToAllPrimWithDims 4 1
          [initPM 2393, initPM 2394, initPM 2395, initPM 2396] 2 1)) := by
  have hL : denoteGraph pm_goal_200 initPM 2520
          = denoteGraph {pm_goal_200 with nodes := pm_goal_200.nodes.take 10} initPM 2520 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_200 initPM 2520 _ _
