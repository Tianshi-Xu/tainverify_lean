/- AUTO-GENERATED by bridge_emitter (FAMILY-A: multi-tp, 0 mid, per-rank op).
   goal_307: SM=FW_multiref([675])->1055;
   PM=4xFW_multiref(per-rank inputs)->[2869, 2870, 2871, 2872] multi-tps gatherDim=1.
...
-- ========== denote_pm (finals [2869, 2870, 2871, 2872] = multiref out[2] of 3 = input) ==========
theorem denote_pm_goal_307_2869 (s : Store) :
    denoteGraph pm_goal_307 s 2869 = s 2785 := by
  simp only [pm_goal_307, denoteGraph, List.foldl]
  rw [applyNode_eq_of_not_mem_outs _ _ _ 2869 (by decide),
      applyNode_eq_of_not_mem_outs _ _ _ 2869 (by decide),
      applyNode_eq_of_not_mem_outs _ _ _ 2869 (by decide),
      applyNode_fw_multiref3_out2_loc _ _ 0 2785 3679 3681 2869 (by decide) (by decide)]

theorem denote_pm_goal_307_2870 (s : Store) :
    denoteGraph pm_goal_307 s 2870 = s 2786 := by
  simp only [pm_goal_307, denoteGraph, List.foldl]
  rw [applyNode_eq_of_not_mem_outs _ _ _ 2870 (by decide),
      applyNode_eq_of_not_mem_outs _ _ _ 2870 (by decide),
      applyNode_fw_multiref3_out2_loc _ _ 1 2786 3689 3691 2870 (by decide) (by decide),
      applyNode_eq_of_not_mem_outs _ _ _ 2786 (by decide)]

theorem denote_pm_goal_307_2871 (s : Store) :
    denoteGraph pm_goal_307 s 2871 = s 2787 := by
  simp only [pm_goal_307, denoteGraph, List.foldl]
  rw [applyNode_eq_of_not_mem_outs _ _ _ 2871 (by decide),
      applyNode_fw_multiref3_out2_loc _ _ 2 2787 3699 3701 2871 (by decide) (by decide),
      applyNode_eq_of_not_mem_outs _ _ _ 2787 (by decide),
      applyNode_eq_of_not_mem_outs _ _ _ 2787 (by decide)]

theorem denote_pm_goal_307_2872 (s : Store) :
    denoteGraph pm_goal_307 s 2872 = s 2788 := by
  simp only [pm_goal_307, denoteGraph, List.foldl]
  rw [applyNode_fw_multiref3_out2_loc _ _ 3 2788 3709 3711 2872 (by decide) (by decide),
      applyNode_eq_of_not_mem_outs _ _ _ 2788 (by decide),
      applyNode_eq_of_not_mem_outs _ _ _ 2788 (by decide),
      applyNode_eq_of_not_mem_outs _ _ _ 2788 (by decide)]

-- ========== denote_sm (final 1055 = multiref out[2] = s 675) ==========
theorem denote_sm_goal_307_1055 (s : Store) :
    denoteGraph sm_goal_307 s 1055 = s 675 := by
  simp only [sm_goal_307, denoteGraph, List.foldl]
  rw [applyNode_fw_multiref3_out2_loc _ _ 0 675 1047 1051 1055 (by decide) (by decide)]

theorem sm_frame_1055_self (initSM : Store) :
    denoteGraph sm initSM 1055 = denoteGraph sm_goal_307 (denoteGraph sm initSM) 1055 := by
  rw [denote_sm_goal_307_1055]
  rw [sm_val initSM 89 1055 (by native_decide) (by native_decide)]
...
theorem pm_frame_2869_self (initPM : Store) :
    denoteGraph pm initPM 2869 = denoteGraph pm_goal_307 (denoteGraph pm initPM) 2869 := by
  rw [denote_pm_goal_307_2869]
  rw [pm_val initPM 578 2869 (by native_decide) (by native_decide)]
  rw [show pm.nodes[578]'(by native_decide)
      = { rank := 0, op := "OpName.FW_multiref", ins := [2785], outs := [3679, 3681, 2869], params := [3] }
      from by native_decide]
  rw [applyNode_fw_multiref3_out2_loc _ _ 0 2785 3679 3681 2869 (by decide) (by decide)]
  rw [pm_prefix_eq initPM 578 2785 (by native_decide)]

theorem pm_frame_2870_self (initPM : Store) :
    denoteGraph pm initPM 2870 = denoteGraph pm_goal_307 (denoteGraph pm initPM) 2870 := by
  rw [denote_pm_goal_307_2870]
  rw [pm_val initPM 579 2870 (by native_decide) (by native_decide)]
  rw [show pm.nodes[579]'(by native_decide)
      = { rank := 1, op := "OpName.FW_multiref", ins := [2786], outs := [3689, 3691, 2870], params := [3] }
      from by native_decide]
  rw [applyNode_fw_multiref3_out2_loc _ _ 1 2786 3689 3691 2870 (by decide) (by decide)]
  rw [pm_prefix_eq initPM 579 2786 (by native_decide)]

theorem pm_frame_2871_self (initPM : Store) :
    denoteGraph pm initPM 2871 = denoteGraph pm_goal_307 (denoteGraph pm initPM) 2871 := by
  rw [denote_pm_goal_307_2871]
  rw [pm_val initPM 580 2871 (by native_decide) (by native_decide)]
  rw [show pm.nodes[580]'(by native_decide)
      = { rank := 2, op := "OpName.FW_multiref", ins := [2787], outs := [3699, 3701, 2871], params := [3] }
      from by native_decide]
  rw [applyNode_fw_multiref3_out2_loc _ _ 2 2787 3699 3701 2871 (by decide) (by decide)]
  rw [pm_prefix_eq initPM 580 2787 (by native_decide)]

theorem pm_frame_2872_self (initPM : Store) :
    denoteGraph pm initPM 2872 = denoteGraph pm_goal_307 (denoteGraph pm initPM) 2872 := by
  rw [denote_pm_goal_307_2872]
  rw [pm_val initPM 581 2872 (by native_decide) (by native_decide)]
  rw [show pm.nodes[581]'(by native_decide)
      = { rank := 3, op := "OpName.FW_multiref", ins := [2788], outs := [3709, 3711, 2872], params := [3] }
      from by native_decide]
  rw [applyNode_fw_multiref3_out2_loc _ _ 3 2788 3709 3711 2872 (by decide) (by decide)]
  rw [pm_prefix_eq initPM 581 2788 (by native_decide)]

-- ========== helper: hInitCut separate lemma (heartbeat workaround) ==========
lemma goal_307_hInitCut_helper (Ssm Spm : Store)
    ...
    InitGoalsHold pm_goal_307.numRanks goal_307_cut_initGoals Ssm Spm := by
  have hnr : pm_goal_307.numRanks = pm.numRanks := by native_decide
  rw [hnr]; intro g hg
  simp only [goal_307_cut_initGoals, goal_307_prereqs, List.mem_append] at hg
...
-- ========== Assembly: goal_307_cut_to_full ==========
theorem goal_307_cut_to_full (h : goal_307_stmt_cut) : goal_307_stmt := by
  ...
  have hSM307 : StoreShapesHold Ssm sm_goal_307InitEnv := by
    intro tid sh hsh
    rw [sm_goal_307InitEnv] at hsh
    have hmem := mem_of_shapeEnvOfList_eq_some hsh
    simp only [sm_goal_307InitShapes, List.mem_cons, List.not_mem_nil, or_false,
               Prod.mk.injEq] at hmem
    rcases hmem with ⟨rfl, rfl⟩
    · exact h675_smsh
  have hPM307 : StoreShapesHold Spm pm_goal_307InitEnv := by
    intro tid sh hsh
    rw [pm_goal_307InitEnv] at hsh
    have hmem := mem_of_shapeEnvOfList_eq_some hsh
    simp only [pm_goal_307InitShapes, List.mem_cons, List.not_mem_nil, or_false,
               Prod.mk.injEq] at hmem
  ...
  have hInitCut : InitGoalsHold pm_goal_307.numRanks goal_307_cut_initGoals Ssm Spm :=
    goal_307_hInitCut_helper Ssm Spm hinitC hg2 hg3 hg4 hg5 hg6 hg7 hg8 hg9 hg10 hg11 hg12 hg13 hg14 hg15 hg16 hg17 hg18 hg19 hg20 hg21 hg22 hg23 hg24 hg25 hg26 hg27 hg28 hg29 hg30 hg31 hg32 hg33 hg34 hg35 hg36 hg37 hg38 hg39 hg40 hg41 hg42 hg43 hg44 hg45 hg46 hg47 hg48 hg49 hg50 hg51 hg52 hg53 hg54 hg55 hg56 hg57 hg58 hg59 hg60 hg61 hg62 hg63 hg64 hg65 hg66 hg67 hg68 hg69 hg70 hg71 hg72 hg73 hg74 hg75 hg76 hg77 hg78 hg79 hg80 hg257 hg259 hg261 hg263 hg265 hg267 hg269 hg271 hg273 hg275 hg277 hg279 hg281 hg283 hg285 hg287 hg289 hg291 hg293 hg295 hg297 hg299
  have hcut := h Ssm Spm hSM307 hPM307 hInitCut
  have hsmf : Ssm 1055 = denoteGraph sm_goal_307 Ssm 1055 := by
    rw [hSsm]; exact sm_frame_1055_self initSM
  have hpm2869 : Spm 2869 = denoteGraph pm_goal_307 Spm 2869 := by
    rw [hSpm]; exact pm_frame_2869_self initPM
  have hpm2870 : Spm 2870 = denoteGraph pm_goal_307 Spm 2870 := by
    rw [hSpm]; exact pm_frame_2870_self initPM
  have hpm2871 : Spm 2871 = denoteGraph pm_goal_307 Spm 2871 := by
    rw [hSpm]; exact pm_frame_2871_self initPM
  have hpm2872 : Spm 2872 = denoteGraph pm_goal_307 Spm 2872 := by
    rw [hSpm]; exact pm_frame_2872_self initPM
  rw [hnr] at hcut
  simp only [goal_307, List.map] at hcut ⊢
  rw [hsmf, hpm2869, hpm2870, hpm2871, hpm2872]
  exact hcut

theorem goal_307_intermediate (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    InitGoalHolds pm.numRanks goal_307 (denoteGraph sm initSM) (denoteGraph pm initPM) := by
  have hfull : goal_307_stmt := goal_307_cut_to_full prove_goal_307_cut
  have := hfull initSM initPM hSM hPM hInit
  simpa [InitGoalHolds, goal_307] using this
