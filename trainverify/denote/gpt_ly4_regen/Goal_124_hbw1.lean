...
-- 6-node graph instead of a 12-node one.
set_option maxHeartbeats 400000 in
theorem hbw1_124 (initPM : Store) :
    (denoteGraph pm_goal_124 initPM) 1347 = transposeAxes 2 3 (initPM 1348) := by
  have hL : denoteGraph pm_goal_124 initPM 1347
          = denoteGraph {pm_goal_124 with nodes := pm_goal_124.nodes.take 6} initPM 1347 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_124 initPM 1347 _ _
