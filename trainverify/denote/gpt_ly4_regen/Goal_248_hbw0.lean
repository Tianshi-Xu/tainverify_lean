...
theorem hbw0_248 (initPM : Store) :
    (denoteGraph pm_goal_248 initPM) 3305 =
      (bw_linear (initPM 889) (allToAllPrimWithDims 4 0 [initPM 3265, initPM 3266, initPM 3267, initPM 3268] 1 2) (initPM 3289)).1 := by
  have hL : denoteGraph pm_goal_248 initPM 3305
          = denoteGraph {pm_goal_248 with nodes := pm_goal_248.nodes.take 5} initPM 3305 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_248 initPM 3305 _ _
