...
theorem hbw0_200 (initPM : Store) :
    (denoteGraph pm_goal_200 initPM) 2517 =
      batchedMatmul (initPM 2519)
        (transpose2d (allToAllPrimWithDims 4 0
          [initPM 2393, initPM 2394, initPM 2395, initPM 2396] 2 1)) := by
  have hL : denoteGraph pm_goal_200 initPM 2517
          = denoteGraph {pm_goal_200 with nodes := pm_goal_200.nodes.take 9} initPM 2517 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_200 initPM 2517 _ _
