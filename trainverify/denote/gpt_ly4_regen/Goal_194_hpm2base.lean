...
theorem hpm2base_194 (initPM : Store) :
    (denoteGraph pm_goal_194 initPM) 2386 = allToAllPrimWithDims 4 2
  ...
  have hL : denoteGraph pm_goal_194 initPM 2386
    ...
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_194 initPM 2386 _ _
      (List.take_append_drop 11 _).symm (by decide)
  have hR : ∀ t : Tid, t = 2429 ∨ t = 2431 ∨ t = 2433 ∨ t = 2435 →
      denoteGraph pm_goal_194 initPM t
        = denoteGraph {pm_goal_194 with nodes := pm_goal_194.nodes.take 10} initPM t := by
