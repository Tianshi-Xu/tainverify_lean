...
theorem hbw3_194 (initPM : Store) :
    (denoteGraph pm_goal_194 initPM) 2435 = transposeAxes 2 3 (initPM 2436) := by
  have hL : denoteGraph pm_goal_194 initPM 2435
          = denoteGraph {pm_goal_194 with nodes := pm_goal_194.nodes.take 8} initPM 2435 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_194 initPM 2435 _ _
