...
theorem hpm2base_157 (initPM : Store) :
    (denoteGraph pm_goal_157 initPM) 1798 = allToAllPrimWithDims 4 2 [(denoteGraph pm_goal_157 initPM) 1893, (denoteGraph pm_goal_157 initPM) 1896, (denoteGraph pm_goal_157 initPM) 1899, (denoteGraph pm_goal_157 initPM) 1902] 1 2 := by
  have hL : denoteGraph pm_goal_157 initPM 1798
          = denoteGraph {pm_goal_157 with nodes := pm_goal_157.nodes.take 15} initPM 1798 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_157 initPM 1798 _ _
      (List.take_append_drop 15 _).symm (by decide)
  have hR : ∀ t : Tid, t = 1893 ∨ t = 1896 ∨ t = 1899 ∨ t = 1902 →
      denoteGraph pm_goal_157 initPM t
        = denoteGraph {pm_goal_157 with nodes := pm_goal_157.nodes.take 14} initPM t := by
