...
theorem hpm3base_145 (initPM : Store) :
    (denoteGraph pm_goal_145 initPM) 1628 = allToAllPrimWithDims 4 3 [(denoteGraph pm_goal_145 initPM) 1650, (denoteGraph pm_goal_145 initPM) 1653, (denoteGraph pm_goal_145 initPM) 1656, (denoteGraph pm_goal_145 initPM) 1659] 2 1 := by
  have hL : denoteGraph pm_goal_145 initPM 1628
          = denoteGraph {pm_goal_145 with nodes := pm_goal_145.nodes.take 12} initPM 1628 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_145 initPM 1628 _ _ (List.take_append_drop 12 _).symm (by decide)
