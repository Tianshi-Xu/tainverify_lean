...
theorem hbw2_194 (initPM : Store) :
    (denoteGraph pm_goal_194 initPM) 2433 = transposeAxes 2 3 (initPM 2434) := by
  have hL : denoteGraph pm_goal_194 initPM 2433
          = denoteGraph {pm_goal_194 with nodes := pm_goal_194.nodes.take 7} initPM 2433 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_194 initPM 2433 _ _
