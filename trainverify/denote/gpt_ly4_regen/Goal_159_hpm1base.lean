...
theorem hpm1base_159 (initPM : Store) :
    (denoteGraph pm_goal_159 initPM) 1820 = allToAllPrimWithDims 4 1
  ...
  have hL : denoteGraph pm_goal_159 initPM 1820
    ...
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_159 initPM 1820 _ _
      (List.take_append_drop 10 _).symm (by decide)
  have hR : ∀ t : Tid, t = 1865 ∨ t = 1867 ∨ t = 1869 ∨ t = 1871 →
      denoteGraph pm_goal_159 initPM t
        = denoteGraph {pm_goal_159 with nodes := pm_goal_159.nodes.take 9} initPM t := by
