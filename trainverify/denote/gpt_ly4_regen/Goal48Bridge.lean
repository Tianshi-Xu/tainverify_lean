...
theorem goal_48_cut_to_full (h : goal_48_stmt_cut) : goal_48_stmt := by
  ...
  have hInitCut : InitGoalsHold pm_goal_48.numRanks goal_48_cut_initGoals Ssm Spm := by
    rw [hnr]; intro g hg
    simp only [goal_48_cut_initGoals, goal_48_prereqs, List.mem_append] at hg
    rcases hg with hg | hg
    · exact hinitC g hg
    · simp only [List.mem_cons, List.not_mem_nil, or_false] at hg
      rcases hg with rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl
      · exact hg2
      · exact hg3
      · exact hg4
      · exact hg5
  ...
  have hpm625 : Spm 625 = denoteGraph pm initPM 625 := by rfl
  have hpm626 : Spm 626 = denoteGraph pm initPM 626 := by rfl
...
theorem goal_48_intermediate (initSM initPM : Store)
  ...
  simpa [InitGoalHolds, goal_48] using this
