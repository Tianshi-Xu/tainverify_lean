...
theorem hpm3base_201 (initPM : Store) :
    (denoteGraph pm_goal_201 initPM) 2528 = allToAllPrimWithDims 4 3
  ...
  have hL : denoteGraph pm_goal_201 initPM 2528
    ...
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_201 initPM 2528 _ _
      (List.take_append_drop 12 _).symm (by decide)
  have hR : ∀ t : Tid, t = 2545 ∨ t = 2547 ∨ t = 2549 ∨ t = 2551 →
      denoteGraph pm_goal_201 initPM t
        = denoteGraph {pm_goal_201 with nodes := pm_goal_201.nodes.take 11} initPM t := by
