...
theorem hbw1_236 (initPM : Store) :
    (denoteGraph pm_goal_236 initPM) 3111 = transposeAxes 1 2 (initPM 3112) := by
  have hL : denoteGraph pm_goal_236 initPM 3111
          = denoteGraph {pm_goal_236 with nodes := pm_goal_236.nodes.take 6} initPM 3111 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_236 initPM 3111 _ _
