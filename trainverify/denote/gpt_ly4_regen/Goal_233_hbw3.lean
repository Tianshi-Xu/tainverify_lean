...
theorem hbw3_233 (initPM : Store) :
    (denoteGraph pm_goal_233 initPM) 3039 = bw_div ((2 : Nat) : Scalar) (initPM 3040) := by
  have hL : denoteGraph pm_goal_233 initPM 3039
          = denoteGraph {pm_goal_233 with nodes := pm_goal_233.nodes.take 8} initPM 3039 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_233 initPM 3039 _ _
