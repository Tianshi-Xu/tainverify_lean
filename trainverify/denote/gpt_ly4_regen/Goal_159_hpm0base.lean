...
theorem hpm0base_159 (initPM : Store) :
    (denoteGraph pm_goal_159 initPM) 1818 = allToAllPrimWithDims 4 0
  ...
  have hL : denoteGraph pm_goal_159 initPM 1818
    ...
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_159 initPM 1818 _ _
      (List.take_append_drop 9 _).symm (by decide)
  have hR : ∀ t : Tid, t = 1865 ∨ t = 1867 ∨ t = 1869 ∨ t = 1871 →
      denoteGraph pm_goal_159 initPM t
        = denoteGraph {pm_goal_159 with nodes := pm_goal_159.nodes.take 8} initPM t := by
