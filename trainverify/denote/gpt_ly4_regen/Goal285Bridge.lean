/- goal_285 bridge (prereqs=[2..54,257-283 odd]=67). FW_multiref params=[2] FIRST-output,
   no collective, multi-tps gatherDim=1. SM=FW_multiref(637)->[989,993] node 59 take first 989=637.
   PM=4xFW_multiref(2201+r)->[2225+?,2605+?] node 388-391 take first out 2225-2228 = each rank input 2201-2204.
   637=goal_54 output [1,8,32] dim1-sharded tps 2201-2204 [1,2,32]. No AllToAll/AllGather.
   Core semantics (multiref first-out copy) in prove_goal_285_cut. Bridge = frame only.
   Template = Goal269Bridge (multiref no-collective) but FIRST output via generic
   applyNode_fw_multiref2_first_out (no hne needed). Multiref nodes 388-391 adjacent. -/
...
theorem denote_sm_goal_285_989 (s : Store) :
    denoteGraph sm_goal_285 s 989 = s 637 := by
  simp only [sm_goal_285, denoteGraph, List.foldl]
  rw [applyNode_fw_multiref2_first_out]

theorem sm_frame_989_self (initSM : Store) :
    denoteGraph sm initSM 989 = denoteGraph sm_goal_285 (denoteGraph sm initSM) 989 := by
  rw [denote_sm_goal_285_989]
  rw [sm_val initSM 59 989 (by native_decide) (by native_decide)]
...
theorem pm_full_2225 (initPM : Store) :
    denoteGraph pm initPM 2225 = denoteGraph pm initPM 2201 := by
  rw [pm_val initPM 388 2225 (by native_decide) (by native_decide)]
...
theorem pm_full_2226 (initPM : Store) :
    denoteGraph pm initPM 2226 = denoteGraph pm initPM 2202 := by
  rw [pm_val initPM 389 2226 (by native_decide) (by native_decide)]
...
theorem pm_full_2227 (initPM : Store) :
    denoteGraph pm initPM 2227 = denoteGraph pm initPM 2203 := by
  rw [pm_val initPM 390 2227 (by native_decide) (by native_decide)]
...
theorem pm_full_2228 (initPM : Store) :
    denoteGraph pm initPM 2228 = denoteGraph pm initPM 2204 := by
  rw [pm_val initPM 391 2228 (by native_decide) (by native_decide)]
...
theorem denote_pm_goal_285_2225 (s : Store) :
    denoteGraph pm_goal_285 s 2225 = s 2201 := by
...
theorem denote_pm_goal_285_2226 (s : Store) :
    denoteGraph pm_goal_285 s 2226 = s 2202 := by
  simp only [pm_goal_285, denoteGraph, List.foldl]
  repeat first
    | rw [applyNode_fw_multiref2_first_out]
...
theorem denote_pm_goal_285_2227 (s : Store) :
    denoteGraph pm_goal_285 s 2227 = s 2203 := by
  simp only [pm_goal_285, denoteGraph, List.foldl]
  repeat first
    | rw [applyNode_fw_multiref2_first_out]
...
theorem denote_pm_goal_285_2228 (s : Store) :
    denoteGraph pm_goal_285 s 2228 = s 2204 := by
  simp only [pm_goal_285, denoteGraph, List.foldl]
  repeat first
    | rw [applyNode_fw_multiref2_first_out]
    | rw [applyNode_skip _ _ _ 2228 (by decide)]
    | rw [applyNode_eq_of_not_mem_outs (h := by decide)]

theorem pm_frame_2225_self (initPM : Store) :
    denoteGraph pm initPM 2225 = denoteGraph pm_goal_285 (denoteGraph pm initPM) 2225 := by
  rw [denote_pm_goal_285_2225]
  exact pm_full_2225 initPM

theorem pm_frame_2226_self (initPM : Store) :
    denoteGraph pm initPM 2226 = denoteGraph pm_goal_285 (denoteGraph pm initPM) 2226 := by
  rw [denote_pm_goal_285_2226]
  exact pm_full_2226 initPM

theorem pm_frame_2227_self (initPM : Store) :
    denoteGraph pm initPM 2227 = denoteGraph pm_goal_285 (denoteGraph pm initPM) 2227 := by
  rw [denote_pm_goal_285_2227]
  exact pm_full_2227 initPM

theorem pm_frame_2228_self (initPM : Store) :
    denoteGraph pm initPM 2228 = denoteGraph pm_goal_285 (denoteGraph pm initPM) 2228 := by
  rw [denote_pm_goal_285_2228]
  exact pm_full_2228 initPM

lemma goal_285_hInitCut_helper (Ssm Spm : Store)
    ...
    : InitGoalsHold pm_goal_285.numRanks goal_285_cut_initGoals Ssm Spm := by
  have hnr : pm_goal_285.numRanks = pm.numRanks := by native_decide
  rw [hnr]; intro g hg
  simp only [goal_285_cut_initGoals, goal_285_prereqs, List.mem_append] at hg
  rcases hg with hg | hg
  · exact hinitC g hg
  · simp only [List.mem_cons, List.not_mem_nil, or_false] at hg
    rcases hg with rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl
    · exact hg2
    · exact hg3
    · exact hg4
    · exact hg5
...
theorem goal_285_cut_to_full (h : goal_285_stmt_cut) : goal_285_stmt := by
  ...
  rw [← hSsm, ← hSpm] at hg2 hg3 hg4 hg5 hg6 hg7 hg8 hg9 hg10 hg11 hg12 hg13 hg14 hg15 hg16 hg17 hg18 hg19 hg20 hg21 hg22 hg23 hg24 hg25 hg26 hg27 hg28 hg29 hg30 hg31 hg32 hg33 hg34 hg35 hg36 hg37 hg38 hg39 hg40 hg41 hg42 hg43 hg44 hg45 hg46 hg47 hg48 hg49 hg50 hg51 hg52 hg53 hg54 hg257 hg259 hg261 hg263 hg265 hg267 hg269 hg271 hg273 hg275 hg277 hg279 hg281 hg283 hinitC
  have hnr : pm_goal_285.numRanks = pm.numRanks := by native_decide
  have hInitCut : InitGoalsHold pm_goal_285.numRanks goal_285_cut_initGoals Ssm Spm :=
    goal_285_hInitCut_helper Ssm Spm hinitC hg2 hg3 hg4 hg5 hg6 hg7 hg8 hg9 hg10 hg11 hg12 hg13 hg14 hg15 hg16 hg17 hg18 hg19 hg20 hg21 hg22 hg23 hg24 hg25 hg26 hg27 hg28 hg29 hg30 hg31 hg32 hg33 hg34 hg35 hg36 hg37 hg38 hg39 hg40 hg41 hg42 hg43 hg44 hg45 hg46 hg47 hg48 hg49 hg50 hg51 hg52 hg53 hg54 hg257 hg259 hg261 hg263 hg265 hg267 hg269 hg271 hg273 hg275 hg277 hg279 hg281 hg283
  have h637_smsh : (Ssm 637).shape = [1, 8, 32] := by
    have h := hg54.1; simp only [goal_54] at h; exact h
  have hpmsh : (Spm 2201).shape = [1,2,32] ∧ (Spm 2202).shape = [1,2,32] ∧
               (Spm 2203).shape = [1,2,32] ∧ (Spm 2204).shape = [1,2,32] := by
    have h := hg54.2.1
    simp only [goal_54, List.map, List.cons.injEq, and_true] at h
    exact ⟨h.1, h.2.1, h.2.2.1, h.2.2.2⟩
  obtain ⟨h2201sh, h2202sh, h2203sh, h2204sh⟩ := hpmsh
  have hSM285 : StoreShapesHold Ssm sm_goal_285InitEnv := by
    intro tid sh hsh
    rw [sm_goal_285InitEnv] at hsh
    have hmem := mem_of_shapeEnvOfList_eq_some hsh
    simp only [sm_goal_285InitShapes, List.mem_cons, List.not_mem_nil, or_false,
               Prod.mk.injEq] at hmem
    rcases hmem with ⟨rfl, rfl⟩
    · exact h637_smsh
  have hPM285 : StoreShapesHold Spm pm_goal_285InitEnv := by
    intro tid sh hsh
    rw [pm_goal_285InitEnv] at hsh
    have hmem := mem_of_shapeEnvOfList_eq_some hsh
    simp only [pm_goal_285InitShapes, List.mem_cons, List.not_mem_nil, or_false,
               Prod.mk.injEq] at hmem
    ...
    · exact h2203sh
    · exact h2204sh
  have hcut := h Ssm Spm hSM285 hPM285 hInitCut
  have hsmf : Ssm 989 = denoteGraph sm_goal_285 Ssm 989 := by
    rw [hSsm]; exact sm_frame_989_self initSM
  have hpm2225 : Spm 2225 = denoteGraph pm_goal_285 Spm 2225 := by
    rw [hSpm]; exact pm_frame_2225_self initPM
  have hpm2226 : Spm 2226 = denoteGraph pm_goal_285 Spm 2226 := by
    rw [hSpm]; exact pm_frame_2226_self initPM
  have hpm2227 : Spm 2227 = denoteGraph pm_goal_285 Spm 2227 := by
    rw [hSpm]; exact pm_frame_2227_self initPM
  have hpm2228 : Spm 2228 = denoteGraph pm_goal_285 Spm 2228 := by
    rw [hSpm]; exact pm_frame_2228_self initPM
  rw [hnr] at hcut
  simp only [goal_285, List.map] at hcut ⊢
  rw [hsmf, hpm2225, hpm2226, hpm2227, hpm2228]
  exact hcut

theorem goal_285_intermediate (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    InitGoalHolds pm.numRanks goal_285 (denoteGraph sm initSM) (denoteGraph pm initPM) := by
  have hfull : goal_285_stmt := goal_285_cut_to_full prove_goal_285_cut
