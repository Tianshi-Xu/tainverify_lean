...
theorem hbw0_194 (initPM : Store) :
    (denoteGraph pm_goal_194 initPM) 2429 = transposeAxes 2 3 (initPM 2430) := by
  have hL : denoteGraph pm_goal_194 initPM 2429
          = denoteGraph {pm_goal_194 with nodes := pm_goal_194.nodes.take 5} initPM 2429 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_194 initPM 2429 _ _
