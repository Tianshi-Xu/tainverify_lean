...
theorem hpm0base_145 (initPM : Store) :
    (denoteGraph pm_goal_145 initPM) 1619 = allToAllPrimWithDims 4 0 [(denoteGraph pm_goal_145 initPM) 1650, (denoteGraph pm_goal_145 initPM) 1653, (denoteGraph pm_goal_145 initPM) 1656, (denoteGraph pm_goal_145 initPM) 1659] 2 1 := by
  have hL : denoteGraph pm_goal_145 initPM 1619
          = denoteGraph {pm_goal_145 with nodes := pm_goal_145.nodes.take 9} initPM 1619 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_145 initPM 1619 _ _ (List.take_append_drop 9 _).symm (by decide)
