...
theorem b45_3_161 (initPM : Store) :
    (denoteGraph pm_goal_161 initPM) 1948 =
  ...
  have hL : denoteGraph pm_goal_161 initPM 1948
          = denoteGraph {pm_goal_161 with nodes := pm_goal_161.nodes.take 8} initPM 1948 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_161 initPM 1948 _ _
