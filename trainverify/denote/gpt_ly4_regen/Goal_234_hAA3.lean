...
theorem hAA3_234 (initPM : Store) :
    (denoteGraph pm_goal_234 initPM) 3044 =
      allToAllPrimWithDims 4 3 [initPM 3021, initPM 3022, initPM 3023, initPM 3024] 2 1 := by
  have hL : denoteGraph pm_goal_234 initPM 3044
          = denoteGraph {pm_goal_234 with nodes := pm_goal_234.nodes.take 4} initPM 3044 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_234 initPM 3044 _ _
