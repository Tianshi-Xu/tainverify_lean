...
theorem b45_2_161 (initPM : Store) :
    (denoteGraph pm_goal_161 initPM) 1947 =
  ...
  have hL : denoteGraph pm_goal_161 initPM 1947
          = denoteGraph {pm_goal_161 with nodes := pm_goal_161.nodes.take 7} initPM 1947 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_161 initPM 1947 _ _
