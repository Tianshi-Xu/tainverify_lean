...
theorem hbw0_233 (initPM : Store) :
    (denoteGraph pm_goal_233 initPM) 3033 = bw_div ((2 : Nat) : Scalar) (initPM 3034) := by
  have hL : denoteGraph pm_goal_233 initPM 3033
          = denoteGraph {pm_goal_233 with nodes := pm_goal_233.nodes.take 5} initPM 3033 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_233 initPM 3033 _ _
