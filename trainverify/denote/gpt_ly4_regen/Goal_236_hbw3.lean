...
theorem hbw3_236 (initPM : Store) :
    (denoteGraph pm_goal_236 initPM) 3115 = transposeAxes 1 2 (initPM 3116) := by
  have hL : denoteGraph pm_goal_236 initPM 3115
          = denoteGraph {pm_goal_236 with nodes := pm_goal_236.nodes.take 8} initPM 3115 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_236 initPM 3115 _ _
