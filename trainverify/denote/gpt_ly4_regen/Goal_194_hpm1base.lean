...
theorem hpm1base_194 (initPM : Store) :
    (denoteGraph pm_goal_194 initPM) 2384 = allToAllPrimWithDims 4 1
  ...
  have hL : denoteGraph pm_goal_194 initPM 2384
    ...
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_194 initPM 2384 _ _
      (List.take_append_drop 10 _).symm (by decide)
  have hR : ∀ t : Tid, t = 2429 ∨ t = 2431 ∨ t = 2433 ∨ t = 2435 →
      denoteGraph pm_goal_194 initPM t
        = denoteGraph {pm_goal_194 with nodes := pm_goal_194.nodes.take 9} initPM t := by
