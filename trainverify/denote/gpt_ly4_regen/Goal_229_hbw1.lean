...
theorem hbw1_229 (initPM : Store) :
    (denoteGraph pm_goal_229 initPM) 2987 = transposeAxes 2 3 (initPM 2988) := by
  have hL : denoteGraph pm_goal_229 initPM 2987
          = denoteGraph {pm_goal_229 with nodes := pm_goal_229.nodes.take 6} initPM 2987 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_229 initPM 2987 _ _
