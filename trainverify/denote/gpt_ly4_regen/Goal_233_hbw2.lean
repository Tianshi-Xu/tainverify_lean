...
theorem hbw2_233 (initPM : Store) :
    (denoteGraph pm_goal_233 initPM) 3037 = bw_div ((2 : Nat) : Scalar) (initPM 3038) := by
  have hL : denoteGraph pm_goal_233 initPM 3037
          = denoteGraph {pm_goal_233 with nodes := pm_goal_233.nodes.take 7} initPM 3037 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_233 initPM 3037 _ _
