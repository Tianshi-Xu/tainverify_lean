...
theorem hbw0_236 (initPM : Store) :
    (denoteGraph pm_goal_236 initPM) 3109 = transposeAxes 1 2 (initPM 3110) := by
  have hL : denoteGraph pm_goal_236 initPM 3109
          = denoteGraph {pm_goal_236 with nodes := pm_goal_236.nodes.take 5} initPM 3109 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_236 initPM 3109 _ _
