...
theorem hbw3_201 (initPM : Store) :
    (denoteGraph pm_goal_201 initPM) 2551 = transposeAxes 1 2 (initPM 2552) := by
  have hL : denoteGraph pm_goal_201 initPM 2551
          = denoteGraph {pm_goal_201 with nodes := pm_goal_201.nodes.take 8} initPM 2551 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_201 initPM 2551 _ _
