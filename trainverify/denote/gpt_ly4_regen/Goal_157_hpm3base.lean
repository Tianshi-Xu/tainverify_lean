...
theorem hpm3base_157 (initPM : Store) :
    (denoteGraph pm_goal_157 initPM) 1800 = allToAllPrimWithDims 4 3 [(denoteGraph pm_goal_157 initPM) 1893, (denoteGraph pm_goal_157 initPM) 1896, (denoteGraph pm_goal_157 initPM) 1899, (denoteGraph pm_goal_157 initPM) 1902] 1 2 := by
  have hL : denoteGraph pm_goal_157 initPM 1800
          = denoteGraph {pm_goal_157 with nodes := pm_goal_157.nodes.take 16} initPM 1800 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_157 initPM 1800 _ _
      (List.take_append_drop 16 _).symm (by decide)
  have hR : ∀ t : Tid, t = 1893 ∨ t = 1896 ∨ t = 1899 ∨ t = 1902 →
      denoteGraph pm_goal_157 initPM t
        = denoteGraph {pm_goal_157 with nodes := pm_goal_157.nodes.take 15} initPM t := by
