...
theorem hpm2base_234 (initPM : Store) :
    (denoteGraph pm_goal_234 initPM) 3038 = allToAllPrimWithDims 4 2 [(denoteGraph pm_goal_234 initPM) 3057, (denoteGraph pm_goal_234 initPM) 3059, (denoteGraph pm_goal_234 initPM) 3061, (denoteGraph pm_goal_234 initPM) 3063] 1 2 := by
  have hL : denoteGraph pm_goal_234 initPM 3038
          = denoteGraph {pm_goal_234 with nodes := pm_goal_234.nodes.take 11} initPM 3038 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_234 initPM 3038 _ _
      (List.take_append_drop 11 _).symm (by decide)
  have hR : ∀ t : Tid, t = 3057 ∨ t = 3059 ∨ t = 3061 ∨ t = 3063 →
      denoteGraph pm_goal_234 initPM t
        = denoteGraph {pm_goal_234 with nodes := pm_goal_234.nodes.take 10} initPM t := by
