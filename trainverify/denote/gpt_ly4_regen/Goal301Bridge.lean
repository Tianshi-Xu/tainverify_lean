/- AUTO-GENERATED by bridge_emitter (FAMILY-A: multi-tp, 0 mid, per-rank op).
   goal_301: SM=FW_multiref([672])->1036;
   PM=4xFW_multiref(per-rank inputs)->[3169, 3170, 3171, 3172] multi-tps gatherDim=1.
...
-- ========== denote_pm (finals [3169, 3170, 3171, 3172] = multiref 2nd out = input) ==========
theorem denote_pm_goal_301_3169 (s : Store) :
    denoteGraph pm_goal_301 s 3169 = s 2757 := by
  simp only [pm_goal_301, denoteGraph, List.foldl]
  rw [applyNode_skip _ _ _ 3169 (by decide),
      applyNode_skip _ _ _ 3169 (by decide),
      applyNode_skip _ _ _ 3169 (by decide),
      applyNode_fw_multiref2_second_out_loc _ _ 0 2757 2781 3169 (by decide)]

theorem denote_pm_goal_301_3170 (s : Store) :
    denoteGraph pm_goal_301 s 3170 = s 2758 := by
  simp only [pm_goal_301, denoteGraph, List.foldl]
  rw [applyNode_skip _ _ _ 3170 (by decide),
      applyNode_skip _ _ _ 3170 (by decide),
      applyNode_fw_multiref2_second_out_loc _ _ 1 2758 2782 3170 (by decide),
      applyNode_skip _ _ _ 2758 (by decide)]

theorem denote_pm_goal_301_3171 (s : Store) :
    denoteGraph pm_goal_301 s 3171 = s 2759 := by
  simp only [pm_goal_301, denoteGraph, List.foldl]
  rw [applyNode_skip _ _ _ 3171 (by decide),
      applyNode_fw_multiref2_second_out_loc _ _ 2 2759 2783 3171 (by decide),
      applyNode_skip _ _ _ 2759 (by decide),
      applyNode_skip _ _ _ 2759 (by decide)]

theorem denote_pm_goal_301_3172 (s : Store) :
    denoteGraph pm_goal_301 s 3172 = s 2760 := by
  simp only [pm_goal_301, denoteGraph, List.foldl]
  rw [applyNode_fw_multiref2_second_out_loc _ _ 3 2760 2784 3172 (by decide),
      applyNode_skip _ _ _ 2760 (by decide),
      applyNode_skip _ _ _ 2760 (by decide),
      applyNode_skip _ _ _ 2760 (by decide)]

-- ========== denote_sm (final 1036 = multiref 2nd out = s 672) ==========
theorem denote_sm_goal_301_1036 (s : Store) :
    denoteGraph sm_goal_301 s 1036 = s 672 := by
  simp only [sm_goal_301, denoteGraph, List.foldl]
  rw [applyNode_fw_multiref2_second_out_loc _ _ 0 672 1032 1036 (by decide)]

theorem sm_frame_1036_self (initSM : Store) :
    denoteGraph sm initSM 1036 = denoteGraph sm_goal_301 (denoteGraph sm initSM) 1036 := by
  rw [denote_sm_goal_301_1036]
  rw [sm_val initSM 87 1036 (by native_decide) (by native_decide)]
...
theorem pm_frame_3169_self (initPM : Store) :
    denoteGraph pm initPM 3169 = denoteGraph pm_goal_301 (denoteGraph pm initPM) 3169 := by
  rw [denote_pm_goal_301_3169]
  rw [pm_val initPM 570 3169 (by native_decide) (by native_decide)]
  rw [show pm.nodes[570]'(by native_decide)
      = { rank := 0, op := "OpName.FW_multiref", ins := [2757], outs := [2781, 3169], params := [2] }
      from by native_decide]
  rw [applyNode_fw_multiref2_second_out_loc _ _ 0 2757 2781 3169 (by decide)]
  rw [pm_prefix_eq initPM 570 2757 (by native_decide)]

theorem pm_frame_3170_self (initPM : Store) :
    denoteGraph pm initPM 3170 = denoteGraph pm_goal_301 (denoteGraph pm initPM) 3170 := by
  rw [denote_pm_goal_301_3170]
  rw [pm_val initPM 571 3170 (by native_decide) (by native_decide)]
  rw [show pm.nodes[571]'(by native_decide)
      = { rank := 1, op := "OpName.FW_multiref", ins := [2758], outs := [2782, 3170], params := [2] }
      from by native_decide]
  rw [applyNode_fw_multiref2_second_out_loc _ _ 1 2758 2782 3170 (by decide)]
  rw [pm_prefix_eq initPM 571 2758 (by native_decide)]

theorem pm_frame_3171_self (initPM : Store) :
    denoteGraph pm initPM 3171 = denoteGraph pm_goal_301 (denoteGraph pm initPM) 3171 := by
  rw [denote_pm_goal_301_3171]
  rw [pm_val initPM 572 3171 (by native_decide) (by native_decide)]
  rw [show pm.nodes[572]'(by native_decide)
      = { rank := 2, op := "OpName.FW_multiref", ins := [2759], outs := [2783, 3171], params := [2] }
      from by native_decide]
  rw [applyNode_fw_multiref2_second_out_loc _ _ 2 2759 2783 3171 (by decide)]
  rw [pm_prefix_eq initPM 572 2759 (by native_decide)]

theorem pm_frame_3172_self (initPM : Store) :
    denoteGraph pm initPM 3172 = denoteGraph pm_goal_301 (denoteGraph pm initPM) 3172 := by
  rw [denote_pm_goal_301_3172]
  rw [pm_val initPM 573 3172 (by native_decide) (by native_decide)]
...
lemma goal_301_hInitCut_helper (Ssm Spm : Store)
    ...
    InitGoalsHold pm_goal_301.numRanks goal_301_cut_initGoals Ssm Spm := by
  have hnr : pm_goal_301.numRanks = pm.numRanks := by native_decide
  rw [hnr]; intro g hg
  simp only [goal_301_cut_initGoals, goal_301_prereqs, List.mem_append] at hg
...
-- ========== Assembly: goal_301_cut_to_full ==========
theorem goal_301_cut_to_full (h : goal_301_stmt_cut) : goal_301_stmt := by
  ...
  have hSM301 : StoreShapesHold Ssm sm_goal_301InitEnv := by
    intro tid sh hsh
    rw [sm_goal_301InitEnv] at hsh
    have hmem := mem_of_shapeEnvOfList_eq_some hsh
    simp only [sm_goal_301InitShapes, List.mem_cons, List.not_mem_nil, or_false,
               Prod.mk.injEq] at hmem
    rcases hmem with ⟨rfl, rfl⟩
    · exact h672_smsh
  have hPM301 : StoreShapesHold Spm pm_goal_301InitEnv := by
    intro tid sh hsh
    rw [pm_goal_301InitEnv] at hsh
    have hmem := mem_of_shapeEnvOfList_eq_some hsh
    simp only [pm_goal_301InitShapes, List.mem_cons, List.not_mem_nil, or_false,
               Prod.mk.injEq] at hmem
  ...
  have hInitCut : InitGoalsHold pm_goal_301.numRanks goal_301_cut_initGoals Ssm Spm :=
    goal_301_hInitCut_helper Ssm Spm hinitC hg2 hg3 hg4 hg5 hg6 hg7 hg8 hg9 hg10 hg11 hg12 hg13 hg14 hg15 hg16 hg17 hg18 hg19 hg20 hg21 hg22 hg23 hg24 hg25 hg26 hg27 hg28 hg29 hg30 hg31 hg32 hg33 hg34 hg35 hg36 hg37 hg38 hg39 hg40 hg41 hg42 hg43 hg44 hg45 hg46 hg47 hg48 hg49 hg50 hg51 hg52 hg53 hg54 hg55 hg56 hg57 hg58 hg59 hg60 hg61 hg62 hg63 hg64 hg65 hg66 hg67 hg68 hg69 hg70 hg71 hg72 hg73 hg74 hg75 hg76 hg77 hg78 hg79 hg257 hg259 hg261 hg263 hg265 hg267 hg269 hg271 hg273 hg275 hg277 hg279 hg281 hg283 hg285 hg287 hg289 hg291 hg293 hg295 hg297
  have hcut := h Ssm Spm hSM301 hPM301 hInitCut
  have hsmf : Ssm 1036 = denoteGraph sm_goal_301 Ssm 1036 := by
    rw [hSsm]; exact sm_frame_1036_self initSM
  have hpm3169 : Spm 3169 = denoteGraph pm_goal_301 Spm 3169 := by
    rw [hSpm]; exact pm_frame_3169_self initPM
  have hpm3170 : Spm 3170 = denoteGraph pm_goal_301 Spm 3170 := by
    rw [hSpm]; exact pm_frame_3170_self initPM
  have hpm3171 : Spm 3171 = denoteGraph pm_goal_301 Spm 3171 := by
    rw [hSpm]; exact pm_frame_3171_self initPM
  have hpm3172 : Spm 3172 = denoteGraph pm_goal_301 Spm 3172 := by
    rw [hSpm]; exact pm_frame_3172_self initPM
  rw [hnr] at hcut
  simp only [goal_301, List.map] at hcut ⊢
  rw [hsmf, hpm3169, hpm3170, hpm3171, hpm3172]
  exact hcut

theorem goal_301_intermediate (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    InitGoalHolds pm.numRanks goal_301 (denoteGraph sm initSM) (denoteGraph pm initPM) := by
  have hfull : goal_301_stmt := goal_301_cut_to_full prove_goal_301_cut
  have := hfull initSM initPM hSM hPM hInit
  simpa [InitGoalHolds, goal_301] using this
