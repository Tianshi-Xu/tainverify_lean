...
theorem hbw3_159 (initPM : Store) :
    (denoteGraph pm_goal_159 initPM) 1871 = transposeAxes 2 3 (initPM 1872) := by
  have hL : denoteGraph pm_goal_159 initPM 1871
          = denoteGraph {pm_goal_159 with nodes := pm_goal_159.nodes.take 8} initPM 1871 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_159 initPM 1871 _ _
