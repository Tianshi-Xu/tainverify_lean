...
theorem hbw3_157 (initPM : Store) :
    (denoteGraph pm_goal_157 initPM) 1902 =
      batchedMatmul (initPM 1904)
        (transpose2d (allToAllPrimWithDims 4 3
          [initPM 1853, initPM 1854, initPM 1855, initPM 1856] 3 1)) := by
  have hL : denoteGraph pm_goal_157 initPM 1902
          = denoteGraph {pm_goal_157 with nodes := pm_goal_157.nodes.take 12} initPM 1902 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_157 initPM 1902 _ _
