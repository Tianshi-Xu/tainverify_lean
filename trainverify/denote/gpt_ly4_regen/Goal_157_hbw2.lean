...
theorem hbw2_157 (initPM : Store) :
    (denoteGraph pm_goal_157 initPM) 1899 =
      batchedMatmul (initPM 1901)
        (transpose2d (allToAllPrimWithDims 4 2
          [initPM 1853, initPM 1854, initPM 1855, initPM 1856] 3 1)) := by
  have hL : denoteGraph pm_goal_157 initPM 1899
          = denoteGraph {pm_goal_157 with nodes := pm_goal_157.nodes.take 11} initPM 1899 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_157 initPM 1899 _ _
