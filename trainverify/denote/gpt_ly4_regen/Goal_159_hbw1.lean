...
theorem hbw1_159 (initPM : Store) :
    (denoteGraph pm_goal_159 initPM) 1867 = transposeAxes 2 3 (initPM 1868) := by
  have hL : denoteGraph pm_goal_159 initPM 1867
          = denoteGraph {pm_goal_159 with nodes := pm_goal_159.nodes.take 6} initPM 1867 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_159 initPM 1867 _ _
