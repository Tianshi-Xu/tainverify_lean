...
theorem hbw1_233 (initPM : Store) :
    (denoteGraph pm_goal_233 initPM) 3035 = bw_div ((2 : Nat) : Scalar) (initPM 3036) := by
  have hL : denoteGraph pm_goal_233 initPM 3035
          = denoteGraph {pm_goal_233 with nodes := pm_goal_233.nodes.take 6} initPM 3035 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_233 initPM 3035 _ _
