...
theorem hbw0_159 (initPM : Store) :
    (denoteGraph pm_goal_159 initPM) 1865 = transposeAxes 2 3 (initPM 1866) := by
  have hL : denoteGraph pm_goal_159 initPM 1865
          = denoteGraph {pm_goal_159 with nodes := pm_goal_159.nodes.take 5} initPM 1865 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_159 initPM 1865 _ _
