...
theorem hbw0_192 (initPM : Store) :
    (denoteGraph pm_goal_192 initPM) 2453 =
      batchedMatmul (initPM 2455) (transpose2d (initPM 653)) := by
  have hL : denoteGraph pm_goal_192 initPM 2453
          = denoteGraph {pm_goal_192 with nodes := pm_goal_192.nodes.take 5} initPM 2453 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_192 initPM 2453 _ _
