...
theorem hpm2base_200 (initPM : Store) :
    (denoteGraph pm_goal_200 initPM) 2495 = allToAllPrimWithDims 4 2 [(denoteGraph pm_goal_200 initPM) 2517, (denoteGraph pm_goal_200 initPM) 2520, (denoteGraph pm_goal_200 initPM) 2523, (denoteGraph pm_goal_200 initPM) 2526] 1 2 := by
  have hL : denoteGraph pm_goal_200 initPM 2495
          = denoteGraph {pm_goal_200 with nodes := pm_goal_200.nodes.take 15} initPM 2495 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_200 initPM 2495 _ _
      (List.take_append_drop 15 _).symm (by decide)
  have hR : ∀ t : Tid, t = 2517 ∨ t = 2520 ∨ t = 2523 ∨ t = 2526 →
      denoteGraph pm_goal_200 initPM t
        = denoteGraph {pm_goal_200 with nodes := pm_goal_200.nodes.take 14} initPM t := by
