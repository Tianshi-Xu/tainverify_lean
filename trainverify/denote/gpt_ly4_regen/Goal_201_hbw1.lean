...
theorem hbw1_201 (initPM : Store) :
    (denoteGraph pm_goal_201 initPM) 2547 = transposeAxes 1 2 (initPM 2548) := by
  have hL : denoteGraph pm_goal_201 initPM 2547
          = denoteGraph {pm_goal_201 with nodes := pm_goal_201.nodes.take 6} initPM 2547 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_201 initPM 2547 _ _
