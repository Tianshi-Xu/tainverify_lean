...
theorem hpm0base_200 (initPM : Store) :
    (denoteGraph pm_goal_200 initPM) 2493 = allToAllPrimWithDims 4 0 [(denoteGraph pm_goal_200 initPM) 2517, (denoteGraph pm_goal_200 initPM) 2520, (denoteGraph pm_goal_200 initPM) 2523, (denoteGraph pm_goal_200 initPM) 2526] 1 2 := by
  have hL : denoteGraph pm_goal_200 initPM 2493
          = denoteGraph {pm_goal_200 with nodes := pm_goal_200.nodes.take 13} initPM 2493 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_200 initPM 2493 _ _
      (List.take_append_drop 13 _).symm (by decide)
  have hR : ∀ t : Tid, t = 2517 ∨ t = 2520 ∨ t = 2523 ∨ t = 2526 →
      denoteGraph pm_goal_200 initPM t
        = denoteGraph {pm_goal_200 with nodes := pm_goal_200.nodes.take 12} initPM t := by
