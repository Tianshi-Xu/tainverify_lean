...
theorem hpm3base_192 (initPM : Store) :
    (denoteGraph pm_goal_192 initPM) 2364 = allToAllPrimWithDims 4 3 [(denoteGraph pm_goal_192 initPM) 2453, (denoteGraph pm_goal_192 initPM) 2456, (denoteGraph pm_goal_192 initPM) 2459, (denoteGraph pm_goal_192 initPM) 2462] 2 1 := by
  have hL : denoteGraph pm_goal_192 initPM 2364
          = denoteGraph {pm_goal_192 with nodes := pm_goal_192.nodes.take 12} initPM 2364 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_192 initPM 2364 _ _
