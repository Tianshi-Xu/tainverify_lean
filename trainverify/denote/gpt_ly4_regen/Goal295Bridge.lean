/- AUTO-GENERATED by bridge_emitter (FAMILY-A: multi-tp, 0 mid, per-rank op).
   goal_295: SM=FW_multiref([663])->1020;
   PM=4xFW_multiref(per-rank inputs)->[2637, 2638, 2639, 2640] multi-tps gatherDim=1.
...
-- ========== denote_pm (finals [2637, 2638, 2639, 2640] = multiref out[0] of 2 = input) ==========
theorem denote_pm_goal_295_2637 (s : Store) :
    denoteGraph pm_goal_295 s 2637 = s 2613 := by
  simp only [pm_goal_295, denoteGraph, List.foldl]
  rw [applyNode_eq_of_not_mem_outs _ _ _ 2637 (by decide),
      applyNode_eq_of_not_mem_outs _ _ _ 2637 (by decide),
      applyNode_eq_of_not_mem_outs _ _ _ 2637 (by decide),
      applyNode_fw_multiref2_out0_loc _ _ 0 2613 2637 2749]

theorem denote_pm_goal_295_2638 (s : Store) :
    denoteGraph pm_goal_295 s 2638 = s 2614 := by
  simp only [pm_goal_295, denoteGraph, List.foldl]
  rw [applyNode_eq_of_not_mem_outs _ _ _ 2638 (by decide),
      applyNode_eq_of_not_mem_outs _ _ _ 2638 (by decide),
      applyNode_fw_multiref2_out0_loc _ _ 1 2614 2638 2750,
      applyNode_eq_of_not_mem_outs _ _ _ 2614 (by decide)]

theorem denote_pm_goal_295_2639 (s : Store) :
    denoteGraph pm_goal_295 s 2639 = s 2615 := by
  simp only [pm_goal_295, denoteGraph, List.foldl]
  rw [applyNode_eq_of_not_mem_outs _ _ _ 2639 (by decide),
      applyNode_fw_multiref2_out0_loc _ _ 2 2615 2639 2751,
      applyNode_eq_of_not_mem_outs _ _ _ 2615 (by decide),
      applyNode_eq_of_not_mem_outs _ _ _ 2615 (by decide)]

theorem denote_pm_goal_295_2640 (s : Store) :
    denoteGraph pm_goal_295 s 2640 = s 2616 := by
  simp only [pm_goal_295, denoteGraph, List.foldl]
  rw [applyNode_fw_multiref2_out0_loc _ _ 3 2616 2640 2752,
      applyNode_eq_of_not_mem_outs _ _ _ 2616 (by decide),
      applyNode_eq_of_not_mem_outs _ _ _ 2616 (by decide),
      applyNode_eq_of_not_mem_outs _ _ _ 2616 (by decide)]

-- ========== denote_sm (final 1020 = multiref out[0] = s 663) ==========
theorem denote_sm_goal_295_1020 (s : Store) :
    denoteGraph sm_goal_295 s 1020 = s 663 := by
  simp only [sm_goal_295, denoteGraph, List.foldl]
  rw [applyNode_fw_multiref2_out0_loc _ _ 0 663 1020 1024]

theorem sm_frame_1020_self (initSM : Store) :
    denoteGraph sm initSM 1020 = denoteGraph sm_goal_295 (denoteGraph sm initSM) 1020 := by
  rw [denote_sm_goal_295_1020]
  rw [sm_val initSM 81 1020 (by native_decide) (by native_decide)]
...
theorem pm_frame_2637_self (initPM : Store) :
    denoteGraph pm initPM 2637 = denoteGraph pm_goal_295 (denoteGraph pm initPM) 2637 := by
  rw [denote_pm_goal_295_2637]
  rw [pm_val initPM 528 2637 (by native_decide) (by native_decide)]
  rw [show pm.nodes[528]'(by native_decide)
      = { rank := 0, op := "OpName.FW_multiref", ins := [2613], outs := [2637, 2749], params := [2] }
      from by native_decide]
  rw [applyNode_fw_multiref2_out0_loc _ _ 0 2613 2637 2749]
  rw [pm_prefix_eq initPM 528 2613 (by native_decide)]

theorem pm_frame_2638_self (initPM : Store) :
    denoteGraph pm initPM 2638 = denoteGraph pm_goal_295 (denoteGraph pm initPM) 2638 := by
  rw [denote_pm_goal_295_2638]
  rw [pm_val initPM 529 2638 (by native_decide) (by native_decide)]
  rw [show pm.nodes[529]'(by native_decide)
      = { rank := 1, op := "OpName.FW_multiref", ins := [2614], outs := [2638, 2750], params := [2] }
      from by native_decide]
  rw [applyNode_fw_multiref2_out0_loc _ _ 1 2614 2638 2750]
  rw [pm_prefix_eq initPM 529 2614 (by native_decide)]

theorem pm_frame_2639_self (initPM : Store) :
    denoteGraph pm initPM 2639 = denoteGraph pm_goal_295 (denoteGraph pm initPM) 2639 := by
  rw [denote_pm_goal_295_2639]
  rw [pm_val initPM 530 2639 (by native_decide) (by native_decide)]
  rw [show pm.nodes[530]'(by native_decide)
      = { rank := 2, op := "OpName.FW_multiref", ins := [2615], outs := [2639, 2751], params := [2] }
      from by native_decide]
  rw [applyNode_fw_multiref2_out0_loc _ _ 2 2615 2639 2751]
  rw [pm_prefix_eq initPM 530 2615 (by native_decide)]

theorem pm_frame_2640_self (initPM : Store) :
    denoteGraph pm initPM 2640 = denoteGraph pm_goal_295 (denoteGraph pm initPM) 2640 := by
  rw [denote_pm_goal_295_2640]
  rw [pm_val initPM 531 2640 (by native_decide) (by native_decide)]
...
lemma goal_295_hInitCut_helper (Ssm Spm : Store)
    ...
    InitGoalsHold pm_goal_295.numRanks goal_295_cut_initGoals Ssm Spm := by
  have hnr : pm_goal_295.numRanks = pm.numRanks := by native_decide
  rw [hnr]; intro g hg
  simp only [goal_295_cut_initGoals, goal_295_prereqs, List.mem_append] at hg
...
-- ========== Assembly: goal_295_cut_to_full ==========
theorem goal_295_cut_to_full (h : goal_295_stmt_cut) : goal_295_stmt := by
  ...
  have hSM295 : StoreShapesHold Ssm sm_goal_295InitEnv := by
    intro tid sh hsh
    rw [sm_goal_295InitEnv] at hsh
    have hmem := mem_of_shapeEnvOfList_eq_some hsh
    simp only [sm_goal_295InitShapes, List.mem_cons, List.not_mem_nil, or_false,
               Prod.mk.injEq] at hmem
    rcases hmem with ⟨rfl, rfl⟩
    · exact h663_smsh
  have hPM295 : StoreShapesHold Spm pm_goal_295InitEnv := by
    intro tid sh hsh
    rw [pm_goal_295InitEnv] at hsh
    have hmem := mem_of_shapeEnvOfList_eq_some hsh
    simp only [pm_goal_295InitShapes, List.mem_cons, List.not_mem_nil, or_false,
               Prod.mk.injEq] at hmem
  ...
  have hInitCut : InitGoalsHold pm_goal_295.numRanks goal_295_cut_initGoals Ssm Spm :=
    goal_295_hInitCut_helper Ssm Spm hinitC hg2 hg3 hg4 hg5 hg6 hg7 hg8 hg9 hg10 hg11 hg12 hg13 hg14 hg15 hg16 hg17 hg18 hg19 hg20 hg21 hg22 hg23 hg24 hg25 hg26 hg27 hg28 hg29 hg30 hg31 hg32 hg33 hg34 hg35 hg36 hg37 hg38 hg39 hg40 hg41 hg42 hg43 hg44 hg45 hg46 hg47 hg48 hg49 hg50 hg51 hg52 hg53 hg54 hg55 hg56 hg57 hg58 hg59 hg60 hg61 hg62 hg63 hg64 hg65 hg66 hg67 hg68 hg69 hg70 hg71 hg72 hg73 hg74 hg257 hg259 hg261 hg263 hg265 hg267 hg269 hg271 hg273 hg275 hg277 hg279 hg281 hg283 hg285 hg287 hg289 hg291 hg293
  have hcut := h Ssm Spm hSM295 hPM295 hInitCut
  have hsmf : Ssm 1020 = denoteGraph sm_goal_295 Ssm 1020 := by
    rw [hSsm]; exact sm_frame_1020_self initSM
  have hpm2637 : Spm 2637 = denoteGraph pm_goal_295 Spm 2637 := by
    rw [hSpm]; exact pm_frame_2637_self initPM
  have hpm2638 : Spm 2638 = denoteGraph pm_goal_295 Spm 2638 := by
    rw [hSpm]; exact pm_frame_2638_self initPM
  have hpm2639 : Spm 2639 = denoteGraph pm_goal_295 Spm 2639 := by
    rw [hSpm]; exact pm_frame_2639_self initPM
  have hpm2640 : Spm 2640 = denoteGraph pm_goal_295 Spm 2640 := by
    rw [hSpm]; exact pm_frame_2640_self initPM
  rw [hnr] at hcut
  simp only [goal_295, List.map] at hcut ⊢
  rw [hsmf, hpm2637, hpm2638, hpm2639, hpm2640]
  exact hcut

theorem goal_295_intermediate (initSM initPM : Store)
    (hSM : StoreShapesHold initSM smInitEnv) (hPM : StoreShapesHold initPM pmInitEnv)
    (hInit : InitGoalsHold pm.numRanks initGoals initSM initPM) :
    InitGoalHolds pm.numRanks goal_295 (denoteGraph sm initSM) (denoteGraph pm initPM) := by
  have hfull : goal_295_stmt := goal_295_cut_to_full prove_goal_295_cut
  have := hfull initSM initPM hSM hPM hInit
  simpa [InitGoalHolds, goal_295] using this
