...
theorem hbw2_229 (initPM : Store) :
    (denoteGraph pm_goal_229 initPM) 2989 = transposeAxes 2 3 (initPM 2990) := by
  have hL : denoteGraph pm_goal_229 initPM 2989
          = denoteGraph {pm_goal_229 with nodes := pm_goal_229.nodes.take 7} initPM 2989 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_229 initPM 2989 _ _
