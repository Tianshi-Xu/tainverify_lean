...
theorem hpm1base_124 (initPM : Store) :
    (denoteGraph pm_goal_124 initPM) 1300 = allToAllPrimWithDims 4 1
  ...
  have hL : denoteGraph pm_goal_124 initPM 1300
    ...
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_124 initPM 1300 _ _
      (List.take_append_drop 10 _).symm (by decide)
  have hR : ∀ t : Tid, t = 1345 ∨ t = 1347 ∨ t = 1349 ∨ t = 1351 →
      denoteGraph pm_goal_124 initPM t
        = denoteGraph {pm_goal_124 with nodes := pm_goal_124.nodes.take 9} initPM t := by
