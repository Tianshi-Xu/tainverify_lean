...
theorem b42_3_161 (initPM : Store) :
    (denoteGraph pm_goal_161 initPM) 1848 = allToAllPrimWithDims 4 3 [(denoteGraph pm_goal_161 initPM) 1966, (denoteGraph pm_goal_161 initPM) 1968, (denoteGraph pm_goal_161 initPM) 1970, (denoteGraph pm_goal_161 initPM) 1972] 2 3 := by
  have hL : denoteGraph pm_goal_161 initPM 1848
          = denoteGraph {pm_goal_161 with nodes := pm_goal_161.nodes.take 16} initPM 1848 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_161 initPM 1848 _ _
      (List.take_append_drop 16 _).symm (by decide)
  have hR : ∀ t : Tid, t = 1966 ∨ t = 1968 ∨ t = 1970 ∨ t = 1972 →
      denoteGraph pm_goal_161 initPM t
        = denoteGraph {pm_goal_161 with nodes := pm_goal_161.nodes.take 15} initPM t := by
