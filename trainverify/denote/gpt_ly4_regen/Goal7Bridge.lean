...
theorem pm_full_g7_1205 (initPM : Store) :
...
theorem pm_full_g7_1206 (initPM : Store) :
...
theorem pm_full_g7_1207 (initPM : Store) :
...
theorem pm_full_g7_1208 (initPM : Store) :
...
theorem pm_frame_574_self (initPM : Store) :
  ...
  rw [pm_full_g7_1205, pm_full_g7_1206, pm_full_g7_1207, pm_full_g7_1208]
...
theorem goal_7_cut_to_full (h : goal_7_stmt_cut) : goal_7_stmt := by
  ...
  have hInitCut : InitGoalsHold pm_goal_7.numRanks goal_7_cut_initGoals Ssm Spm := by
    ...
    simp only [goal_7_cut_initGoals, goal_7_prereqs, List.forall_mem_append,
      List.forall_mem_cons, List.forall_mem_nil, and_true]
    exact ⟨hinitC, hg2, hg3, hg4, hg5, hg257, hg263, List.forall_mem_nil _⟩
