...
theorem hbw1_194 (initPM : Store) :
    (denoteGraph pm_goal_194 initPM) 2431 = transposeAxes 2 3 (initPM 2432) := by
  have hL : denoteGraph pm_goal_194 initPM 2431
          = denoteGraph {pm_goal_194 with nodes := pm_goal_194.nodes.take 6} initPM 2431 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_194 initPM 2431 _ _
