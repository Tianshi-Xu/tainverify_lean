...
theorem hbw2_201 (initPM : Store) :
    (denoteGraph pm_goal_201 initPM) 2549 = transposeAxes 1 2 (initPM 2550) := by
  have hL : denoteGraph pm_goal_201 initPM 2549
          = denoteGraph {pm_goal_201 with nodes := pm_goal_201.nodes.take 7} initPM 2549 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_201 initPM 2549 _ _
