...
theorem hbw2_192 (initPM : Store) :
    (denoteGraph pm_goal_192 initPM) 2459 =
      batchedMatmul (initPM 2461) (transpose2d (initPM 653)) := by
  have hL : denoteGraph pm_goal_192 initPM 2459
          = denoteGraph {pm_goal_192 with nodes := pm_goal_192.nodes.take 7} initPM 2459 :=
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_192 initPM 2459 _ _
