...
theorem pm_full_g12_1281 (initPM : Store) :
...
theorem pm_full_g12_1282 (initPM : Store) :
...
theorem pm_full_g12_1283 (initPM : Store) :
...
theorem pm_full_g12_1284 (initPM : Store) :
...
theorem goal_12_cut_to_full (h : goal_12_stmt_cut) : goal_12_stmt := by
  ...
  have hInitCut : InitGoalsHold pm_goal_12.numRanks goal_12_cut_initGoals Ssm Spm := by
    ...
    simp only [goal_12_cut_initGoals, goal_12_prereqs, List.forall_mem_append,
      List.forall_mem_cons, List.forall_mem_nil, and_true]
    exact ⟨hinitC, hg2, hg3, hg4, hg5, hg7, hg11, hg257, hg263, List.forall_mem_nil _⟩
