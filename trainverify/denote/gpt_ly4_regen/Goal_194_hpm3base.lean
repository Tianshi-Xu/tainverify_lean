...
theorem hpm3base_194 (initPM : Store) :
    (denoteGraph pm_goal_194 initPM) 2388 = allToAllPrimWithDims 4 3
  ...
  have hL : denoteGraph pm_goal_194 initPM 2388
    ...
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_194 initPM 2388 _ _
      (List.take_append_drop 12 _).symm (by decide)
  have hR : ∀ t : Tid, t = 2429 ∨ t = 2431 ∨ t = 2433 ∨ t = 2435 →
      denoteGraph pm_goal_194 initPM t
        = denoteGraph {pm_goal_194 with nodes := pm_goal_194.nodes.take 11} initPM t := by
