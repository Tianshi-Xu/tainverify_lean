...
theorem hpm0base_124 (initPM : Store) :
    (denoteGraph pm_goal_124 initPM) 1298 = allToAllPrimWithDims 4 0
  ...
  have hL : denoteGraph pm_goal_124 initPM 1298
    ...
    denoteGraph_tid_eq_of_suffix_no_writes pm_goal_124 initPM 1298 _ _
      (List.take_append_drop 9 _).symm (by decide)
  have hR : ∀ t : Tid, t = 1345 ∨ t = 1347 ∨ t = 1349 ∨ t = 1351 →
      denoteGraph pm_goal_124 initPM t
        = denoteGraph {pm_goal_124 with nodes := pm_goal_124.nodes.take 8} initPM t := by
