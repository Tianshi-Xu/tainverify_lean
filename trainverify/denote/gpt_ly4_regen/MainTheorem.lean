...
import denote.gpt_ly4_regen.Goal291Bridge   -- goal_291_cut_to_full (FW_multiref params=[3] SECOND-output + AllGather dim1 -> single-tp 1000; sibling of goal_289 (same multiref, 2nd out); SM node 61 FW_multiref(640)->[1004,1008,1012] take 2nd 1008=640, PM nodes 396-399 4xFW_multiref(2229+r)->[3607+,3609+,2313+] take 2nd 3609/3619/3629/3639 + node 404 AllGatherPrim(literal ins)->1000; 640 from goal_55 dim1-gathered tps 2229-2232 [1,2,32]; template Goal289Bridge (1st-out) clone via applyNode_fw_multiref3_second_out_g291 (needs t1!=t2 via by decide); 69 prereqs [2..55,257-285 odd] NOT incl goal_289; unblocked by goal_55, unlocks goal_57)
