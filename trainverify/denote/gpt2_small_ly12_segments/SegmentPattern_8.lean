/- Auto-generated segment pattern proof file.
   ...
   Instances: 12
   Representative op scale: instances=12, goals/instance=3, ops/instance: SM=3, PM=17, ops=[OpName.BW_gelu, OpName.BW_linear, OpName.AllReducePrim, OpName.ChunkPrim]
-/
