...
namespace BWLayernormParamGraphK3B2S3D7DgammaDbeta
...
end BWLayernormParamGraphK3B2S3D7DgammaDbeta
/- AUTO-GENERATED closed relation state universe. -/

open TrainVerify.Denote
open TrainVerify.Denote.RelationCompiler

namespace TrainVerify.Denote.GeneratedBWLayernormParamK3B2S3D7DgammaDbeta
...
private def state_after : RelationState where
  facts := [fact_g, fact_x, fact_gamma, fact_beta, fact_dgamma, fact_dbeta, public_anchor]
  nonempty := by decide
...
@[irreducible] private def segment_000000_sm_final (store : Store) : Store :=
  segment_000000_sm_nodes.foldl (applyNodeDistributedFaithful BWLayernormParamGraphK3B2S3D7DgammaDbeta.sm) store
@[irreducible] private def segment_000000_pm_final (store : Store) : Store :=
  segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful BWLayernormParamGraphK3B2S3D7DgammaDbeta.pm) store
...
private theorem segment_000000_hSmdgamma (store : Store) :
  ...
  have hfinal : (segment_000000_sm_final store) = segment_000000_sm_nodes.foldl (applyNodeDistributedFaithful BWLayernormParamGraphK3B2S3D7DgammaDbeta.sm) store := by
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK3B2S3D7DgammaDbeta.sm
    ...
    hnodes hfinal (by
      ...
      exact applyNode_bw_layernorm_dw_out BWLayernormParamGraphK3B2S3D7DgammaDbeta.sm t 0 1 2 3 4 10 11 12 (by native_decide)
...
private theorem segment_000000_hPmdgamma0 (store : Store) :
  ...
  have hfinal : (segment_000000_pm_final store) = segment_000000_pm_nodes.foldl (applyNodeDistributedFaithful BWLayernormParamGraphK3B2S3D7DgammaDbeta.pm) store := by
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK3B2S3D7DgammaDbeta.pm
    ...
    hnodes hfinal (by
      ...
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_dw_out BWLayernormParamGraphK3B2S3D7DgammaDbeta.pm t 0 100 103 3 4 106 109 112 (by native_decide)
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hPmdgamma1 (store : Store) :
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK3B2S3D7DgammaDbeta.pm
    ...
    hnodes hfinal (by
      ...
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_dw_out BWLayernormParamGraphK3B2S3D7DgammaDbeta.pm t 1 101 104 3 4 107 110 113 (by native_decide)
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hPmdgamma2 (store : Store) :
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK3B2S3D7DgammaDbeta.pm
    ...
    hnodes hfinal (by
      ...
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_dw_out BWLayernormParamGraphK3B2S3D7DgammaDbeta.pm t 2 102 105 3 4 108 111 114 (by native_decide)
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hSmdbeta (store : Store) :
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK3B2S3D7DgammaDbeta.sm
    ...
    hnodes hfinal (by
      ...
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_db_out BWLayernormParamGraphK3B2S3D7DgammaDbeta.sm t 0 1 2 3 4 10 11 12 (by native_decide) (by native_decide)
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hPmdbeta0 (store : Store) :
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK3B2S3D7DgammaDbeta.pm
    ...
    hnodes hfinal (by
      ...
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_db_out BWLayernormParamGraphK3B2S3D7DgammaDbeta.pm t 0 100 103 3 4 106 109 112 (by native_decide) (by native_decide)
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hPmdbeta1 (store : Store) :
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK3B2S3D7DgammaDbeta.pm
    ...
    hnodes hfinal (by
      ...
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_db_out BWLayernormParamGraphK3B2S3D7DgammaDbeta.pm t 1 101 104 3 4 107 110 113 (by native_decide) (by native_decide)
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_hPmdbeta2 (store : Store) :
  ...
  exact segment_000000_four_input_middle_writer BWLayernormParamGraphK3B2S3D7DgammaDbeta.pm
    ...
    hnodes hfinal (by
      ...
      rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
      simp [applyNodeDistributed, applyNodeRingAttn]
      exact applyNode_bw_layernorm_db_out BWLayernormParamGraphK3B2S3D7DgammaDbeta.pm t 2 102 105 3 4 108 111 114 (by native_decide) (by native_decide)
    ) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
    (by native_decide) (by native_decide)
...
private theorem segment_000000_sound (smStore pmStore : Store)
  ...
  intro fact hfact
  have covered : fact ∈ [fact_dgamma, fact_dbeta] ++ state_before.facts :=
    (show state_after.facts ⊆ [fact_dgamma, fact_dbeta] ++ state_before.facts by native_decide) hfact
...
private def segment_000000 : ClosedDepSegmentCertificate BWLayernormParamGraphK3B2S3D7DgammaDbeta.sm BWLayernormParamGraphK3B2S3D7DgammaDbeta.pm state_before state_after where
...
end TrainVerify.Denote.GeneratedBWLayernormParamK3B2S3D7DgammaDbeta
