...
def pmGraph : GraphDecl := { numRanks := 3, nodes := [{ rank := 0, op := "OpName.BW_linear", ins := [1000, 2000, 3000], outs := [4000, 5000] }, { rank := 1, op := "OpName.BW_linear", ins := [1001, 2000, 3001], outs := [4001, 5001] }, { rank := 2, op := "OpName.BW_linear", ins := [1002, 2000, 3002], outs := [4002, 5002] }, { rank := 0, op := "OpName.AllReducePrim", ins := [6000, 6001, 6002], outs := [7000] }] }
...
def fact_tail_in : RelationFact := .reduction 600 [6000, 6001, 6002] [2, 5, 11]
...
private def segment_000000_pm_nodes : List NodeDecl := [{ rank := 0, op := "OpName.BW_linear", ins := [1000, 2000, 3000], outs := [4000, 5000] }, { rank := 1, op := "OpName.BW_linear", ins := [1001, 2000, 3001], outs := [4001, 5001] }, { rank := 2, op := "OpName.BW_linear", ins := [1002, 2000, 3002], outs := [4002, 5002] }, { rank := 0, op := "OpName.AllReducePrim", ins := [6000, 6001, 6002], outs := [7000] }]
...
private theorem segment_000000_hAllReduceWriter (pmStore : Store) :
    (segment_000000_pm_final pmStore) 7000 = allReducePrim 3 0 [(segment_000000_pm_final pmStore) 6000, (segment_000000_pm_final pmStore) 6001, (segment_000000_pm_final pmStore) 6002] := by
  have hfinal : (segment_000000_pm_final pmStore) = segment_000000_pm_nodes.foldl
    ...
    unfold segment_000000_pm_final
    rfl
  have hout_nodes : segment_000000_pm_nodes = (segment_000000_pm_nodes.take 3) ++ [{ rank := 0, op := "OpName.AllReducePrim", ins := [6000, 6001, 6002], outs := [7000] }] ++ (segment_000000_pm_nodes.drop 4) := by
    native_decide
  have hout_prefix : (segment_000000_pm_final pmStore) 7000 = allReducePrim 3 0 [((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticBWLinearDwRow.pmGraph) pmStore 6000, ((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticBWLinearDwRow.pmGraph) pmStore 6001, ((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticBWLinearDwRow.pmGraph) pmStore 6002] := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_middle_writer SyntheticBWLinearDwRow.pmGraph pmStore
      (segment_000000_pm_nodes.take 3) (segment_000000_pm_nodes.drop 4)
      { rank := 0, op := "OpName.AllReducePrim", ins := [6000, 6001, 6002], outs := [7000] } 7000
      (fun t => allReducePrim 3 0 [t 6000, t 6001, t 6002]) (by
        intro t
        rw [applyNodeDistributedFaithful_eq_applyNodeDistributed_of_not_collective (hshuffle := by native_decide) (hunshuffle := by native_decide) (hattn := by native_decide)]
        ...
        · exact applyNode_allReducePrim_out SyntheticBWLinearDwRow.pmGraph t 0 [6000, 6001, 6002] 7000
        · native_decide
        · native_decide
      ) (by native_decide) (by native_decide)
  have hout_read_0 : ((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticBWLinearDwRow.pmGraph) pmStore 6000 = (segment_000000_pm_final pmStore) 6000 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SyntheticBWLinearDwRow.pmGraph pmStore
      (segment_000000_pm_nodes.take 3) ({ rank := 0, op := "OpName.AllReducePrim", ins := [6000, 6001, 6002], outs := [7000] } :: (segment_000000_pm_nodes.drop 4)) 6000
      (by native_decide) (by native_decide)
  have hout_read_1 : ((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticBWLinearDwRow.pmGraph) pmStore 6001 = (segment_000000_pm_final pmStore) 6001 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SyntheticBWLinearDwRow.pmGraph pmStore
      (segment_000000_pm_nodes.take 3) ({ rank := 0, op := "OpName.AllReducePrim", ins := [6000, 6001, 6002], outs := [7000] } :: (segment_000000_pm_nodes.drop 4)) 6001
      (by native_decide) (by native_decide)
  have hout_read_2 : ((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticBWLinearDwRow.pmGraph) pmStore 6002 = (segment_000000_pm_final pmStore) 6002 := by
    rw [hfinal, hout_nodes]
    exact foldl_faithful_prefix_read_eq_final SyntheticBWLinearDwRow.pmGraph pmStore
      (segment_000000_pm_nodes.take 3) ({ rank := 0, op := "OpName.AllReducePrim", ins := [6000, 6001, 6002], outs := [7000] } :: (segment_000000_pm_nodes.drop 4)) 6002
      (by native_decide) (by native_decide)
  have hout : (segment_000000_pm_final pmStore) 7000 = allReducePrim 3 0 [(segment_000000_pm_final pmStore) 6000, (segment_000000_pm_final pmStore) 6001, (segment_000000_pm_final pmStore) 6002] := by
    calc
      _ = allReducePrim 3 0 [((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticBWLinearDwRow.pmGraph) pmStore 6000, ((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticBWLinearDwRow.pmGraph) pmStore 6001, ((segment_000000_pm_nodes.take 3)).foldl (applyNodeDistributedFaithful SyntheticBWLinearDwRow.pmGraph) pmStore 6002] := hout_prefix
      _ = allReducePrim 3 0 [(segment_000000_pm_final pmStore) 6000, (segment_000000_pm_final pmStore) 6001, (segment_000000_pm_final pmStore) 6002] := by rw [hout_read_0, hout_read_1, hout_read_2]
  exact hout
...
private theorem segment_000000_sound (smStore pmStore : Store)
    ...
    change ReductionRel (smFinal 600) [pmFinal 6000, pmFinal 6001, pmFinal 6002] [2, 5, 11] at hred
    have hReduceWriter := segment_000000_hAllReduceWriter pmStore
    change pmFinal 7000 = allReducePrim 3 0 [pmFinal 6000, pmFinal 6001, pmFinal 6002] at hReduceWriter
    have hReduceValue : smFinal 600 = allReducePrim 3 0 [pmFinal 6000, pmFinal 6001, pmFinal 6002] := by
