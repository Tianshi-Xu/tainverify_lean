...
def smGraph : GraphDecl where
  numRanks := 1
  nodes := [{ rank := 0, op := "OpName.FW_contiguous", ins := [10], outs := [30] }, { rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [30, 90], outs := [20], params := [1, 0] }]
  replicaGroups := [{ logical := { cid := 0, mb := 0, irname := "BW_maybe_unshuffle" }, members := [{ rank := 0, primaryOutTid := 20 }] }]
...
def pmGraph : GraphDecl where
  numRanks := 3
  nodes := [{ rank := 0, op := "OpName.FW_contiguous", ins := [100], outs := [110] }, { rank := 1, op := "OpName.FW_contiguous", ins := [101], outs := [111] }, { rank := 2, op := "OpName.FW_contiguous", ins := [102], outs := [112] }, { rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [110, 90], outs := [200], params := [3, 0] }, { rank := 1, op := "OpName.BW_maybe_unshuffle", ins := [111, 90], outs := [201], params := [3, 1] }, { rank := 2, op := "OpName.BW_maybe_unshuffle", ins := [112, 90], outs := [202], params := [3, 2] }]
  replicaGroups := [{ logical := { cid := 0, mb := 0, irname := "BW_maybe_unshuffle" }, members := [{ rank := 0, primaryOutTid := 200 }, { rank := 1, primaryOutTid := 201 }, { rank := 2, primaryOutTid := 202 }] }]
...
private def segment_000000_pm_nodes : List NodeDecl := [{ rank := 0, op := "OpName.FW_contiguous", ins := [100], outs := [110] }, { rank := 1, op := "OpName.FW_contiguous", ins := [101], outs := [111] }, { rank := 2, op := "OpName.FW_contiguous", ins := [102], outs := [112] }]
...
private def segment_000000 :
  ...
  sound := by
    ...
    have hPmWriter0 : pmFinal 110 = fw_contiguous (pmStore 100) := by
      ...
      rw [foldl_applyNodeDistributedFaithful_at_not_written CPEntry.pmGraph (pmNodes.take 0) pmStore 100 (by native_decide) (by native_decide)]
    have hPmWriter1 : pmFinal 111 = fw_contiguous (pmStore 101) := by
      ...
      rw [foldl_applyNodeDistributedFaithful_at_not_written CPEntry.pmGraph (pmNodes.take 1) pmStore 101 (by native_decide) (by native_decide)]
    have hPmWriter2 : pmFinal 112 = fw_contiguous (pmStore 102) := by
      ...
      rw [foldl_applyNodeDistributedFaithful_at_not_written CPEntry.pmGraph (pmNodes.take 2) pmStore 102 (by native_decide) (by native_decide)]
...
private def segment_000001 :
  ...
  smNodes := [{ rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [30, 90], outs := [20], params := [1, 0] }]
  pmNodes := [{ rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [110, 90], outs := [200], params := [3, 0] }, { rank := 1, op := "OpName.BW_maybe_unshuffle", ins := [111, 90], outs := [201], params := [3, 1] }, { rank := 2, op := "OpName.BW_maybe_unshuffle", ins := [112, 90], outs := [202], params := [3, 2] }]
  sound := by
    intro smStore pmStore hstate
    let smNodes : List NodeDecl := [{ rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [30, 90], outs := [20], params := [1, 0] }]
    let pmNodes : List NodeDecl := [{ rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [110, 90], outs := [200], params := [3, 0] }, { rank := 1, op := "OpName.BW_maybe_unshuffle", ins := [111, 90], outs := [201], params := [3, 1] }, { rank := 2, op := "OpName.BW_maybe_unshuffle", ins := [112, 90], outs := [202], params := [3, 2] }]
    let smFinal := smNodes.foldl (applyNodeDistributedFaithful CPEntry.smGraph) smStore
    let pmFinal := pmNodes.foldl (applyNodeDistributedFaithful CPEntry.pmGraph) pmStore
    ...
    have hSm : smFinal 20 = ZigzagCollective.fw_maybe_shuffle_collective [smStore 30] (decodeCuSeqlens (smStore 90)) 1 0 := by
      have hw : smFinal 20 = ZigzagCollective.fw_maybe_shuffle_collective [([].foldl (applyNodeDistributedFaithful CPEntry.smGraph) smStore) 30] (decodeCuSeqlens (([].foldl (applyNodeDistributedFaithful CPEntry.smGraph) smStore) 90)) 1 0 := by
        simpa [smFinal, smNodes] using
          (foldl_faithful_middle_writer CPEntry.smGraph smStore [] [] { rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [30, 90], outs := [20], params := [1, 0] } 20
            (fun t => ZigzagCollective.fw_maybe_shuffle_collective [t 30] (decodeCuSeqlens (t 90)) 1 0) (by
              ...
              rw [show CPEntry.smGraph.replicaBuddies { rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [30, 90], outs := [20], params := [1, 0] } = [{ rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [30, 90], outs := [20], params := [1, 0] }] by native_decide]
    ...
    have hPm0 : pmFinal 200 = ZigzagCollective.fw_maybe_shuffle_collective [pmStore 110, pmStore 111, pmStore 112] (decodeCuSeqlens (pmStore 90)) 3 0 := by
      have hw : pmFinal 200 = ZigzagCollective.fw_maybe_shuffle_collective [([].foldl (applyNodeDistributedFaithful CPEntry.pmGraph) pmStore) 110, ([].foldl (applyNodeDistributedFaithful CPEntry.pmGraph) pmStore) 111, ([].foldl (applyNodeDistributedFaithful CPEntry.pmGraph) pmStore) 112] (decodeCuSeqlens (([].foldl (applyNodeDistributedFaithful CPEntry.pmGraph) pmStore) 90)) 3 0 := by
        simpa [pmFinal, pmNodes] using
          (foldl_faithful_middle_writer CPEntry.pmGraph pmStore [] [{ rank := 1, op := "OpName.BW_maybe_unshuffle", ins := [111, 90], outs := [201], params := [3, 1] }, { rank := 2, op := "OpName.BW_maybe_unshuffle", ins := [112, 90], outs := [202], params := [3, 2] }] { rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [110, 90], outs := [200], params := [3, 0] } 200
            (fun t => ZigzagCollective.fw_maybe_shuffle_collective [t 110, t 111, t 112] (decodeCuSeqlens (t 90)) 3 0) (by
              ...
              unfold applyNodeBWMaybeUnshuffleValue
              rw [ZigzagCollective.bw_maybe_unshuffle_collective_eq_fw_shuffle]
              rw [show CPEntry.pmGraph.replicaBuddies { rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [110, 90], outs := [200], params := [3, 0] } = [{ rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [110, 90], outs := [200], params := [3, 0] }, { rank := 1, op := "OpName.BW_maybe_unshuffle", ins := [111, 90], outs := [201], params := [3, 1] }, { rank := 2, op := "OpName.BW_maybe_unshuffle", ins := [112, 90], outs := [202], params := [3, 2] }] by native_decide]
              rfl) (by native_decide) (by native_decide))
    ...
    have hPm1 : pmFinal 201 = ZigzagCollective.fw_maybe_shuffle_collective [pmStore 110, pmStore 111, pmStore 112] (decodeCuSeqlens (pmStore 90)) 3 1 := by
      have hw : pmFinal 201 = ZigzagCollective.fw_maybe_shuffle_collective [([{ rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [110, 90], outs := [200], params := [3, 0] }].foldl (applyNodeDistributedFaithful CPEntry.pmGraph) pmStore) 110, ([{ rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [110, 90], outs := [200], params := [3, 0] }].foldl (applyNodeDistributedFaithful CPEntry.pmGraph) pmStore) 111, ([{ rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [110, 90], outs := [200], params := [3, 0] }].foldl (applyNodeDistributedFaithful CPEntry.pmGraph) pmStore) 112] (decodeCuSeqlens (([{ rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [110, 90], outs := [200], params := [3, 0] }].foldl (applyNodeDistributedFaithful CPEntry.pmGraph) pmStore) 90)) 3 1 := by
        simpa [pmFinal, pmNodes] using
          (foldl_faithful_middle_writer CPEntry.pmGraph pmStore [{ rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [110, 90], outs := [200], params := [3, 0] }] [{ rank := 2, op := "OpName.BW_maybe_unshuffle", ins := [112, 90], outs := [202], params := [3, 2] }] { rank := 1, op := "OpName.BW_maybe_unshuffle", ins := [111, 90], outs := [201], params := [3, 1] } 201
            (fun t => ZigzagCollective.fw_maybe_shuffle_collective [t 110, t 111, t 112] (decodeCuSeqlens (t 90)) 3 1) (by
              ...
              unfold applyNodeBWMaybeUnshuffleValue
              rw [ZigzagCollective.bw_maybe_unshuffle_collective_eq_fw_shuffle]
              rw [show CPEntry.pmGraph.replicaBuddies { rank := 1, op := "OpName.BW_maybe_unshuffle", ins := [111, 90], outs := [201], params := [3, 1] } = [{ rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [110, 90], outs := [200], params := [3, 0] }, { rank := 1, op := "OpName.BW_maybe_unshuffle", ins := [111, 90], outs := [201], params := [3, 1] }, { rank := 2, op := "OpName.BW_maybe_unshuffle", ins := [112, 90], outs := [202], params := [3, 2] }] by native_decide]
              rfl) (by native_decide) (by native_decide))
      rw [foldl_applyNodeDistributedFaithful_at_not_written CPEntry.pmGraph [{ rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [110, 90], outs := [200], params := [3, 0] }] pmStore 110 (by native_decide) (by native_decide)] at hw
      rw [foldl_applyNodeDistributedFaithful_at_not_written CPEntry.pmGraph [{ rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [110, 90], outs := [200], params := [3, 0] }] pmStore 111 (by native_decide) (by native_decide)] at hw
      rw [foldl_applyNodeDistributedFaithful_at_not_written CPEntry.pmGraph [{ rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [110, 90], outs := [200], params := [3, 0] }] pmStore 112 (by native_decide) (by native_decide)] at hw
      rw [foldl_applyNodeDistributedFaithful_at_not_written CPEntry.pmGraph [{ rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [110, 90], outs := [200], params := [3, 0] }] pmStore 90 (by native_decide) (by native_decide)] at hw
      exact hw
    have hPm2 : pmFinal 202 = ZigzagCollective.fw_maybe_shuffle_collective [pmStore 110, pmStore 111, pmStore 112] (decodeCuSeqlens (pmStore 90)) 3 2 := by
      have hw : pmFinal 202 = ZigzagCollective.fw_maybe_shuffle_collective [([{ rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [110, 90], outs := [200], params := [3, 0] }, { rank := 1, op := "OpName.BW_maybe_unshuffle", ins := [111, 90], outs := [201], params := [3, 1] }].foldl (applyNodeDistributedFaithful CPEntry.pmGraph) pmStore) 110, ([{ rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [110, 90], outs := [200], params := [3, 0] }, { rank := 1, op := "OpName.BW_maybe_unshuffle", ins := [111, 90], outs := [201], params := [3, 1] }].foldl (applyNodeDistributedFaithful CPEntry.pmGraph) pmStore) 111, ([{ rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [110, 90], outs := [200], params := [3, 0] }, { rank := 1, op := "OpName.BW_maybe_unshuffle", ins := [111, 90], outs := [201], params := [3, 1] }].foldl (applyNodeDistributedFaithful CPEntry.pmGraph) pmStore) 112] (decodeCuSeqlens (([{ rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [110, 90], outs := [200], params := [3, 0] }, { rank := 1, op := "OpName.BW_maybe_unshuffle", ins := [111, 90], outs := [201], params := [3, 1] }].foldl (applyNodeDistributedFaithful CPEntry.pmGraph) pmStore) 90)) 3 2 := by
        simpa [pmFinal, pmNodes] using
          (foldl_faithful_middle_writer CPEntry.pmGraph pmStore [{ rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [110, 90], outs := [200], params := [3, 0] }, { rank := 1, op := "OpName.BW_maybe_unshuffle", ins := [111, 90], outs := [201], params := [3, 1] }] [] { rank := 2, op := "OpName.BW_maybe_unshuffle", ins := [112, 90], outs := [202], params := [3, 2] } 202
            (fun t => ZigzagCollective.fw_maybe_shuffle_collective [t 110, t 111, t 112] (decodeCuSeqlens (t 90)) 3 2) (by
              ...
              unfold applyNodeBWMaybeUnshuffleValue
              rw [ZigzagCollective.bw_maybe_unshuffle_collective_eq_fw_shuffle]
              rw [show CPEntry.pmGraph.replicaBuddies { rank := 2, op := "OpName.BW_maybe_unshuffle", ins := [112, 90], outs := [202], params := [3, 2] } = [{ rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [110, 90], outs := [200], params := [3, 0] }, { rank := 1, op := "OpName.BW_maybe_unshuffle", ins := [111, 90], outs := [201], params := [3, 1] }, { rank := 2, op := "OpName.BW_maybe_unshuffle", ins := [112, 90], outs := [202], params := [3, 2] }] by native_decide]
              rfl) (by native_decide) (by native_decide))
      rw [foldl_applyNodeDistributedFaithful_at_not_written CPEntry.pmGraph [{ rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [110, 90], outs := [200], params := [3, 0] }, { rank := 1, op := "OpName.BW_maybe_unshuffle", ins := [111, 90], outs := [201], params := [3, 1] }] pmStore 110 (by native_decide) (by native_decide)] at hw
      rw [foldl_applyNodeDistributedFaithful_at_not_written CPEntry.pmGraph [{ rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [110, 90], outs := [200], params := [3, 0] }, { rank := 1, op := "OpName.BW_maybe_unshuffle", ins := [111, 90], outs := [201], params := [3, 1] }] pmStore 111 (by native_decide) (by native_decide)] at hw
      rw [foldl_applyNodeDistributedFaithful_at_not_written CPEntry.pmGraph [{ rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [110, 90], outs := [200], params := [3, 0] }, { rank := 1, op := "OpName.BW_maybe_unshuffle", ins := [111, 90], outs := [201], params := [3, 1] }] pmStore 112 (by native_decide) (by native_decide)] at hw
      rw [foldl_applyNodeDistributedFaithful_at_not_written CPEntry.pmGraph [{ rank := 0, op := "OpName.BW_maybe_unshuffle", ins := [110, 90], outs := [200], params := [3, 0] }, { rank := 1, op := "OpName.BW_maybe_unshuffle", ins := [111, 90], outs := [201], params := [3, 1] }] pmStore 90 (by native_decide) (by native_decide)] at hw
      exact hw
