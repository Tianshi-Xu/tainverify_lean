...
def smGraph : GraphDecl where
  numRanks := 1
  nodes := [{ rank := 0, op := "OpName.FW_maybe_shuffle", ins := [10, 90], outs := [20], params := [1, 0] }, { rank := 0, op := "OpName.FW_maybe_unshuffle", ins := [20, 90], outs := [30], params := [1, 0] }]
  replicaGroups := [{ logical := { cid := 0, mb := 0, irname := "FW_maybe_shuffle" }, members := [{ rank := 0, primaryOutTid := 20 }] }, { logical := { cid := 1, mb := 0, irname := "FW_maybe_unshuffle" }, members := [{ rank := 0, primaryOutTid := 30 }] }]
...
def pmGraph : GraphDecl where
  numRanks := 3
  nodes := [{ rank := 0, op := "OpName.FW_maybe_shuffle", ins := [100, 90], outs := [200], params := [3, 0] }, { rank := 1, op := "OpName.FW_maybe_shuffle", ins := [101, 90], outs := [201], params := [3, 1] }, { rank := 2, op := "OpName.FW_maybe_shuffle", ins := [102, 90], outs := [202], params := [3, 2] }, { rank := 2, op := "OpName.FW_maybe_unshuffle", ins := [202, 90], outs := [302], params := [3, 2] }, { rank := 0, op := "OpName.FW_maybe_unshuffle", ins := [200, 90], outs := [300], params := [3, 0] }, { rank := 1, op := "OpName.FW_maybe_unshuffle", ins := [201, 90], outs := [301], params := [3, 1] }]
  replicaGroups := [{ logical := { cid := 0, mb := 0, irname := "FW_maybe_shuffle" }, members := [{ rank := 0, primaryOutTid := 200 }, { rank := 1, primaryOutTid := 201 }, { rank := 2, primaryOutTid := 202 }] }, { logical := { cid := 1, mb := 0, irname := "FW_maybe_unshuffle" }, members := [{ rank := 0, primaryOutTid := 300 }, { rank := 1, primaryOutTid := 301 }, { rank := 2, primaryOutTid := 302 }] }]
...
private def segment_000001 :
  ...
  smNodes := [{ rank := 0, op := "OpName.FW_maybe_unshuffle", ins := [20, 90], outs := [30], params := [1, 0] }]
  pmNodes := [{ rank := 2, op := "OpName.FW_maybe_unshuffle", ins := [202, 90], outs := [302], params := [3, 2] }, { rank := 0, op := "OpName.FW_maybe_unshuffle", ins := [200, 90], outs := [300], params := [3, 0] }, { rank := 1, op := "OpName.FW_maybe_unshuffle", ins := [201, 90], outs := [301], params := [3, 1] }]
  sound := by
    intro smStore pmStore hstate
    let smNodes : List NodeDecl := [{ rank := 0, op := "OpName.FW_maybe_unshuffle", ins := [20, 90], outs := [30], params := [1, 0] }]
    let pmNodes : List NodeDecl := [{ rank := 2, op := "OpName.FW_maybe_unshuffle", ins := [202, 90], outs := [302], params := [3, 2] }, { rank := 0, op := "OpName.FW_maybe_unshuffle", ins := [200, 90], outs := [300], params := [3, 0] }, { rank := 1, op := "OpName.FW_maybe_unshuffle", ins := [201, 90], outs := [301], params := [3, 1] }]
    let smFinal := smNodes.foldl (applyNodeDistributedFaithful CPEntry.smGraph) smStore
    let pmFinal := pmNodes.foldl (applyNodeDistributedFaithful CPEntry.pmGraph) pmStore
    ...
    have hSm : smFinal 30 = ZigzagCollective.fw_maybe_unshuffle_collective [smStore 20] (decodeCuSeqlens (smStore 90)) 1 0 := by
      have hw : smFinal 30 = ZigzagCollective.fw_maybe_unshuffle_collective [([].foldl (applyNodeDistributedFaithful CPEntry.smGraph) smStore) 20] (decodeCuSeqlens (([].foldl (applyNodeDistributedFaithful CPEntry.smGraph) smStore) 90)) 1 0 := by
        simpa [smFinal, smNodes] using
          (foldl_faithful_middle_writer CPEntry.smGraph smStore [] [] { rank := 0, op := "OpName.FW_maybe_unshuffle", ins := [20, 90], outs := [30], params := [1, 0] } 30
            (fun t => ZigzagCollective.fw_maybe_unshuffle_collective [t 20] (decodeCuSeqlens (t 90)) 1 0) (by
              ...
              rw [show CPEntry.smGraph.replicaBuddies { rank := 0, op := "OpName.FW_maybe_unshuffle", ins := [20, 90], outs := [30], params := [1, 0] } = [{ rank := 0, op := "OpName.FW_maybe_unshuffle", ins := [20, 90], outs := [30], params := [1, 0] }] by native_decide]
              rfl) (by native_decide) (by native_decide))
    ...
    have hPm0 : pmFinal 300 = ZigzagCollective.fw_maybe_unshuffle_collective [pmStore 200, pmStore 201, pmStore 202] (decodeCuSeqlens (pmStore 90)) 3 0 := by
      have hw : pmFinal 300 = ZigzagCollective.fw_maybe_unshuffle_collective [([{ rank := 2, op := "OpName.FW_maybe_unshuffle", ins := [202, 90], outs := [302], params := [3, 2] }].foldl (applyNodeDistributedFaithful CPEntry.pmGraph) pmStore) 200, ([{ rank := 2, op := "OpName.FW_maybe_unshuffle", ins := [202, 90], outs := [302], params := [3, 2] }].foldl (applyNodeDistributedFaithful CPEntry.pmGraph) pmStore) 201, ([{ rank := 2, op := "OpName.FW_maybe_unshuffle", ins := [202, 90], outs := [302], params := [3, 2] }].foldl (applyNodeDistributedFaithful CPEntry.pmGraph) pmStore) 202] (decodeCuSeqlens (([{ rank := 2, op := "OpName.FW_maybe_unshuffle", ins := [202, 90], outs := [302], params := [3, 2] }].foldl (applyNodeDistributedFaithful CPEntry.pmGraph) pmStore) 90)) 3 0 := by
        simpa [pmFinal, pmNodes] using
          (foldl_faithful_middle_writer CPEntry.pmGraph pmStore [{ rank := 2, op := "OpName.FW_maybe_unshuffle", ins := [202, 90], outs := [302], params := [3, 2] }] [{ rank := 1, op := "OpName.FW_maybe_unshuffle", ins := [201, 90], outs := [301], params := [3, 1] }] { rank := 0, op := "OpName.FW_maybe_unshuffle", ins := [200, 90], outs := [300], params := [3, 0] } 300
            (fun t => ZigzagCollective.fw_maybe_unshuffle_collective [t 200, t 201, t 202] (decodeCuSeqlens (t 90)) 3 0) (by
              intro t
              rw [applyNodeDistributedFaithful_unshuffle_out]
              unfold applyNodeFaithfulUnshuffleValue
              rw [show CPEntry.pmGraph.replicaBuddies { rank := 0, op := "OpName.FW_maybe_unshuffle", ins := [200, 90], outs := [300], params := [3, 0] } = [{ rank := 0, op := "OpName.FW_maybe_unshuffle", ins := [200, 90], outs := [300], params := [3, 0] }, { rank := 1, op := "OpName.FW_maybe_unshuffle", ins := [201, 90], outs := [301], params := [3, 1] }, { rank := 2, op := "OpName.FW_maybe_unshuffle", ins := [202, 90], outs := [302], params := [3, 2] }] by native_decide]
              rfl) (by native_decide) (by native_decide))
      rw [foldl_applyNodeDistributedFaithful_at_not_written CPEntry.pmGraph [{ rank := 2, op := "OpName.FW_maybe_unshuffle", ins := [202, 90], outs := [302], params := [3, 2] }] pmStore 200 (by native_decide) (by native_decide)] at hw
      rw [foldl_applyNodeDistributedFaithful_at_not_written CPEntry.pmGraph [{ rank := 2, op := "OpName.FW_maybe_unshuffle", ins := [202, 90], outs := [302], params := [3, 2] }] pmStore 201 (by native_decide) (by native_decide)] at hw
      rw [foldl_applyNodeDistributedFaithful_at_not_written CPEntry.pmGraph [{ rank := 2, op := "OpName.FW_maybe_unshuffle", ins := [202, 90], outs := [302], params := [3, 2] }] pmStore 202 (by native_decide) (by native_decide)] at hw
      rw [foldl_applyNodeDistributedFaithful_at_not_written CPEntry.pmGraph [{ rank := 2, op := "OpName.FW_maybe_unshuffle", ins := [202, 90], outs := [302], params := [3, 2] }] pmStore 90 (by native_decide) (by native_decide)] at hw
      exact hw
    have hPm1 : pmFinal 301 = ZigzagCollective.fw_maybe_unshuffle_collective [pmStore 200, pmStore 201, pmStore 202] (decodeCuSeqlens (pmStore 90)) 3 1 := by
      have hw : pmFinal 301 = ZigzagCollective.fw_maybe_unshuffle_collective [([{ rank := 2, op := "OpName.FW_maybe_unshuffle", ins := [202, 90], outs := [302], params := [3, 2] }, { rank := 0, op := "OpName.FW_maybe_unshuffle", ins := [200, 90], outs := [300], params := [3, 0] }].foldl (applyNodeDistributedFaithful CPEntry.pmGraph) pmStore) 200, ([{ rank := 2, op := "OpName.FW_maybe_unshuffle", ins := [202, 90], outs := [302], params := [3, 2] }, { rank := 0, op := "OpName.FW_maybe_unshuffle", ins := [200, 90], outs := [300], params := [3, 0] }].foldl (applyNodeDistributedFaithful CPEntry.pmGraph) pmStore) 201, ([{ rank := 2, op := "OpName.FW_maybe_unshuffle", ins := [202, 90], outs := [302], params := [3, 2] }, { rank := 0, op := "OpName.FW_maybe_unshuffle", ins := [200, 90], outs := [300], params := [3, 0] }].foldl (applyNodeDistributedFaithful CPEntry.pmGraph) pmStore) 202] (decodeCuSeqlens (([{ rank := 2, op := "OpName.FW_maybe_unshuffle", ins := [202, 90], outs := [302], params := [3, 2] }, { rank := 0, op := "OpName.FW_maybe_unshuffle", ins := [200, 90], outs := [300], params := [3, 0] }].foldl (applyNodeDistributedFaithful CPEntry.pmGraph) pmStore) 90)) 3 1 := by
        simpa [pmFinal, pmNodes] using
          (foldl_faithful_middle_writer CPEntry.pmGraph pmStore [{ rank := 2, op := "OpName.FW_maybe_unshuffle", ins := [202, 90], outs := [302], params := [3, 2] }, { rank := 0, op := "OpName.FW_maybe_unshuffle", ins := [200, 90], outs := [300], params := [3, 0] }] [] { rank := 1, op := "OpName.FW_maybe_unshuffle", ins := [201, 90], outs := [301], params := [3, 1] } 301
            (fun t => ZigzagCollective.fw_maybe_unshuffle_collective [t 200, t 201, t 202] (decodeCuSeqlens (t 90)) 3 1) (by
              intro t
              rw [applyNodeDistributedFaithful_unshuffle_out]
              unfold applyNodeFaithfulUnshuffleValue
              rw [show CPEntry.pmGraph.replicaBuddies { rank := 1, op := "OpName.FW_maybe_unshuffle", ins := [201, 90], outs := [301], params := [3, 1] } = [{ rank := 0, op := "OpName.FW_maybe_unshuffle", ins := [200, 90], outs := [300], params := [3, 0] }, { rank := 1, op := "OpName.FW_maybe_unshuffle", ins := [201, 90], outs := [301], params := [3, 1] }, { rank := 2, op := "OpName.FW_maybe_unshuffle", ins := [202, 90], outs := [302], params := [3, 2] }] by native_decide]
              rfl) (by native_decide) (by native_decide))
      rw [foldl_applyNodeDistributedFaithful_at_not_written CPEntry.pmGraph [{ rank := 2, op := "OpName.FW_maybe_unshuffle", ins := [202, 90], outs := [302], params := [3, 2] }, { rank := 0, op := "OpName.FW_maybe_unshuffle", ins := [200, 90], outs := [300], params := [3, 0] }] pmStore 200 (by native_decide) (by native_decide)] at hw
      rw [foldl_applyNodeDistributedFaithful_at_not_written CPEntry.pmGraph [{ rank := 2, op := "OpName.FW_maybe_unshuffle", ins := [202, 90], outs := [302], params := [3, 2] }, { rank := 0, op := "OpName.FW_maybe_unshuffle", ins := [200, 90], outs := [300], params := [3, 0] }] pmStore 201 (by native_decide) (by native_decide)] at hw
      rw [foldl_applyNodeDistributedFaithful_at_not_written CPEntry.pmGraph [{ rank := 2, op := "OpName.FW_maybe_unshuffle", ins := [202, 90], outs := [302], params := [3, 2] }, { rank := 0, op := "OpName.FW_maybe_unshuffle", ins := [200, 90], outs := [300], params := [3, 0] }] pmStore 202 (by native_decide) (by native_decide)] at hw
      rw [foldl_applyNodeDistributedFaithful_at_not_written CPEntry.pmGraph [{ rank := 2, op := "OpName.FW_maybe_unshuffle", ins := [202, 90], outs := [302], params := [3, 2] }, { rank := 0, op := "OpName.FW_maybe_unshuffle", ins := [200, 90], outs := [300], params := [3, 0] }] pmStore 90 (by native_decide) (by native_decide)] at hw
      exact hw
    have hPm2 : pmFinal 302 = ZigzagCollective.fw_maybe_unshuffle_collective [pmStore 200, pmStore 201, pmStore 202] (decodeCuSeqlens (pmStore 90)) 3 2 := by
      have hw : pmFinal 302 = ZigzagCollective.fw_maybe_unshuffle_collective [([].foldl (applyNodeDistributedFaithful CPEntry.pmGraph) pmStore) 200, ([].foldl (applyNodeDistributedFaithful CPEntry.pmGraph) pmStore) 201, ([].foldl (applyNodeDistributedFaithful CPEntry.pmGraph) pmStore) 202] (decodeCuSeqlens (([].foldl (applyNodeDistributedFaithful CPEntry.pmGraph) pmStore) 90)) 3 2 := by
        simpa [pmFinal, pmNodes] using
          (foldl_faithful_middle_writer CPEntry.pmGraph pmStore [] [{ rank := 0, op := "OpName.FW_maybe_unshuffle", ins := [200, 90], outs := [300], params := [3, 0] }, { rank := 1, op := "OpName.FW_maybe_unshuffle", ins := [201, 90], outs := [301], params := [3, 1] }] { rank := 2, op := "OpName.FW_maybe_unshuffle", ins := [202, 90], outs := [302], params := [3, 2] } 302
            (fun t => ZigzagCollective.fw_maybe_unshuffle_collective [t 200, t 201, t 202] (decodeCuSeqlens (t 90)) 3 2) (by
              intro t
              rw [applyNodeDistributedFaithful_unshuffle_out]
              unfold applyNodeFaithfulUnshuffleValue
              rw [show CPEntry.pmGraph.replicaBuddies { rank := 2, op := "OpName.FW_maybe_unshuffle", ins := [202, 90], outs := [302], params := [3, 2] } = [{ rank := 0, op := "OpName.FW_maybe_unshuffle", ins := [200, 90], outs := [300], params := [3, 0] }, { rank := 1, op := "OpName.FW_maybe_unshuffle", ins := [201, 90], outs := [301], params := [3, 1] }, { rank := 2, op := "OpName.FW_maybe_unshuffle", ins := [202, 90], outs := [302], params := [3, 2] }] by native_decide]
              rfl) (by native_decide) (by native_decide))
